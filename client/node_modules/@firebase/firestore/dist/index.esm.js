...
var T = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return n ? (Re("string" == typeof n.accessToken), new N(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.m = function() {
        ...
        return Re(null === t || "string" == typeof t), new b(t);
    }, t;
}(), k = /** @class */ function() {
    function t(t, e) {
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new k(this.P, this.V));
    }, t.prototype.l = function(t) {
...
/** Extracts the backend's type order for the provided value. */ function Q(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? z(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : xe();
}
...
function J(t, e) {
    ...
    var n = X(t), r = X(e), i = Pe(n.seconds, r.seconds);
...
e) {
     ...
     */
    t.wt = function(t) {
        return t instanceof Dt ? t.version : x.min();
    }, t;
}(), mt = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    n.prototype.gt = function(t) {
        var e;
        return e = t instanceof Dt ? t.data() : Tt.empty(), this.pt(e);
    }, n.prototype.pt = function(t) {
    ...
    return t(n, e), n.prototype.at = function(t, e) {
        if (this.It(t), Re(null != e.transformResults), !this.Rt.Et(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
    ...
    n.prototype.vt = function(t, e) {
        var n = [];
        Re(this.fieldTransforms.length === e.length);
...
var At, _t, kt = function(t, e) {
    ...
    function t(t, e, n, r, i, o, s) {
        ...
        this.startAt = o, this.endAt = s, this.Mt = null;
    }
    ...
    t.prototype.ee = function() {
        if (!this.Ut) if ("F" /* First */ === this.Bt) this.Ut = new Rt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            ...
            // Now return as a LimitType.First query.
                        this.Ut = new Rt(this.path, this.collectionGroup, t, this.filters, this.limit, o, s);
        }
        return this.Ut;
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        ...
        // Only compare types with matching backend order (such as double and int).
                return null !== e && Q(this.value) === Q(e) && this.de($(e, this.value));
    ...
    t.prototype.le = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? L.N(L.Z(o.referenceValue), e.key) : $(o, e.field(i.field)), 
     ...
     */ , s) {
        void 0 === i && (i = x.min()), void 0 === o && (o = x.min()), void 0 === s && (s = q.ht), 
 ...
 */ function Gt(t) {
    ...
    return De("GRPC error has no .code"), T.UNKNOWN;
    switch (t) {
      case At.OK:
        return T.OK;
...
var Yt = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.ze = function(t) {
        ...
        return new $t(this.data.be());
    }, t.prototype.ve = function(t) {
        return new $t(this.data.ve(t));
    }, 
 ...
 */ var ue = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, fe.ds(e, n)), new t(x.min(), r, se(), Ht(), ie());
    }, t;
}(), fe = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.qs = function(t) {
        for (var e = 0, n = t.ws; e < n.length; e++) {
            var r = n[e];
            t.Rs instanceof Dt ? this.Us(r, t.Rs) : t.Rs instanceof St && this.Qs(r, t.key, t.Rs);
        }
    ...
    t.prototype.Xs = function(t) {
        ...
        return this.Os = Ht(), this.xs = me(), this.Bs = new Yt(Pe), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.Ms.get(t);
        return e || (e = new ye, this.Ms.set(t, e)), e;
    ...
    t.prototype.Gs = function(t) {
        ...
        return e || ke("WatchChangeAggregator", "Detected inactive target", t), e;
    }, 
    /**
    ...
    t.prototype.zs = function(t) {
        var e = this;
        this.Ms.set(t, new ye), this.Ls.ei(t).forEach((function(n) {
 ...
 */ var we = {
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (Re(void 0 === t || "string" == typeof t), q.fromBase64String(t || "")) : (Re(void 0 === t || t instanceof Uint8Array), 
        q.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.C(t.C());
    }, t.prototype.fromVersion = function(t) {
        return Re(!!t), x.v(this.v(t));
        ...
        var e = this.di(t);
        return Re(e.get(1) === this.ii.projectId), Re(!e.get(3) && !this.ii.database || e.get(3) === this.ii.database), 
        new L(this.Ti(e));
        ...
        return Re(t.length > 4 && "documents" === t.get(4)), t.k(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ri = function(t, e) {
        ...
        Re(!!t.found), t.found.name, t.found.updateTime;
        ...
        if (t.transform) {
            ...
            return Re(!0 === n.exists), new wt(u, a);
        }
        if (t.verify) {
        ...
        var n = this;
        return t && t.length > 0 ? (Re(void 0 !== e), t.map((function(t) {
            return n.Li(t, e);
        }))) : [];
    }, t.prototype.Di = function(t) {
        var e = t.transform;
        ...
        var e = null;
        if ("setToServerValue" in t) Re("REQUEST_TIME" === t.setToServerValue), e = ut.instance; else if ("appendMissingElements" in t) {
        ...
        var c = null;
        return n.endAt && (c = this.Gi(n.endAt)), new Vt(e, i, u, s, a, "F" /* First */ , h, c).ee();
...
function(t, e, n, r, i) {
    ...
    return t.from = function(e, n, r, i) {
        Re(e.mutations.length === r.length);
    ...
    t.prototype.Ln = function(t, e) {
        this.$n();
        var n = this.Dn.get(e);
        return void 0 !== n ? Be.resolve(n) : this.Mn(t, e);
    }, 
    /**
    ...
    t;
}(), Ge = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", We = /** @class */ function() {
    function t() {
        this.Bn = [];
    }
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.Kn(t, new L(e)).next((function(t) {
            var e = te();
            return t instanceof Dt && (e = e.Ae(t.key, t)), e;
        }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.rr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    r = f instanceof Dt ? r.Ae(h, f) : r.remove(h);
                }
            }));
        })).next((function() {
        ...
        return this.Qn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof Dt && (h = h.Ae(t, e));
            })), h;
        }));
    }, t;
}(), Ke = /** @class */ function() {
...
var $e = function() {
    ...
    t.prototype.gr = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && ke("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ar + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
 ...
 */
function He(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Ze(e)), e = Xe(t.get(n), e);
    return Ze(e);
}
 ...
 */ function tn(t) {
    ...
    var e = t.length;
    if (Re(e >= 2), 2 === e) return Re("" === t.charAt(0) && "" === t.charAt(1)), 
    V.G;
 ...
 */ var en = /** @class */ function() {
    ...
    return t.prototype.Dr = function(t, e) {
        return this.Sr.add(e), Be.resolve();
    }, t.prototype.ir = function(t, e) {
        return Be.resolve(this.Sr.getEntries(e));
    }, t;
}(), nn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.O(), n = t.L(), r = this.index[e] || new Yt(V.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.O(), n = t.L(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Yt(V.N)).W();
    }, t;
}(), rn = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.Dr = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return on(t).Fr(r).next((function(t) {
 ...
 */ var sn = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return an(t).get(hn(e)).next((function(t) {
            return n.kr(t);
        }));
    }, 
    /**
    ...
    t.prototype.xr = function(t, e) {
        var n = this, r = Xt(), i = new Wt(L.N);
        return this.Or(t, e, (function(t, e) {
            var o = n.kr(e);
            o ? (r = r.Ae(t, o), i = i.Ae(t, cn(e))) : (r = r.Ae(t, null), i = i.Ae(t, 0));
        })).next((function() {
            return {
                Br: r,
                qr: i
        ...
        return an(t).Ur(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.q(u.key.path) ? u instanceof Dt && e.matches(u) && (i = i.Ae(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    ...
    t.prototype.Kr = function(t, e) {
        var n = this, r = Ht(), i = this.serializer.Wr(e), o = an(t), s = IDBKeyRange.lowerBound(i, !0);
        return o.Ur({
    ...
    t.prototype.Hr = function(t) {
        ...
        return un(t).get(jn.key).next((function(t) {
            return Re(!!t), t;
        }));
    }, t.prototype.$r = function(t, e) {
        return un(t).put(jn.key, e);
    }, 
    /**
 ...
 */ function un(t) {
    return wn.Nr(t, jn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function an(t) {
    return wn.Nr(t, qn.store);
}
 ...
 * limitations under the License.
 */
/** Offset to ensure non-overlapping target ids. */ sn.Jr = /** @class */ function(e) {
    /**
    ...
    return t(n, e), n.prototype.xn = function(t) {
        ...
        return this.Dn.forEach((function(o, s) {
            ...
            if (s) {
                ...
                var c = e.th.serializer.sh(new St(o, x.min()), e.readTime);
                n.push(e.th.Nn(t, o, c));
            } else n.push(e.th.kn(t, o));
        })), i.forEach((function(r) {
            n.push(e.th.jn.Dr(t, r));
        })), n.push(this.th.updateMetadata(t, r)), Be.vn(n);
...
var fn = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Rh(t, e.targetId).next((function() {
            ...
            return Re(e.targetCount > 0), e.targetCount -= 1, n.uh(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.js = function(t, e) {
        var n = this;
        return pn(t).Ur((function(t, r) {
            var i = n.serializer.mh(r);
            e(i);
        }));
    }, t.prototype.ah = function(t) {
        return dn(t).get(zn.key).next((function(t) {
            return Re(null !== t), t;
        }));
    }, t.prototype.uh = function(t, e) {
        return dn(t).put(zn.key, e);
    }, t.prototype.Th = function(t, e) {
        return pn(t).put(this.serializer.Ph(e));
    }, 
    /**
    ...
    t.prototype.Eh = function(t, e) {
        ...
        // depends on the queryTargets index to be efficient.
                return pn(t).Ur({
            range: i,
            index: Fn.queryTargetsIndexName
        }, (function(t, r, i) {
        ...
        // IndexedDb.
            ...
            var s = He(e.path);
            i.push(o.put(new Bn(n, s))), i.push(r.hh.yh(t, n, e));
        })), Be.vn(i);
        ...
        // IndexedDb.
            ...
            var o = He(e.path);
            return Be.vn([ i.delete([ n, o ]), r.hh.vh(t, n, e) ]);
        }));
    }, t.prototype.Rh = function(t, e) {
        var n = yn(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = yn(t), i = ie();
        return r.Ur({
            range: n,
            Dh: !0
        }, (function(t, e, n) {
            var r = tn(t[1]), o = new L(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.Ch = function(t, e) {
        var n = He(e.path), r = IDBKeyRange.bound([ n ], [ Ue(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return yn(t).Ur({
            index: Bn.documentTargetsIndex,
            Dh: !0,
            range: r
        }, (function(t, e, n) {
            var r = t[0];
 ...
 */
function pn(t) {
    return wn.Nr(t, Fn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function dn(t) {
    return wn.Nr(t, zn.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function yn(t) {
    return wn.Nr(t, Bn.store);
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ var vn = /** @class */ function() {
    function t(t) {
        this.Fh = t;
    }
    ...
    /** Encodes a document for storage locally. */ t.prototype.sh = function(t, e) {
        var n = this.Wr(e), r = t.key.path.L().W();
        if (t instanceof Dt) {
        ...
        if (t instanceof St) {
            ...
            return new qn(
            /* unknownDocument= */ null, new Cn(s, u), 
            /* document= */ null, a, n, r);
        }
        if (t instanceof xt) {
            var h = t.key.path.W(), c = this.$h(t.version);
            return new qn(new Mn(h, c), 
            /* noDocument= */ null, 
            /* document= */ null, 
        ...
        var e = t.C();
        return new Vn(e.seconds, e.nanoseconds);
    ...
    /** Decodes a DbMutationBatch into a MutationBatch */ t.prototype.Lh = function(t) {
    ...
    /** Decodes a DbTarget into TargetData */ t.prototype.mh = function(t) {
        var e, n = this.Nh(t.readTime), r = void 0 !== t.lastLimboFreeSnapshotVersion ? this.Nh(t.lastLimboFreeSnapshotVersion) : x.min();
        return e = void 0 !== t.query.documents ? this.Fh.xi(t.query) : this.Fh.Wi(t.query), 
    ...
    /** Encodes TargetData into a DbTarget for storage locally. */ t.prototype.Ph = function(t) {
        ...
        // lastListenSequenceNumber is always 0 until we do real GC.
                return new Fn(t.targetId, t.target.canonicalId(), n, i, t.sequenceNumber, r, e);
    }, t;
}(), mn = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs.", gn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Mh = t, r.Oh = n, r;
    }
    return t(n, e), n;
}(We), wn = /** @class */ function() {
    function t(e, n, r, i, o, s, u, a) {
        if (this.allowTabSynchronization = e, this.persistenceKey = n, this.clientId = r, 
        this.Tr = s, this.xh = a, this.Bh = null, this.qh = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        ...
        }, !t.Gh()) throw new I(T.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        if (this.hh = new Tn(this, o), this.zh = n + t.Hh, this.serializer = new vn(u), 
        this.document = i.document, this.Yh = new ln(this.hh, this.serializer), this.jn = new rn, 
        this.Qn = new sn(this.serializer, this.jn), !i.window || !i.window.localStorage) throw new I(T.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        this.window = i.window, this.Jh = this.window.localStorage;
    }
    return t.Nr = function(t, e) {
        if (t instanceof gn) return Yn.Nr(t.Mh, e);
        throw xe();
    }, 
    /**
    ...
    t.prototype.start = function() {
        var t = this;
        return Yn.Xh(this.zh, xn, new Rn(this.serializer)).then((function(e) {
            return t.Zh = e, t.to();
        })).then((function() {
            if (!t.isPrimary && !t.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new I(T.FAILED_PRECONDITION, mn);
    ...
    t.prototype.no = function(t) {
        var r = this;
        return this.Kh = function(i) {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(e) {
                    return this.ro ? [ 2 /*return*/ , t(i) ] : [ 2 /*return*/ ];
                }));
            }));
        }, t(this.isPrimary);
    }, 
        ...
        this.Tr.uo((function() {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.ro ? [ 4 /*yield*/ , this.to() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.to = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return bn(e).put(new Qn(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
            ...
            if (!t.allowTabSynchronization) {
                ...
                return ke("IndexedDbPersistence", "Failed to extend owner lease: ", e), t.isPrimary;
                throw e;
            }
            return ke("IndexedDbPersistence", "Releasing owner lease after error during lease refresh", e), 
            /* isPrimary= */ !1;
        })).then((function(e) {
        ...
        var e = this;
        return En(t).get(On.key).next((function(t) {
            return Be.resolve(e.fo(t));
        }));
    }, t.prototype.To = function(t) {
        return bn(t).delete(this.clientId);
    }, 
    /**
    ...
    t.prototype.Eo = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return !this.isPrimary || this.Io(this.jh, 18e5) ? [ 3 /*break*/ , 2 ] : (this.jh = Date.now(), 
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(n) {
                        var r = t.Nr(n, Qn.store);
                        return r.Fr().next((function(t) {
                            var n = e.wo(t, 18e5), i = t.filter((function(t) {
                  ...
                  case 1:
                    ...
                    n.sent().forEach((function(t) {
                        e.window.localStorage.removeItem(e.Ro(t.clientId));
                    })), n.label = 2;
    ...
    t.prototype.io = function() {
        var t = this;
        this.Wh = this.Tr.yr("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
    ...
    /** Checks whether `client` is the local client. */ t.prototype.fo = function(t) {
    ...
    t.prototype._o = function(t) {
        var e = this;
        return En(t).get(On.key).next((function(n) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || bn(t).Fr().next((function(t) {
            ...
            return e.isPrimary !== t && ke("IndexedDbPersistence", "Client " + (t ? "is" : "is not") + " eligible for a primary lease."), 
            t;
        }));
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.qh = !1, this.Po(), this.Wh && (this.Wh.cancel(), this.Wh = null), this.Vo(), 
                    this.po(), [ 4 /*yield*/ , this.runTransaction("shutdown", "readwrite", (function(e) {
                        return t.lo(e).next((function() {
                            return t.To(e);
                        }));
                    })).catch((function(t) {
                        ke("IndexedDbPersistence", "Proceeding with shutdown despite failure: ", t);
                    })) ];

                  case 1:
                    // The shutdown() operations are idempotent and can be called even when
                    // start() aborted (e.g. because it couldn't acquire the persistence lease).
                    return e.sent(), this.Zh.close(), 
    ...
    t.prototype.bo = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return bn(e).Fr().next((function(e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return t.Gh() ? (e = r + t.Hh, [ 4 /*yield*/ , Yn.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
        ...
        return Nn.So(t, this.serializer, this.jn, this.hh);
        ...
        var r = this;
        ke("IndexedDbPersistence", "Starting transaction:", t);
        var i, o = "readonly" === e ? "readonly" : "readwrite";
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.Zh.runTransaction(o, Kn, (function(o) {
            return i = new gn(o, r.Bh ? r.Bh.next() : Ye.dr), "readwrite-primary" === e ? r.co(i).next((function(t) {
                return !!t || r._o(i);
            })).next((function(e) {
                if (!e) throw De("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Tr.uo((function() {
                    return r.Kh(!1);
                })), new I(T.FAILED_PRECONDITION, Ge);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.No = function(t) {
        var e = this;
        return En(t).get(On.key).next((function(t) {
            if (null !== t && e.Io(t.leaseTimestampMs, 5e3) && !e.Ao(t.ownerId) && !e.fo(t) && (!e.allowTabSynchronization || !t.allowTabSynchronization)) throw new I(T.FAILED_PRECONDITION, mn);
        }));
    }, 
    /**
    ...
    t.prototype.do = function(t) {
        var e = new On(this.clientId, this.allowTabSynchronization, Date.now());
        return En(t).put(On.key, e);
    }, t.Gh = function() {
        return Yn.Gh();
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.lo = function(t) {
        var e = this, n = En(t);
        return n.get(On.key).next((function(t) {
            return e.fo(t) ? (ke("IndexedDbPersistence", "Releasing primary lease."), n.delete(On.key)) : Be.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.Io = function(t, e) {
        var n = Date.now();
        return !(t < n - e || t > n && (De("Detected an update time that is in the future: " + t + " > " + n), 
        1));
    }, t.prototype.eo = function() {
        var t = this;
    ...
    t.prototype.Ao = function(t) {
        try {
            ...
            return ke("IndexedDbPersistence", "Client '" + t + "' " + (e ? "is" : "is not") + " zombied in LocalStorage"), 
            e;
        } catch (t) {
            // Gracefully handle if LocalStorage isn't working.
            return De("IndexedDbPersistence", "Failed to get zombied client id.", t), !1;
        }
    }, 
    /**
    ...
    t.prototype.Po = function() {
        try {
            ...
            De("Failed to set zombie client id.", t);
        }
    }, 
    /** Removes the zombied client entry if it exists. */ t.prototype.yo = function() {
        try {
...
/** Provides LRU functionality for IndexedDB persistence. */ wn.Hh = "main";

var Tn = /** @class */ function() {
    function t(t, e) {
        this.db = t, this.ko = new fr(this, e);
    }
    ...
    t.prototype.qo = function(t, e) {
        ...
        var n = this, r = this.db.Co().Yr(), i = [], o = 0;
            ...
            if (u <= e) {
                var a = n.qo(t, s).next((function(e) {
                    ...
                    return o++, r.Ln(t, s).next((function() {
                        return r.kn(s), yn(t).delete([ 0, He(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var Nn = /** @class */ function() {
    function t(
    /**
    ...
    return t.So = function(e, n, r, i) {
        ...
        return Re("" !== e.uid), new t(e.t() ? e.uid : "", n, r, i);
        ...
        return this.Ho(t).next((function(t) {
            return q.fromBase64String(t.lastStreamToken);
        }));
        ...
        return s.add({}).next((function(u) {
            Re("number" == typeof u);
            for (var a = new je(u, e, n, r), h = i.serializer.kh(i.userId, a), c = [], f = new Yt((function(t, e) {
                return Pe(t.j(), e.j());
            })), l = 0, p = r; l < p.length; l++) {
                var d = p[l], y = Un.key(i.userId, d.key.path, u);
                f = f.add(d.key.path.L()), c.push(s.put(h)), c.push(o.put(y, Un.PLACEHOLDER));
            }
        ...
        var n = this;
        return kn(t).get(e).next((function(t) {
            return t ? (Re(t.userId === n.userId), n.serializer.Lh(t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.ta = function(t, e) {
        var n = this;
        return this.Ko[e] ? Be.resolve(this.Ko[e]) : this.Zo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Ko[e] = r, r;
            }
        ...
        return kn(t).Ur({
            ...
            e.userId === n.userId && (Re(e.batchId >= r), o = n.serializer.Lh(e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return kn(t).Fr(Ln.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return e.serializer.Lh(t);
            }));
        }));
    }, t.prototype.Gn = function(t, e) {
        var n = this, r = Un.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
                return Dn(t).Ur({
            range: i
        }, (function(r, i, s) {
            var u = r[0], a = r[1], h = r[2], c = tn(a);
            ...
            return kn(t).get(h).next((function(t) {
                if (!t) throw xe();
                Re(t.userId === n.userId), o.push(n.serializer.Lh(t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        return e.forEach((function(e) {
            var o = Un.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = Dn(t).Ur({
                range: s
            }, (function(t, i, o) {
                var s = t[0], u = t[1], a = t[2], h = tn(u);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
        ...
        var n = this, r = e.path, i = r.length + 1, o = Un.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Yt(Pe);
        return Dn(t).Ur({
            range: s
        }, (function(t, e, o) {
            var s = t[0], a = t[1], h = t[2], c = tn(a);
            s === n.userId && r.q(c) ? 
        ...
        return e.forEach((function(e) {
            i.push(kn(t).get(e).next((function(t) {
                if (null === t) throw xe();
                Re(t.userId === n.userId), r.push(n.serializer.Lh(t));
            })));
        })), Be.vn(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return _n(t.Mh, this.userId, e).next((function(r) {
    ...
    t.prototype.ha = function(t) {
        ...
        return this.Go(t).next((function(n) {
            ...
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(Un.prefixForUser(e.userId)), i = [];
            return Dn(t).Ur({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
 ...
 */ function An(t, e, n) {
    var r = Un.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return Dn(t).Ur({
        range: o,
        Dh: !0
    }, (function(t, n, r) {
...
function _n(t, e, n) {
    var r = t.store(Ln.store), i = t.store(Un.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Ur({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var h = [], c = 0, f = n.mutations; c < f.length; c++) {
        var l = f[c], p = Un.key(e, l.key.path, n.batchId);
 ...
 */ function kn(t) {
    return wn.Nr(t, Ln.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Dn(t) {
    return wn.Nr(t, Un.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Sn(t) {
    return wn.Nr(t, Pn.store);
}
 ...
 */ var xn = 10, Rn = /** @class */ function() {
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Bn.store), t.deleteObjectStore(Fn.store), t.deleteObjectStore(zn.store);
        }(t), Wn(t)), s = s.next((function() {
            /**
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Ln.store).Fr().next((function(n) {
        ...
        var e = 0;
        return t.store(qn.store).Ur((function(t, n) {
            e += cn(n);
        })).next((function() {
            var n = new jn(e);
            return t.store(jn.store).put(jn.key, n);
        }));
    }, t.prototype.removeAcknowledgedMutations = function(t) {
        var e = this, n = t.store(Pn.store), r = t.store(Ln.store);
        return n.Fr().next((function(n) {
            return Be.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Fr(Ln.userMutationsIndex, i).next((function(r) {
                    return Be.forEach(r, (function(r) {
                        Re(r.userId === n.userId);
                        var i = e.serializer.Lh(r);
                        return _n(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        var e = t.store(Bn.store), n = t.store(qn.store);
        return t.store(zn.store).get(zn.key).next((function(t) {
            var r = [];
            return n.Ur((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? Be.resolve() : function(n) {
                        return e.put(new Bn(0, He(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Be.vn(r);
        ...
        var n = e.store(Gn.store), r = new nn, i = function(t) {
            if (r.add(t)) {
                var e = t.O(), i = t.L();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(qn.store).Ur({
            Dh: !0
        }, (function(t, e) {
            var n = new V(t);
            return i(n.L());
        })).next((function() {
            return e.store(Un.store).Ur({
                Dh: !0
            }, (function(t, e) {
                t[0];
                var n = t[1], r = (t[2], tn(n));
                return i(r.L());
            }));
        }));
    }, t.prototype.rewriteCanonicalIds = function(t) {
        var e = this, n = t.store(Fn.store);
...
jn.store = "remoteDocumentGlobal", jn.key = "remoteDocumentGlobalKey";
...
Fn.queryTargetsIndexName = "queryTargetsIndex", 
/**
...
/** Name of the IndexedDb object store.  */ Bn.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Bn.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Bn.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Bn.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ function Wn(t) {
    t.createObjectStore(Bn.store, {
        keyPath: Bn.keyPath
    }).createIndex(Bn.documentTargetsIndex, Bn.documentTargetsKeyPath, {
        unique: !0
    }), 
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore(Fn.store, {
        keyPath: Fn.keyPath
    }).createIndex(Fn.queryTargetsIndexName, Fn.queryTargetsKeyPath, {
        unique: !0
...
/** Name of the IndexedDb object store. */ Qn.store = "clientMetadata", 
/** Keys are automatically assigned via the clientId properties. */
Qn.keyPath = "clientId";

var Kn = r(r(r([ Pn.store, Ln.store, Un.store, qn.store, Fn.store, On.store, zn.store, Bn.store ], [ Qn.store ]), [ jn.store ]), [ Gn.store ]), Yn = /** @class */ function() {
    function t(e) {
        this.db = e, 
        ...
        // log on 12.2.
        12.2 === t.aa(u()) && De("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.")
        /**
    ...
    return t.Xh = function(e, n, r) {
        return ke("SimpleDb", "Opening database:", e), new Be((function(i, o) {
            ...
            s.onsuccess = function(e) {
                ...
                ke("SimpleDb", 'Database "' + e + '" requires upgrade from version:', t.oldVersion);
                var n = t.target.result;
                r.createOrUpgrade(n, s.transaction, t.oldVersion, xn).next((function() {
                    ke("SimpleDb", "Database upgrade to version " + xn + " complete");
                }));
            };
        })).yn();
    }, 
    /** Deletes the specified database. */ t.delete = function(t) {
        return ke("SimpleDb", "Removing database:", t), tr(window.indexedDB.deleteDatabase(t)).yn();
    }, 
    /** Returns true if IndexedDB is available in the current environment. */ t.Gh = function() {
        ...
        // Check the UA string to find out the browser.
                var e = u(), n = t.aa(e), r = 0 < n && n < 10, i = t.ca(e), o = 0 < i && i < 4.5;
        // IE 10
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                ...
                                })).yn(), a = {}, s.catch((function() {})), [ 4 /*yield*/ , t.la ];
                              ...
                              case 3:
                                return h = n.sent(), c = "FirebaseError" !== h.name && o < 3, ke("SimpleDb", "Transaction failed with error: %s. Retrying: %s.", h.message, c), 
 ...
 */ var Xn = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             */
        this.Ia = new $e, this.transaction.oncomplete = function() {
            e.Ia.resolve();
        }, this.transaction.onabort = function() {
            t.error ? e.Ia.reject(new Jn(t.error)) : e.Ia.resolve();
        }, this.transaction.onerror = function(t) {
            var n = nr(t.target.error);
            e.Ia.reject(new Jn(n));
        };
    }
    return t.open = function(e, n, r) {
        ...
        t && this.Ia.reject(t), this.aborted || (ke("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    return t.prototype.put = function(t, e) {
        var n;
        return void 0 !== e ? (ke("SimpleDb", "PUT", this.store.name, t, e), n = this.store.put(e, t)) : (ke("SimpleDb", "PUT", this.store.name, "<auto-key>", t), 
    ...
    t.prototype.add = function(t) {
        return ke("SimpleDb", "ADD", this.store.name, t, t), tr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
            ...
            return void 0 === n && (n = null), ke("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return ke("SimpleDb", "DELETE", this.store.name, t), tr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return ke("SimpleDb", "COUNT", this.store.name), tr(this.store.count());
        ...
        ke("SimpleDb", "DELETE ALL", this.store.name);
    ...
    t.prototype.Uo = function(t) {
        ...
        return new Be((function(r, i) {
            t.onerror = function(t) {
                ...
                if (i) {
                    var o = new $n(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof Be) {
 ...
 */ var rr = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Aa = t, this.Er = e, this.ma = n, this.op = r, this.Pa = i, this.Va = new $e, 
        this.then = this.Va.promise.then.bind(this.Va.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.pa && (this.clearTimeout(), this.Va.reject(new I(T.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.$a = new Je(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.qa = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Oa(), this.Sa ? [ 3 /*break*/ , 2 ] : (this.Sa = !0, (e = Ie.nt().window) && e.removeEventListener("visibilitychange", this.ka), 
                    [ 4 /*yield*/ , this.Ba(t) ]);
    ...
    t.prototype.Ua = function(t) {
        ...
        this.Oa(), this.Sa || (this.va = this.va.then((function() {
                ...
                return e(r, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return n.sent(), i.resolve(), this.$a.reset(), [ 3 /*break*/ , 3 ];

                          case 2:
                            if (!Hn(e = n.sent())) throw i.resolve(), e;
                            // Failure will be handled by AsyncQueue
                                                        return ke("AsyncQueue", "Operation failed with retryable error: " + e), 
                            this.$a.gr(o), [ 3 /*break*/ , 3 ];
            ...
            return r.uo(o), i.promise;
        })));
    }, t.prototype.xa = function(t) {
        var e = this, n = this.ba.then((function() {
            return e.Fa = !0, t().catch((function(t) {
                // Re-throw the error so that this.tail becomes a rejected Promise and
                // all further attempts to chain (via .then) will just short-circuit
                // and return the rejected Promise.
                throw e.Ca = t, e.Fa = !1, De("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.Fa = !1, t;
            }));
    ...
    t.prototype.yr = function(t, e, n) {
        ...
        var i = rr.ga(this, t, e, n, (function(t) {
            return r.Qa(t);
        }));
    ...
    t.prototype.ja = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.ba ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.ba) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
 ...
 */
function or(t, e) {
    if (De("AsyncQueue", e + ": " + t), Hn(t)) return new I(T.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var ur = /** @class */ function() {
    function t(t) {
        this.Ha = t, this.buffer = new Yt(sr), this.Ya = 0;
    }
...
hr.uu = -1, hr.cu = 1048576, hr._u = 41943040, hr.ou = 10, hr.au = 1e3, hr.lu = new hr(hr._u, hr.ou, hr.au), 
hr.DISABLED = new hr(hr.uu, 0, 0);
...
var cr = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        var r = this, i = this.du ? 3e5 : 6e4;
        ke("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.fu = this.Aa.yr("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return e(r, void 0, void 0, (function() {
                var e;
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.fu = null, this.du = !0, n.label = 1;

                      case 1:
                        return n.trys.push([ 1, 3, , 7 ]), [ 4 /*yield*/ , t.Iu(this.ko) ];

                      case 2:
                        return n.sent(), [ 3 /*break*/ , 7 ];

                      case 3:
                        return Hn(e = n.sent()) ? (ke("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Au = function(t, e) {
        var n = this;
    ...
    t.prototype.Qo = function(t, e) {
        ...
        var n = this;
        return this.Tu.iu === hr.uu ? (ke("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Be.resolve(ar)) : this.jo(t).next((function(r) {
            return r < n.Tu.iu ? (ke("LruGarbageCollector", "Garbage collection skipped; Cache size " + r + " is lower than threshold " + n.Tu.iu), 
            ar) : n.Pu(t, e);
        }));
    }, t.prototype.jo = function(t) {
        return this.wu.jo(t);
        ...
        return this.Ru(t, this.Tu.nu).next((function(e) {
            ...
            return e > c.Tu.ru ? (ke("LruGarbageCollector", "Capping sequence numbers to collect down to the maximum of " + c.Tu.ru + " from " + e), 
            r = c.Tu.ru) : r = e, o = Date.now(), c.Au(t, r);
        })).next((function(r) {
            return n = r, u = Date.now(), c.Ah(t, n, e);
        })).next((function(e) {
            return i = e, a = Date.now(), c.Qo(t, n);
        })).next((function(t) {
            return h = Date.now(), Ae() <= s.DEBUG && ke("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - f) + "ms\n\tDetermined least recently used " + r + " in " + (u - o) + "ms\n\tRemoved " + i + " targets in " + (a - u) + "ms\n\tRemoved " + t + " documents in " + (h - a) + "ms\nTotal Duration: " + (h - f) + "ms"), 
            Be.resolve({
                Za: !0,
                tu: r,
                eu: i,
    ...
    t, e, n) {
        ...
        /**
             ...
             * PORTING NOTE: This is only used for multi-tab synchronization.
             */
        this.yu = x.min(), this.Wn = t.vo(n), this.bu = t.Co(), this.Yh = t.Do(), this.vu = new Qe(this.bu, this.Wn, this.persistence.Fo()), 
        this.Vu.Su(this.vu)
    ...
    t.prototype.Du = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Wn, r = this.vu, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        // Swap out the mutation queue, grabbing the pending mutation batches
                        // before and after.
                        var i;
                        return o.Wn.ia(n).next((function(s) {
                            return i = s, e = o.persistence.vo(t), 
                            // Recreate our LocalDocumentsView using the new
                            // MutationQueue.
                            r = new Qe(o.bu, e, o.persistence.Fo()), e.ia(n);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.Wn = e, this.vu = r, this.Vu.Su(this.vu), 
                    i) ];
                }
            }));
        }));
    }, 
    /* Accept locally generated Mutations and commit them to storage. */ t.prototype.$u = function(t) {
    ...
    t.prototype.Lu = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Wn.Zo(n, t).next((function(t) {
                return Re(null !== t), r = t.keys(), e.Wn.ra(n, t);
            })).next((function() {
                return e.Wn.oa(n);
            })).next((function() {
                return e.vu.Yn(n, r);
    ...
    /** Returns the last recorded stream token for the current user. */ t.prototype.Yo = function() {
        var t = this;
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // access.
                    s.kn(i, r), a = a.Ae(i, h)) : null == c || h.version.S(c.version) > 0 || 0 === h.version.S(c.version) && c.hasPendingWrites ? (s.Nn(h, r), 
                    a = a.Ae(i, h)) : ke("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
                    e._s.has(i) && u.push(n.persistence.hh.Wo(o, i));
                }));
            }))), !r.isEqual(x.min())) {
    ...
    t.Ou = function(t, e, n) {
        ...
        return Re(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Ee.D() - t.Ee.D() >= this.xu || n.Ts.size + n.Es.size + n.Is.size > 0);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return Be.forEach(t, (function(t) {
                            return Be.forEach(t.hr, (function(n) {
                                return c.persistence.hh.yh(e, t.targetId, n);
                            })).next((function() {
                                return Be.forEach(t.or, (function(n) {
                  ...
                  case 2:
                    if (!Hn(e = n.sent())) throw e;
                    // If `notifyLocalViewChanges` fails, we did not advance the sequence
                    // number for the documents that were included in this transaction.
                    // This might trigger them to be deleted earlier than they otherwise
                    // would have, but it should not invalidate the integrity of the data.
                                        return ke("LocalStore", "Failed to update sequence numbers: " + e), 
                    [ 3 /*break*/ , 3 ];

                  case 3:
                    for (r = 0, i = t; r < i.length; r++) o = i[r], s = o.targetId, o.fromCache || (u = this.gu.get(s), 
                    a = u.Ee, h = u.Re(a), 
    ...
    t.prototype.Qu = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Yh.gh(n, t).next((function(i) {
                ...
                r = i, Be.resolve(r)) : e.Yh.oh(n).next((function(i) {
                    return r = new Ft(t, i, 0 /* Listen */ , n.Oh), e.Yh.fh(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
        })).then((function(n) {
            return null === e.gu.get(n.targetId) && (e.gu = e.gu.Ae(n.targetId, n), e.pu.set(t, n.targetId)), 
            n;
        }));
    }, 
    /**
    ...
    t.prototype.gh = function(t, e) {
        var n = this.pu.get(e);
        return void 0 !== n ? Be.resolve(this.gu.get(n)) : this.Yh.gh(t, e);
    }, 
    /**
    ...
    t.prototype.Wu = function(t, e) {
        var n = this, r = this.gu.get(t), i = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? Be.resolve() : n.persistence.hh.removeTarget(t, r);
        })).then((function() {
    ...
    t.prototype.ju = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.gh(o, t.ee()).next((function(t) {
                ...
                return n.Vu.Zn(o, t, e ? r : x.min(), e ? i : ie());
            })).next((function(t) {
                return {
                    documents: t,
                    Ku: i
        ...
        return o.forEach((function(r) {
            s = s.next((function() {
                ...
                Re(null !== s), (!o || o.version.S(s) < 0) && ((o = i.at(r, o, e)) && 
...
var pr = /** @class */ function(r) {
    function i(t, e, n) {
        var i = this;
        return (i = r.call(this, t, e, n) || this).persistence = t, i.Wn = t.vo(n), i.bu = t.Co(), 
        i.Yh = t.Do(), i;
    }
    /** Starts the LocalStore. */    return t(i, r), i.prototype.start = function() {
        return this.Gu();
    }, 
    /** Returns the local view of the documents affected by a mutation batch. */ i.prototype.zu = function(t) {
        var e = this;
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", (function(n) {
            return e.Wn.ta(n, t).next((function(t) {
                return t ? e.vu.Yn(n, t) : Be.resolve(null);
            }));
        }));
    ...
    }, i.prototype.Yu = function(t) {
        var e = this, n = this.gu.get(t);
 ...
 */ function dr(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            if (t.code !== T.FAILED_PRECONDITION || t.message !== Ge) throw t;
            return ke("LocalStore", "Unexpectedly lost primary lease"), [ 2 /*return*/ ];
        }));
    }));
}
 ...
 */ var yr = /** @class */ function() {
    function t() {
        ...
        this.Ju = new Yt(vr.Xu), 
        // A set of outstanding references to a document sorted by target id.
        this.Zu = new Yt(vr.tc)
    ...
    /** Add references to the given document keys for the given ID. */ t.prototype.ec = function(t, e) {
        var n = this;
    ...
    t.prototype.nc = function(t) {
        var e = this, n = L.EMPTY, r = new vr(n, t), i = new vr(n, t + 1), o = [];
        ...
        var e = L.EMPTY, n = new vr(e, t), r = new vr(e, t + 1), i = ie();
        return this.Zu.Ke([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Ch = function(t) {
        var e = new vr(t, 0), n = this.Ju.ze(e);
    ...
    return t.Xu = function(t, e) {
        return L.N(t.key, e.key) || Pe(t.oc, e.oc);
    }, 
    /** Compare by ID then by key */ t.tc = function(t, e) {
        return Pe(t.oc, e.oc) || L.N(t.key, e.key);
    }, t;
}();
 ...
 */
function mr(t, e) {
    if (0 !== e.length) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + Pr(e.length, "argument") + ".");
}
 ...
 */ function gr(t, e, n) {
    if (e.length !== n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires " + Pr(n, "argument") + ", but was called with " + Pr(e.length, "argument") + ".");
}
 ...
 */ function wr(t, e, n) {
    if (e.length < n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires at least " + Pr(n, "argument") + ", but was called with " + Pr(e.length, "argument") + ".");
}
 ...
 */ function Er(t, e, n, r) {
    if (e.length < n || e.length > r) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + Pr(e.length, "argument") + ".");
}
...
/** Helper to validate the type of a provided input. */ function _r(t, e, n, r) {
    if (!("object" === e ? kr(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = Dr(r);
...
function Sr(t, e, n) {
    if (void 0 === n) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + Or(e) + " argument, but it was undefined.");
}
 ...
 */ function Rr(t, e, n, r) {
    var i = Dr(r);
    return new I(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + Or(n) + " argument to be a " + e + ", but it was: " + i);
}

function Vr(t, e, n) {
    if (n <= 0) throw new I(T.INVALID_ARGUMENT, "Function " + t + "() requires its " + Or(e) + " argument to be a positive number, but it was: " + n + ".");
}
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function Lr() {
    if ("undefined" == typeof Uint8Array) throw new I(T.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function Ur() {
    if (!Ie.nt().ac) throw new I(T.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var Cr = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        gr("Blob.fromBase64String", arguments, 1), br("Blob.fromBase64String", "string", 1, e), 
        Ur();
        try {
        ...
        if (gr("Blob.fromUint8Array", arguments, 1), Lr(), !(e instanceof Uint8Array)) throw Rr("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(q.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return gr("Blob.toBase64", arguments, 0), Ur(), this.uc.toBase64();
    }, t.prototype.toUint8Array = function() {
        return gr("Blob.toUint8Array", arguments, 0), Lr(), this.uc.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new I(T.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + Pr(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (br("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new I(T.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.cc = new P(t);
    }
    return t.documentId = function() {
        return t._c;
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Rr("isEqual", "FieldPath", 1, e);
 ...
 */
var qr = new RegExp("[~\\*/\\[\\]]"), jr = function(t) {
    this.lc = t;
}, Fr = /** @class */ function(e) {
    function n() {
    ...
    return t(n, e), n.prototype.Di = function(t) {
        if (2 /* MergeSet */ !== t.dc) throw 1 /* Update */ === t.dc ? t.fc("FieldValue.delete() can only appear at the top level of your update data") : t.fc("FieldValue.delete() cannot be used with set() unless you pass {merge:true}");
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayUnion") || this).Tc = t, n;
    }
    return t(n, e), n.prototype.Di = function(t) {
        ...
        var e = new Hr({
            ...
            methodName: this.lc,
            Ec: !0
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = this.Tc.map((function(t) {
            return Zr(t, e);
        })), r = new at(n);
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayRemove") || this).Tc = t, n;
    }
    return t(n, e), n.prototype.Di = function(t) {
        // Although array transforms are used with writes, the actual elements
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.increment") || this).Ic = t, n;
    }
    return t(n, e), n.prototype.Di = function(t) {
        var e = new Hr({
            dc: 3 /* Argument */ ,
            methodName: this.lc
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = Zr(this.Ic, e), r = new ct(t.serializer, n);
        return new pt(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(jr), Qr = /** @class */ function() {
    function t(t, e) {
        if (gr("GeoPoint", arguments, 2), br("GeoPoint", "number", 1, t), br("GeoPoint", "number", 2, e), 
     ...
     */
    t.prototype.p = function(t) {
        return Pe(this.wc, t.wc) || Pe(this.Rc, t.Rc);
    }, t;
}(), Kr = /^__.*__$/, Yr = /** @class */ function() {
    function t(t, e, n) {
...
/** A "context" object passed around while parsing user data. */ var Hr = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Pc = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Pc({
            path: n,
            Ec: !1
        });
        return r.gc(t), r;
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.gc(this.path.get(t));
    }, t.prototype.gc = function(t) {
        if (0 === t.length) throw this.fc("Document fields must not be empty");
        if (Jr(this.dc) && Kr.test(t)) throw this.fc('Document fields cannot begin and end with "__"');
    }, t;
}(), Xr = /** @class */ function() {
    function t(t, e, n) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = n || Ie.nt().bc(t)
        /** Parse document data from a non-merge set() call. */;
    }
    return t.prototype.vc = function(t, e) {
        var n = this.Sc(0 /* Set */ , t);
        ni("Data must be an object, but it was:", n, e);
        var r = ti(e, n);
        return new Yr(new Tt(r), 
        /* fieldMask= */ null, n.fieldTransforms);
    }, 
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Dc = function(t, e, n) {
        var r = this.Sc(2 /* MergeSet */ , t);
        ni("Data must be an object, but it was:", r, e);
        var i, o, s = ti(e, r);
        if (n) {
            for (var u = [], a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
                if (c instanceof Mr) f = c.cc; else {
        ...
        return new Yr(new Tt(s), i, o);
    }, 
    /** Parse update data from an update() call. */ t.prototype.Cc = function(t, e) {
        var n = this.Sc(1 /* Update */ , t);
        ni("Data must be an object, but it was:", n, e);
        var r = [], i = new It;
        C(e, (function(e, o) {
            var s = ii(t, e), u = n.pc(s);
            if (o instanceof Fr) 
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Fc = function(t, e, n, r) {
        var i = this.Sc(1 /* Update */ , t), o = [ ri(t, e) ], s = [ n ];
        ...
        for (var a = [], h = new It, c = o.length - 1; c >= 0; --c) if (!oi(a, o[c])) {
            var f = o[c], l = s[c], p = i.pc(f);
            if (l instanceof Fr) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(f); else {
                var d = Zr(l, p);
        ...
        var y = new lt(a);
        return new $r(h.yt(), y, i.fieldTransforms);
    }, 
    /** Creates a new top-level parse context. */ t.prototype.Sc = function(t, e) {
        return new Hr({
            dc: t,
            methodName: e,
            path: P.G,
    ...
    t.prototype.Nc = function(t, e, n) {
        return void 0 === n && (n = !1), Zr(e, this.Sc(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Zr(t, e) {
    if (ei(t)) return ni("Unsupported field value:", e, t), ti(t, e);
    if (t instanceof jr) 
    ...
    return function(t, e) {
        ...
        if (!Jr(e.dc)) throw e.fc(t.lc + "() can only be used with update() and set()");
    ...
    e.path && e.Vt.push(e.path), t instanceof Array) {
        ...
        if (e.settings.Ec && 4 /* ArrayArgument */ !== e.dc) throw e.fc("Nested arrays are not supported");
        return function(t, e) {
    ...
    return function(t, e) {
        ...
        throw e.fc("Unsupported field value: " + Dr(t));
    }(t, e);
}
...
function ei(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof S || t instanceof Qr || t instanceof Cr || t instanceof Xi || t instanceof jr);
}
 ...
 */ function ri(t, e) {
    if (e instanceof Mr) return e.cc;
    if ("string" == typeof e) return ii(t, e);
 ...
 */ var si = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this.Tr = t, this.Lc = n, this.Mc = r, this.Oc = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
             * A close count that's incremented every time the stream is closed; used by
             * getCloseGuardedDispatcher() to invalidate callbacks that happen after
             * close.
             */
        this.xc = 0, this.Bc = null, this.stream = null, this.$a = new Je(t, e)
        /**
     ...
     */
    t.prototype.start = function() {
        3 /* Error */ !== this.state ? this.auth() : this.Qc();
    }, 
    /**
    ...
    t.prototype.stop = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.qc() ? [ 4 /*yield*/ , this.close(0 /* Initial */) ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.Wc = function() {
        this.state = 0 /* Initial */ , this.$a.reset();
    }, 
    /**
    ...
    /** Sends a message to the underlying stream. */ t.prototype.Gc = function(t) {
        this.zc(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.Kc = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
    ...
    /** Marks the stream as active again. */ t.prototype.zc = function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.zc(), this.$a.cancel(), 
                    // Invalidates any stream-related callbacks (e.g. from auth or the
                    // underlying stream), guaranteeing they won't execute.
                    this.xc++, 3 /* Error */ !== t ? 
                    // If this is an intentional close ensure we don't delay our next connection attempt.
                    this.$a.reset() : r && r.code === T.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    De(r.toString()), De("Using maximum backoff delay to prevent overloading the backend."), 
                    this.$a.Vr()) : r && r.code === T.UNAUTHENTICATED && 
                    // "unauthenticated" error means the token was rejected. Try force refreshing it in case it
                    // just expired.
                    this.Oc._(), 
                    // Clean up the underlying stream because we are no longer interested in events.
                    null !== this.stream && (this.Hc(), this.stream.close(), this.stream = null), 
                    // This state must be assigned before calling onClose() to allow the callback to
                    // inhibit backoff or otherwise manipulate the state in its non-started state.
                    this.state = t, [ 4 /*yield*/ , this.listener.Yc(r) ];
    ...
    t.prototype.Hc = function() {}, t.prototype.auth = function() {
        ...
        var e = this.Jc(this.xc), n = this.xc;
        ...
        var e = this, n = this.Jc(this.xc);
        this.stream = this.t_(t), this.stream.e_((function() {
            n((function() {
                return e.state = 2 /* Open */ , e.listener.e_();
            }));
        ...
        var t = this;
        this.state = 4 /* Backoff */ , this.$a.gr((function() {
    ...
    t.prototype.Zc = function(t) {
        ...
        return ke("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.Jc = function(t) {
        ...
        return function(n) {
            e.Tr.uo((function() {
                return e.xc === t ? n() : (ke("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.t_ = function(t) {
    ...
    n.prototype.start = function() {
        this.h_ = !1, e.prototype.start.call(this);
        ...
        Re(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.h_) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.$a.reset();
            var e = this.serializer.Mi(t.writeResults, t.commitTime), n = this.serializer.fromVersion(t.commitTime);
            return this.listener.u_(n, e);
        }
        // The first response is always the handshake response
                return Re(!t.writeResults || 0 === t.writeResults.length), this.h_ = !0, 
        this.listener.c_();
    }, 
    /**
...
}(si), hi = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Mc = t, i.credentials = n, i.serializer = r, i;
    }
    /** Gets an auth token and invokes the provided RPC. */    return t(n, e), n.prototype.d_ = function(t, e) {
        var n = this;
    ...
    /** Gets an auth token and invokes the provided RPC with streamed results. */ n.prototype.f_ = function(t, e) {
        var n = this;
        return this.credentials.getToken().then((function(r) {
    ...
    function t(t) {
        ...
        this.E_ = ne(), this.mutations = [], this.I_ = !1, 
        /**
    ...
    return t.prototype.A_ = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.m_(), this.mutations.length > 0) throw new I(T.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.f_("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof St || t instanceof Dt ? i.P_(t) : xe();
                    })), r) ];
                }
            }));
        }));
        ...
        this.write([ new Et(t, this.Rt(t)) ]), this.R_.add(t);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.d_("Commit", i) ];

                                  case 1:
                                    return o = n.sent(), [ 2 /*return*/ , e.serializer.Mi(o.writeResults, o.commitTime) ];
                                }
                            }));
                        }));
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.I_ = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.Rt = function(t) {
        var e = this.E_.get(t);
        return !this.R_.has(t) && e ? yt.updateTime(e) : yt.ft();
    }, 
    /**
    ...
    return t.prototype.v_ = function() {
        var t = this;
        0 === this.p_ && (this.S_("Unknown" /* Unknown */), this.y_ = this.Aa.yr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.y_ = null, t.D_("Backend didn't respond within 10 seconds."), t.S_("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.C_ = function(t) {
        "Online" /* Online */ === this.state ? this.S_("Unknown" /* Unknown */) : (this.p_++, 
        this.p_ >= 1 && (this.F_(), this.D_("Connection failed 1 times. Most recent error: " + t.toString()), 
        this.S_("Offline" /* Offline */)));
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        this.F_(), this.p_ = 0, "Online" /* Online */ === t && (
        ...
        this.b_ ? (De(e), this.b_ = !1) : ke("OnlineStateTracker", e);
    ...
    r, i, o, s) {
        ...
        /**
             ...
             * again.
             */
        this.O_ = !1, this.x_ = s, this.x_.B_((function(t) {
            i.uo((function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.q_() ? (ke("RemoteStore", "Restarting streams for network reachability change."), 
                            [ 4 /*yield*/ , this.U_() ]) : [ 3 /*break*/ , 2 ];
        ...
        this.W_ = function(t, e, n) {
            ...
            var r = Ve(t);
            return new ai(e, r.Mc, r.credentials, r.serializer, n);
        }(this.T_, i, {
    ...
    /** Re-enables the network. Idempotent. */ t.prototype.enableNetwork = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.q_() ? (t = this.z_, [ 4 /*yield*/ , this.N_.Yo() ]) : [ 3 /*break*/ , 3 ];

                  case 1:
                    // This will start the write stream if necessary.
                    return t.lastStreamToken = e.sent(), this.Z_() ? this.tl() : this.Q_.set("Unknown" /* Unknown */), 
                    [ 4 /*yield*/ , this.el() ];
    ...
    t.prototype.disableNetwork = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.networkEnabled = !1, [ 4 /*yield*/ , this.sl() ];

                  case 1:
                    return t.sent(), 
                    // Set the OnlineState to Offline so get()s return from cache, etc.
                    this.Q_.set("Offline" /* Offline */), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.z_.stop() ];

                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.W_.stop() ];

                  case 2:
                    return t.sent(), this.k_.length > 0 && (ke("RemoteStore", "Stopping write stream with " + this.k_.length + " pending writes"), 
                    this.k_ = []), this.il(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.mo = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return ke("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, 
                    [ 4 /*yield*/ , this.sl() ];

                  case 1:
                    return t.sent(), this.x_.mo(), 
                    // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                    // triggering spurious listener events with cached data, etc.
                    this.Q_.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.listen = function(t) {
        ...
        this.L_.set(t.targetId, t), this.Z_() ? 
    ...
    t.prototype.rl = function(t) {
        this.L_.delete(t), this.W_.Uc() && this.hl(t), 0 === this.L_.size && (this.W_.Uc() ? this.W_.jc() : this.q_() && 
        // Revert to OnlineState.Unknown if the watch stream is not open and we
        // have no listeners, since without any listens to send we cannot
        // confirm if the stream is healthy and upgrade to OnlineState.Online.
        this.Q_.set("Unknown" /* Unknown */));
    }, 
    ...
    t.prototype.hl = function(t) {
        ...
        this.M_ = new ve(this), this.W_.start(), this.Q_.v_();
    }, 
    /**
    ...
    t.prototype.Z_ = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.Q_.set("Online" /* Online */), !(t instanceof de && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.al(t) ];

                  case 2:
                    return n.sent(), [ 3 /*break*/ , 5 ];

                  case 3:
                    return e = n.sent(), ke("RemoteStore", "Failed to remove targets %s: %s ", t.targetIds.join(","), e), 
                    [ 4 /*yield*/ , this.ul(e) ];
                  ...
                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.N_._h() ];

                  case 8:
                    return i = n.sent(), r.S(i) >= 0 ? [ 4 /*yield*/ , this.cl(r) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return ke("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.ul(o) ];
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    return this.O_ = !0, [ 4 /*yield*/ , this.sl() ];

                  case 1:
                    // Disable network and raise offline snapshots
                    return i.sent(), this.Q_.set("Offline" /* Offline */), 
                            ...
                            return n(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    ...
                                    return ke("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , this.N_._h() ];

                                  case 1:
                                    // Issue a simple read operation to determine if IndexedDB recovered.
                                    // Ideally, we would expose a health check directly on SimpleDb, but
                                    // RemoteStore only has access to persistence through LocalStore.
                                    return t.sent(), this.O_ = !1, [ 4 /*yield*/ , this.X_() ];
    ...
    /** Handles an error on a target */ t.prototype.al = function(t) {
        return e(this, void 0, void 0, (function() {
            var e, r, i, o;
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.L_.has(o) ? [ 4 /*yield*/ , this.ol._l(o, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    n.sent(), this.L_.delete(o), this.M_.removeTarget(o), n.label = 3;
    ...
    t.prototype.el = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ll() ? (t = this.k_.length > 0 ? this.k_[this.k_.length - 1].batchId : -1, 
                    [ 4 /*yield*/ , this.N_.qu(t) ]) : [ 3 /*break*/ , 5 ];

                  case 1:
                    return null !== (e = n.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.k_.length && this.z_.jc(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.dl(e), [ 4 /*yield*/ , this.el() ];
                  ...
                  case 5:
                    return this.fl() && this.Tl(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.dl = function(t) {
        ...
        var n = this, r = this.k_.shift(), i = Fe.from(r, t, e, this.z_.lastStreamToken);
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return t && this.k_.length > 0 ? this.z_.o_ ? [ 4 /*yield*/ , this.wl(t) ] : [ 3 /*break*/ , 2 ] : [ 3 /*break*/ , 5 ];
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                ...
                return zt(t.code) ? [ 2 /*return*/ , (ke("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.z_.lastStreamToken), 
                this.z_.lastStreamToken = q.ht, this.N_.Jo(q.ht).catch(dr)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                ...
                // logic kick in.
                return zt(r = t.code) && r !== T.ABORTED ? (e = this.k_.shift(), [ 2 /*return*/ , (this.z_.Wc(), 
                this.ol.Al(e.batchId, t).then((function() {
                    return i.el();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.ml = function() {
        return new ci(this.T_);
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), this.Q_.set("Unknown" /* Unknown */), [ 4 /*yield*/ , this.enableNetwork() ];
            ...
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    ke("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.U_() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.sl() ];

                  case 3:
                    n.sent(), e = this.Q_.set("Unknown" /* Unknown */), n.label = 4;
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function di(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function yi(t, e) {
...
var vi = /** @class */ function() {
    ...
    return t.gl = function(e, n, r) {
        ...
        o ? new t(e, n, i.state, s) : (De("SharedClientState", "Failed to parse mutation state for ID '" + n + "': " + r), 
        null);
    }, t.prototype.pl = function() {
        var t = {
            state: this.state,
    ...
    return t.gl = function(e, n) {
        ...
        i ? new t(e, r.state, o) : (De("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n), 
        null);
    }, t.prototype.pl = function() {
        var t = {
            state: this.state,
    ...
    return t.gl = function(e, n) {
        ...
        return i ? new t(e, o) : (De("SharedClientState", "Failed to parse client data for instance '" + e + "': " + n), 
        null);
    }, t;
}(), wi = /** @class */ function() {
    function t(t, e) {
    ...
    return t.gl = function(e) {
        var n = JSON.parse(e);
        return "object" == typeof n && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(n.onlineState) && "string" == typeof n.clientId ? new t(n.clientId, n.onlineState) : (De("SharedClientState", "Failed to parse online state: " + e), 
        null);
    }, t;
}(), Ei = /** @class */ function() {
    function t() {
    ...
    function t(e, n, r, i, o) {
        if (this.Tr = e, this.platform = n, this.persistenceKey = r, this.vl = i, this.ol = null, 
        this.g_ = null, this.ur = null, this.Sl = this.Dl.bind(this), this.Cl = new Wt(Pe), 
        this.ro = !1, 
        /**
             * Captures WebStorage events that occur before `start()` is called. These
             * events are replayed once `WebStorageSharedClientState` is started.
             */
        this.Fl = [], !t.Gh(this.platform)) throw new I(T.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                var s = r.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = o, this.Nl = pi(this.persistenceKey, this.vl), 
        this.$l = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.Cl = this.Cl.Ae(this.vl, new Ei), this.kl = new RegExp("^firestore_clients_" + s + "_([^_]*)$"), 
        this.Ll = new RegExp("^firestore_mutations_" + s + "_(\\d+)(?:_(.*))?$"), this.Ml = new RegExp("^firestore_targets_" + s + "_(\\d+)$"), 
        this.Ol = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.Gh = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.ol.bo() ];

                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.vl && (o = this.getItem(pi(this.persistenceKey, i))) && (s = gi.gl(i, o)) && (this.Cl = this.Cl.Ae(s.clientId, s));
                    for (this.xl(), (u = this.storage.getItem(this.Ol)) && (a = this.Bl(u)) && this.ql(a), 
                    h = 0, c = this.Fl; h < c.length; h++) f = c[h], this.Dl(f);
                    return this.Fl = [], 
        ...
        // by another tab
                if (this.Wl(t)) {
            var n = this.storage.getItem(yi(this.persistenceKey, t));
            if (n) {
                var r = mi.gl(t, n);
                r && (e = r.state);
            }
        ...
        this.ro && (this.platform.window.removeEventListener("storage", this.Sl), this.removeItem(this.Nl), 
        this.ro = !1);
    }, t.prototype.getItem = function(t) {
        var e = this.storage.getItem(t);
        return ke("SharedClientState", "READ", t, e), e;
    }, t.prototype.setItem = function(t, e) {
        ke("SharedClientState", "SET", t, e), this.storage.setItem(t, e);
    }, t.prototype.removeItem = function(t) {
        ke("SharedClientState", "REMOVE", t), this.storage.removeItem(t);
    }, t.prototype.Dl = function(t) {
        var r = this;
        if (t.storageArea === this.storage) {
            if (ke("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Nl) return void De("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Tr.Ua((function() {
                return e(r, void 0, void 0, (function() {
                    var e, r, i, o, s, u;
                    return n(this, (function(n) {
                        if (this.ro) {
                            if (null !== t.key) if (this.kl.test(t.key)) {
                                if (null == t.newValue) return e = this.rd(t.key), [ 2 /*return*/ , this.hd(e, null) ];
                                if (r = this.od(t.key, t.newValue)) return [ 2 /*return*/ , this.hd(r.clientId, r) ];
                            } else if (this.Ll.test(t.key)) {
                                if (null !== t.newValue && (i = this.ad(t.key, t.newValue))) return [ 2 /*return*/ , this.ud(i) ];
                            } else if (this.Ml.test(t.key)) {
                                if (null !== t.newValue && (o = this._d(t.key, t.newValue))) return [ 2 /*return*/ , this.ld(o) ];
                            } else if (t.key === this.Ol) {
                                if (null !== t.newValue && (s = this.Bl(t.newValue))) return [ 2 /*return*/ , this.ql(s) ];
                            } else t.key === this.$l && (u = function(t) {
                                var e = Ye.dr;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                    Re("number" == typeof n), e = n;
                                } catch (t) {
                                    De("SharedClientState", "Failed to read sequence number from WebStorage", t);
                                }
                                return e;
        ...
        var r = new vi(this.currentUser, t, e, n), i = di(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.pl());
    }, t.prototype.zl = function(t) {
        var e = di(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = yi(this.persistenceKey, t), i = new mi(t, e, n);
        this.setItem(r, i.pl());
    }, 
    /**
    ...
    t.prototype.Bl = function(t) {
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.ol.dd(t.batchId, t.state, t.error) ] : (ke("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.Cl.Ae(t, e) : this.Cl.remove(t), i = this.Ql(this.Cl), o = this.Ql(r), s = [], u = [];
    ...
    function t() {
        this.Ed = new Ei, this.Id = {}, this.ol = null, this.g_ = null, this.ur = null;
    }
    return t.prototype.jl = function(t) {
        // No op.
    }, t.prototype.Gl = function(t, e, n) {
        // No op.
    }, t.prototype.Hl = function(t) {
        ...
        return this.Ed = new Ei, Promise.resolve();
    }, t.prototype.Du = function(t, e, n) {
        // No op.
    }, t.prototype.sd = function(t) {
        // No op.
    ...
    e) {
        ...
        this.ns = ie(), this.md = new ue(t.se.bind(t));
    }
    ...
    t.prototype.Vd = function(t, e) {
        var n = this, r = e ? e.gd : new ae, i = e ? e.md : this.md, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, h = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.xn = function(t, e, n) {
        ...
        var s = e ? this.vd() : [], u = 0 === this.Ad.size && this.fs ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.Rd;
        return this.Rd = u, 0 !== o.length || a ? {
            snapshot: new he(this.query, t.md, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Sd: s
        } : {
            Sd: s
    ...
    t.prototype.bd = function(t) {
        ...
        // updating many documents.
                var e = this.Ad;
        this.Ad = ie(), this.md.forEach((function(e) {
            t.Cd(e.key) && (t.Ad = t.Ad.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Ad.has(e) || n.push(new Ni(e));
    ...
    t.prototype.Nd = function() {
        return he.os(this.query, this.md, this.ns, 0 /* Local */ === this.Rd);
    }, t;
}(), _i = /** @class */ function() {
    function t(t, e, n, r) {
        this.Aa = t, this.$d = e, this.updateFunction = n, this.Va = r, this.kd = 5, this.$a = new Je(this.Aa, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.Ld = function() {
        ...
        this.$a.gr((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = this.$d.ml(), (e = this.Od(t)) && e.then((function(e) {
                        r.Aa.uo((function() {
        ...
        try {
            ...
            return !j(e) && e.catch && e.then ? e : (this.Va.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        this.N_ = t, this.$d = e, this.Ud = n, this.currentUser = r, this.Qd = i, this.Wd = null, 
        this.jd = new qe((function(t) {
            return t.canonicalId();
        })), this.Kd = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Hd = new Map, this.Yd = new yr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Jd = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Xd = new Map, this.Zd = fn.rh(), this.onlineState = "Unknown" /* Unknown */;
    }
    ...
    t.prototype.listen = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ef("listen()"), (i = this.jd.get(t)) ? (
                    ...
                    e = i.targetId, this.Ud.Hl(e), r = i.view.Nd(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.N_.Qu(t.ee()) ];

                  case 2:
                    return o = n.sent(), s = this.Ud.Hl(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.sf(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.tf && this.$d.listen(o), n.label = 4;
     ...
     * snapshot.
     */
    t.prototype.sf = function(t, r, i) {
        return e(this, void 0, void 0, (function() {
            var e, o, s, u, a, h;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.N_.ju(t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), o = new Ai(t, e.Ku), s = o.Vd(e.documents), u = fe.ds(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.xn(s, 
                    /* updateLimboDocuments= */ this.tf, u), this.if(r, a.Sd), h = new ki(t, r, o), 
                    [ 2 /*return*/ , (this.jd.set(t, h), this.Kd.has(r) ? this.Kd.get(r).push(t) : this.Kd.set(r, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
    }, 
    /** Stops listening to the query. */ t.prototype.rl = function(t) {
        return e(this, void 0, void 0, (function() {
            var e, r, i = this;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.ef("unlisten()"), e = this.jd.get(t), (r = this.Kd.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this.Kd.set(e.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.jd.delete(t)) ] : this.tf ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Ud.Jl(e.targetId), this.Ud.Wl(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.N_.Wu(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Ud.Zl(e.targetId), i.$d.rl(e.targetId), i.nf(e.targetId);
                    })).catch(dr) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.nf(e.targetId), [ 4 /*yield*/ , this.N_.Wu(e.targetId, 
    ...
    t.prototype.write = function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ef("write()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.N_.$u(t) ];

                  case 2:
                    return e = n.sent(), this.Ud.jl(e.batchId), this.rf(e.batchId, r), [ 4 /*yield*/ , this.hf(e.Dn) ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.$d.el() ];

                  case 4:
                    return n.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = n.sent(), o = or(i, "Failed to persist write"), r.reject(o), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ef("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.N_.Mu(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        Re(t.Ts.size + t.Es.size + t.Is.size <= 1), t.Ts.size > 0 ? n.qd = !0 : t.Es.size > 0 ? Re(n.qd) : t.Is.size > 0 && (Re(n.qd), 
                        n.qd = !1));
                    })), [ 4 /*yield*/ , this.hf(e, t) ];
    ...
    t.prototype.Dd = function(t, e) {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ef("rejectListens()"), 
                    // PORTING NOTE: Multi-tab only.
                    this.Ud.td(t, "rejected", r), e = this.Hd.get(t), (i = e && e.key) ? (o = (o = new Wt(L.N)).Ae(i, new St(i, x.min())), 
                    s = ie().add(i), u = new ce(x.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Yt(Pe), o, s), [ 4 /*yield*/ , this.Mu(u) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 1:
                    ...
                    this.zd = this.zd.remove(i), this.Hd.delete(t), this.uf(), [ 3 /*break*/ , 4 ];

                  case 2:
                    return [ 4 /*yield*/ , this.N_.Wu(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.nf(t, r);
                    })).catch(dr) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ef("applySuccessfulWrite()"), e = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.cf(e, /*error=*/ null), this._f(e), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.N_.zo(t) ];

                  case 2:
                    return r = n.sent(), this.Ud.Gl(e, "acknowledged"), [ 4 /*yield*/ , this.hf(r) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.ef("rejectFailedWrite()"), 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught up),
                    // so we raise user callbacks first so that they consistently happen before
                    // listen events.
                    this.cf(t, r), this._f(t), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.N_.Lu(t) ];

                  case 2:
                    return e = n.sent(), this.Ud.Gl(t, "rejected", r), [ 4 /*yield*/ , this.hf(e) ];
    ...
    t.prototype.lf = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.$d.q_() || ke("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.N_.sa() ];

                  case 2:
                    return -1 === (e = n.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.Xd.get(e) || []).push(t), 
                    this.Xd.set(e, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = n.sent(), o = or(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.df = function(t) {
        ...
        n || (n = new Wt(Pe)), n = n.Ae(t, e), this.Jd[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.cf = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Ii ? (this.Yd.yh(i.key, t), this.Ef(i)) : i instanceof Ni ? (ke("SyncEngine", "Document no longer in limbo: " + i.key), 
            this.Yd.vh(i.key, t), this.Yd.Ch(i.key) || 
            // We removed the last reference for this key
            this.Tf(i.key)) : xe();
        }
    }, t.prototype.Ef = function(t) {
        var e = t.key;
        this.zd.get(e) || (ke("SyncEngine", "New document in limbo: " + e), this.Gd.push(e), 
        this.uf());
    }, 
    /**
    ...
    t.prototype.uf = function() {
        for (;this.Gd.length > 0 && this.zd.size < this.Qd; ) {
            var t = this.Gd.shift(), e = this.Zd.next();
            this.Hd.set(e, new Di(t)), this.zd = this.zd.Ae(t, e), this.$d.listen(new Ft(Vt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ye.dr));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.wf = function() {
        return this.Gd;
    }, t.prototype.hf = function(t, r) {
        return e(this, void 0, void 0, (function() {
            var e, i, o, s = this;
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.jd.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            var e = u.view.Vd(t);
                            return e.yd ? s.N_.ju(u.query, /* usePreviousResults= */ !1).then((function(t) {
                                var n = t.documents;
                            ...
                            /* updateLimboDocuments= */ s.tf, n);
                            if (s.if(u.targetId, o.Sd), o.snapshot) {
                                s.tf && s.Ud.td(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), e.push(o.snapshot);
                  ...
                  case 1:
                    return n.sent(), this.Wd.i_(e), [ 4 /*yield*/ , this.N_.Bu(i) ];
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.N_.Du(t) ];

                  case 1:
                    return e = n.sent(), this.currentUser = t, 
                    // Fails tasks waiting for pending writes requested by previous user.
                    this.df("'waitForPendingWrites' promise is rejected due to a user change."), 
                    // TODO(b/114226417): Consider calling this only in the primary tab.
                    this.Ud.Du(t, e.Fu, e.Nu), [ 4 /*yield*/ , this.hf(e.Cu) ];

                  case 2:
                    n.sent(), n.label = 3;

                  case 3:
                    return [ 4 /*yield*/ , this.$d.Pl() ];
        ...
        var e = this.Hd.get(t);
        if (e && e.qd) return ie().add(e.key);
        var n = ie(), r = this.Kd.get(t);
        if (!r) return n;
        for (var i = 0, o = r; i < o.length; i++) {
            var s = o[i], u = this.jd.get(s);
            n = n.He(u.view.Pd);
        }
        return n;
    }, t;
    ...
    function i(t, e, n, i, o) {
        var s = this;
        return (s = r.call(this, t, e, n, i, o) || this).N_ = t, 
        // The primary state is set to `true` or `false` immediately after Firestore
        // startup. In the interim, a client should only be considered primary if
        // `isPrimary` is true.
        s.Rf = void 0, s;
    }
    return t(i, r), Object.defineProperty(i.prototype, "tf", {
        get: function() {
            return !0 === this.Rf;
        },
        enumerable: !0,
        ...
        return this.N_.ao(!0), r.prototype.enableNetwork.call(this);
    }, i.prototype.disableNetwork = function() {
        return this.N_.ao(!1), r.prototype.disableNetwork.call(this);
    }, 
    /**
    ...
    i.prototype.Af = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.N_.ju(t.query, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), r = t.view.Fd(e), [ 2 /*return*/ , (this.Rf && this.if(t.targetId, r.Sd), 
                    r) ];
                }
            }));
        }));
    }, i.prototype.Dd = function(t, e) {
        // If we are the primary client, the online state of all clients only
        // depends on the online state of the local RemoteStore.
        this.tf && 0 /* RemoteStore */ === e && (r.prototype.Dd.call(this, t, e), this.Ud.sd(t)), 
        // If we are the secondary client, we explicitly ignore the remote store's
        // online state (the local client may go offline, even though the primary
        // tab remains online) and only apply the primary tab's online state from
        // SharedClientState.
        this.tf || 1 /* SharedClientState */ !== e || r.prototype.Dd.call(this, t, e);
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ef("applyBatchState()"), [ 4 /*yield*/ , this.N_.zu(t) ];

                  case 1:
                    return null === (e = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== r ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.$d.el() ];
                  ...
                  case 3:
                    ...
                    // other clients.
                    this.cf(t, i || null), this.N_.Hu(t)) : xe(), n.label = 4;

                  case 4:
                    return [ 4 /*yield*/ , this.hf(e) ];
                  ...
                  case 6:
                    ...
                    // as applicable.
                    ke("SyncEngine", "Cannot apply mutation batch with id: " + t), n.label = 7;
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return !0 !== t || !0 === this.Rf ? [ 3 /*break*/ , 3 ] : (e = this.Ud.Ul(), [ 4 /*yield*/ , this.mf(e.W(), 
                    /*transitionToPrimary=*/ !0) ]);

                  case 1:
                    return r = n.sent(), this.Rf = !0, [ 4 /*yield*/ , this.$d.Vl(!0) ];

                  case 2:
                    for (n.sent(), i = 0, o = r; i < o.length; i++) s = o[i], this.$d.listen(s);
                    return [ 3 /*break*/ , 7 ];

                  case 3:
                    return !1 !== t || !1 === this.Rf ? [ 3 /*break*/ , 7 ] : (u = [], a = Promise.resolve(), 
                    this.Kd.forEach((function(t, e) {
                  ...
                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.mf(u, 
                    /*transitionToPrimary=*/ !1) ];

                  case 5:
                    return n.sent(), this.Pf(), this.Rf = !1, [ 4 /*yield*/ , this.$d.Vl(!1) ];
        ...
        this.Hd.forEach((function(e, n) {
            t.$d.rl(n);
        })), this.Yd.rc(), this.Hd = new Map, this.zd = new Wt(L.N);
    }, 
    /**
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return i < o.length ? (s = o[i], u = void 0, (a = this.Kd.get(s)) && 0 !== a.length ? [ 4 /*yield*/ , this.N_.Wu(s, 
                  ...
                  case 2:
                    ...
                    return n.sent(), [ 4 /*yield*/ , this.N_.Qu(a[0].ee()) ];
                  ...
                  case 4:
                    return h < c.length ? (f = c[h], l = this.jd.get(f), [ 4 /*yield*/ , this.Af(l) ]) : [ 3 /*break*/ , 7 ];
                  ...
                  case 8:
                    return [ 4 /*yield*/ , this.N_.Yu(s) ];

                  case 9:
                    return d = n.sent(), [ 4 /*yield*/ , this.N_.Qu(d) ];

                  case 10:
                    return u = n.sent(), [ 4 /*yield*/ , this.sf(this.Vf(d), s, 
                    /*current=*/ !1) ];
                  ...
                  case 14:
                    return [ 2 /*return*/ , (this.Wd.i_(r), e) ];
                }
            }));
        }));
    }, 
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    ke("SyncEngine", "Ignoring unexpected query state notification."), [ 3 /*break*/ , 8 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    if (!this.Kd.has(t)) return [ 3 /*break*/ , 8 ];
                    switch (r) {
                      case "current":
                      case "not-current":
                        return [ 3 /*break*/ , 2 ];
                  ...
                  case 2:
                    return [ 4 /*yield*/ , this.N_.Kr() ];

                  case 3:
                    return e = n.sent(), o = ce.ls(t, "current" === r), [ 4 /*yield*/ , this.hf(e, o) ];

                  case 4:
                    return n.sent(), [ 3 /*break*/ , 8 ];

                  case 5:
                    return [ 4 /*yield*/ , this.N_.Wu(t, 
                    /* keepPersistedTargetData */ !0) ];

                  case 6:
                    return n.sent(), this.nf(t, i), [ 3 /*break*/ , 8 ];
    ...
    }, i.prototype.Td = function(t, r) {
        return e(this, void 0, void 0, (function() {
            var e, i, o, s, u, a, h, c, f, l, p = this;
            return n(this, (function(d) {
                switch (d.label) {
                  case 0:
                    if (!this.Rf) return [ 3 /*break*/ , 10 ];
                    e = 0, i = t, d.label = 1;

                  case 1:
                    return e < i.length ? (o = i[e], this.Kd.has(o) ? (
                    // A target might have been added in a previous attempt
                    ke("SyncEngine", "Adding an already active target " + o), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , this.N_.Yu(o) ]) : [ 3 /*break*/ , 6 ];

                  case 2:
                    return s = d.sent(), [ 4 /*yield*/ , this.N_.Qu(s) ];

                  case 3:
                    return u = d.sent(), [ 4 /*yield*/ , this.sf(this.Vf(s), u.targetId, 
                    /*current=*/ !1) ];
                  ...
                  case 6:
                    a = function(t) {
                        return n(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return h.Kd.has(t) ? [ 4 /*yield*/ , h.N_.Wu(t, /* keepPersistedTargetData */ !1).then((function() {
                                    p.$d.rl(t), p.nf(t);
                                })).catch(dr) ] : [ 3 /*break*/ , 2 ];
    ...
    function t(t) {
        this.ol = t, this.yf = new qe((function(t) {
            return t.canonicalId();
        })), this.onlineState = "Unknown" /* Unknown */ , this.bf = new Set, this.ol.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.yf.get(e)) || (r = !0, i = new Ri), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.ol.listen(e) ];

                  case 2:
                    return o.gf = n.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = n.sent(), u = or(s, "Initialization of query '" + t.query + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.yf.set(e, i), i.pf.push(t), 
                    // Run global snapshot listeners if a consistent snapshot has been emitted.
                    t.Dd(this.onlineState), i.gf && t.vf(i.gf) && this.Sf(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.rl = function(t) {
        return e(this, void 0, void 0, (function() {
            var e, r, i, o;
            return n(this, (function(n) {
                return e = t.query, r = !1, (i = this.yf.get(e)) && (o = i.pf.indexOf(t)) >= 0 && (i.pf.splice(o, 1), 
                r = 0 === i.pf.length), r ? [ 2 /*return*/ , (this.yf.delete(e), this.ol.rl(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.i_ = function(t) {
        for (var e = !1, n = 0, r = t; n < r.length; n++) {
            var i = r[n], o = i.query, s = this.yf.get(o);
            if (s) {
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.Nf = !1, this.$f = null, this.onlineState = "Unknown" /* Unknown */ , this.options = n || {}
        /**
    ...
    return t.prototype.vf = function(t) {
        ...
        var o = !1;
        return this.Nf ? this.kf(t) && (this.Ff.next(t), o = !0) : this.Lf(t, this.onlineState) && (this.Mf(t), 
        o = !0), this.$f = t, o;
    }, t.prototype.onError = function(t) {
        this.Ff.error(t);
    }, 
    /** Returns whether a snapshot was raised. */ t.prototype.Dd = function(t) {
        this.onlineState = t;
        var e = !1;
        return this.$f && !this.Nf && this.Lf(this.$f, t) && (this.Mf(this.$f), e = !0), 
        e;
        ...
        // above) and are waiting for a sync.
                return !(this.options.Of && n || t.docs.B() && "Offline" /* Offline */ !== e);
        ...
        t = he.os(t.query, t.docs, t.ns, t.fromCache), this.Nf = !0, this.Ff.next(t);
    }, t;
}(), Pi = /** @class */ function() {
    function t() {}
    return t.prototype.Su = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(x.min()) ? this.Bf(t, e) : this.xf.Yn(t, r).next((function(o) {
            var u = i.qf(e, o);
            return (e.oe() || e.ae()) && i.yd(e.Bt, u, r, n) ? i.Bf(t, e) : (Ae() <= s.DEBUG && ke("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.xf.Zn(t, e, n).next((function(t) {
    ...
    t.prototype.yd = function(t, e, n, r) {
        ...
        return Ae() <= s.DEBUG && ke("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.xf.Zn(t, e, x.min());
    }, t;
}(), Li = /** @class */ function() {
    function t(t, e) {
        this.jn = t, this.hh = e, 
        ...
        /** The last received stream token from the server, used to acknowledge which
             ...
             * markers whose only real value is their inclusion in the next request.
             */
        this.lastStreamToken = q.ht, 
        /** An ordered mapping between documents and the mutations batch IDs. */
        this.Qf = new Yt(vr.Xu);
    }
    return t.prototype.Go = function(t) {
        return Be.resolve(0 === this.Wn.length);
    }, t.prototype.zo = function(t, e, n) {
        var r = e.batchId, i = this.Wf(r, "acknowledged");
        return Re(0 === i), 
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Qf = this.Qf.add(new vr(a.key, i)), this.jn.Dr(t, a.key.path.L());
        }
        return Be.resolve(o);
    }, t.prototype.Zo = function(t, e) {
        return Be.resolve(this.jf(e));
    }, t.prototype.ea = function(t, e) {
        var n = e + 1, r = this.Kf(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Be.resolve(this.Wn.length > i ? this.Wn[i] : null);
    }, t.prototype.sa = function() {
        return Be.resolve(0 === this.Wn.length ? -1 : this.Uf - 1);
    }, t.prototype.ia = function(t) {
        return Be.resolve(this.Wn.slice());
    }, t.prototype.Gn = function(t, e) {
        var n = this, r = new vr(e, 0), i = new vr(e, Number.POSITIVE_INFINITY), o = [];
        ...
        return e.forEach((function(t) {
            var e = new vr(t, 0), i = new vr(t, Number.POSITIVE_INFINITY);
            n.Qf.Ke([ e, i ], (function(t) {
                r = r.add(t.oc);
            }));
        })), Be.resolve(this.Gf(r));
    }, t.prototype.nr = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                L.et(i) || (i = i.child(""));
        var o = new vr(new L(i), 0), s = new Yt(Pe);
        ...
        var n = this;
        Re(0 === this.Wf(e.batchId, "removed")), this.Wn.shift();
        var r = this.Qf;
        return Be.forEach(e.mutations, (function(i) {
            var o = new vr(i.key, e.batchId);
        ...
        var n = new vr(e, 0), r = this.Qf.ze(n);
    ...
    t.prototype.kn = function(t) {
        ...
        ; o.$e(); ) {
            var s = o.Ne(), u = s.key, a = s.value, h = a.Mr, c = a.readTime;
            if (!e.path.q(u.path)) break;
            c.S(n) <= 0 || h instanceof Dt && e.matches(h) && (r = r.Ae(h.key, h));
        }
        return Be.resolve(r);
...
var Ci = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Xf = new yr, this.targetCount = 0, this.Zf = fn.nh();
    }
    return t.prototype.js = function(t, e) {
        ...
        return Be.resolve(this.Jf);
    }, t.prototype.oh = function(t) {
        return this.highestTargetId = this.Zf.next(), Be.resolve(this.highestTargetId);
    }, t.prototype.dh = function(t, e, n) {
        return n && (this.lastRemoteSnapshotVersion = n), e > this.Jf && (this.Jf = e), 
        Be.resolve();
    }, t.prototype.Th = function(t) {
        this.Yf.set(t.target, t);
        var e = t.targetId;
        e > this.highestTargetId && (this.Zf = new fn(e), this.highestTargetId = e), t.sequenceNumber > this.Jf && (this.Jf = t.sequenceNumber);
    }, t.prototype.fh = function(t, e) {
        return this.Th(e), this.targetCount += 1, Be.resolve();
    }, t.prototype.Ih = function(t, e) {
        return this.Th(e), Be.resolve();
    }, t.prototype.wh = function(t, e) {
        return this.Yf.delete(e.target), this.Xf.nc(e.targetId), this.targetCount -= 1, 
        Be.resolve();
    }, t.prototype.Ah = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Yf.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.Yf.delete(s), o.push(r.Rh(t, u.targetId)), 
            i++);
        ...
        return this.Xf.ec(e, n), Be.resolve();
    }, t.prototype.bh = function(t, e, n) {
        this.Xf.ic(e, n);
        ...
        return this.Xf.nc(e), Be.resolve();
    }, t.prototype.Sh = function(t, e) {
        var n = this.Xf.hc(e);
        return Be.resolve(n);
    }, t.prototype.Ch = function(t, e) {
        return Be.resolve(this.Xf.Ch(e));
    }, t;
}(), Mi = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.tT = {}, this.Bh = new Ye(0), this.qh = !1, this.qh = !0, this.hh = t(this), 
        this.Yh = new Ci(this), this.jn = new en, this.Qn = new Ui(this.jn, (function(t) {
            return e.hh.eT(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.tT[t.s()];
        return e || (e = new Li(this.jn, this.hh), this.tT[t.s()] = e), e;
    }, t.prototype.Do = function() {
        return this.Yh;
    }, t.prototype.Co = function() {
        return this.Qn;
        ...
        var r = this;
        ke("MemoryPersistence", "Starting transaction:", t);
        var i = new qi(this.Bh.next());
        ...
        return Be.Sn(Object.values(this.tT).map((function(n) {
            return function() {
                return n.Ch(t, e);
            };
        })));
    ...
    return t.oT = function(e) {
        ...
        return this.rT.yh(n, e), this.aT.delete(n), Be.resolve();
    }, t.prototype.vh = function(t, e, n) {
        return this.rT.vh(n, e), this.aT.add(n), Be.resolve();
    }, t.prototype.Bo = function(t, e) {
        return this.aT.add(e), Be.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        var e = this, n = this.persistence.Co().Yr();
        // Remove newly orphaned documents.
                return Be.forEach(this.aT, (function(r) {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Ud = this.cT(t), this.persistence = this._T(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return n.sent(), this.lT = this.dT(t), this.N_ = this.fT(t), this.$d = this.TT(t), 
                    this.ol = this.ET(t), this.IT = this.wT(t), this.Ud.g_ = function(t) {
                        return e.ol.Dd(t, 1 /* SharedClientState */);
                    }, this.$d.ol = this.ol, [ 4 /*yield*/ , this.N_.start() ];

                  case 2:
                    return n.sent(), [ 4 /*yield*/ , this.Ud.start() ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.$d.start() ];

                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.$d.Vl(this.ol.tf) ];
        ...
        return new Vi(this.ol);
    }, t.prototype.dT = function(t) {
        return null;
    }, t.prototype.fT = function(t) {
        return new lr(this.persistence, new Pi, t.RT);
    }, t.prototype._T = function(t) {
        return new Mi(ji.oT);
    }, t.prototype.TT = function(t) {
        var e = this;
        return new li(this.N_, t.T_, t.Aa, (function(t) {
            return e.ol.Dd(t, 0 /* RemoteStore */);
        }), t.platform.AT());
    }, t.prototype.cT = function(t) {
        return new Ti;
    }, t.prototype.ET = function(t) {
        return new Si(this.N_, this.$d, this.Ud, t.RT, t.Qd);
    ...
    return t(i, r), i.prototype.initialize = function(t) {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  ...
                  case 1:
                    ...
                    return o.sent(), [ 4 /*yield*/ , this.persistence.no((function(t) {
                        return e(i, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , this.ol.Vl(t) ];

                                  case 1:
                                    return e.sent(), this.lT && (t && !this.lT.ro ? this.lT.start(this.N_) : t || this.lT.stop()), 
                                    [ 2 /*return*/ ];
                                }
                            }));
                        }));
        ...
        return new pr(this.persistence, new Pi, t.RT);
    }, i.prototype.ET = function(t) {
        var e = new xi(this.N_, this.$d, this.Ud, t.RT, t.Qd);
        return this.Ud instanceof bi && (this.Ud.ol = e), e;
    }, i.prototype.dT = function(t) {
        var e = this.persistence.hh.ko;
        return new cr(e, t.Aa);
    }, i.prototype._T = function(t) {
        var e = wn.$o(t.mT), n = t.platform.bc(t.mT.ii);
        return new wn(t.PT.synchronizeTabs, e, t.clientId, t.platform, hr.hu(t.PT.cacheSizeBytes), t.Aa, n, this.Ud);
    }, i.prototype.cT = function(t) {
        if (t.PT.VT && t.PT.synchronizeTabs) {
            if (!bi.Gh(t.platform)) throw new I(T.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var e = wn.$o(t.mT);
            return new bi(t.Aa, t.platform, e, t.clientId, t.RT);
        }
        return new Ti;
    }, i.prototype.clearPersistence = function(t) {
        var e = wn.$o(t);
        return wn.clearPersistence(e);
    }, i;
}(Fi), zi = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.mT = e, this.credentials = n, this.Aa = r, this.clientId = Oe.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials.l((function(s) {
            if (!o) return o = !0, ke("FirestoreClient", "Initializing. user=", s.uid), n.pT(t, e, s, i).then(r.resolve, r.reject);
            n.Aa.Ua((function() {
                return n.Pl(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.pT = function(t, r, i, o) {
        return e(this, void 0, void 0, (function() {
            var s, u, a, h, c = this;
            return n(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.yT(this.mT) ];

                  case 1:
                    return s = f.sent(), u = this.platform.bc(this.mT.ii), a = function(t, e, n) {
                        return new hi(t, e, n);
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.Ud = t.Ud, this.N_ = t.N_, 
                    this.$d = t.$d, this.ol = t.ol, this.lT = t.lT, this.bT = t.IT, 
    ...
    t.prototype.gT = function() {
        if (this.Aa.La) throw new I(T.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Pl = function(t) {
        return this.Aa.Wa(), ke("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.ol.Pl(t);
    }, 
                ...
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        ...
                        return this.lT && this.lT.stop(), [ 4 /*yield*/ , this.$d.mo() ];

                      case 1:
                        return t.sent(), [ 4 /*yield*/ , this.Ud.mo() ];
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.gT(), r = new $e, [ 4 /*yield*/ , this.Aa.enqueue((function() {
                        return e(i, void 0, void 0, (function() {
                            var e, i, o;
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.N_.Uu(t) ];

                                  case 1:
                                    return (e = n.sent()) instanceof Dt ? r.resolve(e) : e instanceof St ? r.resolve(null) : r.reject(new I(T.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return i = n.sent(), o = or(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.gT(), r = new $e, [ 4 /*yield*/ , this.Aa.enqueue((function() {
                        return e(i, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.N_.ju(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return e = n.sent(), i = new Ai(t, e.Ku), o = i.Vd(e.documents), s = i.xn(o, 
                                    /* updateLimboDocuments= */ !1), r.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = n.sent(), a = or(u, "Failed to execute query '" + t + " against cache"), 
...
var Qi = /** @class */ function() {
    ...
    return t.prototype.kT = function(t) {
        ...
        return new Qr(Z(t.latitude), Z(t.longitude));
        ...
        var e = X(t), n = new S(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.OT = function(t) {
        var e = V.K(t);
        Re(Te(e));
        var n = new Me(e.get(1), e.get(3)), r = new L(e.k(5));
        return n.isEqual(this.firestore.$c) || 
        // TODO(b/64130202): Somehow support foreign references.
        De("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.$c.projectId + "/" + this.firestore.$c.database + ") instead."), 
        new Xi(r, this.firestore, this.converter);
    }, t;
}(), Ki = hr.uu, Yi = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new I(T.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Ir("settings", "non-empty string", "host", t.host), this.host = t.host, Nr("settings", "boolean", "ssl", t.ssl), 
        ...
        Nr("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        Nr("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), Nr("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        Nr("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = hr._u; else {
            if (t.cacheSizeBytes !== Ki && t.cacheSizeBytes < hr.cu) throw new I(T.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + hr.cu);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        Nr("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new Fi), this.UT = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.QT = new ir, this.INTERNAL = {
            delete: function() {
                    ...
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            ...
                            // throws an exception.
                            return this.WT(), [ 4 /*yield*/ , this.jT.terminate() ];
            ...
            var u = r;
            this.UT = u, this.$c = t.KT(u), this.GT = u.name, this.zT = new _(i);
        } else {
            var a = r;
            if (!a.projectId) throw new I(T.INVALID_ARGUMENT, "Must provide projectId");
            this.$c = new Me(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.GT = "[DEFAULT]", this.zT = new A;
        }
        this.HT = o, this.YT = new Yi({});
    }
    return Object.defineProperty(t.prototype, "JT", {
        get: function() {
            return this.XT || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.XT = new Xr(this.$c, this.YT.ignoreUndefinedProperties)), this.XT;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.settings = function(t) {
        gr("Firestore.settings", arguments, 1), br("Firestore.settings", "object", 1, t);
        var e = new Yi(t);
        if (this.jT && !this.YT.isEqual(e)) throw new I(T.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
            ...
            switch (t.type) {
              case "gapi":
                ...
                // Make sure this really is a Gapi client.
                                return Re(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), 
                new D(e, t.V || "0");
        ...
        var e, n;
        if (this.jT) throw new I(T.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.jT && !this.jT.ST) throw new I(T.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new $e, [ 2 /*return*/ , (this.QT.Ma((function() {
                    return e(r, void 0, void 0, (function() {
                        var e, r;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.eE(), [ 4 /*yield*/ , this.HT.clearPersistence(e) ];
        ...
        if (this.WT(), Wi(t)) return this.iE(t);
        ...
        return new Ce(this.$c, this.GT, this.YT.host, this.YT.ssl, this.YT.forceLongPolling);
    }, t.prototype.tE = function(t, e) {
        var n = this.eE();
        return this.jT = new zi(Ie.nt(), n, this.zT, this.QT), this.jT.start(t, e);
    }, t.KT = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new I(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.UT) throw new I(T.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.UT;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return gr("Firestore.collection", arguments, 1), br("Firestore.collection", "non-empty string", 1, t), 
        this.WT(), new io(V.K(t), this);
    }, t.prototype.doc = function(t) {
        return gr("Firestore.doc", arguments, 1), br("Firestore.doc", "non-empty string", 1, t), 
        this.WT(), Xi.nE(V.K(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (gr("Firestore.collectionGroup", arguments, 1), br("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.WT(), new no(new Vt(V.G, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return gr("Firestore.runTransaction", arguments, 1), br("Firestore.runTransaction", "function", 1, t), 
        this.WT().transaction((function(n) {
            return t(new Ji(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.WT(), new Hi(this);
        ...
        switch (gr("Firestore.setLogLevel", arguments, 1), br("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            _e(s.DEBUG);
            break;
    ...
    return t.prototype.get = function(t) {
        ...
        var n = ao("Transaction.get", t, this.hE);
        return this.oE.A_([ n.kc ]).then((function(t) {
            if (!t || 1 !== t.length) return xe();
            var r = t[0];
            if (r instanceof St) return new to(e.hE, n.kc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.aE);
            if (r instanceof Dt) return new to(e.hE, n.kc, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.aE);
            throw xe();
        }));
    }, t.prototype.set = function(t, e, n) {
        Er("Transaction.set", arguments, 2, 3);
        var r = ao("Transaction.set", t, this.hE);
        n = oo("Transaction.set", n);
        var i = co(r.aE, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.hE.JT.Dc(s, o, n.mergeFields) : this.hE.JT.vc(s, o);
        return this.oE.set(r.kc, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof Mr ? (wr("Transaction.update", arguments, 3), 
        r = ao("Transaction.update", t, this.hE), i = this.hE.JT.Fc("Transaction.update", e, n, o)) : (gr("Transaction.update", arguments, 2), 
        r = ao("Transaction.update", t, this.hE), i = this.hE.JT.Cc("Transaction.update", e)), 
        this.oE.update(r.kc, i), this;
    }, t.prototype.delete = function(t) {
        gr("Transaction.delete", arguments, 1);
        var e = ao("Transaction.delete", t, this.hE);
    ...
    return t.prototype.set = function(t, e, n) {
        Er("WriteBatch.set", arguments, 2, 3), this._E();
        var r = ao("WriteBatch.set", t, this.hE);
        n = oo("WriteBatch.set", n);
        var i = co(r.aE, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.hE.JT.Dc(s, o, n.mergeFields) : this.hE.JT.vc(s, o);
        return this.uE = this.uE.concat(u.Ac(r.kc, yt.ft())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this._E(), "string" == typeof e || e instanceof Mr ? (wr("WriteBatch.update", arguments, 3), 
        r = ao("WriteBatch.update", t, this.hE), i = this.hE.JT.Fc("WriteBatch.update", e, n, o)) : (gr("WriteBatch.update", arguments, 2), 
        r = ao("WriteBatch.update", t, this.hE), i = this.hE.JT.Cc("WriteBatch.update", e)), 
        this.uE = this.uE.concat(i.Ac(r.kc, yt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        gr("WriteBatch.delete", arguments, 1), this._E();
        var e = ao("WriteBatch.delete", t, this.hE);
        return this.uE = this.uE.concat(new Et(e.kc, yt.ft())), this;
    }, t.prototype.commit = function() {
        return this._E(), this.cE = !0, this.uE.length > 0 ? this.hE.WT().write(this.uE) : Promise.resolve();
    }, t.prototype._E = function() {
        if (this.cE) throw new I(T.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Xi = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.nE = function(e, n, r) {
        ...
        get: function() {
            return new io(this.kc.path.L(), this.firestore, this.aE);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (gr("DocumentReference.collection", arguments, 1), br("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new I(T.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = V.K(t);
        return new io(this.kc.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Rr("isEqual", "DocumentReference", 1, e);
        return this.firestore === e.firestore && this.kc.isEqual(e.kc) && this.aE === e.aE;
    }, t.prototype.set = function(t, e) {
        Er("DocumentReference.set", arguments, 1, 2), e = oo("DocumentReference.set", e);
        var n = co(this.aE, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.JT.Dc(i, r, e.mergeFields) : this.firestore.JT.vc(i, r);
        return this.jT.write(o.Ac(this.kc, yt.ft()));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Mr ? (wr("DocumentReference.update", arguments, 2), 
        n = this.firestore.JT.Fc("DocumentReference.update", t, e, r)) : (gr("DocumentReference.update", arguments, 1), 
        n = this.firestore.JT.Cc("DocumentReference.update", t)), this.jT.write(n.Ac(this.kc, yt.exists(!0)));
    }, t.prototype.delete = function() {
        return gr("DocumentReference.delete", arguments, 0), this.jT.write([ new Et(this.kc, yt.ft()) ]);
    }, t.prototype.onSnapshot = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        Er("DocumentReference.onSnapshot", arguments, 1, 4);
        var n, r = {
            includeMetadataChanges: !1
        }, i = 0;
        "object" != typeof t[i] || Wi(t[i]) || (xr("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Nr("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return Wi(t[i]) ? n = t[i] : (br("DocumentReference.onSnapshot", "function", i, t[i]), 
        ...
        var i = new Gi({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new to(n.firestore, n.kc, r, t.fromCache, t.hasPendingWrites, n.aE));
                }
            },
            error: r
        }), o = this.jT.listen(Vt.Wt(this.kc.path), i, t);
        return function() {
            i.NT(), n.jT.rl(o);
        };
    }, t.prototype.get = function(t) {
        var e = this;
        return Er("DocumentReference.get", arguments, 0, 1), uo("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.WT().DT(e.kc).then((function(t) {
                n(new to(e.firestore, e.kc, t, 
                /*fromCache=*/ !0, t instanceof Dt && t.At, e.aE));
            }), r) : e.dE(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        if (Er("DocumentSnapshot.data", arguments, 0, 1), t = so("DocumentSnapshot.data", t), 
        this.fE) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.aE) {
                var e = new eo(this.hE, this.kc, this.fE, this.TE, this.EE);
                return this.aE.fromFirestore(e, t);
            }
            return new Qi(this.hE, this.hE.rE(), t.serverTimestamps, 
            /* converter= */ void 0).kT(this.fE.Lt());
        }
    }, t.prototype.get = function(t, e) {
        if (Er("DocumentSnapshot.get", arguments, 1, 2), e = so("DocumentSnapshot.get", e), 
        this.fE) {
            var n = this.fE.data().field(ri("DocumentSnapshot.get", t));
            if (null !== n) return new Qi(this.hE, this.hE.rE(), e.serverTimestamps, this.aE).kT(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.kc.path.O();
        ...
        get: function() {
            return new Xi(this.kc, this.hE, this.aE);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        gr("Query.where", arguments, 3), Sr("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i, o = function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new I(T.INVALID_ARGUMENT, "Invalid value " + Dr(r) + " provided to function Query.where() for its " + Or(2) + " argument. Acceptable values: " + e.join(", "));
            return r;
        }(0, [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 0, n), s = ri("Query.where", e);
        if (s.Y()) {
        ...
        i = this.firestore.JT.Nc("Query.where", r, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === o);
        var f = Ot.create(s, o, i);
        return this.AE(f), new t(this.IE.Gt(f), this.firestore, this.aE);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (Er("Query.orderBy", arguments, 1, 2), Tr("Query.orderBy", "non-empty string", 2, n), 
        ...
        if (null !== this.IE.startAt) throw new I(T.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.IE.endAt) throw new I(T.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = ri("Query.orderBy", e), o = new jt(i, r);
        return this.mE(o), new t(this.IE.zt(o), this.firestore, this.aE);
    }, t.prototype.limit = function(e) {
        return gr("Query.limit", arguments, 1), br("Query.limit", "number", 1, e), Vr("Query.limit", 1, e), 
        new t(this.IE.Ht(e), this.firestore, this.aE);
    }, t.prototype.limitToLast = function(e) {
        return gr("Query.limitToLast", arguments, 1), br("Query.limitToLast", "number", 1, e), 
        Vr("Query.limitToLast", 1, e), new t(this.IE.Yt(e), this.firestore, this.aE);
    ...
    t.prototype.VE = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.IE.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(et(this.firestore.$c, t.key)); else {
                var s = t.field(o.field);
                if (z(s)) throw new I(T.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
    ...
    t.prototype.gE = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.IE._e() && -1 !== s.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.IE.path.child(V.K(s));
                ...
                var a = new L(u);
                i.push(et(this.firestore.$c, a));
            } else {
                var h = this.firestore.JT.Nc(t, s);
                i.push(h);
            }
        }
        return new qt(i, n);
        ...
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        Er("Query.onSnapshot", arguments, 1, 4);
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Wi(t[i]) || (xr("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        Nr("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), Wi(t[i]) ? n = t[i] : (br("Query.onSnapshot", "function", i, t[i]), Tr("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        ...
        var i = new Gi({
            next: function(t) {
                e.next && e.next(new ro(n.firestore, n.IE, t, n.aE));
            },
            error: r
        }), o = this.firestore.WT(), s = o.listen(this.IE, i, t);
        return function() {
            i.NT(), o.rl(s);
        };
    }, t.prototype.pE = function(t) {
        ...
        var e = this;
        return Er("Query.get", arguments, 0, 1), uo("Query.get", t), this.pE(this.IE), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.WT().CT(e.IE).then((function(t) {
                n(new ro(e.firestore, e.IE, t, e.aE));
            }), r) : e.dE(n, r, t);
        }));
    }, t.prototype.dE = function(t, e, n) {
        var r = this.lE({
    ...
    t.prototype.RE = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.IE._e() && -1 !== t.indexOf("/")) throw new I(T.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.IE.path.child(V.K(t));
            ...
            return et(this.firestore.$c, new L(e));
        }
        if (t instanceof Xi) {
            var n = t;
            return et(this.firestore.$c, n.kc);
        }
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        Er("QuerySnapshot.forEach", arguments, 1, 2), br("QuerySnapshot.forEach", "function", 1, t), 
        this.vE.docs.forEach((function(r) {
            t.call(e, n.CE(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new no(this.bE, this.hE, this.aE);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (xr("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Nr("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.vE.hs) throw new I(T.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e, n, r) {
            if (n.ss.B()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new eo(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new eo(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new eo(this.hE, t.key, t, this.metadata.fromCache, this.vE.ns.has(t.key), this.aE);
    }, t;
}(), io = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Vt.Wt(t), n, r) || this).FE = t, t.length % 2 != 1) throw new I(T.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.B() ? null : new Xi(new L(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (Er("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = Oe.cn()), br("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new I(T.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = V.K(t);
        return Xi.nE(this.IE.path.child(e), this.firestore, this.aE);
    }, n.prototype.add = function(t) {
        gr("CollectionReference.add", arguments, 1), br("CollectionReference.add", "object", 1, this.aE ? this.aE.toFirestore(t) : t);
        var e = this.doc();
...
function oo(t, e) {
    ...
    if (xr(t, e, [ "merge", "mergeFields" ]), Nr(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function so(t, e) {
    return void 0 === e ? {} : (xr(t, e, [ "serverTimestamps" ]), Ar(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function uo(t, e) {
    Tr(t, "object", 1, e), e && (xr(t, e, [ "source" ]), Ar(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var lo = fo($i, "Use firebase.firestore() instead."), po = fo(Ji, "Use firebase.firestore().runTransaction() instead."), yo = fo(Hi, "Use firebase.firestore().batch() instead."), vo = fo(Xi, "Use firebase.firestore().doc() instead."), mo = fo(to), go = fo(eo), wo = fo(no), Eo = fo(ro), bo = fo(io, "Use firebase.firestore().collection() instead."), To = fo(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        return mr("FieldValue.delete", arguments), new Fr;
    }, t.serverTimestamp = function() {
        return mr("FieldValue.serverTimestamp", arguments), new Br;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return wr("FieldValue.arrayUnion", arguments, 1), new zr(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return wr("FieldValue.arrayRemove", arguments, 1), new Gr(t);
    }, t.increment = function(t) {
        return br("FieldValue.increment", "number", 1, t), gr("FieldValue.increment", arguments, 1), 
        new Wr(t);
    }, t.prototype.isEqual = function(t) {
        return this === t;
    }, t;
}(), "Use FieldValue.<field>() instead."), Io = fo(Cr, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), No = {
    Firestore: lo,
    GeoPoint: Qr,
    Timestamp: S,
    Blob: Io,
    Transaction: po,
    WriteBatch: yo,
    DocumentReference: vo,
    DocumentSnapshot: mo,
    Query: wo,
    QueryDocumentSnapshot: go,
    QuerySnapshot: Eo,
    ...
    return t.prototype.B_ = function(t) {
        ...
        ke("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
        for (var t = 0, e = this.ME; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
    }, t.prototype.LE = function() {
        ke("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (var t = 0, e = this.ME; t < e.length; t++) {
            (0, e[t])(1 /* UNAVAILABLE */);
        }
    }, 
    ...
    Commit: "commit"
}, So = "gl-js/ fire/" + E, xo = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.zE = function(t, e) {
                ...
                try {
                    switch (u.getLastErrorCode()) {
                      case m.NO_ERROR:
                        ...
                        ke("Connection", "XHR received:", JSON.stringify(e)), o(e);
                        break;

                      case m.TIMEOUT:
                        ke("Connection", 'RPC "' + t + '" timed out'), s(new I(T.DEADLINE_EXCEEDED, "Request time out"));
                        break;

                      case m.HTTP_ERROR:
                        var n = u.getStatus();
                        if (ke("Connection", 'RPC "' + t + '" failed with status:', n, "response text:", u.getResponseText()), 
                        n > 0) {
                        ...
                        ke("Connection", 'RPC "' + t + '" failed'), s(new I(T.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var o = n.join("");
        ke("Connection", "Creating WebChannel: " + o + " " + i);
        var s = r.createWebChannel(o, i), u = !1, d = !1, y = new ko({
            xE: function(t) {
                d ? ke("Connection", "Not sending because WebChannel is closed:", t) : (u || (ke("Connection", "Opening WebChannel transport."), 
                s.open(), u = !0), ke("Connection", "WebChannel sending:", t), s.send(t));
            },
            BE: function() {
                return s.close();
            }
        ...
        return v(w.EventType.OPEN, (function() {
            d || ke("Connection", "WebChannel transport opened.");
        })), v(w.EventType.CLOSE, (function() {
            d || (d = !0, ke("Connection", "WebChannel transport closed"), y.jE());
        })), v(w.EventType.ERROR, (function(t) {
            d || (d = !0, ke("Connection", "WebChannel transport errored:", t), y.jE(new I(T.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ke("Connection", "WebChannel received error:", i);
                    ...
                    d = !0, y.jE(new I(u, a)), s.close();
                } else ke("Connection", "WebChannel received:", n), y.KE(n);
            }
        })), setTimeout((function() {
