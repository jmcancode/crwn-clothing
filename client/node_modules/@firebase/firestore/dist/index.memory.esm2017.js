...
class A {
    ...
    A() {
        ...
        return ge(null === t || "string" == typeof t), new T(t);
    }
}
 ...
 */ class At extends Rt {
    ...
    isEqual(t) {
        return t instanceof At && this.key.isEqual(t.key) && this.version.isEqual(t.version) && this.At === t.At && this.hasCommittedMutations === t.hasCommittedMutations && this.kt.isEqual(t.kt);
    }
    toString() {
 ...
 */ class pt {
    ...
    canonicalId() {
        if (null === this.Ot) {
            ...
            k(this.limit) || (t += "|l:", t += this.limit), this.startAt && (t += "|lb:", t += this.startAt.canonicalId()), 
    ...
    toString() {
        ...
        this.filters.length > 0 && (t += `, filters: [${this.filters.join(", ")}]`), k(this.limit) || (t += ", limit: " + this.limit), 
 ...
 */ class yt {
    ...
    oe() {
        return !k(this.limit) && "F" /* First */ === this.xt;
    }
    ae() {
        return !k(this.limit) && "L" /* Last */ === this.xt;
    }
    Gt() {
 ...
 *     Code.UNKNOWN.
 */ (Ot = Lt || (Lt = {}))[Ot.OK = 0] = "OK", Ot[Ot.CANCELLED = 1] = "CANCELLED", 
...
class le {
    ...
    /** Processes and adds the WatchTargetChange to the current set of changes. */    Ws(t) {
        this.js(t, e => {
            ...
            switch (t.state) {
              ...
              case 3 /* Current */ :
                this.Hs(e) && (s.ks(), s.vs(t.resumeToken));
                break;
     ...
     * from all documents).
     */    Ks(t) {
        this.Os.set(t, new ce), this.Ls.ei(t).forEach(e => {
 ...
 */ (t) ? this.lt(t) : this._t(t);
    ...
    yi(t) {
        ...
        if ("targetChange" in t) {
            ...
            if (!("filter" in t)) return ye();
            {
                ...
                const s = t.filter;
                s.targetId;
                const i = s.count || 0, n = new kt(i), r = s.targetId;
                e = new ae(r, n);
            }
        }
        return e;
    ...
    Oi(t, e) {
        return t && t.length > 0 ? (ge(void 0 !== e), t.map(t => this.Li(t, e))) : [];
    }
    Ci(t) {
        const e = t.transform;
    ...
    xi(t) {
        ...
        null !== t.collectionGroup ? (e.parent = this.Ti(s), e.structuredQuery.from = [ {
            ...
            allDescendants: !0
        } ]) : (e.parent = this.Ti(s.L()), e.structuredQuery.from = [ {
            collectionId: s.q()
        } ]);
...
/** The result of applying a mutation batch to the backend. */ class ke {
    constructor(t, e, s, i, 
    /**
     ...
     */
    n) {
        this.batch = t, this.mn = e, this.Tn = s, this.streamToken = i, this.In = n;
    }
    /**
 ...
 */ class Le {
    ...
    next(t, e) {
        return this.Vn && ye(), this.Vn = !0, this.Pn ? this.error ? this.pn(e, this.error) : this.yn(t, this.result) : new Le((s, i) => {
            this.Rn = e => {
...
class Oe {
     ...
     * state for it.
     */    Nn(t, e) {
        return this.Dn.$n(t, e).next(s => this.kn(t, e, s));
    }
    /** Internal version of `getDocument` that allows reusing batches. */    kn(t, e, s) {
        return this.Cn.Ln(t, e).next(t => {
 ...
 */ class Qe {
    ...
    add(t) {
        const e = t.q(), s = t.L(), i = this.index[e] || new Qt(b.N), n = !i.has(s);
        return this.index[e] = i.add(s), n;
    }
    has(t) {
        const e = t.q(), s = t.L(), i = this.index[e];
        return i && i.has(s);
    }
    getEntries(t) {
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function je(t) {
...
class Ge {
    constructor(t, e, s, i, n) {
        this.Pr = t, this.ir = e, this.Vr = s, this.op = i, this.pr = n, this.yr = new xe, 
     ...
     */    cancel(t) {
        null !== this.br && (this.clearTimeout(), this.yr.reject(new m(E.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    vr() {
...
class He {
    constructor() {
        ...
        this.Or = new Be(this, "async_queue_retry" /* AsyncQueueRetry */), 
     ...
     */    jr(t) {
        this.Br(), this.Fr || (this.Dr = this.Dr.then(() => {
            const e = new xe, s = async () => {
                try {
                    await t(), e.resolve(), this.Or.reset();
                } catch (t) {
                    if (!je(t)) throw e.resolve(), t;
 // Failure will be handled by AsyncQueue
    ...
    Ur(t) {
        const e = this.Cr.then(() => (this.kr = !0, t().catch(t => {
            // Re-throw the error so that this.tail becomes a rejected Promise and
            // all further attempts to chain (via .then) will just short-circuit
            // and return the rejected Promise.
            throw this.$r = t, this.kr = !1, Ve("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
            t;
        }).then(t => (this.kr = !1, t))));
        return this.Cr = e, e;
    }
     ...
     */    dr(t, e, s) {
        ...
        const i = Ge.gr(this, t, e, s, t => this.Gr(t));
 ...
 */ function Ke(t, e) {
    if (Ve("AsyncQueue", `${e}: ${t}`), je(t)) return new m(E.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class ze {
    ...
    static eh(t) {
        return new ze(t, ze.sh, ze.ih);
    }
}

ze.nh = -1, ze.rh = 1048576, ze.hh = 41943040, ze.sh = 10, ze.ih = 1e3, ze.oh = new ze(ze.hh, ze.sh, ze.ih), 
ze.DISABLED = new ze(ze.nh, 0, 0);
...
class Ye {
    ...
    t, e, s) {
        ...
        this.lh = new Ne(t => t.canonicalId()), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this._h = y.min(), this.Dn = t.fh(s), this.dh = t.wh(), this.Th = t.Eh(), this.mh = new Oe(this.dh, this.Dn, this.persistence.Ih()), 
        this.ah.Rh(this.mh);
    }
    ...
    async Ah(t) {
        ...
        const i = await this.persistence.runTransaction("Handle user change", "readonly", i => {
            ...
            // MutationQueue.
            s = new Oe(this.dh, e, this.persistence.Ih()), e.Ph(i))).next(t => {
                const e = [], r = [];
        ...
        return this.Dn = e, this.mh = s, this.ah.Rh(this.mh), i;
    }
    /* Accept locally generated Mutations and commit them to storage. */    gh(t) {
        const e = p.now(), s = t.reduce((t, e) => t.add(e.key), Zt());
        let i;
        return this.persistence.runTransaction("Locally write mutations", "readwrite", n => this.mh.qn(n, s).next(s => {
            i = s;
     ...
     */    Sh(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            ...
            return this.Dn.Sh(e, t.batch, t.streamToken).next(() => this.Fh(e, t, i)).next(() => i.apply(e)).next(() => this.Dn.Nh(e)).next(() => this.mh.qn(e, s));
        });
    }
    /**
     ...
     */    $h(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let s;
            return this.Dn.kh(e, t).next(t => (ge(null !== t), s = t.keys(), this.Dn.Lh(e, t))).next(() => this.Dn.Nh(e)).next(() => this.mh.qn(e, s));
        });
    }
    /**
     ...
     */    Oh() {
        return this.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", t => this.Dn.Oh(t));
    }
    /** Returns the last recorded stream token for the current user. */    qh() {
        return this.persistence.runTransaction("Get last stream token", "readonly", t => this.Dn.qh(t));
    }
    /**
     ...
     */    Mh(t) {
        return this.persistence.runTransaction("Set last stream token", "readwrite-primary", e => this.Dn.Mh(e, t));
    }
    /**
     * Returns the last consistent snapshot processed (used by the RemoteStore to
     * determine whether to buffer incoming snapshots from the backend).
     */    xh() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Th.xh(t));
    }
    /**
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", i => {
            ...
            t.as.forEach((t, n) => {
                ...
                // the updated assignment.
                                r.push(this.Th.Uh(i, t.Es, n).next(() => this.Th.Qh(i, t.ws, n)));
                const o = t.resumeToken;
                // Update the resume token if the change includes one.
                                if (o.rt() > 0) {
                    const a = h.me(o, e).Ee(i.Wh);
                    s = s.Re(n, a), 
                    // Update the target data if there are target changes (or if
                    // sufficient time has passed since the last update).
                    Ye.jh(h, a, t) && r.push(this.Th.Gh(i, a));
                }
            });
            let h = Gt(), o = Zt();
            ...
            r.push(n.getEntries(i, o).next(s => {
                t.cs.forEach((o, a) => {
                    ...
                    // access.
                    n.Hh(o, e), h = h.Re(o, a)) : null == u || a.version.S(u.version) > 0 || 0 === a.version.S(u.version) && u.hasPendingWrites ? (n.Kh(a, e), 
                    h = h.Re(o, a)) : Pe("LocalStore", "Ignoring outdated watch update for ", o, ". Current version:", u.version, " Watch version:", a.version), 
                    t.ls.has(o) && r.push(this.persistence.Yh.zh(i, o));
                });
            })), !e.isEqual(y.min())) {
                const t = this.Th.xh(i).next(t => this.Th.Xh(i, i.Wh, e));
                r.push(t);
            }
            return Le.vn(r).next(() => n.apply(i)).next(() => this.mh.Mn(i, h));
        }).then(t => (this.uh = s, t));
    }
    /**
     ...
     */    static jh(t, e, s) {
        ...
        // closing.
                return e.Te.C() - t.Te.C() >= this.Jh || s.ws.size + s.Ts.size + s.Es.size > 0;
     ...
     */    async Zh(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => Le.forEach(t, t => Le.forEach(t.Kn, s => this.persistence.Yh.to(e, t.targetId, s)).next(() => Le.forEach(t.zn, s => this.persistence.Yh.eo(e, t.targetId, s)))));
        } catch (t) {
            if (!je(t)) throw t;
        ...
        for (const e of t) {
            const t = e.targetId;
            if (!e.fromCache) {
                const e = this.uh.get(t), s = e.Te, i = e.Ie(s);
                // Advance the last limbo free snapshot version
                                this.uh = this.uh.Re(t, i);
            }
        }
    }
    /**
     ...
     */    no(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.mh.Nn(e, t));
    }
    /**
     ...
     */    ro(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            let s;
            return this.Th.ho(e, t).next(i => i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            s = i, Le.resolve(s)) : this.Th.oo(e).next(i => (s = new $t(t, i, 0 /* Listen */ , e.Wh), 
            this.Th.ao(e, s).next(() => s))));
        }).then(e => (null === this.uh.get(e.targetId) && (this.uh = this.uh.Re(e.targetId, e), 
    ...
    ho(t, e) {
        ...
        return void 0 !== s ? Le.resolve(this.uh.get(s)) : this.Th.ho(t, e);
    }
    /**
    ...
    uo(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, t => e ? Le.resolve() : this.persistence.Yh.removeTarget(t, s)).then(() => {
     ...
     */    co(t, e) {
        let s = y.min(), i = Zt();
        return this.persistence.runTransaction("Execute query", "readonly", n => this.ho(n, t.ee()).next(t => {
            if (t) return s = t.lastLimboFreeSnapshotVersion, this.Th.lo(n, t.targetId).next(t => {
                i = t;
            });
        }).next(() => this.ah.Bn(n, t, e ? s : y.min(), e ? i : Zt())).next(t => ({
            documents: t,
            _o: i
        })));
    }
    ...
    fo(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", e => t.do(e, this.uh));
    }
}
...
class Je {
    constructor() {
        ...
        this.wo = new Qt(Ze.To), 
        // A set of outstanding references to a document sorted by target id.
        this.Eo = new Qt(Ze.mo);
    }
    ...
    /** Adds a reference to the given document key for the given ID. */    to(t, e) {
        const s = new Ze(t, e);
        this.wo = this.wo.add(s), this.Eo = this.Eo.add(s);
    }
     ...
     * removed.
     */    Po(t) {
        const e = C.EMPTY, s = new Ze(e, t), i = new Ze(e, t + 1), n = [];
        return this.Eo.Ge([ s, i ], t => {
            this.Ro(t), n.push(t.key);
        }), n;
    }
    Vo() {
        this.wo.forEach(t => this.Ro(t));
    }
    Ro(t) {
        this.wo = this.wo.delete(t), this.Eo = this.Eo.delete(t);
    }
    po(t) {
        const e = C.EMPTY, s = new Ze(e, t), i = new Ze(e, t + 1);
        let n = Zt();
        return this.Eo.Ge([ s, i ], t => {
            n = n.add(t.key);
        }), n;
    ...
    yo(t) {
        const e = new Ze(t, 0), s = this.wo.Ke(e);
...
class Ze {
    ...
    /** Compare by key then by ID */    static To(t, e) {
        return C.N(t.key, e.key) || Se(t.bo, e.bo);
    }
    /** Compare by ID then by key */    static mo(t, e) {
        return Se(t.bo, e.bo) || C.N(t.key, e.key);
    }
}
 ...
 */ function ts(t, e) {
    if (0 !== e.length) throw new m(E.INVALID_ARGUMENT, `Function ${t}() does not support arguments, ` + "but was called with " + ms(e.length, "argument") + ".");
}
 ...
 */ function es(t, e, s) {
    if (e.length !== s) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires ` + ms(s, "argument") + ", but was called with " + ms(e.length, "argument") + ".");
}
 ...
 */ function ss(t, e, s) {
    if (e.length < s) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires at least ` + ms(s, "argument") + ", but was called with " + ms(e.length, "argument") + ".");
}
 ...
 */ function is(t, e, s, i) {
    if (e.length < s || e.length > i) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires between ${s} and ` + `${i} arguments, but was called with ` + ms(e.length, "argument") + ".");
}
...
function as(t, e, s, i, n) {
    void 0 !== i && function(t, e, s, i, n) {
        if (!(i instanceof Array)) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires its ${e} ` + `option to be an array, but it was: ${_s(i)}`);
        for (let r = 0; r < i.length; ++r) if (!n(i[r])) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires all ${e} ` + `elements to be ${s}, but the value at index ${r} ` + `was: ${_s(i[r])}`);
    }(t, e, s, i, n);
}
...
function fs(t, e, s) {
    if (void 0 === s) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires a valid ${Es(e)} ` + "argument, but it was undefined.");
}
 ...
 */ function ws(t, e, s, i) {
    const n = _s(i);
    return new m(E.INVALID_ARGUMENT, `Function ${t}() requires its ${Es(s)} ` + `argument to be a ${e}, but it was: ${n}`);
}

function Ts(t, e, s) {
    if (s <= 0) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires its ${Es(e)} argument to be a positive number, but it was: ${s}.`);
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function Rs() {
    if (!me.nt().vo) throw new m(E.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ class As {
    ...
    static fromBase64String(t) {
        ...
        Rs();
        try {
            return new As($.fromBase64String(t));
        } catch (t) {
            throw new m(E.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (es("Blob.fromUint8Array", arguments, 1), Is(), !(t instanceof Uint8Array)) throw ws("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new As($.fromUint8Array(t));
    }
    toBase64() {
        return es("Blob.toBase64", arguments, 0), Rs(), this.So.toBase64();
    }
    toUint8Array() {
        return es("Blob.toUint8Array", arguments, 0), Is(), this.So.toUint8Array();
    }
    toString() {
 ...
 */ class Ps {
    ...
    constructor(...t) {
        !function(t, e, s, i) {
            if (!(e instanceof Array) || e.length < i) throw new m(E.INVALID_ARGUMENT, `Function ${t}() requires its ${s} argument to be an ` + "array with at least " + `${ms(i, "element")}.`);
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (ns("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new m(E.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.Co = new S(t);
    }
    static documentId() {
        return Ps.Do;
...
class bs extends ps {
    constructor(t) {
        super("FieldValue.arrayUnion"), this.ko = t;
    }
    Ci(t) {
        ...
        const e = new ks({
            ...
            methodName: this.Fo,
            Lo: !0
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), s = this.ko.map(t => Os(t, e)), i = new it(s);
...
class vs extends ps {
    constructor(t) {
        super("FieldValue.arrayRemove"), this.ko = t;
    }
    Ci(t) {
        // Although array transforms are used with writes, the actual elements
        ...
        const e = new ks({
            ...
            methodName: this.Fo,
            Lo: !0
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), s = this.ko.map(t => Os(t, e)), i = new nt(s);
        return new at(t.path, i);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Ss extends ps {
    constructor(t) {
        super("FieldValue.increment"), this.Oo = t;
    }
    Ci(t) {
        const e = new ks({
            No: 3 /* Argument */ ,
            methodName: this.Fo
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), s = Os(this.Oo, e), i = new rt(t.serializer, s);
        return new at(t.path, i);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
/** The result of parsing document data (e.g. for a setData call). */ class Fs {
    constructor(t, e, s) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class Ns {
    constructor(t, e, s) {
        this.data = t, this.Vt = e, this.fieldTransforms = s;
    }
    xo(t, e) {
...
/** A "context" object passed around while parsing user data. */ class ks {
    ...
    constructor(t, e, s, i, n, r) {
        ...
        void 0 === n && this.Bo(), this.fieldTransforms = n || [], this.Vt = r || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Uo(t) {
        return new ks(Object.assign(Object.assign({}, this.settings), t), this.ii, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.Vt);
    }
    Qo(t) {
        var e;
        const s = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), i = this.Uo({
            path: s,
            Lo: !1
        });
        return i.Wo(t), i;
    ...
    Bo() {
        ...
        // within arrays.
        if (this.path) for (let t = 0; t < this.path.length; t++) this.Wo(this.path.get(t));
    }
    Wo(t) {
        if (0 === t.length) throw this.$o("Document fields must not be empty");
        if ($s(this.No) && Ds.test(t)) throw this.$o('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Ls {
    constructor(t, e, s) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = s || me.nt().Ho(t);
    }
    /** Parse document data from a non-merge set() call. */    Ko(t, e) {
        const s = this.zo(0 /* Set */ , t);
        xs("Data must be an object, but it was:", s, e);
        const i = qs(e, s);
        return new Fs(new Et(i), 
        /* fieldMask= */ null, s.fieldTransforms);
    }
    /** Parse document data from a set() call with '{merge:true}'. */    Yo(t, e, s) {
        const i = this.zo(2 /* MergeSet */ , t);
        xs("Data must be an object, but it was:", i, e);
        const n = qs(e, i);
        let r, h;
        if (s) {
            const e = [];
            for (const n of s) {
                let s;
                if (n instanceof Ps) s = n.Co; else {
        ...
        return new Fs(new Et(n), r, h);
    }
    /** Parse update data from an update() call. */    Xo(t, e) {
        const s = this.zo(1 /* Update */ , t);
        xs("Data must be an object, but it was:", s, e);
        const i = [], n = new mt;
        F(e, (e, r) => {
            const h = Us(t, e), o = s.jo(h);
            if (r instanceof ys) 
        ...
        const r = new ot(i);
        return new Ns(n.gt(), r, s.fieldTransforms);
    }
    /** Parse update data from a list of field/value arguments. */    Jo(t, e, s, i) {
        const n = this.zo(1 /* Update */ , t), r = [ Bs(t, e) ], h = [ s ];
        ...
        for (let e = 0; e < i.length; e += 2) r.push(Bs(t, i[e])), h.push(i[e + 1]);
        const o = [], a = new mt;
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (let t = r.length - 1; t >= 0; --t) if (!Qs(o, r[t])) {
            const e = r[t], s = h[t], i = n.jo(e);
            if (s instanceof ys) 
            // Add it to the field mask, but don't add anything to updateData.
            o.push(e); else {
                const t = Os(s, i);
        ...
        const u = new ot(o);
        return new Ns(a.gt(), u, n.fieldTransforms);
    }
    /** Creates a new top-level parse context. */    zo(t, e) {
        return new ks({
            No: t,
            methodName: e,
            path: S.H,
     ...
     */    Zo(t, e, s = !1) {
        return Os(e, this.zo(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }
}
 ...
 */ function Os(t, e) {
    if (Ms(t)) return xs("Unsupported field value:", e, t), qs(t, e);
    if (t instanceof ps) 
 ...
 */
    return function(t, e) {
        ...
        if (!$s(e.No)) throw e.$o(`${t.Fo}() can only be used with update() and set()`);
...
function Ms(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof p || t instanceof Cs || t instanceof As || t instanceof gi || t instanceof ps);
}
 ...
 */ function Bs(t, e) {
    if (e instanceof Ps) return e.Co;
    if ("string" == typeof e) return Us(t, e);
 ...
 */ function Us(t, e) {
    try {
        return function(t) {
            if (t.search(Vs) >= 0) throw new m(E.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain ` + "'~', '*', '/', '[', or ']'");
            try {
...
class Ws {
    constructor(t, e, s, i, n, r) {
         ...
         * close.
         */
        this.ra = 0, this.ha = null, this.stream = null, this.Or = new Be(t, e);
    }
    /**
    ...
    ma(t) {
        ...
        this.stream = this.Ra(t), this.stream.Aa(() => {
    ...
    ua() {
        this.state = 4 /* Backoff */ , this.Or.lr(async () => {
     ...
     */    Ea(t) {
        return e => {
            this.sr.Sr(() => this.ra === t ? e() : (Pe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class Gs extends Ws {
    ...
    onMessage(t) {
        ...
        return ge(!t.writeResults || 0 === t.writeResults.length), this.ga = !0, this.listener.Ca();
    }
    /**
...
class Hs extends class {
    ...
    constructor(t, e, s) {
        super(), this.ia = t, this.credentials = e, this.serializer = s;
    }
    /** Gets an auth token and invokes the provided RPC. */    Na(t, e) {
        return this.credentials.getToken().then(s => this.ia.Na(t, e, s)).catch(t => {
            throw t.code === E.UNAUTHENTICATED && this.credentials.l(), t;
        });
    }
    /** Gets an auth token and invokes the provided RPC with streamed results. */    $a(t, e) {
        return this.credentials.getToken().then(s => this.ia.$a(t, e, s)).catch(t => {
            throw t.code === E.UNAUTHENTICATED && this.credentials.l(), t;
        });
    }
}
...
class Ks {
    constructor(t) {
        ...
        this.La = Xt(), this.mutations = [], this.Oa = !1, 
        /**
    ...
    async xa(t) {
        if (this.Ba(), this.mutations.length > 0) throw new m(E.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const s = be(t), i = {
                database: s.serializer.mi,
                documents: e.map(t => s.serializer.di(t))
            }, n = await s.$a("BatchGetDocuments", i), r = new Map;
            n.forEach(t => {
        ...
        return e.forEach(t => {
            t instanceof Pt || t instanceof At ? this.Ua(t) : ye();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new wt(t, this.Rt(t)) ]), this.Ma.add(t);
    }
    async commit() {
        ...
        // a `verify` operation.
        t.forEach((t, e) => {
            this.mutations.push(new Tt(t, this.Rt(t)));
        }), await async function(t, e) {
            const s = be(t), i = {
                database: s.serializer.mi,
                writes: e.map(t => s.serializer.vi(t))
            }, n = await s.Na("Commit", i);
            return s.serializer.Oi(n.writeResults, n.commitTime);
        }(this.ka, this.mutations), this.Oa = !0;
    }
    Ua(t) {
        let e;
     ...
     */    Rt(t) {
        ...
        return !this.Ma.has(t) && e ? ct.updateTime(e) : ct.dt();
    }
    /**
...
class zs {
     ...
     */    Ka() {
        0 === this.ja && (this.za("Unknown" /* Unknown */), this.Ga = this.Pr.dr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, () => (this.Ga = null, 
        this.Ya("Backend didn't respond within 10 seconds."), this.za("Offline" /* Offline */), 
        Promise.resolve())));
    }
    /**
    ...
    Ya(t) {
        ...
        this.Ha ? (Ve(e), this.Ha = !1) : Pe("OnlineStateTracker", e);
    }
    Ja() {
...
class Ys {
    ...
    e, s, i, n) {
         ...
         * again.
         */
        this.iu = !1, this.nu = n, this.nu.ru(t => {
            s.Sr(async () => {
                this.hu() && (Pe("RemoteStore", "Restarting streams for network reachability change."), 
                await this.ou());
            });
        }), this.au = new zs(s, i), 
        // Create streams (but note they're not started yet).
        this.uu = function(t, e, s) {
            const i = be(t);
            return new js(e, i.ia, i.credentials, i.serializer, s);
        }(this.ka, s, {
            Aa: this.cu.bind(this),
            Ta: this.lu.bind(this),
            Va: this._u.bind(this)
        }), this.fu = function(t, e, s) {
            const i = be(t);
            return new Gs(e, i.ia, i.credentials, i.serializer, s);
        }(this.ka, s, {
    ...
    async Eu() {
        this.hu() && (this.fu.lastStreamToken = await this.Za.qh(), this.mu() ? this.Iu() : this.au.set("Unknown" /* Unknown */), 
     ...
     */    async disableNetwork() {
        this.networkEnabled = !1, await this.Au(), 
        // Set the OnlineState to Offline so get()s return from cache, etc.
        this.au.set("Offline" /* Offline */);
    }
    async Au() {
        await this.fu.stop(), await this.uu.stop(), this.tu.length > 0 && (Pe("RemoteStore", `Stopping write stream with ${this.tu.length} pending writes`), 
        this.tu = []), this.Pu();
    }
    async Vu() {
        Pe("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, await this.Au(), 
        this.nu.Vu(), 
    ...
    Iu() {
        this.su = new le(this), this.uu.start(), this.au.Ka();
    }
    /**
    ...
    async _u(t, e) {
        ...
        this.au.set("Online" /* Online */), t instanceof ue && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.Su(e);
        } else if (t instanceof oe ? this.su.Bs(t) : t instanceof ae ? this.su.zs(t) : this.su.Ws(t), 
        !e.isEqual(y.min())) try {
            const t = await this.Za.xh();
            e.S(t) >= 0 && 
            // We have received a target change with a global snapshot if the snapshot
            // version is not equal to SnapshotVersion.min().
            await this.Cu(e);
        } catch (t) {
            Pe("RemoteStore", "Failed to raise snapshot:", t), await this.Su(t);
        }
    }
    /**
     ...
     */    async Su(t) {
        ...
        await this.Au(), this.au.set("Offline" /* Offline */), 
        ...
        this.Pr.jr(async () => {
            ...
            await this.Za.xh(), this.iu = !1, await this.Eu();
        });
    }
    /**
     ...
     * SyncEngine.
     */    Cu(t) {
        const e = this.su.Js(t);
        // Update in-memory resume tokens. LocalStore will update the
        // persistent view of these when applying the completed RemoteEvent.
                // Finally raise remote event
        return e.as.forEach((e, s) => {
            if (e.resumeToken.rt() > 0) {
                const i = this.eu.get(s);
                // A watched target might have been removed already.
                                i && this.eu.set(s, i.me(e.resumeToken, t));
            }
        }), 
        // Re-establish listens for the targets that have been invalidated by
        // existence filter mismatches.
        e.us.forEach(t => {
            const e = this.eu.get(t);
            if (!e) 
            // A watched target might have been removed already.
            return;
            // Clear the resume token for the target, since we're in a known mismatch
            // state.
                        this.eu.set(t, e.me($.ht, e.Te)), 
    ...
    /** Handles an error on a target */    async vu(t) {
        const e = t.cause;
        for (const s of t.targetIds) 
        // A watched target might have been removed already.
        this.eu.has(s) && (await this.bu.Du(s, e), this.eu.delete(s), this.su.removeTarget(s));
    }
    /**
     ...
     */    async Ru() {
        if (this.Fu()) {
            const t = this.tu.length > 0 ? this.tu[this.tu.length - 1].batchId : -1, e = await this.Za.so(t);
            null === e ? 0 === this.tu.length && this.fu.la() : (this.Nu(e), await this.Ru());
        }
        this.$u() && this.ku();
    }
    /**
    ...
    Tu() {
        ...
        return this.Za.Mh(this.fu.lastStreamToken).then(() => {
            // Send the write pipeline now that the stream is established.
            for (const t of this.tu) this.fu.va(t.mutations);
        }).catch(Xe);
    }
    Sa(t, e) {
        const s = this.tu.shift(), i = ke.from(s, t, e, this.fu.lastStreamToken);
        return this.bu.Ou(i).then(() => this.Ru());
    }
    async wu(t) {
        // If the write stream closed due to an error, invoke the error callbacks if
        // there are pending writes.
        t && this.tu.length > 0 && (this.fu.ba ? 
    ...
    async Mu(t) {
        ...
        if (qt(t.code)) return Pe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.fu.lastStreamToken), 
        this.fu.lastStreamToken = $.ht, this.Za.Mh($.ht).catch(Xe);
    }
    async qu(t) {
        ...
        if (qt(e = t.code) && e !== E.ABORTED) {
            ...
            const e = this.tu.shift();
            // In this case it's also unlikely that the server itself is melting
            // down -- this was just a bad request so inhibit backoff on the next
            // restart.
                        return this.fu.ca(), this.bu.xu(e.batchId, t).then(() => this.Ru());
        }
        var e;
        /**
 ...
 */    }
    Bu() {
        return new Ks(this.ka);
    }
    async ou() {
        this.networkEnabled = !1, await this.Au(), this.au.set("Unknown" /* Unknown */), 
    ...
    async Uu() {
        ...
        Pe("RemoteStore", "RemoteStore restarting streams for new credential"), await this.ou());
    }
    /**
     * Toggles the network state when the client gains or loses its primary lease.
     */    async Qu(t) {
        this.isPrimary = t, t && this.networkEnabled ? await this.enableNetwork() : t || (await this.Au(), 
        this.au.set("Unknown" /* Unknown */));
    }
}
 ...
 */ class Js {
    constructor() {
        this.Hu = new Xs, this.Ku = {}, this.bu = null, this.Wa = null, this.Xn = null;
    }
    zu(t) {
        // No op.
    }
    ...
    start() {
        return this.Hu = new Xs, Promise.resolve();
    }
    Ah(t, e, s) {
        // No op.
    }
 ...
 */ class ei {
    ...
    e) {
        ...
        this.ns = Zt(), this.ac = new se(t.se.bind(t));
    }
    /**
     ...
     */    cc(t, e) {
        const s = e ? e.lc : new ie, i = e ? e.ac : this.ac;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (t.type, e.type) || this.query.se(t.doc, e.doc)), this.wc(s);
        const r = e ? this.Tc() : [], h = 0 === this.oc.size && this.ds ? 1 /* Synced */ : 0 /* Local */ , o = h !== this.hc;
        if (this.hc = h, 0 !== n.length || o) {
            return {
                snapshot: new ne(this.query, t.ac, i, n, t.ns, 0 /* Local */ === h, o, 
                /* excludesMetadataChanges= */ !1),
                Ec: r
            };
        }
     ...
     */    wc(t) {
        t && (t.ws.forEach(t => this.rc = this.rc.add(t)), t.Ts.forEach(t => {}), t.Es.forEach(t => this.rc = this.rc.delete(t)), 
        this.ds = t.ds);
    }
    Tc() {
        ...
        // updating many documents.
                const t = this.oc;
        this.oc = Zt(), this.ac.forEach(t => {
            this.Ic(t.key) && (this.oc = this.oc.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.oc.has(t) || e.push(new ti(t));
        }), this.oc.forEach(s => {
    ...
    // PORTING NOTE: Multi-tab only.
    Ac() {
        return ne.os(this.query, this.ac, this.ns, 0 /* Local */ === this.hc);
    }
}
...
class si {
    constructor(t, e, s, i) {
        this.Pr = t, this.Pc = e, this.updateFunction = s, this.yr = i, this.Vc = 5, this.Or = new Be(this.Pr, "transaction_retry" /* TransactionRetry */);
    }
    /** Runs the transaction and sets the result on deferred. */    pc() {
        this.yc();
    }
    yc() {
        this.Or.lr(async () => {
            const t = this.Pc.Bu(), e = this.gc(t);
            e && e.then(e => {
    ...
    gc(t) {
        try {
            ...
            return !k(e) && e.catch && e.then ? e : (this.yr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    bc(t) {
        this.Vc > 0 && this.vc(t) ? (this.Vc -= 1, this.Pr.Sr(() => (this.yc(), Promise.resolve()))) : this.yr.reject(t);
    }
    vc(t) {
 ...
 */ class ri {
    ...
    s, i, n) {
        this.Za = t, this.Pc = e, this.Cc = s, this.currentUser = i, this.Dc = n, this.Fc = null, 
        this.Nc = new Ne(t => t.canonicalId()), this.$c = new Map, 
        /**
         ...
         */
        this.Oc = new Map, this.qc = new Je, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Mc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.xc = new Map, this.Bc = We.Ar(), this.onlineState = "Unknown" /* Unknown */;
    }
    get Uc() {
        return !0;
    }
     ...
     */    async listen(t) {
        ...
        e = i.targetId, this.Cc.Xu(e), s = i.view.Ac(); else {
            const i = await this.Za.ro(t.ee()), n = this.Cc.Xu(i.targetId);
            e = i.targetId, s = await this.Wc(t, e, "current" === n), this.Uc && this.Pc.listen(i);
        }
        return s;
    }
    /**
     ...
     * snapshot.
     */    async Wc(t, e, s) {
        const i = await this.Za.co(t, 
        /* usePreviousResults= */ !0), n = new ei(t, i._o), r = n.cc(i.documents), h = he.fs(e, s && "Offline" /* Offline */ !== this.onlineState), o = n.dc(r, 
        /* updateLimboDocuments= */ this.Uc, h);
        this.jc(e, o.Ec);
        const a = new ii(t, e, n);
        return this.Nc.set(t, a), this.$c.has(e) ? this.$c.get(e).push(t) : this.$c.set(e, [ t ]), 
        o.snapshot;
    }
    /** Stops listening to the query. */    async yu(t) {
        this.Qc("unlisten()");
        const e = this.Nc.get(t), s = this.$c.get(e.targetId);
        // Only clean up the query view and target if this is the only query mapped
        // to the target.
                if (s.length > 1) return this.$c.set(e.targetId, s.filter(e => !e.isEqual(t))), 
        void this.Nc.delete(t);
        // No other queries are mapped to the target, clean up the query and the target.
                if (this.Uc) {
            // We need to remove the local query target first to allow us to verify
            // whether any other client is still interested in this target.
            this.Cc.Zu(e.targetId), this.Cc.ic(e.targetId) || await this.Za.uo(e.targetId, /*keepPersistedTargetData=*/ !1).then(() => {
                this.Cc.ec(e.targetId), this.Pc.yu(e.targetId), this.Gc(e.targetId);
            }).catch(Xe);
        } else this.Gc(e.targetId), await this.Za.uo(e.targetId, 
     ...
     */    async write(t, e) {
        this.Qc("write()");
        try {
            const s = await this.Za.gh(t);
            this.Cc.zu(s.batchId), this.Hc(s.batchId, e), await this.Kc(s.vh), await this.Pc.Ru();
        } catch (t) {
            // If we can't persist the mutation, we reject the user callback and
            // don't send the mutation. The user can then retry the write.
            const s = Ke(t, "Failed to persist write");
            e.reject(s);
        }
    }
    /**
     ...
     */    runTransaction(t, e, s) {
        new si(t, this.Pc, e, s).pc();
    }
    async Bh(t) {
        this.Qc("applyRemoteEvent()");
        try {
            const e = await this.Za.Bh(t);
            // Update `receivedDocument` as appropriate for any limbo targets.
                        t.as.forEach((t, e) => {
                const s = this.Oc.get(e);
                s && (
                // Since this is a limbo resolution lookup, it's for a single document
                // and it could be added, modified, or removed, but not a combination.
                ge(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? s.Sc = !0 : t.Ts.size > 0 ? ge(s.Sc) : t.Es.size > 0 && (ge(s.Sc), 
                s.Sc = !1));
            }), await this.Kc(e, t);
        } catch (t) {
            await Xe(t);
     ...
     */    mc(t, e) {
        ...
        }), this.Fc.zc(t), this.Fc.Va(s), this.onlineState = t;
    }
    async Du(t, e) {
        this.Qc("rejectListens()"), 
        // PORTING NOTE: Multi-tab only.
        this.Cc.Ju(t, "rejected", e);
        const s = this.Oc.get(t), i = s && s.key;
        if (i) {
            ...
            this.Lc = this.Lc.remove(i), this.Oc.delete(t), this.Yc();
        } else await this.Za.uo(t, /* keepPersistedTargetData */ !1).then(() => this.Gc(t, e)).catch(Xe);
    }
    async Ou(t) {
        this.Qc("applySuccessfulWrite()");
        const e = t.batch.batchId;
        // The local store may or may not be able to apply the write result and
        // raise events immediately (depending on whether the watcher is caught
        // up), so we raise user callbacks first so that they consistently happen
        // before listen events.
                this.Xc(e, /*error=*/ null), this.Jc(e);
        try {
            const s = await this.Za.Sh(t);
            this.Cc.Yu(e, "acknowledged"), await this.Kc(s);
        } catch (t) {
            await Xe(t);
        }
    }
    async xu(t, e) {
        ...
        // listen events.
        this.Xc(t, e), this.Jc(t);
        try {
            const s = await this.Za.$h(t);
            this.Cc.Yu(t, "rejected", e), await this.Kc(s);
        } catch (e) {
            await Xe(e);
        }
    }
     ...
     */    async Zc(t) {
        ...
        try {
            const e = await this.Za.Oh();
            if (-1 === e) 
            // Trigger the callback right away if there is no pending writes at the moment.
            return void t.resolve();
            const s = this.xc.get(e) || [];
            s.push(t), this.xc.set(e, s);
        } catch (e) {
            const s = Ke(e, "Initialization of waitForPendingWrites() operation failed");
            t.reject(s);
        }
    }
    /**
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */    tl(t) {
        this.xc.forEach(e => {
            e.forEach(e => {
    ...
    Hc(t, e) {
        let s = this.Mc[this.currentUser.s()];
        s || (s = new xt(Se)), s = s.Re(t, e), this.Mc[this.currentUser.s()] = s;
    }
    /**
     ...
     */    Xc(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (s) {
            const i = s.get(t);
            i && (e ? i.reject(e) : i.resolve(), s = s.remove(t)), this.Mc[this.currentUser.s()] = s;
        }
    }
    Gc(t, e = null) {
        this.Cc.Zu(t);
        for (const s of this.$c.get(t)) this.Nc.delete(s), e && this.Fc.el(s, e);
        if (this.$c.delete(t), this.Uc) {
            this.qc.Po(t).forEach(t => {
                this.qc.yo(t) || 
    ...
    jc(t, e) {
        for (const s of e) if (s instanceof Zs) this.qc.to(s.key, t), this.il(s); else if (s instanceof ti) {
            Pe("SyncEngine", "Document no longer in limbo: " + s.key), this.qc.eo(s.key, t), 
            this.qc.yo(s.key) || 
            // We removed the last reference for this key
            this.sl(s.key);
        } else ye();
     ...
     */    Yc() {
        for (;this.kc.length > 0 && this.Lc.size < this.Dc; ) {
            const t = this.kc.shift(), e = this.Bc.next();
            this.Oc.set(e, new ni(t)), this.Lc = this.Lc.Re(t, e), this.Pc.listen(new $t(yt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Me.er));
        }
    }
    // Visible for testing
    nl() {
    ...
    async Kc(t, e) {
        ...
        this.Nc.forEach((r, h) => {
            n.push(Promise.resolve().then(() => {
                const e = h.view.cc(t);
                return e.fc ? this.Za.co(h.query, /* usePreviousResults= */ !1).then(({documents: t}) => h.view.cc(t, e)) : e;
                // The query has a limit and some docs were removed, so we need
                // to re-run the query against the local store to make sure we
                // didn't lose any good docs that had been past the limit.
                        }).then(t => {
                const n = e && e.as.get(h.targetId), r = h.view.dc(t, 
                /* updateLimboDocuments= */ this.Uc, n);
                if (this.jc(h.targetId, r.Ec), r.snapshot) {
                    this.Uc && this.Cc.Ju(h.targetId, r.snapshot.fromCache ? "not-current" : "current"), 
                    s.push(r.snapshot);
                    const t = qe.Yn(h.targetId, r.snapshot);
                    i.push(t);
                }
            }));
        }), await Promise.all(n), this.Fc.Va(s), await this.Za.Zh(i);
    }
    Qc(t) {}
    async Uu(t) {
        if (!this.currentUser.isEqual(t)) {
            const e = await this.Za.Ah(t);
            this.currentUser = t, 
            // Fails tasks waiting for pending writes requested by previous user.
            this.tl("'waitForPendingWrites' promise is rejected due to a user change."), 
            // TODO(b/114226417): Consider calling this only in the primary tab.
            this.Cc.Ah(t, e.ph, e.yh), await this.Kc(e.Vh);
        }
        await this.Pc.Uu();
    }
    enableNetwork() {
 ...
 */ class oi {
    constructor(t) {
        this.bu = t, this.al = new Ne(t => t.canonicalId()), this.onlineState = "Unknown" /* Unknown */ , 
        this.ul = new Set, this.bu.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let s = !1, i = this.al.get(e);
        if (i || (s = !0, i = new hi), s) try {
            i.hl = await this.bu.listen(e);
        } catch (e) {
            const s = Ke(e, `Initialization of query '${t.query}' failed`);
            return void t.onError(s);
        }
        this.al.set(e, i), i.ol.push(t);
    ...
    async yu(t) {
        const e = t.query;
        let s = !1;
        const i = this.al.get(e);
        if (i) {
            const e = i.ol.indexOf(t);
            e >= 0 && (i.ol.splice(e, 1), s = 0 === i.ol.length);
        }
        if (s) return this.al.delete(e), this.bu.yu(e);
    }
    Va(t) {
        let e = !1;
        for (const s of t) {
            const t = s.query, i = this.al.get(t);
            if (i) {
                for (const t of i.ol) t.cl(s) && (e = !0);
                i.hl = s;
            }
        }
        e && this.ll();
    ...
    el(t, e) {
        const s = this.al.get(t);
        if (s) for (const t of s.ol) t.onError(e);
 ...
 */ class ai {
    constructor(t, e, s) {
         ...
         */
        this.wl = !1, this.Tl = null, this.onlineState = "Unknown" /* Unknown */ , this.options = s || {};
    }
    /**
     ...
     */    cl(t) {
        ...
        let e = !1;
        return this.wl ? this.El(t) && (this.dl.next(t), e = !0) : this.ml(t, this.onlineState) && (this.Il(t), 
        e = !0), this.Tl = t, e;
    }
    onError(t) {
        this.dl.error(t);
    ...
    ml(t, e) {
        ...
        // above) and are waiting for a sync.
                return (!this.options.Rl || !s) && (!t.docs.M() || "Offline" /* Offline */ === e);
    ...
    Il(t) {
        t = ne.os(t.query, t.docs, t.ns, t.fromCache), this.wl = !0, this.dl.next(t);
    }
}
 ...
 */ class ui {
    ...
    Bn(t, e, i, n) {
        ...
        return e.te() || i.isEqual(y.min()) ? this.Pl(t, e) : this.Al.qn(t, n).next(r => {
            const h = this.Vl(e, r);
            return (e.oe() || e.ae()) && this.fc(e.xt, h, n, i) ? this.Pl(t, e) : (Re() <= s.DEBUG && Pe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", i.toString(), e.toString()), 
            this.Al.Bn(t, e, i).next(t => (
    ...
    /** Applies the query filter and sorting to the provided documents.  */    Vl(t, e) {
    ...
    Pl(t, e) {
        return Re() <= s.DEBUG && Pe("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.Al.Bn(t, e, y.min());
    }
}
 ...
 */ class ci {
    constructor(t, e) {
        ...
        this.yl = new Qt(Ze.To);
    }
    gl(t) {
        return Le.resolve(0 === this.Dn.length);
    }
    Sh(t, e, s) {
        const i = e.batchId, n = this.bl(i, "acknowledged");
        ge(0 === n);
        // Verify that the batch in the queue is the one to be acknowledged.
        this.Dn[n];
        return this.lastStreamToken = s, Le.resolve();
    }
    qh(t) {
    ...
    bh(t, e, s, i) {
        const n = this.pl;
        if (this.pl++, this.Dn.length > 0) {
            this.Dn[this.Dn.length - 1];
        }
        const r = new $e(n, e, s, i);
        this.Dn.push(r);
        // Track references by document key and index collection parents.
        for (const e of i) this.yl = this.yl.add(new Ze(e.key, n)), this.Fn.mr(t, e.key.path.L());
        return Le.resolve(r);
    }
    kh(t, e) {
        return Le.resolve(this.vl(e));
    }
    io(t, e) {
        const s = e + 1, i = this.Sl(s), n = i < 0 ? 0 : i;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Le.resolve(this.Dn.length > n ? this.Dn[n] : null);
    }
    Oh() {
        return Le.resolve(0 === this.Dn.length ? -1 : this.pl - 1);
    }
    Ph(t) {
        return Le.resolve(this.Dn.slice());
    }
    $n(t, e) {
        const s = new Ze(e, 0), i = new Ze(e, Number.POSITIVE_INFINITY), n = [];
        return this.yl.Ge([ s, i ], t => {
            const e = this.vl(t.bo);
            n.push(e);
        }), Le.resolve(n);
    }
    xn(t, e) {
        let s = new Qt(Se);
        return e.forEach(t => {
            const e = new Ze(t, 0), i = new Ze(t, Number.POSITIVE_INFINITY);
            this.yl.Ge([ e, i ], t => {
                s = s.add(t.bo);
            });
        }), Le.resolve(this.Cl(s));
    }
    Gn(t, e) {
        ...
        return this.yl.He(t => {
            ...
            // ancestor queries.
            e.length === i && (h = h.add(t.bo)), !0);
        }, r), Le.resolve(this.Cl(h));
    }
    Cl(t) {
    ...
    Lh(t, e) {
        ...
        return Le.forEach(e.mutations, i => {
            const n = new Ze(i.key, e.batchId);
            return s = s.delete(n), this.Yh.Dl(t, i.key);
        }).next(() => {
            this.yl = s;
        });
    }
    ...
    yo(t, e) {
        const s = new Ze(e, 0), i = this.yl.Ke(s);
 ...
 */ class li {
     ...
     */    Kh(t, e, s) {
        const i = e.key, n = this.docs.get(i), r = n ? n.size : 0, h = this.Nl(e);
        return this.docs = this.docs.Re(i, {
            $l: e,
            size: h,
            readTime: s
        }), this.size += h - r, this.Fn.mr(t, i.path.L());
    }
    /**
    ...
    Bn(t, e, s) {
        ...
        for (;r.$e(); ) {
            const {key: t, value: {$l: n, readTime: h}} = r.Ne();
 ...
 */ li.Ll = class extends class {
    constructor() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.vh = new Ne(t => t.toString()), this.ql = !1;
    }
    set readTime(t) {
        this.Ml = t;
    }
     ...
     */    Ln(t, e) {
        ...
        return void 0 !== s ? Le.resolve(s) : this.Bl(t, e);
    }
    /**
    ...
    /** Helper to assert this.changes is not null  */    xl() {}
}
/**
 * @license
 * Copyright 2017 Google LLC
 ...
 */ {
    ...
    dc(t) {
        ...
        return this.vh.forEach((s, i) => {
            i ? e.push(this.Ql.Kh(t, i, this.readTime)) : this.Ql.Hh(s);
        }), Le.vn(e);
    }
    Bl(t, e) {
...
class _i {
    constructor(t) {
         ...
         */
        this.Wl = new Ne(t => t.canonicalId()), 
         ...
         * IDs.
         */
        this.Gl = new Je, this.targetCount = 0, this.Hl = We.Rr();
    }
    js(t, e) {
        return this.Wl.forEach((t, s) => e(s)), Le.resolve();
    }
    xh(t) {
        return Le.resolve(this.lastRemoteSnapshotVersion);
    }
    Kl(t) {
        return Le.resolve(this.jl);
    }
    oo(t) {
        return this.highestTargetId = this.Hl.next(), Le.resolve(this.highestTargetId);
    }
    Xh(t, e, s) {
    ...
    zl(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Hl = new We(e), this.highestTargetId = e), t.sequenceNumber > this.jl && (this.jl = t.sequenceNumber);
    }
    ao(t, e) {
        return this.zl(e), this.targetCount += 1, Le.resolve();
    }
    Gh(t, e) {
        return this.zl(e), Le.resolve();
    }
    Yl(t, e) {
    ...
    Xl(t, e, s) {
        let i = 0;
        const n = [];
        return this.Wl.forEach((r, h) => {
            h.sequenceNumber <= e && null === s.get(h.targetId) && (this.Wl.delete(r), n.push(this.Jl(t, h.targetId)), 
            i++);
        }), Le.vn(n).next(() => i);
    }
    Zl(t) {
    ...
    ho(t, e) {
        const s = this.Wl.get(e) || null;
        return Le.resolve(s);
    }
    Qh(t, e, s) {
        return this.Gl.Io(e, s), Le.resolve();
    }
    Uh(t, e, s) {
        this.Gl.Ao(e, s);
        const i = this.persistence.Yh, n = [];
        return i && e.forEach(e => {
            n.push(i.Dl(t, e));
        }), Le.vn(n);
    }
    Jl(t, e) {
        return this.Gl.Po(e), Le.resolve();
    }
    lo(t, e) {
        const s = this.Gl.po(e);
        return Le.resolve(s);
    }
    yo(t, e) {
        return Le.resolve(this.Gl.yo(e));
    }
}
...
class fi {
     ...
     */
    constructor(t) {
        this.t_ = {}, this.e_ = new Me(0), this.s_ = !1, this.s_ = !0, this.Yh = t(this), 
        this.Th = new _i(this);
        this.Fn = new Ue, this.Cn = new li(this.Fn, t => this.Yh.i_(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    fh(t) {
        let e = this.t_[t.s()];
        return e || (e = new ci(this.Fn, this.Yh), this.t_[t.s()] = e), e;
    }
    Eh() {
        return this.Th;
    }
    ...
    runTransaction(t, e, s) {
        ...
        const i = new di(this.e_.next());
        return this.Yh.h_(), s(i).next(t => this.Yh.o_(i).next(() => t)).gn().then(t => (i.a_(), 
        t));
    }
    u_(t, e) {
        return Le.Sn(Object.values(this.t_).map(s => () => s.yo(t, e)));
    }
}
...
class wi {
    ...
    to(t, e, s) {
        return this.__.to(s, e), this.w_.delete(s), Le.resolve();
    }
    eo(t, e, s) {
        return this.__.eo(s, e), this.w_.add(s), Le.resolve();
    }
    Dl(t, e) {
        return this.w_.add(e), Le.resolve();
    }
    removeTarget(t, e) {
        this.__.Po(e.targetId).forEach(t => this.w_.add(t));
        const s = this.persistence.Eh();
        return s.lo(t, e.targetId).next(t => {
    ...
    o_(t) {
        ...
        return Le.forEach(this.w_, s => this.T_(t, s).next(t => {
            t || e.Hh(s);
    ...
    T_(t, e) {
        return Le.Sn([ () => Le.resolve(this.__.yo(e)), () => this.persistence.Eh().yo(t, e), () => this.persistence.u_(t, e) ]);
    }
}
...
class Ti {
    async initialize(t) {
        this.Cc = this.E_(t), this.persistence = this.m_(t), await this.persistence.start(), 
        this.I_ = this.R_(t), this.Za = this.A_(t), this.Pc = this.P_(t), this.bu = this.V_(t), 
        this.p_ = this.y_(t), this.Cc.Wa = t => this.bu.mc(t, 1 /* SharedClientState */), 
        this.Pc.bu = this.bu, await this.Za.start(), await this.Cc.start(), await this.Pc.start(), 
        await this.Pc.Qu(this.bu.Uc);
    }
    y_(t) {
        return new oi(this.bu);
    }
    R_(t) {
        return null;
    }
    A_(t) {
        return new Ye(this.persistence, new ui, t.g_);
    }
    m_(t) {
        return new fi(wi.d_);
    }
    P_(t) {
        return new Ys(this.Za, t.ka, t.Pr, t => this.bu.mc(t, 0 /* RemoteStore */), t.platform.b_());
    }
    E_(t) {
        return new Js;
    }
    V_(t) {
        return new ri(this.Za, this.Pc, this.Cc, t.g_, t.Dc);
    }
    clearPersistence(t) {
...
class Ei {
     ...
     */
    i) {
        this.platform = t, this.v_ = e, this.credentials = s, this.Pr = i, this.clientId = ve.cn();
    }
    /**
     ...
     */    start(t, e) {
        ...
        return this.credentials._(r => {
            if (!n) return n = !0, Pe("FirestoreClient", "Initializing. user=", r.uid), this.C_(t, e, r, i).then(s.resolve, s.reject);
            this.Pr.jr(() => this.Uu(r));
        }), 
        // Block the async queue until initialization is done
        this.Pr.Sr(() => s.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.S_(), this.Pr.enqueue(() => this.bu.enableNetwork());
    }
    /**
     ...
     */    async C_(t, e, s, i) {
        try {
            ...
            // provider).
            const n = await this.platform.D_(this.v_), r = this.platform.Ho(this.v_.ii), h = function(t, e, s) {
                return new Hs(t, e, s);
            ...
            await t.initialize({
                ...
                Dc: 100,
                F_: e
            }), this.persistence = t.persistence, this.Cc = t.Cc, this.Za = t.Za, this.Pc = t.Pc, 
            this.bu = t.bu, this.I_ = t.I_, this.N_ = t.p_, 
            // When a user calls clearPersistence() in one client, all other clients
            // need to be terminated to allow the delete to succeed.
            this.persistence.r_(async () => {
     ...
     */    S_() {
        if (this.Pr.Mr) throw new m(E.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    Uu(t) {
    ...
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.S_(), this.Pr.enqueue(() => this.bu.disableNetwork());
    }
    terminate() {
        return this.Pr.Wr(async () => {
            // PORTING NOTE: LocalStore does not need an explicit shutdown on web.
            this.I_ && this.I_.stop(), await this.Pc.Vu(), await this.Cc.Vu(), await this.persistence.Vu(), 
     ...
     */    waitForPendingWrites() {
        this.S_();
        const t = new xe;
        return this.Pr.Sr(() => this.bu.Zc(t)), t.promise;
    }
    listen(t, e, s) {
        this.S_();
        const i = new ai(t, e, s);
        return this.Pr.Sr(() => this.N_.listen(i)), i;
    }
    yu(t) {
        // Checks for termination but does not raise error, allowing unlisten after
        // termination to be a no-op.
        this.O_ || this.Pr.Sr(() => this.N_.yu(t));
    }
    async q_(t) {
        this.S_();
        const e = new xe;
        return await this.Pr.enqueue(async () => {
            try {
                const s = await this.Za.no(t);
                s instanceof At ? e.resolve(s) : s instanceof Pt ? e.resolve(null) : e.reject(new m(E.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
            } catch (s) {
                const i = Ke(s, `Failed to get document '${t} from cache`);
                e.reject(i);
            }
        }), e.promise;
    }
    async M_(t) {
        ...
        return await this.Pr.enqueue(async () => {
            try {
                const s = await this.Za.co(t, 
                /* usePreviousResults= */ !0), i = new ei(t, s._o), n = i.cc(s.documents), r = i.dc(n, 
                /* updateLimboDocuments= */ !1);
                e.resolve(r.snapshot);
            } catch (s) {
                const i = Ke(s, `Failed to execute query '${t} against cache`);
                e.reject(i);
            }
        }), e.promise;
    }
    write(t) {
        this.S_();
        const e = new xe;
        return this.Pr.Sr(() => this.bu.write(t, e)), e.promise;
    }
    ii() {
        return this.v_.ii;
    }
    _l(t) {
        this.S_(), this.Pr.Sr(() => (this.N_._l(t), Promise.resolve()));
    }
    fl(t) {
        // Checks for shutdown but does not raise error, allowing remove after
        // shutdown to be a no-op.
        this.O_ || this.Pr.Sr(() => (this.N_.fl(t), Promise.resolve()));
    }
    get O_() {
    ...
    transaction(t) {
        this.S_();
        const e = new xe;
        return this.Pr.Sr(() => (this.bu.runTransaction(this.Pr, t, e), Promise.resolve())), 
        e.promise;
    }
}
...
class Ri {
    constructor(t, e, s, i) {
        this.firestore = t, this.timestampsInSnapshots = e, this.U_ = s, this.converter = i;
    }
    Q_(t) {
        switch (x(t)) {
          case 0 /* NullValue */ :
    ...
    H_(t) {
        return new Cs(K(t.latitude), K(t.longitude));
    }
    K_(t) {
        return (t.values || []).map(t => this.Q_(t));
    }
    j_(t) {
        switch (this.U_) {
          case "previous":
    ...
    G_(t) {
        const e = b.G(t);
        ge(Ee(e));
        const s = new Fe(e.get(1), e.get(3)), i = new C(e.k(5));
        return s.isEqual(this.firestore.ta) || 
        // TODO(b/64130202): Somehow support foreign references.
        Ve(`Document ${i} contains a document ` + "reference within a different database (" + `${s.projectId}/${s.database}) which is not ` + "supported. It will be treated as a reference in the current " + `database (${this.firestore.ta.projectId}/${this.firestore.ta.database}) ` + "instead."), 
        new gi(i, this.firestore, this.converter);
    }
}
...
class Pi {
    constructor(t) {
        ...
        os("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), os("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        os("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = ze.hh; else {
            if (t.cacheSizeBytes !== Ai && t.cacheSizeBytes < ze.rh) throw new m(E.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${ze.rh}`);
 ...
 */ class Vi {
    ...
    constructor(t, e, s = new Ti) {
        if (this.Y_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.X_ = new He, this.INTERNAL = {
            delete: async () => {
                // The client must be initalized to ensure that all subsequent API usage
                // throws an exception.
                this.J_(), await this.Z_.terminate();
            }
        }, "object" == typeof t.options) {
            // This is very likely a Firebase app object
            // TODO(b/34177605): Can we somehow use instanceof?
            const s = t;
            this.Y_ = s, this.ta = Vi.tf(s), this.ef = s.name, this.sf = new A(e);
        } else {
            const e = t;
            if (!e.projectId) throw new m(E.INVALID_ARGUMENT, "Must provide projectId");
            this.ta = new Fe(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.ef = "[DEFAULT]", this.sf = new R;
        }
        this.if = s, this.nf = new Pi({});
    }
    get rf() {
        return this.hf || (
        // Lazy initialize UserDataReader once the settings are frozen
        this.hf = new Ls(this.ta, this.nf.ignoreUndefinedProperties)), this.hf;
    }
    settings(t) {
        es("Firestore.settings", arguments, 1), ns("Firestore.settings", "object", 1, t);
        const e = new Pi(t);
        if (this.Z_ && !this.nf.isEqual(e)) throw new m(E.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */
    ...
    enablePersistence(t) {
        var e, s;
        if (this.Z_) throw new m(E.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.Z_ && !this.Z_.O_) throw new m(E.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        const t = new xe;
        return this.X_.xr(async () => {
            try {
                const e = this.cf();
                await this.if.clearPersistence(e), t.resolve();
            } catch (e) {
                t.reject(e);
            }
        }), t.promise;
    ...
    onSnapshotsInSync(t) {
        if (this.J_(), Ii(t)) return this._f(t);
        {
    ...
    cf() {
        return new De(this.ta, this.ef, this.nf.host, this.nf.ssl, this.nf.forceLongPolling);
    }
    uf(t, e) {
        const s = this.cf();
        return this.Z_ = new Ei(me.nt(), s, this.sf, this.X_), this.Z_.start(t, e);
    }
    static tf(t) {
 ...
 */        const i = t.options.projectId;
    ...
    get app() {
        if (!this.Y_) throw new m(E.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Y_;
    }
    collection(t) {
        return es("Firestore.collection", arguments, 1), ns("Firestore.collection", "non-empty string", 1, t), 
        this.J_(), new Fi(b.G(t), this);
    }
    doc(t) {
        return es("Firestore.doc", arguments, 1), ns("Firestore.doc", "non-empty string", 1, t), 
        this.J_(), gi.ff(b.G(t), this);
    }
    collectionGroup(t) {
        ...
        return this.J_(), new Ci(new yt(b.H, t), this);
    }
    runTransaction(t) {
        return es("Firestore.runTransaction", arguments, 1), ns("Firestore.runTransaction", "function", 1, t), 
        this.J_().transaction(e => t(new pi(this, e)));
    }
    batch() {
        return this.J_(), new yi(this);
    }
    static get logLevel() {
        switch (Re()) {
          case s.DEBUG:
 ...
 */ class pi {
    ...
    get(t) {
        ...
        const e = Li("Transaction.get", t, this.wf);
        return this.Tf.xa([ e.ea ]).then(t => {
            if (!t || 1 !== t.length) return ye();
            const s = t[0];
            if (s instanceof Pt) return new vi(this.wf, e.ea, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Ef);
            if (s instanceof At) return new vi(this.wf, e.ea, s, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.Ef);
            throw ye();
        });
    ...
    set(t, e, s) {
        ...
        const i = Li("Transaction.set", t, this.wf);
        s = Ni("Transaction.set", s);
        const [n, r] = qi(i.Ef, e, "Transaction.set"), h = s.merge || s.mergeFields ? this.wf.rf.Yo(r, n, s.mergeFields) : this.wf.rf.Ko(r, n);
        return this.Tf.set(i.ea, h), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return "string" == typeof e || e instanceof Ps ? (ss("Transaction.update", arguments, 3), 
        n = Li("Transaction.update", t, this.wf), r = this.wf.rf.Jo("Transaction.update", e, s, i)) : (es("Transaction.update", arguments, 2), 
        n = Li("Transaction.update", t, this.wf), r = this.wf.rf.Xo("Transaction.update", e)), 
        this.Tf.update(n.ea, r), this;
    }
    delete(t) {
        es("Transaction.delete", arguments, 1);
        const e = Li("Transaction.delete", t, this.wf);
...
class yi {
    ...
    set(t, e, s) {
        is("WriteBatch.set", arguments, 2, 3), this.Rf();
        const i = Li("WriteBatch.set", t, this.wf);
        s = Ni("WriteBatch.set", s);
        const [n, r] = qi(i.Ef, e, "WriteBatch.set"), h = s.merge || s.mergeFields ? this.wf.rf.Yo(r, n, s.mergeFields) : this.wf.rf.Ko(r, n);
        return this.mf = this.mf.concat(h.xo(i.ea, ct.dt())), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return this.Rf(), "string" == typeof e || e instanceof Ps ? (ss("WriteBatch.update", arguments, 3), 
        n = Li("WriteBatch.update", t, this.wf), r = this.wf.rf.Jo("WriteBatch.update", e, s, i)) : (es("WriteBatch.update", arguments, 2), 
        n = Li("WriteBatch.update", t, this.wf), r = this.wf.rf.Xo("WriteBatch.update", e)), 
        this.mf = this.mf.concat(r.xo(n.ea, ct.exists(!0))), this;
    }
    delete(t) {
        es("WriteBatch.delete", arguments, 1), this.Rf();
        const e = Li("WriteBatch.delete", t, this.wf);
        return this.mf = this.mf.concat(new wt(e.ea, ct.dt())), this;
    }
    commit() {
        return this.Rf(), this.If = !0, this.mf.length > 0 ? this.wf.J_().write(this.mf) : Promise.resolve();
    }
    Rf() {
        if (this.If) throw new m(E.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class gi {
    constructor(t, e, s) {
        this.ea = t, this.firestore = e, this.Ef = s, this.Z_ = this.firestore.J_();
    }
    static ff(t, e, s) {
        ...
        return new gi(new C(t), e, s);
    }
    get id() {
        return this.ea.path.q();
    }
    get parent() {
        return new Fi(this.ea.path.L(), this.firestore, this.Ef);
    }
    get path() {
    ...
    collection(t) {
        ...
        const e = b.G(t);
        return new Fi(this.ea.path.child(e), this.firestore);
    }
    isEqual(t) {
        if (!(t instanceof gi)) throw ws("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.ea.isEqual(t.ea) && this.Ef === t.Ef;
    }
    set(t, e) {
        is("DocumentReference.set", arguments, 1, 2), e = Ni("DocumentReference.set", e);
        const [s, i] = qi(this.Ef, t, "DocumentReference.set"), n = e.merge || e.mergeFields ? this.firestore.rf.Yo(i, s, e.mergeFields) : this.firestore.rf.Ko(i, s);
        return this.Z_.write(n.xo(this.ea, ct.dt()));
    }
    update(t, e, ...s) {
        let i;
        return "string" == typeof t || t instanceof Ps ? (ss("DocumentReference.update", arguments, 2), 
        i = this.firestore.rf.Jo("DocumentReference.update", t, e, s)) : (es("DocumentReference.update", arguments, 1), 
        i = this.firestore.rf.Xo("DocumentReference.update", t)), this.Z_.write(i.xo(this.ea, ct.exists(!0)));
    }
    delete() {
        return es("DocumentReference.delete", arguments, 0), this.Z_.write([ new wt(this.ea, ct.dt()) ]);
    }
    onSnapshot(...t) {
        ...
        "object" != typeof t[i] || Ii(t[i]) || (s = t[i], ds("DocumentReference.onSnapshot", s, [ "includeMetadataChanges" ]), 
        os("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        i++);
        const n = {
            includeMetadataChanges: s.includeMetadataChanges
        };
        return Ii(t[i]) ? e = t[i] : (ns("DocumentReference.onSnapshot", "function", i, t[i]), 
    ...
    Af(t, e) {
        ...
        const i = new mi({
            next: t => {
                if (e.next) {
                    const s = t.docs.get(this.ea);
                    e.next(new vi(this.firestore, this.ea, s, t.fromCache, t.hasPendingWrites, this.Ef));
                }
            },
            error: s
        }), n = this.Z_.listen(yt.Wt(this.ea.path), i, t);
        return () => {
            i.B_(), this.Z_.yu(n);
        };
    }
    get(t) {
        return is("DocumentReference.get", arguments, 0, 1), ki("DocumentReference.get", t), 
        new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.J_().q_(this.ea).then(t => {
                e(new vi(this.firestore, this.ea, t, 
                /*fromCache=*/ !0, t instanceof At && t.At, this.Ef));
            }, s) : this.Pf(e, s, t);
        });
    }
    Pf(t, e, s) {
    ...
    withConverter(t) {
        return new gi(this.ea, this.firestore, t);
    }
}
...
class vi {
    constructor(t, e, s, i, n, r) {
        this.wf = t, this.ea = e, this.Vf = s, this.pf = i, this.yf = n, this.Ef = r;
    }
    data(t) {
        if (is("DocumentSnapshot.data", arguments, 0, 1), t = $i("DocumentSnapshot.data", t), 
        this.Vf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Ef) {
                const e = new Si(this.wf, this.ea, this.Vf, this.pf, this.yf);
                return this.Ef.fromFirestore(e, t);
            }
            return new Ri(this.wf, this.wf.df(), t.serverTimestamps, 
            /* converter= */ void 0).Q_(this.Vf.Lt());
        }
    }
    get(t, e) {
        if (is("DocumentSnapshot.get", arguments, 1, 2), e = $i("DocumentSnapshot.get", e), 
        this.Vf) {
            const s = this.Vf.data().field(Bs("DocumentSnapshot.get", t));
            if (null !== s) {
                return new Ri(this.wf, this.wf.df(), e.serverTimestamps, this.Ef).Q_(s);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new gi(this.ea, this.wf, this.Ef);
    }
    get exists() {
        return null !== this.Vf;
    }
    get metadata() {
        return new bi(this.yf, this.pf);
    }
    isEqual(t) {
        if (!(t instanceof vi)) throw ws("isEqual", "DocumentSnapshot", 1, t);
        return this.wf === t.wf && this.pf === t.pf && this.ea.isEqual(t.ea) && (null === this.Vf ? null === t.Vf : this.Vf.isEqual(t.Vf)) && this.Ef === t.Ef;
    }
}
...
class Ci {
    constructor(t, e, s) {
        this.gf = t, this.firestore = e, this.Ef = s;
    }
    where(t, e, s) {
        es("Query.where", arguments, 3), fs("Query.where", 3, s);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const i = function(t, e, s, i) {
            if (!e.some(t => t === i)) throw new m(E.INVALID_ARGUMENT, `Invalid value ${_s(i)} provided to function ` + `${t}() for its ${Es(s)} argument. Acceptable ` + `values: ${e.join(", ")}`);
            return i;
        ...
        if (r.Y()) {
            ...
            if ("in" /* IN */ === i) {
                this.bf(s, i);
                const t = [];
                for (const e of s) t.push(this.vf(e));
                n = {
                    arrayValue: {
                        values: t
                    }
        ...
        } else "in" /* IN */ !== i && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== i || this.bf(s, i), 
        n = this.firestore.rf.Zo("Query.where", s, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === i);
        const h = gt.create(r, i, n);
        return this.Sf(h), new Ci(this.gf.Ht(h), this.firestore, this.Ef);
    }
    orderBy(t, e) {
        let s;
        ...
        if (null !== this.gf.startAt) throw new m(E.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.gf.endAt) throw new m(E.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        const i = Bs("Query.orderBy", t), n = new Nt(i, s);
        return this.Cf(n), new Ci(this.gf.Kt(n), this.firestore, this.Ef);
    }
    limit(t) {
        return es("Query.limit", arguments, 1), ns("Query.limit", "number", 1, t), Ts("Query.limit", 1, t), 
        new Ci(this.gf.zt(t), this.firestore, this.Ef);
    }
    limitToLast(t) {
        return es("Query.limitToLast", arguments, 1), ns("Query.limitToLast", "number", 1, t), 
        Ts("Query.limitToLast", 1, t), new Ci(this.gf.Yt(t), this.firestore, this.Ef);
    }
    startAt(t, ...e) {
        ss("Query.startAt", arguments, 1);
        const s = this.Df("Query.startAt", t, e, 
        /*before=*/ !0);
        return new Ci(this.gf.Xt(s), this.firestore, this.Ef);
    }
    startAfter(t, ...e) {
        ss("Query.startAfter", arguments, 1);
        const s = this.Df("Query.startAfter", t, e, 
        /*before=*/ !1);
        return new Ci(this.gf.Xt(s), this.firestore, this.Ef);
    }
    endBefore(t, ...e) {
        ss("Query.endBefore", arguments, 1);
        const s = this.Df("Query.endBefore", t, e, 
        /*before=*/ !0);
        return new Ci(this.gf.Jt(s), this.firestore, this.Ef);
    }
    endAt(t, ...e) {
        ss("Query.endAt", arguments, 1);
        const s = this.Df("Query.endAt", t, e, 
        /*before=*/ !1);
        return new Ci(this.gf.Jt(s), this.firestore, this.Ef);
    }
    isEqual(t) {
        if (!(t instanceof Ci)) throw ws("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && this.gf.isEqual(t.gf);
    }
    withConverter(t) {
        return new Ci(this.gf, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    Df(t, e, s, i) {
        if (fs(t, 1, e), e instanceof vi) {
     ...
     */    Ff(t, e) {
        ...
        // results.
                for (const e of this.gf.orderBy) if (e.field.Y()) s.push(Y(this.firestore.ta, t.key)); else {
     ...
     */    Nf(t, e, s) {
        ...
        for (let s = 0; s < e.length; s++) {
            ...
            if (i[s].field.Y()) {
                ...
                if (!this.gf.le() && -1 !== r.indexOf("/")) throw new m(E.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), " + `the value passed to ${t}() must be a plain document ID, but ` + `'${r}' contains a slash.`);
                const e = this.gf.path.child(b.G(r));
                ...
                const s = new C(e);
                n.push(Y(this.firestore.ta, s));
            } else {
                const e = this.firestore.rf.Zo(t, r);
                n.push(e);
            }
        }
        return new Ft(n, s);
    ...
    onSnapshot(...t) {
        ...
        let e, s = {}, i = 0;
        return "object" != typeof t[i] || Ii(t[i]) || (s = t[i], ds("Query.onSnapshot", s, [ "includeMetadataChanges" ]), 
        os("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        i++), Ii(t[i]) ? e = t[i] : (ns("Query.onSnapshot", "function", i, t[i]), rs("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        rs("Query.onSnapshot", "function", i + 2, t[i + 2]), e = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        }), this.$f(this.gf), this.Af(s, e);
    }
    Af(t, e) {
        let s = t => {
            console.error("Uncaught Error in onSnapshot:", t);
        ...
        const i = new mi({
            next: t => {
                e.next && e.next(new Di(this.firestore, this.gf, t, this.Ef));
            },
            error: s
        }), n = this.firestore.J_(), r = n.listen(this.gf, i, t);
        return () => {
            i.B_(), n.yu(r);
        };
    }
    ...
    get(t) {
        return is("Query.get", arguments, 0, 1), ki("Query.get", t), this.$f(this.gf), new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.J_().M_(this.gf).then(t => {
                e(new Di(this.firestore, this.gf, t, this.Ef));
            }, s) : this.Pf(e, s, t);
        });
    }
    Pf(t, e, s) {
     ...
     */    vf(t) {
        if ("string" == typeof t) {
            ...
            if (!this.gf.le() && -1 !== t.indexOf("/")) throw new m(E.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but " + `'${t}' contains a '/' character.`);
            const e = this.gf.path.child(b.G(t));
            ...
            return Y(this.firestore.ta, new C(e));
        }
        if (t instanceof gi) {
            const e = t;
            return Y(this.firestore.ta, e.ea);
        }
        throw new m(E.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + `${_s(t)}.`);
    }
    /**
    ...
    Sf(t) {
        if (t instanceof gt) {
            ...
            if (t.ue()) {
                ...
                let r = null;
                if (n && (r = this.gf.ce(s)), null === r && i && (r = this.gf.ce(e)), null != r) 
...
class Di {
    constructor(t, e, s, i) {
        this.wf = t, this.Lf = e, this.Of = s, this.Ef = i, this.qf = null, this.Mf = null, 
        this.metadata = new bi(s.hasPendingWrites, s.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        ...
        this.Of.docs.forEach(s => {
            t.call(e, this.xf(s));
        });
    }
    get query() {
        return new Ci(this.Lf, this.wf, this.Ef);
    }
    docChanges(t) {
        ...
        if (e && this.Of.hs) throw new m(E.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
        function(t, e, s, i) {
            if (s.ss.M()) {
                ...
                return s.docChanges.map(r => {
                    const h = new Si(t, r.doc.key, r.doc, s.fromCache, s.ns.has(r.doc.key), i);
                    return e = r.doc, {
                        type: "added",
                        doc: h,
                        oldIndex: -1,
            ...
            }
            {
                ...
                return s.docChanges.filter(t => e || 3 /* Metadata */ !== t.type).map(e => {
                    const r = new Si(t, e.doc.key, e.doc, s.fromCache, s.ns.has(e.doc.key), i);
                    let h = -1, o = -1;
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof Di)) throw ws("isEqual", "QuerySnapshot", 1, t);
        return this.wf === t.wf && this.Lf.isEqual(t.Lf) && this.Of.isEqual(t.Of) && this.Ef === t.Ef;
    }
    xf(t) {
        return new Si(this.wf, t.key, t, this.metadata.fromCache, this.Of.ns.has(t.key), this.Ef);
    }
}

class Fi extends Ci {
    constructor(t, e, s) {
        if (super(yt.Wt(t), e, s), this.Bf = t, t.length % 2 != 1) throw new m(E.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + `${t.j()} has ${t.length}`);
    }
    get id() {
        return this.gf.path.q();
    }
    get parent() {
        const t = this.gf.path.L();
        return t.M() ? null : new gi(new C(t), this.firestore);
    }
    get path() {
    ...
    doc(t) {
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ve.cn()), ns("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new m(E.INVALID_ARGUMENT, "Document path must be a non-empty string");
        const e = b.G(t);
        return gi.ff(this.gf.path.child(e), this.firestore, this.Ef);
    }
    add(t) {
        es("CollectionReference.add", arguments, 1), ns("CollectionReference.add", "object", 1, this.Ef ? this.Ef.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new Fi(this.Bf, this.firestore, t);
    }
}
...
const xi = Mi(Vi, "Use firebase.firestore() instead."), Bi = Mi(pi, "Use firebase.firestore().runTransaction() instead."), Ui = Mi(yi, "Use firebase.firestore().batch() instead."), Qi = Mi(gi, "Use firebase.firestore().doc() instead."), Wi = Mi(vi), ji = Mi(Si), Gi = Mi(Ci), Hi = Mi(Di), Ki = Mi(Fi, "Use firebase.firestore().collection() instead."), zi = Mi(class {
    static delete() {
        return ts("FieldValue.delete", arguments), new ys;
    }
    static serverTimestamp() {
        return ts("FieldValue.serverTimestamp", arguments), new gs;
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
        return ss("FieldValue.arrayUnion", arguments, 1), new bs(t);
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
        return ss("FieldValue.arrayRemove", arguments, 1), new vs(t);
    }
    static increment(t) {
...
}, "Use FieldValue.<field>() instead."), Yi = Mi(As, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Xi = {
    Firestore: xi,
    GeoPoint: Cs,
    Timestamp: p,
    Blob: Yi,
    Transaction: Bi,
    WriteBatch: Ui,
    DocumentReference: Qi,
    DocumentSnapshot: Wi,
    Query: Gi,
    QueryDocumentSnapshot: ji,
    QuerySnapshot: Hi,
    CollectionReference: Ki,
    FieldPath: Ps,
    FieldValue: zi,
    setLogLevel: Vi.setLogLevel,
    CACHE_SIZE_UNLIMITED: Ai
};
...
class Zi {
    constructor() {
        this.Uf = () => this.Qf(), this.Wf = () => this.jf(), this.Gf = [], this.Hf();
    }
    ru(t) {
        this.Gf.push(t);
    }
    ...
    Qf() {
        ...
        for (const t of this.Gf) t(0 /* AVAILABLE */);
    }
    jf() {
        Pe("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (const t of this.Gf) t(1 /* UNAVAILABLE */);
    }
...
class nn {
    ...
    Na(t, e, s) {
        ...
        return new Promise((n, r) => {
            ...
            this.rd(u, s), h.send(i, "POST", a, u, 15);
        });
    }
    $a(t, e, s) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.Na(t, e, s);
    }
    Pa(t, e) {
        const s = [ this.nd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], u = f(), c = {
        ...
        this.rd(c.initMessageHeaders, e), 
        ...
        // on a closed stream
                const I = new tn({
            zf: t => {
                T ? Pe("Connection", "Not sending because WebChannel is closed:", t) : (w || (Pe("Connection", "Opening WebChannel transport."), 
                _.open(), w = !0), Pe("Connection", "WebChannel sending:", t), _.send(t));
            },
            Yf: () => _.close()
        }), R = (t, e) => {
        ...
        // enough the code is exception free.
            ...
            T || Pe("Connection", "WebChannel transport opened.");
        }), R(d.EventType.CLOSE, () => {
            T || (T = !0, Pe("Connection", "WebChannel transport closed"), I.ed());
        }), R(d.EventType.ERROR, t => {
            T || (T = !0, Pe("Connection", "WebChannel transport errored:", t), I.ed(new m(E.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!T) {
                ...
                if (n) {
                    ...
                    T = !0, I.ed(new m(e, s)), _.close();
                } else Pe("Connection", "WebChannel received:", s), I.sd(s);
            }
        }), setTimeout(() => {
 ...
 */
    function(t, e) {
        ...
        }, "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Xi)));
    }(t, (t, e) => new Vi(t, e, new Ti)), t.registerVersion("@firebase/firestore", "1.14.6");
}
