      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return s === i ? M(s) === M(i) : isNaN(s) && isNaN(i);
            }
            return !1;
        }(t, e);
 ...
 */ class yt {
    ...
    constructor(t, e = null, s = [], i = [], n = null, r = null, h = null) {
        ...
        this.startAt = r, this.endAt = h, this.Mt = null;
    }
    canonicalId() {
        if (null === this.Mt) {
            let t = this.path.j();
            ...
            this.endAt && (t += "|ub:", t += this.endAt.canonicalId()), this.Mt = t;
        }
        return this.Mt;
    }
    toString() {
 ...
 */ class bt {
    ...
    oe() {
        return !L(this.limit) && "F" /* First */ === this.Bt;
    }
    ae() {
        return !L(this.limit) && "L" /* Last */ === this.Bt;
    }
    Kt() {
 ...
 */ class Lt {
    ...
    /** Creates a new target data instance with an updated sequence number. */    Ie(t) {
        return new Lt(this.target, this.targetId, this.Te, t, this.Ee, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    we(t, e) {
        return new Lt(this.target, this.targetId, this.Te, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    Re(t) {
        return new Lt(this.target, this.targetId, this.Te, this.sequenceNumber, this.Ee, t, this.resumeToken);
    }
}
...
class Wt {
    ...
    Me() {
        ...
        let t = this;
        return t.left.Oe() || t.left.left.Oe() || (t = t.xe()), t = t.me(null, null, null, t.left.Me(), null), 
        t.Le();
    }
    ...
    remove(t, e) {
        ...
        i = i.me(null, null, null, i.left.remove(t, e), null); else {
            ...
            0 === e(t, i.key)) {
                ...
                s = i.right.min(), i = i.me(s.key, s.value, null, null, i.right.Me());
            }
...
class de {
     ...
     * active targets.
     */    js(t, e) {
        t.targetIds.length > 0 ? t.targetIds.forEach(e) : this.Ms.forEach((t, s) => {
            this.Gs(s) && e(s);
        });
    }
    /**
    ...
    Ks(t) {
        let e = this.Ms.get(t);
        return e || (e = new le, this.Ms.set(t, e)), e;
    }
    ti(t) {
        let e = this.xs.get(t);
     ...
     * from all documents).
     */    zs(t) {
        this.Ms.set(t, new le), this.Ls.ei(t).forEach(e => {
...
class we {
    ...
    pi(t) {
        ...
        if ("targetChange" in t) {
            ...
            if (!("filter" in t)) return be();
            {
                ...
                const s = t.filter;
                s.targetId;
                const i = s.count || 0, n = new Mt(i), r = s.targetId;
                e = new ce(r, n);
            }
        }
        return e;
    ...
    Mi(t, e) {
        return t && t.length > 0 ? (ve(void 0 !== e), t.map(t => this.Li(t, e))) : [];
    }
    Di(t) {
        const e = t.transform;
    ...
    Bi(t) {
        ...
        null !== t.collectionGroup ? (e.parent = this.Ei(s), e.structuredQuery.from = [ {
            ...
            allDescendants: !0
        } ]) : (e.parent = this.Ei(s.L()), e.structuredQuery.from = [ {
            collectionId: s.O()
        } ]);
 ...
 */ class Be {
    constructor() {
        ...
        this.Dn = new Le(t => t.toString()), this.Cn = !1;
    }
    set readTime(t) {
        this.Fn = t;
    }
     ...
     */    Ln(t, e) {
        ...
        return void 0 !== s ? xe.resolve(s) : this.Mn(t, e);
    }
    /**
 ...
 */ class Ze {
    ...
    add(t) {
        const e = t.O(), s = t.L(), i = this.index[e] || new jt(v.N), n = !i.has(s);
        return this.index[e] = i.add(s), n;
    }
    has(t) {
        const e = t.O(), s = t.L(), i = this.index[e];
        return i && i.has(s);
    }
    getEntries(t) {
 ...
 */ class ss {
     ...
     * cache's metadata.
     */    updateMetadata(t, e) {
        return this.getMetadata(t).next(s => (s.byteSize += e, this.$r(t, s)));
    }
    Ln(t, e) {
        return ns(t).get(rs(e)).next(t => this.kr(t));
    }
    /**
     ...
     */    xr(t, e) {
        ...
        return this.Or(t, e, (t, e) => {
            const n = this.kr(e);
            n ? (s = s.Ae(t, n), i = i.Ae(t, hs(e))) : (s = s.Ae(t, null), i = i.Ae(t, 0));
        }).next(() => ({
            Br: s,
            qr: i
        }));
 ...
 */ function is(t) {
    return Ts.Nr(t, Ls.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function ns(t) {
    return Ts.Nr(t, ks.store);
}
 ...
 * limitations under the License.
 */
/** Offset to ensure non-overlapping target ids. */ ss.Jr = class extends Be {
    /**
    ...
    xn(t) {
        ...
        return this.Dn.forEach((n, r) => {
            ...
            } else e.push(this.th.kn(t, n));
        }), i.forEach(s => {
            e.push(this.th.jn.Dr(t, s));
        }), e.push(this.th.updateMetadata(t, s)), xe.vn(e);
    }
    Mn(t, e) {
        // Record the size of everything we load from the cache so we can compute a delta later.
        return this.th.Lr(t, e).next(t => null === t ? (this.eh.set(e, 0), null) : (this.eh.set(e, t.size), 
        t.Mr));
    }
    On(t, e) {
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
        return this.th.xr(t, e).next(({Br: t, qr: e}) => (
 ...
 */ class as {
    ...
    wh(t, e) {
        return this.Rh(t, e.targetId).next(() => us(t).delete(e.targetId)).next(() => this.ah(t)).next(e => (ve(e.targetCount > 0), 
    ...
    ah(t) {
        return cs(t).get(xs.key).next(t => (ve(null !== t), t));
    }
    uh(t, e) {
        return cs(t).put(xs.key, e);
    }
    Th(t, e) {
        return us(t).put(this.serializer.Ph(e));
    }
    /**
    ...
    ph(t, e, s) {
        ...
        return e.forEach(e => {
            const r = ze(e.path);
            i.push(n.put(new Os(s, r))), i.push(this.hh.yh(t, s, e));
        }), xe.vn(i);
    }
    bh(t, e, s) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        ...
        return xe.forEach(e, e => {
            const n = ze(e.path);
            return xe.vn([ i.delete([ s, n ]), this.hh.vh(t, s, e) ]);
        });
    }
    Rh(t, e) {
        const s = _s(t), i = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return s.delete(i);
    }
 ...
 */ function us(t) {
    return Ts.Nr(t, Ms.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function cs(t) {
    return Ts.Nr(t, xs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function _s(t) {
    return Ts.Nr(t, Os.store);
}
...
/** Serializer for values stored in the LocalStore. */ class ls {
    ...
    /** Encodes a document for storage locally. */    sh(t, e) {
        const s = this.Wr(e), i = t.key.path.L().W();
        if (t instanceof Vt) {
        ...
        if (t instanceof gt) {
            const e = t.key.path.W(), n = this.$h(t.version), r = t.hasCommittedMutations;
            return new ks(
            /* unknownDocument= */ null, new Ns(e, n), 
            /* document= */ null, r, s, i);
        }
        if (t instanceof pt) {
            const e = t.key.path.W(), n = this.$h(t.version);
            return new ks(new $s(e, n), 
            /* noDocument= */ null, 
            /* document= */ null, 
    ...
    /** Encodes a batch of mutations into a DbMutationBatch for local storage. */    kh(t, e) {
        const s = e.baseMutations.map(t => this.Fh.vi(t)), i = e.mutations.map(t => this.Fh.vi(t));
        return new Cs(t, e.batchId, e.Tn.toMillis(), s, i);
    }
    /** Decodes a DbMutationBatch into a MutationBatch */    Lh(t) {
    ...
    /** Decodes a DbTarget into TargetData */    mh(t) {
        ...
        let i;
        return i = void 0 !== t.query.documents ? this.Fh.xi(t.query) : this.Fh.Wi(t.query), 
        new Lt(i, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, s, k.fromBase64String(t.resumeToken));
    }
    /** Encodes TargetData into a DbTarget for storage locally. */    Ph(t) {
        const e = this.$h(t.Ee), s = this.$h(t.lastLimboFreeSnapshotVersion);
        let i;
 ...
 * limitations under the License.
 */
const ds = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs.";
 ...
 */ class Ts {
    constructor(t, e, s, i, n, r, h, o) {
        ...
        this.Tr = r, this.xh = o, this.Bh = null, this.qh = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        ...
        this.Kh = t => Promise.resolve(), !Ts.Gh()) throw new R(w.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        if (this.hh = new ws(this, n), this.zh = e + Ts.Hh, this.serializer = new ls(h), 
        this.document = i.document, this.Yh = new as(this.hh, this.serializer), this.jn = new ts, 
    ...
    static Nr(t, e) {
        if (t instanceof fs) return Ws.Nr(t.Mh, e);
        throw be();
    }
    /**
     ...
     */    start() {
        return Ws.Xh(this.zh, ys, new bs(this.serializer)).then(t => (this.Zh = t, this.to())).then(() => {
            if (!this.isPrimary && !this.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new R(w.FAILED_PRECONDITION, ds);
            return this.eo(), this.so(), this.io(), this.runTransaction("getHighestListenSequenceNumber", "readonly", t => this.Yh.lh(t));
        }).then(t => {
            this.Bh = new je(t, this.xh);
        }).then(() => {
            this.qh = !0;
        }).catch(t => (this.Zh && this.Zh.close(), Promise.reject(t)));
    }
    /**
     ...
     */    no(t) {
        return this.Kh = async e => {
            if (this.ro) return t(e);
        }, t(this.isPrimary);
    }
    /**
     ...
     * primary lease.
     */    to() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", t => Is(t).put(new Us(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next(() => {
            if (this.isPrimary) return this.co(t).next(t => {
                t || (this.isPrimary = !1, this.Tr.uo(() => this.Kh(!1)));
            });
        }).next(() => this._o(t)).next(e => this.isPrimary && !e ? this.lo(t).next(() => !1) : !!e && this.do(t).next(() => !0))).catch(t => {
            ...
            this.isPrimary !== t && this.Tr.uo(() => this.Kh(t)), this.isPrimary = t;
        });
    }
    co(t) {
        return Es(t).get(Ss.key).next(t => xe.resolve(this.fo(t)));
    }
    To(t) {
        return Is(t).delete(this.clientId);
    }
    /**
     ...
     * time of all clients.
     */    async Eo() {
        if (this.isPrimary && !this.Io(this.jh, 18e5)) {
            this.jh = Date.now(), 
            ...
            (await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", t => {
                const e = Ts.Nr(t, Us.store);
                return e.Fr().next(t => {
                    const s = this.wo(t, 18e5), i = t.filter(t => -1 === s.indexOf(t));
                    // Delete metadata for clients that are no longer considered active.
                    return xe.forEach(i, t => e.delete(t.clientId)).next(() => i);
                });
            }).catch(() => [])).forEach(t => {
                this.window.localStorage.removeItem(this.Ro(t.clientId));
            });
        }
    }
    /**
     ...
     */    io() {
        this.Wh = this.Tr.yr("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, () => this.to().then(() => this.Eo()).then(() => this.io()));
    }
    /** Checks whether `client` is the local client. */    fo(t) {
     ...
     */    _o(t) {
        return Es(t).get(Ss.key).next(e => {
            ...
            //   the foreground.
            if (null !== e && this.Io(e.leaseTimestampMs, 5e3) && !this.Ao(e.ownerId)) {
                if (this.fo(e) && this.networkEnabled) return !0;
                if (!this.fo(e)) {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Is(t).Fr().next(t => void 0 === this.wo(t, 5e3).find(t => {
    ...
    async mo() {
        ...
        this.qh = !1, this.Po(), this.Wh && (this.Wh.cancel(), this.Wh = null), this.Vo(), 
        this.po(), await this.runTransaction("shutdown", "readwrite", t => this.lo(t).next(() => this.To(t))).catch(t => {
     ...
     * provided threshold.
     */    wo(t, e) {
        return t.filter(t => this.Io(t.updateTimeMs, e) && !this.Ao(t.clientId));
    }
    /**
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    bo() {
        return this.runTransaction("getActiveClients", "readonly", t => Is(t).Fr().next(t => this.wo(t, 18e5).map(t => t.clientId)));
    }
    static async clearPersistence(t) {
        if (!Ts.Gh()) return Promise.resolve();
        const e = t + Ts.Hh;
        await Ws.delete(e);
    }
    get ro() {
    ...
    vo(t) {
        return As.So(t, this.serializer, this.jn, this.hh);
    }
    Do() {
        return this.Yh;
    }
    ...
    runTransaction(t, e, s) {
        ...
        // are the only reader/writer.
                return this.Zh.runTransaction(i, Qs, i => (n = new fs(i, this.Bh ? this.Bh.next() : je.dr), 
        "readwrite-primary" === e ? this.co(n).next(t => !!t || this._o(n)).next(e => {
            if (!e) throw pe(`Failed to obtain primary lease for action '${t}'.`), this.isPrimary = !1, 
            this.Tr.uo(() => this.Kh(!1)), new R(w.FAILED_PRECONDITION, qe);
            return s(n);
        }).next(t => this.do(n).next(() => t)) : this.No(n).next(() => s(n)))).then(t => (n.Un(), 
        t));
    }
    /**
    ...
    // be turned off.
    No(t) {
        return Es(t).get(Ss.key).next(t => {
            if (null !== t && this.Io(t.leaseTimestampMs, 5e3) && !this.Ao(t.ownerId) && !this.fo(t) && (!this.allowTabSynchronization || !t.allowTabSynchronization)) throw new R(w.FAILED_PRECONDITION, ds);
        });
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    lo(t) {
        const e = Es(t);
        return e.get(Ss.key).next(t => this.fo(t) ? (ge("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(Ss.key)) : xe.resolve());
    }
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */    Io(t, e) {
        const s = Date.now();
    ...
    eo() {
        null !== this.document && "function" == typeof this.document.addEventListener && (this.Qh = () => {
            this.Tr.uo(() => (this.inForeground = "visible" === this.document.visibilityState, 
            this.to()));
     ...
     * handler.
     */    so() {
        "function" == typeof this.window.addEventListener && (this.Uh = () => {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            this.Po(), this.Tr.uo(() => this.mo());
     ...
     */    Ao(t) {
        try {
            const e = null !== this.Jh.getItem(this.Ro(t));
    ...
    /** Removes the zombied client entry if it exists. */    yo() {
        try {
 ...
 */
function Es(t) {
    return Ts.Nr(t, Ss.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Is(t) {
    return Ts.Nr(t, Us.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ Ts.Hh = "main";

class ws {
    constructor(t, e) {
        this.db = t, this.ko = new oi(this, e);
    }
    Lo(t) {
        const e = this.Mo(t);
        return this.db.Do().Vh(t).next(t => e.next(e => t + e));
    }
    Mo(t) {
        let e = 0;
        return this.Oo(t, t => {
     ...
     */    qo(t, e) {
        ...
        return function(t, e) {
            let s = !1;
            return ps(t).Uo(i => ms(t, i, e).next(t => (t && (s = !0), xe.resolve(!t)))).next(() => s);
        }
        /**
 ...
 */ (t, e);
    ...
    Qo(t, e) {
        const s = this.db.Co().Yr(), i = [];
        let n = 0;
        return this.xo(t, (r, h) => {
            if (h <= e) {
                const e = this.qo(t, r).next(e => {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return n++, s.Ln(t, r).next(() => (s.kn(r), _s(t).delete([ 0, ze(r.path) ])));
                });
                i.push(e);
            }
...
/** A mutation queue for a specific user, backed by IndexedDB. */ class As {
    ...
    zo(t, e, s) {
        ...
        // We can't store the resumeToken as a ByteString in IndexedDB, so we
        // convert it to a Base64 string for storage.
        e.lastStreamToken = s.toBase64(), ps(t).put(e)));
    }
    Yo(t) {
        return this.Ho(t).next(t => k.fromBase64String(t.lastStreamToken));
    }
    Jo(t, e) {
        return this.Ho(t).next(s => (
        // We can't store the resumeToken as a ByteString in IndexedDB, so we
        // convert it to a Base64 string for storage.
        s.lastStreamToken = e.toBase64(), ps(t).put(s)));
    }
    Xo(t, e, s, i) {
        const n = gs(t), r = Vs(t);
        ...
        return r.add({}).next(h => {
            ve("number" == typeof h);
            const o = new Me(h, e, s, i), a = this.serializer.kh(this.userId, o), u = [];
            let c = new jt((t, e) => Ce(t.j(), e.j()));
            for (const t of i) {
                const e = Fs.key(this.userId, t.key.path, h);
                c = c.add(t.key.path.L()), u.push(r.put(a)), u.push(n.put(e, Fs.PLACEHOLDER));
            }
            return c.forEach(e => {
    ...
    Zo(t, e) {
        return Vs(t).get(e).next(t => t ? (ve(t.userId === this.userId), this.serializer.Lh(t)) : null);
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    ta(t, e) {
        return this.Ko[e] ? xe.resolve(this.Ko[e]) : this.Zo(t, e).next(t => {
            if (t) {
                const s = t.keys();
                return this.Ko[e] = s, s;
            }
            return null;
        });
    }
    ea(t, e) {
        ...
        return Vs(t).Ur({
            ...
            e.userId === this.userId && (ve(e.batchId >= s), n = this.serializer.Lh(e)), i.done();
        }).next(() => n);
    }
    sa(t) {
    ...
    ia(t) {
        ...
        return Vs(t).Fr(Cs.userMutationsIndex, e).next(t => t.map(t => this.serializer.Lh(t)));
    }
    Gn(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const s = Fs.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(s), n = [];
        return gs(t).Ur({
            range: i
        }, (s, i, r) => {
            ...
            return Vs(t).get(a).next(t => {
                if (!t) throw be();
                ve(t.userId === this.userId), n.push(this.serializer.Lh(t));
            });
            r.done();
        }).next(() => n);
    }
    Xn(t, e) {
        ...
        const i = [];
        return e.forEach(e => {
            const n = Fs.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(n), h = gs(t).Ur({
                range: r
            }, (t, i, n) => {
            ...
            i.push(h);
        }), xe.vn(i).next(() => this.na(t, s));
    }
    nr(t, e) {
        const s = e.path, i = s.length + 1, n = Fs.prefixForPath(this.userId, s), r = IDBKeyRange.lowerBound(n);
    ...
    na(t, e) {
        ...
        return e.forEach(e => {
            i.push(Vs(t).get(e).next(t => {
                if (null === t) throw be();
                ve(t.userId === this.userId), s.push(this.serializer.Lh(t));
            }));
        }), xe.vn(i).next(() => s);
    }
    ra(t, e) {
        return Ps(t.Mh, this.userId, e).next(s => (t.qn(() => {
            this.ha(e.batchId);
        }), xe.forEach(s, e => this.hh.Bo(t, e))));
    }
    /**
    ...
    oa(t) {
        return this.Go(t).next(e => {
            ...
            // the queue is empty.
                        const s = IDBKeyRange.lowerBound(Fs.prefixForUser(this.userId)), i = [];
            return gs(t).Ur({
                range: s
            }, (t, e, s) => {
                if (t[0] === this.userId) {
    ...
    Ch(t, e) {
        return ms(t, this.userId, e);
    }
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    Ho(t) {
        return ps(t).get(this.userId).next(t => t || new Ds(this.userId, -1, 
        /*lastStreamToken=*/ ""));
    }
}
 ...
 */ function ms(t, e, s) {
    const i = Fs.prefixForPath(e, s.path), n = i[1], r = IDBKeyRange.lowerBound(i);
    let h = !1;
    return gs(t).Ur({
        range: r,
        Dh: !0
...
function Ps(t, e, s) {
    const i = t.store(Cs.store), n = t.store(Fs.store), r = [], h = IDBKeyRange.only(s.batchId);
    let o = 0;
    const a = i.Ur({
        range: h
    }, (t, e, s) => (o++, s.delete()));
    ...
    for (const t of s.mutations) {
        const i = Fs.key(e, t.key.path, s.batchId);
 ...
 */ function Vs(t) {
    return Ts.Nr(t, Cs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function gs(t) {
    return Ts.Nr(t, Fs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function ps(t) {
    return Ts.Nr(t, Ds.store);
}
...
/** Performs database creation and schema upgrades. */ class bs {
    constructor(t) {
        this.serializer = t;
    }
    /**
 ...
 */ (t));
        ...
        0 !== s && (!function(t) {
            t.deleteObjectStore(Os.store), t.deleteObjectStore(Ms.store), t.deleteObjectStore(xs.store);
        }(t), qs(t)), r = r.next(() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(xs.store), s = new xs(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, y.min().C(), 
            /*targetCount=*/ 0);
            return e.put(xs.key, s);
        }
        /**
 ...
 */ (n))), s < 4 && i >= 4 && (0 !== s && (
        ...
        r = r.next(() => function(t, e) {
            return e.store(Cs.store).Fr().next(s => {
                t.deleteObjectStore(Cs.store), t.createObjectStore(Cs.store, {
                    keyPath: Cs.keyPath,
                    autoIncrement: !0
                }).createIndex(Cs.userMutationsIndex, Cs.userMutationsKeyPath, {
                    unique: !0
                });
                const i = e.store(Cs.store), n = s.map(t => i.put(t));
                return xe.vn(n);
            });
        }
        /**
 ...
 */ (e);
    ...
    removeAcknowledgedMutations(t) {
        const e = t.store(Ds.store), s = t.store(Cs.store);
        return e.Fr().next(e => xe.forEach(e, e => {
            const i = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return s.Fr(Cs.userMutationsIndex, i).next(s => xe.forEach(s, s => {
                ve(s.userId === e.userId);
                const i = this.serializer.Lh(s);
                return Ps(t, e.userId, i).next(() => {});
            }));
        }));
    }
    /**
     ...
     */    ensureSequenceNumbers(t) {
        const e = t.store(Os.store), s = t.store(ks.store);
        return t.store(xs.store).get(xs.key).next(t => {
            const i = [];
            return s.Ur((s, n) => {
 ...
 */ (r);
                i.push(e.get(h).next(s => s ? xe.resolve() : (s => e.put(new Os(0, ze(s), t.highestListenSequenceNumber)))(r)));
            }).next(() => xe.vn(i));
        });
    }
    createCollectionParentIndex(t, e) {
        ...
        const s = e.store(Bs.store), i = new Ze, n = t => {
            if (i.add(t)) {
                const e = t.O(), i = t.L();
                return s.put({
                    collectionId: e,
 ...
 */ xs.key = "targetGlobalKey", xs.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ function qs(t) {
...
const Qs = [ ...[ ...[ ...[ Ds.store, Cs.store, Fs.store, ks.store, Ms.store, Ss.store, xs.store, Os.store ], Us.store ], Ls.store ], Bs.store ];
...
class Ws {
    constructor(t) {
        ...
        // log on 12.2.
        12.2 === Ws.aa(i()) && pe("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /**
     ...
     */    static Xh(t, e, s) {
        return ge("SimpleDb", "Opening database:", t), new xe((i, n) => {
            ...
            r.onsuccess = t => {
                ...
                s.createOrUpgrade(i, r.transaction, e.oldVersion, ys).next(() => {
                    ge("SimpleDb", "Database upgrade to version " + ys + " complete");
                });
            };
        }).yn();
    }
    /** Deletes the specified database. */    static delete(t) {
        return ge("SimpleDb", "Removing database:", t), Ys(window.indexedDB.deleteDatabase(t)).yn();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Gh() {
        ...
        // Check the UA string to find out the browser.
                const t = i(), e = Ws.aa(t), s = 0 < e && e < 10, n = Ws.ca(t), r = 0 < n && n < 4.5;
        // IE 10
    ...
    async runTransaction(t, e, s) {
        ...
        for (;;) {
            ++n;
            const t = zs.open(this.db, i ? "readonly" : "readwrite", e);
            try {
                const e = s(t).catch(e => (
 ...
 */ class js {
     ...
     */    delete() {
        return Ys(this.da.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ks extends R {
    constructor(t) {
 ...
 */ class zs {
    constructor(t) {
         ...
         */
        this.Ia = new Ke, this.transaction.oncomplete = () => {
            this.Ia.resolve();
        }, this.transaction.onabort = () => {
            t.error ? this.Ia.reject(new Ks(t.error)) : this.Ia.resolve();
        }, this.transaction.onerror = t => {
            const e = Xs(t.target.error);
            this.Ia.reject(new Ks(e));
        };
    }
    static open(t, e, s) {
        return new zs(t.transaction(s, e));
    }
    get la() {
        return this.Ia.promise;
    }
    abort(t) {
        t && this.Ia.reject(t), this.aborted || (ge("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Hs {
     ...
     */    add(t) {
        return ge("SimpleDb", "ADD", this.store.name, t, t), Ys(this.store.add(t));
    }
    /**
    ...
    delete(t) {
        return ge("SimpleDb", "DELETE", this.store.name, t), Ys(this.store.delete(t));
    }
    /**
     ...
     */    count() {
        return ge("SimpleDb", "COUNT", this.store.name), Ys(this.store.count());
    }
    Fr(t, e) {
        const s = this.cursor(this.options(t, e)), i = [];
        return this.wa(s, (t, e) => {
            i.push(e);
        }).next(() => i);
    }
    Ra(t, e) {
        ...
        return this.wa(i, (t, e, s) => s.delete());
    }
    Ur(t, e) {
        let s;
        e ? s = t : (s = {}, e = t);
    ...
    wa(t, e) {
        ...
        return new xe((i, n) => {
            t.onerror = t => {
                ...
                if (!n) return void i();
                const r = new js(n), h = e(n.primaryKey, n.value, r);
                if (h instanceof xe) {
                    const t = h.catch(t => (r.done(), xe.reject(t)));
                    s.push(t);
                }
                r.Pn ? i() : null === r.Ea ? n.continue() : n.continue(r.Ea);
            };
        }).next(() => xe.vn(s));
    }
    options(t, e) {
...
class Zs {
    constructor(t, e, s, i, n) {
        this.Aa = t, this.Er = e, this.ma = s, this.op = i, this.Pa = n, this.Va = new Ke, 
        this.then = this.Va.promise.then.bind(this.Va.promise), 
        // It's normal for the deferred promise to be canceled (due to cancellation)
        // and so we attach a dummy catch callback to avoid
        // 'UnhandledPromiseRejectionWarning' log spam.
        this.Va.promise.catch(t => {});
    }
    /**
     ...
     */    static ga(t, e, s, i, n) {
        const r = Date.now() + s, h = new Zs(t, e, r, i, n);
        return h.start(s), h;
    }
    /**
     ...
     */    cancel(t) {
        null !== this.pa && (this.clearTimeout(), this.Va.reject(new R(w.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    ya() {
        this.Aa.uo(() => null !== this.pa ? (this.clearTimeout(), this.op().then(t => this.Va.resolve(t))) : Promise.resolve());
    }
    clearTimeout() {
...
class ti {
    constructor() {
        ...
        this.$a = new Ge(this, "async_queue_retry" /* AsyncQueueRetry */), 
     ...
     */    async qa(t) {
        if (this.Oa(), !this.Sa) {
            ...
            e && e.removeEventListener("visibilitychange", this.ka), await this.Ba(t);
        }
    }
    /**
     ...
     */    enqueue(t) {
        return this.Oa(), this.Sa ? new Promise(t => {}) : this.xa(t);
    }
    /**
     ...
     */    Ua(t) {
        this.Oa(), this.Sa || (this.va = this.va.then(() => {
            const e = new Ke, s = async () => {
                try {
                    await t(), e.resolve(), this.$a.reset();
                } catch (t) {
                    if (!Gs(t)) throw e.resolve(), t;
 // Failure will be handled by AsyncQueue
                                        ge("AsyncQueue", "Operation failed with retryable error: " + t), 
                    this.$a.gr(s);
                }
            };
            return this.uo(s), e.promise;
        }));
    }
    xa(t) {
        const e = this.ba.then(() => (this.Fa = !0, t().catch(t => {
            // Re-throw the error so that this.tail becomes a rejected Promise and
            // all further attempts to chain (via .then) will just short-circuit
            // and return the rejected Promise.
            throw this.Ca = t, this.Fa = !1, pe("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
            t;
        }).then(t => (this.Fa = !1, t))));
        return this.ba = e, e;
    }
     ...
     */    yr(t, e, s) {
        ...
        const i = Zs.ga(this, t, e, s, t => this.Qa(t));
     ...
     * exists.
     */    Ka(t) {
        for (const e of this.Da) if (e.Er === t) return !0;
        return !1;
    }
    /**
     ...
     */    Ga(t) {
        ...
        return this.ja().then(() => {
            ...
            this.Da.sort((t, e) => t.ma - e.ma);
            for (const e of this.Da) if (e.vr(), "all" /* All */ !== t && e.Er === t) break;
            return this.ja();
        });
    }
    /**
 ...
 */ function ei(t, e) {
    if (pe("AsyncQueue", `${e}: ${t}`), Gs(t)) return new R(w.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class ii {
    constructor(t) {
        this.Ha = t, this.buffer = new jt(si), this.Ya = 0;
    }
    Ja() {
        return ++this.Ya;
    }
...
class ri {
    ...
    s) {
        this.iu = t, this.nu = e, this.ru = s;
    }
    static hu(t) {
        return new ri(t, ri.ou, ri.au);
    }
}

ri.uu = -1, ri.cu = 1048576, ri._u = 41943040, ri.ou = 10, ri.au = 1e3, ri.lu = new ri(ri._u, ri.ou, ri.au), 
ri.DISABLED = new ri(ri.uu, 0, 0);
...
class hi {
    ...
    Eu(t) {
        const e = this.du ? 3e5 : 6e4;
        ge("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.fu = this.Aa.yr("lru_garbage_collection" /* LruGarbageCollection */ , e, async () => {
            this.fu = null, this.du = !0;
            try {
                await t.Iu(this.ko);
            } catch (t) {
                Gs(t) ? ge("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await ci(t);
            }
            await this.Eu(t);
        });
    }
...
/** Implements the steps for LRU garbage collection. */ class oi {
    constructor(t, e) {
        this.wu = t, this.Tu = e;
    }
    /** Given a percentile of target to collect, returns the number of targets to collect. */    Ru(t, e) {
        return this.wu.Lo(t).next(t => Math.floor(e / 100 * t));
    }
    /** Returns the nth sequence number, counting in order from the smallest. */    Au(t, e) {
        if (0 === e) return xe.resolve(je.dr);
        const s = new ii(e);
        return this.wu.js(t, t => s.Xa(t.sequenceNumber)).next(() => this.wu.Oo(t, t => s.Xa(t))).next(() => s.maxValue);
    }
    /**
     * Removes targets with a sequence number equal to or less than the given upper bound, and removes
     * document associations with those targets.
     */    Ah(t, e, s) {
        return this.wu.Ah(t, e, s);
    }
    /**
    ...
    mu(t, e) {
        return this.Tu.iu === ri.uu ? (ge("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        xe.resolve(ni)) : this.jo(t).next(s => s < this.Tu.iu ? (ge("LruGarbageCollector", `Garbage collection skipped; Cache size ${s} ` + `is lower than threshold ${this.Tu.iu}`), 
        ni) : this.Pu(t, e));
    }
    jo(t) {
        return this.wu.jo(t);
    ...
    Pu(t, e) {
        let i, n, r, h, o, a, u;
        const c = Date.now();
        return this.Ru(t, this.Tu.nu).next(e => (
        // Cap at the configured max
        e > this.Tu.ru ? (ge("LruGarbageCollector", "Capping sequence numbers to collect down " + `to the maximum of ${this.Tu.ru} ` + `from ${e}`), 
        n = this.Tu.ru) : n = e, h = Date.now(), this.Au(t, n))).next(s => (i = s, o = Date.now(), 
        this.Ah(t, i, e))).next(e => (r = e, a = Date.now(), this.Qo(t, i))).next(t => {
...
class ai {
    ...
    t, e, s) {
        ...
        this.pu = new Le(t => t.canonicalId()), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.yu = y.min(), this.Wn = t.vo(s), this.bu = t.Co(), this.Yh = t.Do(), this.vu = new Qe(this.bu, this.Wn, this.persistence.Fo()), 
        this.Vu.Su(this.vu);
    }
    ...
    // change.
    async Du(t) {
        let e = this.Wn, s = this.vu;
        const i = await this.persistence.runTransaction("Handle user change", "readonly", i => {
            // Swap out the mutation queue, grabbing the pending mutation batches
            // before and after.
            let n;
            return this.Wn.ia(i).next(r => (n = r, e = this.persistence.vo(t), 
            // Recreate our LocalDocumentsView using the new
            // MutationQueue.
            s = new Qe(this.bu, e, this.persistence.Fo()), e.ia(i))).next(t => {
                const e = [], r = [];
        ...
        return this.Wn = e, this.vu = s, this.Vu.Su(this.vu), i;
    }
    /* Accept locally generated Mutations and commit them to storage. */    $u(t) {
        const e = p.now(), s = t.reduce((t, e) => t.add(e.key), ee());
        let i;
        return this.persistence.runTransaction("Locally write mutations", "readwrite", n => this.vu.Yn(n, s).next(s => {
            i = s;
     ...
     */    zo(t) {
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", e => {
            const s = t.batch.keys(), i = this.bu.Yr({
                Xr: !0
            });
            return this.Wn.zo(e, t.batch, t.streamToken).next(() => this.ku(e, t, i)).next(() => i.apply(e)).next(() => this.Wn.oa(e)).next(() => this.vu.Yn(e, s));
        });
    }
    /**
     ...
     */    Lu(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let s;
            return this.Wn.Zo(e, t).next(t => (ve(null !== t), s = t.keys(), this.Wn.ra(e, t))).next(() => this.Wn.oa(e)).next(() => this.vu.Yn(e, s));
        });
    }
    /**
     ...
     */    sa() {
        return this.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", t => this.Wn.sa(t));
    }
    /** Returns the last recorded stream token for the current user. */    Yo() {
        return this.persistence.runTransaction("Get last stream token", "readonly", t => this.Wn.Yo(t));
    }
    /**
     ...
     */    Jo(t) {
        return this.persistence.runTransaction("Set last stream token", "readwrite-primary", e => this.Wn.Jo(e, t));
    }
    /**
     * Returns the last consistent snapshot processed (used by the RemoteStore to
     * determine whether to buffer incoming snapshots from the backend).
     */    _h() {
        return this.persistence.runTransaction("Get last remote snapshot version", "readonly", t => this.Yh._h(t));
    }
    /**
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", i => {
            ...
            t.as.forEach((t, n) => {
                ...
                // the updated assignment.
                                r.push(this.Yh.bh(i, t.Is, n).next(() => this.Yh.ph(i, t.Ts, n)));
                ...
                // Update the resume token if the change includes one.
                    ...
                    ai.Ou(h, a, t) && r.push(this.Yh.Ih(i, a));
                }
            });
            let h = zt(), o = ee();
            ...
            r.push(n.getEntries(i, o).next(s => {
                t.cs.forEach((o, a) => {
                    ...
                    // access.
                    n.kn(o, e), h = h.Ae(o, a)) : null == u || a.version.S(u.version) > 0 || 0 === a.version.S(u.version) && u.hasPendingWrites ? (n.Nn(a, e), 
                    h = h.Ae(o, a)) : ge("LocalStore", "Ignoring outdated watch update for ", o, ". Current version:", u.version, " Watch version:", a.version), 
                    t._s.has(o) && r.push(this.persistence.hh.Wo(i, o));
                });
            })), !e.isEqual(y.min())) {
                const t = this.Yh._h(i).next(t => this.Yh.dh(i, i.Oh, e));
                r.push(t);
            }
            return xe.vn(r).next(() => n.apply(i)).next(() => this.vu.Jn(i, h));
        }).then(t => (this.gu = s, t));
    }
    /**
     ...
     */    async Bu(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => xe.forEach(t, t => xe.forEach(t.hr, s => this.persistence.hh.yh(e, t.targetId, s)).next(() => xe.forEach(t.or, s => this.persistence.hh.vh(e, t.targetId, s)))));
        } catch (t) {
            if (!Gs(t)) throw t;
        ...
        for (const e of t) {
            const t = e.targetId;
            if (!e.fromCache) {
                const e = this.gu.get(t), s = e.Ee, i = e.Re(s);
                // Advance the last limbo free snapshot version
                                this.gu = this.gu.Ae(t, i);
            }
        }
    }
    /**
     ...
     */    Uu(t) {
        return this.persistence.runTransaction("read document", "readonly", e => this.vu.Kn(e, t));
    }
    /**
     ...
     */    Qu(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            let s;
            return this.Yh.gh(e, t).next(i => i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            s = i, xe.resolve(s)) : this.Yh.oh(e).next(i => (s = new Lt(t, i, 0 /* Listen */ , e.Oh), 
            this.Yh.fh(e, s).next(() => s))));
        }).then(e => (null === this.gu.get(e.targetId) && (this.gu = this.gu.Ae(e.targetId, e), 
        this.pu.set(t, e.targetId)), e));
    }
    /**
    ...
    // Visible for testing.
    gh(t, e) {
        const s = this.pu.get(e);
        return void 0 !== s ? xe.resolve(this.gu.get(s)) : this.Yh.gh(t, e);
    }
    /**
    ...
    Wu(t, e) {
        const s = this.gu.get(t), i = e ? "readwrite" : "readwrite-primary";
        return this.persistence.runTransaction("Release target", i, t => e ? xe.resolve() : this.persistence.hh.removeTarget(t, s)).then(() => {
            this.gu = this.gu.remove(t), this.pu.delete(s.target);
        });
    }
    /**
     ...
     */    ju(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", n => this.gh(n, t.ee()).next(t => {
            if (t) return s = t.lastLimboFreeSnapshotVersion, this.Yh.Sh(n, t.targetId).next(t => {
                i = t;
            });
        }).next(() => this.Vu.Zn(n, t, e ? s : y.min(), e ? i : ee())).next(t => ({
            documents: t,
            Ku: i
        })));
    }
    ku(t, e, s) {
        ...
        }), r.next(() => this.Wn.ra(t, i));
    }
    Iu(t) {
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", e => t.mu(e, this.gu));
    }
}
...
class ui extends ai {
    constructor(t, e, s) {
        super(t, e, s), this.persistence = t, this.Wn = t.vo(s), this.bu = t.Co(), this.Yh = t.Do();
    }
    /** Starts the LocalStore. */    start() {
        return this.Gu();
    }
    /** Returns the local view of the documents affected by a mutation batch. */    zu(t) {
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", e => this.Wn.ta(e, t).next(t => t ? this.vu.Yn(e, t) : xe.resolve(null)));
    }
    Hu(t) {
        this.Wn.ha(t);
    }
    ...
    Yu(t) {
        const e = this.gu.get(t);
        return e ? Promise.resolve(e.target) : this.persistence.runTransaction("Get target data", "readonly", e => this.Yh.si(e, t).next(t => t ? t.target : null));
    }
    /**
     ...
     */    Kr() {
        return this.persistence.runTransaction("Get new document changes", "readonly", t => this.bu.Kr(t, this.yu)).then(({Gr: t, readTime: e}) => (this.yu = e, 
        t));
    }
    /**
     ...
     */    async Gu() {
        this.yu = await this.persistence.runTransaction("Synchronize last document change read time", "readonly", t => this.bu.Hr(t));
    }
}
 ...
 */ class _i {
    constructor() {
        ...
        this.Ju = new jt(li.Xu), 
        // A set of outstanding references to a document sorted by target id.
        this.Zu = new jt(li.tc);
    }
    ...
    /** Adds a reference to the given document key for the given ID. */    yh(t, e) {
        const s = new li(t, e);
        this.Ju = this.Ju.add(s), this.Zu = this.Zu.add(s);
    }
    /** Add references to the given document keys for the given ID. */    ec(t, e) {
     ...
     * removed.
     */    nc(t) {
        const e = C.EMPTY, s = new li(e, t), i = new li(e, t + 1), n = [];
        return this.Zu.Ke([ s, i ], t => {
            this.sc(t), n.push(t.key);
        }), n;
    }
    rc() {
        this.Ju.forEach(t => this.sc(t));
    }
    sc(t) {
        this.Ju = this.Ju.delete(t), this.Zu = this.Zu.delete(t);
    }
    hc(t) {
        const e = C.EMPTY, s = new li(e, t), i = new li(e, t + 1);
        let n = ee();
        return this.Zu.Ke([ s, i ], t => {
            n = n.add(t.key);
        }), n;
    ...
    Ch(t) {
        const e = new li(t, 0), s = this.Ju.ze(e);
...
class li {
    ...
    /** Compare by key then by ID */    static Xu(t, e) {
        return C.N(t.key, e.key) || Ce(t.oc, e.oc);
    }
    /** Compare by ID then by key */    static tc(t, e) {
        return Ce(t.oc, e.oc) || C.N(t.key, e.key);
    }
}
 ...
 */ function di(t, e) {
    if (0 !== e.length) throw new R(w.INVALID_ARGUMENT, `Function ${t}() does not support arguments, ` + "but was called with " + Ci(e.length, "argument") + ".");
}
 ...
 */ function fi(t, e, s) {
    if (e.length !== s) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires ` + Ci(s, "argument") + ", but was called with " + Ci(e.length, "argument") + ".");
}
 ...
 */ function Ti(t, e, s) {
    if (e.length < s) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires at least ` + Ci(s, "argument") + ", but was called with " + Ci(e.length, "argument") + ".");
}
 ...
 */ function Ei(t, e, s, i) {
    if (e.length < s || e.length > i) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires between ${s} and ` + `${i} arguments, but was called with ` + Ci(e.length, "argument") + ".");
}
...
function mi(t, e, s, i, n) {
    void 0 !== i && function(t, e, s, i, n) {
        if (!(i instanceof Array)) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires its ${e} ` + `option to be an array, but it was: ${pi(i)}`);
        for (let r = 0; r < i.length; ++r) if (!n(i[r])) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires all ${e} ` + `elements to be ${s}, but the value at index ${r} ` + `was: ${pi(i[r])}`);
    }(t, e, s, i, n);
}
...
function yi(t, e, s) {
    if (void 0 === s) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires a valid ${Di(e)} ` + "argument, but it was undefined.");
}
 ...
 */ function vi(t, e, s, i) {
    const n = pi(i);
    return new R(w.INVALID_ARGUMENT, `Function ${t}() requires its ${Di(s)} ` + `argument to be a ${e}, but it was: ${n}`);
}

function Si(t, e, s) {
    if (s <= 0) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires its ${Di(e)} argument to be a positive number, but it was: ${s}.`);
}
...
/** Helper function to assert Base64 functions are available at runtime. */ function Ni() {
    if (!Ae.nt().ac) throw new R(w.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ class $i {
    ...
    static fromBase64String(t) {
        fi("Blob.fromBase64String", arguments, 1), Ii("Blob.fromBase64String", "string", 1, t), 
        Ni();
        try {
            return new $i(k.fromBase64String(t));
        } catch (t) {
            throw new R(w.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (fi("Blob.fromUint8Array", arguments, 1), Fi(), !(t instanceof Uint8Array)) throw vi("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new $i(k.fromUint8Array(t));
    }
    toBase64() {
        return fi("Blob.toBase64", arguments, 0), Ni(), this.uc.toBase64();
    }
    toUint8Array() {
        return fi("Blob.toUint8Array", arguments, 0), Fi(), this.uc.toUint8Array();
    }
    toString() {
 ...
 */ class ki {
    ...
    constructor(...t) {
        !function(t, e, s, i) {
            if (!(e instanceof Array) || e.length < i) throw new R(w.INVALID_ARGUMENT, `Function ${t}() requires its ${s} argument to be an ` + "array with at least " + `${Ci(i, "element")}.`);
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (Ii("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new R(w.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.cc = new D(t);
    }
    static documentId() {
        return ki._c;
    ...
    isEqual(t) {
        if (!(t instanceof ki)) throw vi("isEqual", "FieldPath", 1, t);
...
class Bi extends Mi {
    constructor(t) {
        super("FieldValue.arrayUnion"), this.Tc = t;
    }
    Di(t) {
        ...
        const e = new zi({
            ...
            methodName: this.lc,
            Ec: !0
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), s = this.Tc.map(t => Yi(t, e)), i = new rt(s);
...
class qi extends Mi {
    constructor(t) {
        super("FieldValue.arrayRemove"), this.Tc = t;
    }
    Di(t) {
        // Although array transforms are used with writes, the actual elements
        ...
        const e = new zi({
            ...
            methodName: this.lc,
            Ec: !0
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), s = this.Tc.map(t => Yi(t, e)), i = new ht(s);
        return new ct(t.path, i);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Ui extends Mi {
    constructor(t) {
        super("FieldValue.increment"), this.Ic = t;
    }
    Di(t) {
        const e = new zi({
            dc: 3 /* Argument */ ,
            methodName: this.lc
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), s = Yi(this.Ic, e), i = new ot(t.serializer, s);
        return new ct(t.path, i);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class Qi {
    constructor(t, e) {
        if (fi("GeoPoint", arguments, 2), Ii("GeoPoint", "number", 1, t), Ii("GeoPoint", "number", 2, e), 
     ...
     * with an underscore.
     */    p(t) {
        return Ce(this.wc, t.wc) || Ce(this.Rc, t.Rc);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class ji {
    constructor(t, e, s) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class Ki {
    constructor(t, e, s) {
        this.data = t, this.Vt = e, this.fieldTransforms = s;
    }
    Ac(t, e) {
...
/** A "context" object passed around while parsing user data. */ class zi {
    /**
    ...
    constructor(t, e, s, i, n, r) {
        ...
        void 0 === n && this.mc(), this.fieldTransforms = n || [], this.Vt = r || [];
    }
    get path() {
    ...
    /** Returns a new context with the specified settings overwritten. */    Pc(t) {
        return new zi(Object.assign(Object.assign({}, this.settings), t), this.ii, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.Vt);
    }
    Vc(t) {
        var e;
        const s = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), i = this.Pc({
            path: s,
            Ec: !1
        });
        return i.gc(t), i;
    ...
    mc() {
        ...
        // within arrays.
        if (this.path) for (let t = 0; t < this.path.length; t++) this.gc(this.path.get(t));
    }
    gc(t) {
        if (0 === t.length) throw this.fc("Document fields must not be empty");
        if (Gi(this.dc) && Wi.test(t)) throw this.fc('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class Hi {
    constructor(t, e, s) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = s || Ae.nt().bc(t);
    }
    /** Parse document data from a non-merge set() call. */    vc(t, e) {
        const s = this.Sc(0 /* Set */ , t);
        Zi("Data must be an object, but it was:", s, e);
        const i = Ji(e, s);
        return new ji(new Rt(i), 
        /* fieldMask= */ null, s.fieldTransforms);
    }
    /** Parse document data from a set() call with '{merge:true}'. */    Dc(t, e, s) {
        const i = this.Sc(2 /* MergeSet */ , t);
        Zi("Data must be an object, but it was:", i, e);
        const n = Ji(e, i);
        let r, h;
        if (s) {
            const e = [];
            for (const n of s) {
                let s;
                if (n instanceof ki) s = n.cc; else {
        ...
        return new ji(new Rt(n), r, h);
    }
    /** Parse update data from an update() call. */    Cc(t, e) {
        const s = this.Sc(1 /* Update */ , t);
        Zi("Data must be an object, but it was:", s, e);
        const i = [], n = new At;
        N(e, (e, r) => {
            const h = en(t, e), o = s.pc(h);
            if (r instanceof Oi) 
        ...
        const r = new ut(i);
        return new Ki(n.yt(), r, s.fieldTransforms);
    }
    /** Parse update data from a list of field/value arguments. */    Fc(t, e, s, i) {
        const n = this.Sc(1 /* Update */ , t), r = [ tn(t, e) ], h = [ s ];
        ...
        for (let e = 0; e < i.length; e += 2) r.push(tn(t, i[e])), h.push(i[e + 1]);
        const o = [], a = new At;
        // We iterate in reverse order to pick the last value for a field if the
        // user specified the field multiple times.
        for (let t = r.length - 1; t >= 0; --t) if (!sn(o, r[t])) {
            const e = r[t], s = h[t], i = n.pc(e);
            if (s instanceof Oi) 
            // Add it to the field mask, but don't add anything to updateData.
            o.push(e); else {
                const t = Yi(s, i);
        ...
        const u = new ut(o);
        return new Ki(a.yt(), u, n.fieldTransforms);
    }
    /** Creates a new top-level parse context. */    Sc(t, e) {
        return new zi({
            dc: t,
            methodName: e,
            path: D.G,
     ...
     */    Nc(t, e, s = !1) {
        return Yi(e, this.Sc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }
}
 ...
 */ function Yi(t, e) {
    if (Xi(t)) return Zi("Unsupported field value:", e, t), Ji(t, e);
    if (t instanceof Mi) 
 ...
 */
    return function(t, e) {
        ...
        if (!Gi(e.dc)) throw e.fc(`${t.lc}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof Yn) {
            const s = e.ii, i = t.firestore.$c;
            if (!i.isEqual(s)) throw e.fc("Document reference is for database " + `${i.projectId}/${i.database} but should be ` + `for database ${s.projectId}/${s.database}`);
            return {
                referenceValue: e.serializer._i(t.kc.path, t.firestore.$c)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.fc(`Unsupported field value: ${pi(t)}`);
    }
    /**
...
function Xi(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof p || t instanceof Qi || t instanceof $i || t instanceof Yn || t instanceof Mi);
}
 ...
 */ function tn(t, e) {
    if (e instanceof ki) return e.cc;
    if ("string" == typeof e) return en(t, e);
...
class nn {
    constructor(t, e, s, i, n, r) {
        this.Tr = t, this.Lc = s, this.Mc = i, this.Oc = n, this.listener = r, this.state = 0 /* Initial */ , 
        /**
         * A close count that's incremented every time the stream is closed; used by
         * getCloseGuardedDispatcher() to invalidate callbacks that happen after
         * close.
         */
        this.xc = 0, this.Bc = null, this.stream = null, this.$a = new Ge(t, e);
    }
    /**
     ...
     */    jc() {
        ...
        this.Uc() && null === this.Bc && (this.Bc = this.Tr.yr(this.Lc, 6e4, () => this.Kc()));
    }
    /** Sends a message to the underlying stream. */    Gc(t) {
        this.zc(), this.stream.send(t);
    }
    /** Called by the idle timer when the stream should close due to inactivity. */    async Kc() {
        if (this.Uc()) 
        // When timing out an idle stream there's no reason to force the stream into backoff when
        // it restarts so set the stream state to Initial instead of Error.
        return this.close(0 /* Initial */);
    }
    /** Marks the stream as active again. */    zc() {
    ...
    auth() {
        ...
        const t = this.Jc(this.xc), e = this.xc;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.Oc.getToken().then(t => {
    ...
    Xc(t) {
        const e = this.Jc(this.xc);
        this.stream = this.t_(t), this.stream.e_(() => {
            e(() => (this.state = 2 /* Open */ , this.listener.e_()));
        }), this.stream.Yc(t => {
            e(() => this.Zc(t));
    ...
    Qc() {
        this.state = 4 /* Backoff */ , this.$a.gr(async () => {
     ...
     */    Jc(t) {
        return e => {
            this.Tr.uo(() => this.xc === t ? e() : (ge("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class hn extends nn {
    ...
    onMessage(t) {
        ...
        ve(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.h_) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.$a.reset();
            const e = this.serializer.Mi(t.writeResults, t.commitTime), s = this.serializer.fromVersion(t.commitTime);
            return this.listener.u_(s, e);
        }
        // The first response is always the handshake response
        return ve(!t.writeResults || 0 === t.writeResults.length), this.h_ = !0, this.listener.c_();
    }
    /**
    ...
    /** Sends a group of mutations to the Firestore backend to apply. */    a_(t) {
        const e = {
...
class on extends class {
    ...
    /** Gets an auth token and invokes the provided RPC with streamed results. */    f_(t, e) {
        return this.credentials.getToken().then(s => this.Mc.f_(t, e, s)).catch(t => {
            throw t.code === w.UNAUTHENTICATED && this.credentials._(), t;
        });
    }
}
...
class an {
    ...
    async A_(t) {
        ...
        const e = await async function(t, e) {
            ...
            }, n = await s.f_("BatchGetDocuments", i), r = new Map;
            n.forEach(t => {
    ...
    delete(t) {
        this.write([ new It(t, this.Rt(t)) ]), this.R_.add(t);
    }
    async commit() {
        ...
        t.forEach((t, e) => {
            ...
            }, n = await s.d_("Commit", i);
            return s.serializer.Mi(n.writeResults, n.commitTime);
        }(this.T_, this.mutations), this.I_ = !0;
    }
    P_(t) {
        let e;
     ...
     */    Rt(t) {
        const e = this.E_.get(t);
        return !this.R_.has(t) && e ? lt.updateTime(e) : lt.ft();
    }
    /**
...
class un {
     ...
     */    v_() {
        0 === this.p_ && (this.S_("Unknown" /* Unknown */), this.y_ = this.Aa.yr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, () => (this.y_ = null, 
        this.D_("Backend didn't respond within 10 seconds."), this.S_("Offline" /* Offline */), 
        Promise.resolve())));
    }
    /**
    ...
    D_(t) {
        ...
        this.b_ ? (pe(e), this.b_ = !1) : ge("OnlineStateTracker", e);
    }
    F_() {
...
class cn {
    ...
    e, s, i, n) {
         ...
         * again.
         */
        this.O_ = !1, this.x_ = n, this.x_.B_(t => {
            s.uo(async () => {
                this.q_() && (ge("RemoteStore", "Restarting streams for network reachability change."), 
                await this.U_());
            });
        }), this.Q_ = new un(s, i), 
        // Create streams (but note they're not started yet).
        this.W_ = function(t, e, s) {
            const i = Se(t);
    ...
    async X_() {
        this.q_() && (this.z_.lastStreamToken = await this.N_.Yo(), this.Z_() ? this.tl() : this.Q_.set("Unknown" /* Unknown */), 
     ...
     */    async disableNetwork() {
        this.networkEnabled = !1, await this.sl(), 
        // Set the OnlineState to Offline so get()s return from cache, etc.
        this.Q_.set("Offline" /* Offline */);
    }
    async sl() {
        await this.z_.stop(), await this.W_.stop(), this.k_.length > 0 && (ge("RemoteStore", `Stopping write stream with ${this.k_.length} pending writes`), 
        this.k_ = []), this.il();
    }
    async mo() {
        ge("RemoteStore", "RemoteStore shutting down."), this.networkEnabled = !1, await this.sl(), 
        this.x_.mo(), 
    ...
    tl() {
        this.M_ = new de(this), this.W_.start(), this.Q_.v_();
    }
    /**
    ...
    async G_(t, e) {
        ...
        this.Q_.set("Online" /* Online */), t instanceof _e && 2 /* Removed */ === t.state && t.cause) 
        ...
        !e.isEqual(y.min())) try {
            const t = await this.N_._h();
            e.S(t) >= 0 && 
            // We have received a target change with a global snapshot if the snapshot
            // version is not equal to SnapshotVersion.min().
            await this.cl(e);
        } catch (t) {
            ge("RemoteStore", "Failed to raise snapshot:", t), await this.ul(t);
        }
    }
    /**
     ...
     */    async ul(t) {
        ...
        await this.sl(), this.Q_.set("Offline" /* Offline */), 
        ...
        this.Aa.Ua(async () => {
            ...
            await this.N_._h(), this.O_ = !1, await this.X_();
        });
    }
    /**
    ...
    /** Handles an error on a target */    async al(t) {
        const e = t.cause;
        for (const s of t.targetIds) 
        // A watched target might have been removed already.
        this.L_.has(s) && (await this.ol._l(s, e), this.L_.delete(s), this.M_.removeTarget(s));
    }
    /**
     ...
     */    async el() {
        if (this.ll()) {
            const t = this.k_.length > 0 ? this.k_[this.k_.length - 1].batchId : -1, e = await this.N_.qu(t);
            null === e ? 0 === this.k_.length && this.z_.jc() : (this.dl(e), await this.el());
        }
        this.fl() && this.Tl();
    }
    /**
    ...
    J_() {
        ...
        return this.N_.Jo(this.z_.lastStreamToken).then(() => {
            // Send the write pipeline now that the stream is established.
            for (const t of this.k_) this.z_.a_(t.mutations);
        }).catch(ci);
    }
    u_(t, e) {
        const s = this.k_.shift(), i = Oe.from(s, t, e, this.z_.lastStreamToken);
        return this.ol.Il(i).then(() => this.el());
    }
    async Y_(t) {
        // If the write stream closed due to an error, invoke the error callbacks if
        // there are pending writes.
        t && this.k_.length > 0 && (this.z_.o_ ? 
    ...
    async Rl(t) {
        ...
        if (Bt(t.code)) return ge("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.z_.lastStreamToken), 
        this.z_.lastStreamToken = k.ht, this.N_.Jo(k.ht).catch(ci);
    }
    async wl(t) {
        ...
        if (Bt(e = t.code) && e !== w.ABORTED) {
            ...
            // restart.
                        return this.z_.Wc(), this.ol.Al(e.batchId, t).then(() => this.el());
        }
        var e;
        /**
 ...
 */    }
    ml() {
        return new an(this.T_);
    }
    async U_() {
        this.networkEnabled = !1, await this.sl(), this.Q_.set("Unknown" /* Unknown */), 
    ...
    async Pl() {
        ...
        ge("RemoteStore", "RemoteStore restarting streams for new credential"), await this.U_());
    }
    /**
     * Toggles the network state when the client gains or loses its primary lease.
     */    async Vl(t) {
        this.isPrimary = t, t && this.networkEnabled ? await this.enableNetwork() : t || (await this.sl(), 
        this.Q_.set("Unknown" /* Unknown */));
    }
}
...
class fn {
     ...
     */    static gl(t, e, s) {
        ...
        n && (r = new R(i.error.code, i.error.message))), n ? new fn(t, e, i.state, r) : (pe("SharedClientState", `Failed to parse mutation state for ID '${e}': ${s}`), 
        null);
    }
    pl() {
        const t = {
...
class Tn {
     ...
     */    static gl(t, e) {
        ...
        i && (n = new R(s.error.code, s.error.message))), i ? new Tn(t, s.state, n) : (pe("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    pl() {
        const t = {
 ...
 */ class En {
     ...
     */    static gl(t, e) {
        ...
        return i ? new En(t, n) : (pe("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class In {
     ...
     */    static gl(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new In(e.clientId, e.onlineState) : (pe("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Rn {
    constructor(t, e, s, i, n) {
        if (this.Tr = t, this.platform = e, this.persistenceKey = s, this.vl = i, this.ol = null, 
        this.g_ = null, this.ur = null, this.Sl = this.Dl.bind(this), this.Cl = new Ut(Ce), 
        this.ro = !1, 
        /**
         * Captures WebStorage events that occur before `start()` is called. These
         * events are replayed once `WebStorageSharedClientState` is started.
         */
        this.Fl = [], !Rn.Gh(this.platform)) throw new R(w.UNIMPLEMENTED, "LocalStorage is not available on this platform.");
        // Escape the special characters mentioned here:
        // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions
                const r = s.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.platform.window.localStorage, this.currentUser = n, this.Nl = _n(this.persistenceKey, this.vl), 
        this.$l = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.Cl = this.Cl.Ae(this.vl, new wn), this.kl = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
        this.Ll = new RegExp(`^firestore_mutations_${r}_(\\d+)(?:_(.*))?$`), this.Ml = new RegExp(`^firestore_targets_${r}_(\\d+)$`), 
        this.Ol = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    static Gh(t) {
        return !(!t.window || null == t.window.localStorage);
    }
    async start() {
        // Retrieve the list of existing clients to backfill the data in
        // SharedClientState.
        const t = await this.ol.bo();
        for (const e of t) {
            if (e === this.vl) continue;
            const t = this.getItem(_n(this.persistenceKey, e));
            if (t) {
                const s = En.gl(e, t);
                s && (this.Cl = this.Cl.Ae(s.clientId, s));
            }
        }
        this.xl();
        // Check if there is an existing online state and call the callback handler
        // if applicable.
        const e = this.storage.getItem(this.Ol);
        if (e) {
            const t = this.Bl(e);
            t && this.ql(t);
        }
        for (const t of this.Fl) this.Dl(t);
        this.Fl = [], 
        // Register a window unload hook to remove the client metadata entry from
        // WebStorage even if `shutdown()` was not called.
        this.platform.window.addEventListener("unload", () => this.mo()), this.ro = !0;
    }
    lr(t) {
    ...
    Hl(t) {
        ...
        // by another tab
                if (this.Wl(t)) {
            const s = this.storage.getItem(dn(this.persistenceKey, t));
            if (s) {
                const i = Tn.gl(t, s);
                i && (e = i.state);
            }
    ...
    Zl(t) {
        this.removeItem(dn(this.persistenceKey, t));
    }
    td(t, e, s) {
        this.ed(t, e, s);
    }
    ...
    Dl(t) {
        if (t.storageArea === this.storage) {
            if (ge("SharedClientState", "EVENT", t.key, t.newValue), t.key === this.Nl) return void pe("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Tr.Ua(async () => {
                if (this.ro) {
                    if (null !== t.key) if (this.kl.test(t.key)) {
                        if (null == t.newValue) {
                            const e = this.rd(t.key);
                            return this.hd(e, null);
                        }
                        {
                            const e = this.od(t.key, t.newValue);
                            if (e) return this.hd(e.clientId, e);
                        }
                    } else if (this.Ll.test(t.key)) {
                        if (null !== t.newValue) {
                            const e = this.ad(t.key, t.newValue);
                            if (e) return this.ud(e);
                        }
                    } else if (this.Ml.test(t.key)) {
                        if (null !== t.newValue) {
                            const e = this._d(t.key, t.newValue);
                            if (e) return this.ld(e);
                        }
                    } else if (t.key === this.Ol) {
                        if (null !== t.newValue) {
                            const e = this.Bl(t.newValue);
                            if (e) return this.ql(e);
                        }
 ...
 */ (t.newValue);
    ...
    Kl(t, e, s) {
        const i = new fn(this.currentUser, t, e, s), n = ln(this.persistenceKey, this.currentUser, t);
        this.setItem(n, i.pl());
    }
    zl(t) {
        const e = ln(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    nd(t) {
        const e = {
    ...
    ed(t, e, s) {
        const i = dn(this.persistenceKey, t), n = new Tn(t, e, s);
        this.setItem(i, n.pl());
    }
    /**
    ...
    async ud(t) {
        if (t.user.uid === this.currentUser.uid) return this.ol.dd(t.batchId, t.state, t.error);
    ...
    hd(t, e) {
        const s = e ? this.Cl.Ae(t, e) : this.Cl.remove(t), i = this.Ql(this.Cl), n = this.Ql(s), r = [], h = [];
        return n.forEach(t => {
            i.has(t) || r.push(t);
        }), i.forEach(t => {
            n.has(t) || h.push(t);
...
class An {
    constructor() {
        this.Ed = new wn, this.Id = {}, this.ol = null, this.g_ = null, this.ur = null;
    }
    jl(t) {
        // No op.
    }
    ...
    start() {
        return this.Ed = new wn, Promise.resolve();
    }
    Du(t, e, s) {
        // No op.
    }
 ...
 */ class Vn {
     ...
     */    Vd(t, e) {
        const s = e ? e.gd : new re, i = e ? e.md : this.md;
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (t.type, e.type) || this.query.se(t.doc, e.doc)), this.bd(s);
        const r = e ? this.vd() : [], h = 0 === this.Ad.size && this.fs ? 1 /* Synced */ : 0 /* Local */ , o = h !== this.Rd;
        if (this.Rd = h, 0 !== n.length || o) {
            return {
     ...
     */    bd(t) {
        t && (t.Ts.forEach(t => this.wd = this.wd.add(t)), t.Es.forEach(t => {}), t.Is.forEach(t => this.wd = this.wd.delete(t)), 
        this.fs = t.fs);
    }
    vd() {
        ...
        // updating many documents.
                const t = this.Ad;
        this.Ad = ee(), this.md.forEach(t => {
            this.Cd(t.key) && (this.Ad = this.Ad.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Ad.has(t) || e.push(new Pn(t));
        }), this.Ad.forEach(s => {
    ...
    // PORTING NOTE: Multi-tab only.
    Fd(t) {
        this.wd = t.Ku, this.Ad = ee();
        const e = this.Vd(t.documents);
...
class gn {
    constructor(t, e, s, i) {
        this.Aa = t, this.$d = e, this.updateFunction = s, this.Va = i, this.kd = 5, this.$a = new Ge(this.Aa, "transaction_retry" /* TransactionRetry */);
    }
    /** Runs the transaction and sets the result on deferred. */    Ld() {
        this.Md();
    }
    Md() {
        this.$a.gr(async () => {
            const t = this.$d.ml(), e = this.Od(t);
            e && e.then(e => {
                this.Aa.uo(() => t.commit().then(() => {
                    this.Va.resolve(e);
                }).catch(t => {
                    this.xd(t);
                }));
    ...
    Od(t) {
        try {
            ...
            return !L(e) && e.catch && e.then ? e : (this.Va.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
    ...
    xd(t) {
        this.kd > 0 && this.Bd(t) ? (this.kd -= 1, this.Aa.uo(() => (this.Md(), Promise.resolve()))) : this.Va.reject(t);
    }
    Bd(t) {
...
/** Tracks a limbo resolution. */ class yn {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class bn {
    ...
    s, i, n) {
        this.N_ = t, this.$d = e, this.Ud = s, this.currentUser = i, this.Qd = n, this.Wd = null, 
        this.jd = new Le(t => t.canonicalId()), this.Kd = new Map, 
        /**
         ...
         */
        this.Hd = new Map, this.Yd = new _i, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Jd = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Xd = new Map, this.Zd = os.rh(), this.onlineState = "Unknown" /* Unknown */;
    }
    get tf() {
        return !0;
    }
     ...
     */    async listen(t) {
        ...
        e = i.targetId, this.Ud.Hl(e), s = i.view.Nd(); else {
            const i = await this.N_.Qu(t.ee()), n = this.Ud.Hl(i.targetId);
            e = i.targetId, s = await this.sf(t, e, "current" === n), this.tf && this.$d.listen(i);
        }
        return s;
    }
    /**
     ...
     * snapshot.
     */    async sf(t, e, s) {
        const i = await this.N_.ju(t, 
        /* usePreviousResults= */ !0), n = new Vn(t, i.Ku), r = n.Vd(i.documents), h = ae.ds(e, s && "Offline" /* Offline */ !== this.onlineState), o = n.xn(r, 
        /* updateLimboDocuments= */ this.tf, h);
        this.if(e, o.Sd);
        const a = new pn(t, e, n);
        return this.jd.set(t, a), this.Kd.has(e) ? this.Kd.get(e).push(t) : this.Kd.set(e, [ t ]), 
        o.snapshot;
    }
    /** Stops listening to the query. */    async rl(t) {
        this.ef("unlisten()");
        const e = this.jd.get(t), s = this.Kd.get(e.targetId);
        // Only clean up the query view and target if this is the only query mapped
        // to the target.
                if (s.length > 1) return this.Kd.set(e.targetId, s.filter(e => !e.isEqual(t))), 
        void this.jd.delete(t);
        // No other queries are mapped to the target, clean up the query and the target.
                if (this.tf) {
            // We need to remove the local query target first to allow us to verify
            // whether any other client is still interested in this target.
            this.Ud.Jl(e.targetId), this.Ud.Wl(e.targetId) || await this.N_.Wu(e.targetId, /*keepPersistedTargetData=*/ !1).then(() => {
                this.Ud.Zl(e.targetId), this.$d.rl(e.targetId), this.nf(e.targetId);
            }).catch(ci);
        } else this.nf(e.targetId), await this.N_.Wu(e.targetId, 
     ...
     */    async write(t, e) {
        this.ef("write()");
        try {
            const s = await this.N_.$u(t);
            this.Ud.jl(s.batchId), this.rf(s.batchId, e), await this.hf(s.Dn), await this.$d.el();
        } catch (t) {
            // If we can't persist the mutation, we reject the user callback and
            // don't send the mutation. The user can then retry the write.
            const s = ei(t, "Failed to persist write");
            e.reject(s);
        }
    }
    /**
     ...
     */    runTransaction(t, e, s) {
        new gn(t, this.$d, e, s).Ld();
    }
    async Mu(t) {
        this.ef("applyRemoteEvent()");
        try {
            const e = await this.N_.Mu(t);
            // Update `receivedDocument` as appropriate for any limbo targets.
                        t.as.forEach((t, e) => {
                const s = this.Hd.get(e);
                s && (
                // Since this is a limbo resolution lookup, it's for a single document
                // and it could be added, modified, or removed, but not a combination.
                ve(t.Ts.size + t.Es.size + t.Is.size <= 1), t.Ts.size > 0 ? s.qd = !0 : t.Es.size > 0 ? ve(s.qd) : t.Is.size > 0 && (ve(s.qd), 
                s.qd = !1));
            }), await this.hf(e, t);
        } catch (t) {
            await ci(t);
     ...
     */    Dd(t, e) {
        ...
        }), this.Wd.af(t), this.Wd.i_(s), this.onlineState = t;
    }
    async _l(t, e) {
        this.ef("rejectListens()"), 
        // PORTING NOTE: Multi-tab only.
        this.Ud.td(t, "rejected", e);
        const s = this.Hd.get(t), i = s && s.key;
        if (i) {
            ...
            this.zd = this.zd.remove(i), this.Hd.delete(t), this.uf();
        } else await this.N_.Wu(t, /* keepPersistedTargetData */ !1).then(() => this.nf(t, e)).catch(ci);
    }
    async Il(t) {
        this.ef("applySuccessfulWrite()");
        const e = t.batch.batchId;
        // The local store may or may not be able to apply the write result and
        // raise events immediately (depending on whether the watcher is caught
        // up), so we raise user callbacks first so that they consistently happen
        // before listen events.
                this.cf(e, /*error=*/ null), this._f(e);
        try {
            const s = await this.N_.zo(t);
            this.Ud.Gl(e, "acknowledged"), await this.hf(s);
        } catch (t) {
            await ci(t);
        }
    }
    async Al(t, e) {
        ...
        // listen events.
        this.cf(t, e), this._f(t);
        try {
            const s = await this.N_.Lu(t);
            this.Ud.Gl(t, "rejected", e), await this.hf(s);
        } catch (e) {
            await ci(e);
        }
    }
     ...
     * are acknowledged .
     */    async lf(t) {
        this.$d.q_() || ge("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
            const e = await this.N_.sa();
            if (-1 === e) 
            // Trigger the callback right away if there is no pending writes at the moment.
            return void t.resolve();
            const s = this.Xd.get(e) || [];
            s.push(t), this.Xd.set(e, s);
        } catch (e) {
            const s = ei(e, "Initialization of waitForPendingWrites() operation failed");
            t.reject(s);
        }
    }
    /**
     ...
     * if there are any.
     */    _f(t) {
        (this.Xd.get(t) || []).forEach(t => {
            t.resolve();
        }), this.Xd.delete(t);
    }
    /** Reject all outstanding callbacks waiting for pending writes to complete. */    df(t) {
        this.Xd.forEach(e => {
            e.forEach(e => {
    ...
    rf(t, e) {
        let s = this.Jd[this.currentUser.s()];
        s || (s = new Ut(Ce)), s = s.Ae(t, e), this.Jd[this.currentUser.s()] = s;
    }
    /**
     ...
     */    cf(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (s) {
            const i = s.get(t);
            i && (e ? i.reject(e) : i.resolve(), s = s.remove(t)), this.Jd[this.currentUser.s()] = s;
        }
    }
    nf(t, e = null) {
        this.Ud.Jl(t);
        for (const s of this.Kd.get(t)) this.jd.delete(s), e && this.Wd.ff(s, e);
        if (this.Kd.delete(t), this.tf) {
            this.Yd.nc(t).forEach(t => {
                this.Yd.Ch(t) || 
    ...
    if(t, e) {
        for (const s of e) if (s instanceof mn) this.Yd.yh(s.key, t), this.Ef(s); else if (s instanceof Pn) {
            ge("SyncEngine", "Document no longer in limbo: " + s.key), this.Yd.vh(s.key, t), 
            this.Yd.Ch(s.key) || 
            // We removed the last reference for this key
            this.Tf(s.key);
        } else be();
    ...
    Ef(t) {
        const e = t.key;
        this.zd.get(e) || (ge("SyncEngine", "New document in limbo: " + e), this.Gd.push(e), 
        this.uf());
    }
    /**
     ...
     */    uf() {
        for (;this.Gd.length > 0 && this.zd.size < this.Qd; ) {
            const t = this.Gd.shift(), e = this.Zd.next();
            this.Hd.set(e, new yn(t)), this.zd = this.zd.Ae(t, e), this.$d.listen(new Lt(bt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , je.dr));
        }
    }
    // Visible for testing
    If() {
    ...
    async hf(t, e) {
        ...
        this.jd.forEach((r, h) => {
            n.push(Promise.resolve().then(() => {
                const e = h.view.Vd(t);
                return e.yd ? this.N_.ju(h.query, /* usePreviousResults= */ !1).then(({documents: t}) => h.view.Vd(t, e)) : e;
                // The query has a limit and some docs were removed, so we need
                // to re-run the query against the local store to make sure we
                // didn't lose any good docs that had been past the limit.
                        }).then(t => {
                const n = e && e.as.get(h.targetId), r = h.view.xn(t, 
                /* updateLimboDocuments= */ this.tf, n);
                if (this.if(h.targetId, r.Sd), r.snapshot) {
                    this.tf && this.Ud.td(h.targetId, r.snapshot.fromCache ? "not-current" : "current"), 
                    s.push(r.snapshot);
                    const t = We.ar(h.targetId, r.snapshot);
                    i.push(t);
                }
            }));
        }), await Promise.all(n), this.Wd.i_(s), await this.N_.Bu(i);
    }
    ef(t) {}
    async Pl(t) {
        if (!this.currentUser.isEqual(t)) {
            const e = await this.N_.Du(t);
            this.currentUser = t, 
            // Fails tasks waiting for pending writes requested by previous user.
            this.df("'waitForPendingWrites' promise is rejected due to a user change."), 
            // TODO(b/114226417): Consider calling this only in the primary tab.
            this.Ud.Du(t, e.Fu, e.Nu), await this.hf(e.Cu);
        }
        await this.$d.Pl();
    }
    enableNetwork() {
    ...
    ei(t) {
        const e = this.Hd.get(t);
        if (e && e.qd) return ee().add(e.key);
        {
            let e = ee();
            const s = this.Kd.get(t);
            if (!s) return e;
            for (const t of s) {
...
class vn extends bn {
    ...
    enableNetwork() {
        return this.N_.ao(!0), super.enableNetwork();
    }
    disableNetwork() {
        return this.N_.ao(!1), super.disableNetwork();
    }
    /**
     * Reconcile the list of synced documents in an existing view with those
     * from persistence.
     */    async Af(t) {
        const e = await this.N_.ju(t.query, 
        /* usePreviousResults= */ !0), s = t.view.Fd(e);
        return this.Rf && this.if(t.targetId, s.Sd), s;
    }
    Dd(t, e) {
        // If we are the primary client, the online state of all clients only
        // depends on the online state of the local RemoteStore.
        this.tf && 0 /* RemoteStore */ === e && (super.Dd(t, e), this.Ud.sd(t)), 
        // If we are the secondary client, we explicitly ignore the remote store's
        // online state (the local client may go offline, even though the primary
        // tab remains online) and only apply the primary tab's online state from
        // SharedClientState.
        this.tf || 1 /* SharedClientState */ !== e || super.Dd(t, e);
    }
    async dd(t, e, s) {
        this.ef("applyBatchState()");
        const i = await this.N_.zu(t);
        null !== i ? ("pending" === e ? 
        // If we are the primary client, we need to send this write to the
        // backend. Secondary clients will ignore these writes since their remote
        // connection is disabled.
        await this.$d.el() : "acknowledged" === e || "rejected" === e ? (
        // NOTE: Both these methods are no-ops for batches that originated from
        // other clients.
        this.cf(t, s || null), this.N_.Hu(t)) : be(), await this.hf(i)) : 
    ...
    async Vl(t) {
        if (!0 === t && !0 !== this.Rf) {
            ...
            const t = this.Ud.Ul(), e = await this.mf(t.W(), 
            /*transitionToPrimary=*/ !0);
            this.Rf = !0, await this.$d.Vl(!0);
            for (const t of e) this.$d.listen(t);
        } else if (!1 === t && !1 !== this.Rf) {
            const t = [];
            let e = Promise.resolve();
            this.Kd.forEach((s, i) => {
                this.Ud.Xl(i) ? t.push(i) : e = e.then(() => (this.nf(i), this.N_.Wu(i, 
                /*keepPersistedTargetData=*/ !0))), this.$d.rl(i);
            }), await e, await this.mf(t, 
            /*transitionToPrimary=*/ !1), this.Pf(), this.Rf = !1, await this.$d.Vl(!1);
        }
    }
    Pf() {
        this.Hd.forEach((t, e) => {
            this.$d.rl(e);
        }), this.Yd.rc(), this.Hd = new Map, this.zd = new Ut(C.N);
    }
    /**
     ...
     */    async mf(t, e) {
        ...
        for (const e of t) {
            ...
            if (n && 0 !== n.length) {
                ...
                await this.N_.Wu(e, 
                /*keepPersistedTargetData=*/ !0), t = await this.N_.Qu(n[0].ee());
                for (const t of n) {
                    const e = this.jd.get(t), s = await this.Af(e);
                    s.snapshot && i.push(s.snapshot);
                }
            } else {
                // For queries that never executed on this client, we need to
                // allocate the target in LocalStore and initialize a new View.
                const s = await this.N_.Yu(e);
                t = await this.N_.Qu(s), await this.sf(this.Vf(s), e, 
                /*current=*/ !1);
            }
            s.push(t);
        }
        return this.Wd.i_(i), s;
    }
    /**
    ...
    async fd(t, e, s) {
        ...
        ge("SyncEngine", "Ignoring unexpected query state notification."); else if (this.Kd.has(t)) switch (e) {
          case "current":
          case "not-current":
            {
                const s = await this.N_.Kr(), i = oe.ls(t, "current" === e);
                await this.hf(s, i);
                break;
            }
          ...
          case "rejected":
            await this.N_.Wu(t, 
            /* keepPersistedTargetData */ !0), this.nf(t, s);
            break;
    ...
    async Td(t, e) {
        if (this.Rf) {
            for (const e of t) {
                ...
                const t = await this.N_.Yu(e), s = await this.N_.Qu(t);
                await this.sf(this.Vf(t), s.targetId, 
                /*current=*/ !1), this.$d.listen(s);
            }
            for (const t of e) 
            ...
            await this.N_.Wu(t, /* keepPersistedTargetData */ !1).then(() => {
                this.$d.rl(t), this.nf(t);
            }).catch(ci);
        }
    }
}
 ...
 */ class Dn {
    constructor(t) {
        this.ol = t, this.yf = new Le(t => t.canonicalId()), this.onlineState = "Unknown" /* Unknown */ , 
        this.bf = new Set, this.ol.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let s = !1, i = this.yf.get(e);
        if (i || (s = !0, i = new Sn), s) try {
            i.gf = await this.ol.listen(e);
        } catch (e) {
            const s = ei(e, `Initialization of query '${t.query}' failed`);
            return void t.onError(s);
        }
        this.yf.set(e, i), i.pf.push(t);
        // Run global snapshot listeners if a consistent snapshot has been emitted.
        t.Dd(this.onlineState);
        if (i.gf) {
            t.vf(i.gf) && this.Sf();
        }
    }
    async rl(t) {
        ...
        if (i) {
            const e = i.pf.indexOf(t);
            e >= 0 && (i.pf.splice(e, 1), s = 0 === i.pf.length);
        }
        if (s) return this.yf.delete(e), this.ol.rl(e);
    }
    i_(t) {
        let e = !1;
        for (const s of t) {
            const t = s.query, i = this.yf.get(t);
            if (i) {
                for (const t of i.pf) t.vf(s) && (e = !0);
                i.gf = s;
            }
        }
        e && this.Sf();
    ...
    ff(t, e) {
        const s = this.yf.get(t);
        if (s) for (const t of s.pf) t.onError(e);
 ...
 */ class Cn {
    constructor(t, e, s) {
         ...
         */
        this.Nf = !1, this.$f = null, this.onlineState = "Unknown" /* Unknown */ , this.options = s || {};
    }
    /**
     ...
     */    vf(t) {
        ...
        let e = !1;
        return this.Nf ? this.kf(t) && (this.Ff.next(t), e = !0) : this.Lf(t, this.onlineState) && (this.Mf(t), 
        e = !0), this.$f = t, e;
    }
    onError(t) {
        this.Ff.error(t);
    }
    /** Returns whether a snapshot was raised. */    Dd(t) {
        this.onlineState = t;
        let e = !1;
    ...
    Lf(t, e) {
        ...
        // above) and are waiting for a sync.
                return (!this.options.Of || !s) && (!t.docs.B() || "Offline" /* Offline */ === e);
 ...
 */ class Fn {
    ...
    Zn(t, e, i, n) {
        ...
        return e.te() || i.isEqual(y.min()) ? this.Bf(t, e) : this.xf.Yn(t, n).next(r => {
            const h = this.qf(e, r);
            return (e.oe() || e.ae()) && this.yd(e.Bt, h, n, i) ? this.Bf(t, e) : (Pe() <= s.DEBUG && ge("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", i.toString(), e.toString()), 
            this.xf.Zn(t, e, i).next(t => (
    ...
    Bf(t, e) {
        return Pe() <= s.DEBUG && ge("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.xf.Zn(t, e, y.min());
    }
}
 ...
 */ class Nn {
    constructor(t, e) {
        ...
        this.Qf = new jt(li.Xu);
    }
    Go(t) {
        return xe.resolve(0 === this.Wn.length);
    }
    zo(t, e, s) {
        const i = e.batchId, n = this.Wf(i, "acknowledged");
        ve(0 === n);
    ...
    Xo(t, e, s, i) {
        const n = this.Uf;
        if (this.Uf++, this.Wn.length > 0) {
            this.Wn[this.Wn.length - 1];
        }
        const r = new Me(n, e, s, i);
        this.Wn.push(r);
        // Track references by document key and index collection parents.
        for (const e of i) this.Qf = this.Qf.add(new li(e.key, n)), this.jn.Dr(t, e.key.path.L());
        return xe.resolve(r);
    }
    Zo(t, e) {
    ...
    ea(t, e) {
        const s = e + 1, i = this.Kf(s), n = i < 0 ? 0 : i;
    ...
    Gn(t, e) {
        const s = new li(e, 0), i = new li(e, Number.POSITIVE_INFINITY), n = [];
        return this.Qf.Ke([ s, i ], t => {
            const e = this.jf(t.oc);
            n.push(e);
        }), xe.resolve(n);
    }
    Xn(t, e) {
        let s = new jt(Ce);
        return e.forEach(t => {
            const e = new li(t, 0), i = new li(t, Number.POSITIVE_INFINITY);
            this.Qf.Ke([ e, i ], t => {
                s = s.add(t.oc);
            });
        }), xe.resolve(this.Gf(s));
    }
    nr(t, e) {
        ...
        return this.Qf.Ge(t => {
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === i && (h = h.add(t.oc)), !0);
        }, r), xe.resolve(this.Gf(h));
    }
    Gf(t) {
    ...
    ra(t, e) {
        ve(0 === this.Wf(e.batchId, "removed")), this.Wn.shift();
        let s = this.Qf;
        return xe.forEach(e.mutations, i => {
            const n = new li(i.key, e.batchId);
            return s = s.delete(n), this.hh.Bo(t, i.key);
        }).next(() => {
            this.Qf = s;
        });
    }
    ...
    Ch(t, e) {
        const s = new li(e, 0), i = this.Qf.ze(s);
 ...
 */ class $n {
     ...
     */    Nn(t, e, s) {
        const i = e.key, n = this.docs.get(i), r = n ? n.size : 0, h = this.zf(e);
        return this.docs = this.docs.Ae(i, {
            Mr: e,
            size: h,
            readTime: s
        }), this.size += h - r, this.jn.Dr(t, i.path.L());
    }
    /**
    ...
    Ln(t, e) {
        ...
        return xe.resolve(s ? s.Mr : null);
    }
    getEntries(t, e) {
        let s = Ht();
        return e.forEach(t => {
            const e = this.docs.get(t);
            s = s.Ae(t, e ? e.Mr : null);
        }), xe.resolve(s);
    }
    Zn(t, e, s) {
        let i = Jt();
        ...
        for (;r.$e(); ) {
            const {key: t, value: {Mr: n, readTime: h}} = r.Ne();
 ...
 */ $n.Jr = class extends Be {
    ...
    xn(t) {
        ...
        return this.Dn.forEach((s, i) => {
            i ? e.push(this.th.Nn(t, i, this.readTime)) : this.th.kn(s);
        }), xe.vn(e);
    }
    Mn(t, e) {
...
class kn {
    constructor(t) {
         ...
         */
        this.Yf = new Le(t => t.canonicalId()), 
         ...
         * IDs.
         */
        this.Xf = new _i, this.targetCount = 0, this.Zf = os.nh();
    }
    js(t, e) {
        return this.Yf.forEach((t, s) => e(s)), xe.resolve();
    }
    _h(t) {
    ...
    dh(t, e, s) {
        return s && (this.lastRemoteSnapshotVersion = s), e > this.Jf && (this.Jf = e), 
        xe.resolve();
    }
    Th(t) {
        this.Yf.set(t.target, t);
        const e = t.targetId;
        e > this.highestTargetId && (this.Zf = new os(e), this.highestTargetId = e), t.sequenceNumber > this.Jf && (this.Jf = t.sequenceNumber);
    }
    fh(t, e) {
    ...
    Ah(t, e, s) {
        let i = 0;
        const n = [];
        return this.Yf.forEach((r, h) => {
            h.sequenceNumber <= e && null === s.get(h.targetId) && (this.Yf.delete(r), n.push(this.Rh(t, h.targetId)), 
            i++);
        }), xe.vn(n).next(() => i);
    }
    Vh(t) {
    ...
    gh(t, e) {
        const s = this.Yf.get(e) || null;
        return xe.resolve(s);
    }
    ph(t, e, s) {
        return this.Xf.ec(e, s), xe.resolve();
    }
    bh(t, e, s) {
        this.Xf.ic(e, s);
...
class Ln {
     ...
     */
    constructor(t) {
        this.tT = {}, this.Bh = new je(0), this.qh = !1, this.qh = !0, this.hh = t(this), 
        this.Yh = new kn(this);
        this.jn = new Xe, this.Qn = new $n(this.jn, t => this.hh.eT(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    vo(t) {
        let e = this.tT[t.s()];
        return e || (e = new Nn(this.jn, this.hh), this.tT[t.s()] = e), e;
    }
    Do() {
        return this.Yh;
    }
    ...
    runTransaction(t, e, s) {
        ...
        const i = new Mn(this.Bh.next());
        return this.hh.sT(), s(i).next(t => this.hh.iT(i).next(() => t)).yn().then(t => (i.Un(), 
        t));
    }
    nT(t, e) {
        return xe.Sn(Object.values(this.tT).map(s => () => s.Ch(t, e)));
    }
}
...
class On {
    ...
    yh(t, e, s) {
        return this.rT.yh(s, e), this.aT.delete(s), xe.resolve();
    }
    vh(t, e, s) {
        return this.rT.vh(s, e), this.aT.add(s), xe.resolve();
    }
    Bo(t, e) {
        return this.aT.add(e), xe.resolve();
    }
    removeTarget(t, e) {
        this.rT.nc(e.targetId).forEach(t => this.aT.add(t));
        const s = this.persistence.Do();
        return s.Sh(t, e.targetId).next(t => {
            t.forEach(t => this.aT.add(t));
        }).next(() => s.wh(t, e));
    }
    sT() {
        this.hT = new Set;
    ...
    iT(t) {
        ...
        const e = this.persistence.Co().Yr();
        return xe.forEach(this.aT, s => this.uT(t, s).next(t => {
            t || e.kn(s);
        })).next(() => (this.hT = null, e.apply(t)));
    }
    Wo(t, e) {
        return this.uT(t, e).next(t => {
            t ? this.aT.delete(e) : this.aT.add(e);
        });
    }
    eT(t) {
    ...
    uT(t, e) {
        return xe.Sn([ () => xe.resolve(this.rT.Ch(e)), () => this.persistence.Do().Ch(t, e), () => this.persistence.nT(t, e) ]);
    }
}
...
class xn {
    async initialize(t) {
        this.Ud = this.cT(t), this.persistence = this._T(t), await this.persistence.start(), 
        this.lT = this.dT(t), this.N_ = this.fT(t), this.$d = this.TT(t), this.ol = this.ET(t), 
        this.IT = this.wT(t), this.Ud.g_ = t => this.ol.Dd(t, 1 /* SharedClientState */), 
        this.$d.ol = this.ol, await this.N_.start(), await this.Ud.start(), await this.$d.start(), 
        await this.$d.Vl(this.ol.tf);
    }
    wT(t) {
        return new Dn(this.ol);
    }
    dT(t) {
        return null;
    }
    fT(t) {
        return new ai(this.persistence, new Fn, t.RT);
    }
    _T(t) {
        return new Ln(On.oT);
    }
    TT(t) {
        return new cn(this.N_, t.T_, t.Aa, t => this.ol.Dd(t, 0 /* RemoteStore */), t.platform.AT());
    }
    cT(t) {
        return new An;
    }
    ET(t) {
        return new bn(this.N_, this.$d, this.Ud, t.RT, t.Qd);
    }
    clearPersistence(t) {
 ...
 */ class Bn extends xn {
    async initialize(t) {
        ...
        await this.persistence.no(async t => {
            await this.ol.Vl(t), this.lT && (t && !this.lT.ro ? this.lT.start(this.N_) : t || this.lT.stop());
        });
    }
    fT(t) {
        return new ui(this.persistence, new Fn, t.RT);
    }
    ET(t) {
        const e = new vn(this.N_, this.$d, this.Ud, t.RT, t.Qd);
        return this.Ud instanceof Rn && (this.Ud.ol = e), e;
    }
    dT(t) {
        const e = this.persistence.hh.ko;
        return new hi(e, t.Aa);
    }
    _T(t) {
        const e = Ts.$o(t.mT), s = t.platform.bc(t.mT.ii);
        return new Ts(t.PT.synchronizeTabs, e, t.clientId, t.platform, ri.hu(t.PT.cacheSizeBytes), t.Aa, s, this.Ud);
    }
    cT(t) {
        if (t.PT.VT && t.PT.synchronizeTabs) {
            if (!Rn.Gh(t.platform)) throw new R(w.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const e = Ts.$o(t.mT);
            return new Rn(t.Aa, t.platform, e, t.clientId, t.RT);
        }
        return new An;
    }
    clearPersistence(t) {
        const e = Ts.$o(t);
        return Ts.clearPersistence(e);
    }
}
...
class qn {
     ...
     */
    i) {
        this.platform = t, this.mT = e, this.credentials = s, this.Aa = i, this.clientId = De.cn();
    }
    /**
     ...
     */    start(t, e) {
        ...
        return this.credentials.l(r => {
            if (!n) return n = !0, ge("FirestoreClient", "Initializing. user=", r.uid), this.pT(t, e, r, i).then(s.resolve, s.reject);
            this.Aa.Ua(() => this.Pl(r));
        }), 
        // Block the async queue until initialization is done
        this.Aa.uo(() => s.promise), i.promise;
    }
    /** Enables the network connection and requeues all pending operations. */    enableNetwork() {
        return this.gT(), this.Aa.enqueue(() => this.ol.enableNetwork());
    }
    /**
     ...
     */    async pT(t, e, s, i) {
        try {
            ...
            // provider).
            const n = await this.platform.yT(this.mT), r = this.platform.bc(this.mT.ii), h = function(t, e, s) {
                return new on(t, e, s);
            ...
            await t.initialize({
                ...
                Qd: 100,
                PT: e
            }), this.persistence = t.persistence, this.Ud = t.Ud, this.N_ = t.N_, this.$d = t.$d, 
            this.ol = t.ol, this.lT = t.lT, this.bT = t.IT, 
            // When a user calls clearPersistence() in one client, all other clients
            // need to be terminated to allow the delete to succeed.
            this.persistence.ho(async () => {
     ...
     */    gT() {
        if (this.Aa.La) throw new R(w.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    Pl(t) {
        return this.Aa.Wa(), ge("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.ol.Pl(t);
    }
    /** Disables the network connection. Pending operations will not complete. */    disableNetwork() {
        return this.gT(), this.Aa.enqueue(() => this.ol.disableNetwork());
    }
    terminate() {
        return this.Aa.qa(async () => {
            // PORTING NOTE: LocalStore does not need an explicit shutdown on web.
            this.lT && this.lT.stop(), await this.$d.mo(), await this.Ud.mo(), await this.persistence.mo(), 
     ...
     */    waitForPendingWrites() {
        this.gT();
        const t = new Ke;
        return this.Aa.uo(() => this.ol.lf(t)), t.promise;
    }
    listen(t, e, s) {
        this.gT();
        const i = new Cn(t, e, s);
        return this.Aa.uo(() => this.bT.listen(i)), i;
    }
    rl(t) {
        // Checks for termination but does not raise error, allowing unlisten after
        // termination to be a no-op.
        this.ST || this.Aa.uo(() => this.bT.rl(t));
    }
    async DT(t) {
        this.gT();
        const e = new Ke;
        return await this.Aa.enqueue(async () => {
            try {
                const s = await this.N_.Uu(t);
                ...
                const i = ei(s, `Failed to get document '${t} from cache`);
                e.reject(i);
            }
        }), e.promise;
    }
    async CT(t) {
        ...
        return await this.Aa.enqueue(async () => {
            try {
                const s = await this.N_.ju(t, 
                /* usePreviousResults= */ !0), i = new Vn(t, s.Ku), n = i.Vd(s.documents), r = i.xn(n, 
                /* updateLimboDocuments= */ !1);
                e.resolve(r.snapshot);
            } catch (s) {
                const i = ei(s, `Failed to execute query '${t} against cache`);
                e.reject(i);
            }
        }), e.promise;
    }
    write(t) {
        this.gT();
        const e = new Ke;
        return this.Aa.uo(() => this.ol.write(t, e)), e.promise;
    }
    ii() {
        return this.mT.ii;
    }
    Df(t) {
        this.gT(), this.Aa.uo(() => (this.bT.Df(t), Promise.resolve()));
    }
    Cf(t) {
        // Checks for shutdown but does not raise error, allowing remove after
        // shutdown to be a no-op.
        this.ST || this.Aa.uo(() => (this.bT.Cf(t), Promise.resolve()));
    }
    get ST() {
    ...
    transaction(t) {
        this.gT();
        const e = new Ke;
        return this.Aa.uo(() => (this.ol.runTransaction(this.Aa, t, e), Promise.resolve())), 
        e.promise;
    }
}
...
class Wn {
    ...
    xT(t) {
        return new Qi(Y(t.latitude), Y(t.longitude));
    }
    BT(t) {
    ...
    OT(t) {
        ...
        return s.isEqual(this.firestore.$c) || 
        // TODO(b/64130202): Somehow support foreign references.
        pe(`Document ${i} contains a document ` + "reference within a different database (" + `${s.projectId}/${s.database}) which is not ` + "supported. It will be treated as a reference in the current " + `database (${this.firestore.$c.projectId}/${this.firestore.$c.database}) ` + "instead."), 
        new Yn(i, this.firestore, this.converter);
    }
}
...
class Kn {
    constructor(t) {
        ...
        } else Ri("settings", "non-empty string", "host", t.host), this.host = t.host, Ai("settings", "boolean", "ssl", t.ssl), 
        ...
        Ai("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = ri._u; else {
            if (t.cacheSizeBytes !== jn && t.cacheSizeBytes < ri.cu) throw new R(w.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${ri.cu}`);
 ...
 */ class Gn {
    ...
    constructor(t, e, s = new xn) {
        ...
        this.QT = new ti, this.INTERNAL = {
            delete: async () => {
                // The client must be initalized to ensure that all subsequent API usage
                // throws an exception.
                this.WT(), await this.jT.terminate();
            }
        }, "object" == typeof t.options) {
            // This is very likely a Firebase app object
            // TODO(b/34177605): Can we somehow use instanceof?
            const s = t;
            this.UT = s, this.$c = Gn.KT(s), this.GT = s.name, this.zT = new P(e);
        } else {
            const e = t;
            if (!e.projectId) throw new R(w.INVALID_ARGUMENT, "Must provide projectId");
            this.$c = new ke(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.GT = "[DEFAULT]", this.zT = new m;
        }
        this.HT = s, this.YT = new Kn({});
    }
    get JT() {
        return this.XT || (
        // Lazy initialize UserDataReader once the settings are frozen
        this.XT = new Hi(this.$c, this.YT.ignoreUndefinedProperties)), this.XT;
    }
    settings(t) {
        fi("Firestore.settings", arguments, 1), Ii("Firestore.settings", "object", 1, t);
        const e = new Kn(t);
        if (this.jT && !this.YT.isEqual(e)) throw new R(w.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */
    ...
    enablePersistence(t) {
        var e, s;
        if (this.jT) throw new R(w.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.jT && !this.jT.ST) throw new R(w.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
        const t = new Ke;
        return this.QT.Ma(async () => {
            try {
                const e = this.eE();
                await this.HT.clearPersistence(e), t.resolve();
            } catch (e) {
                t.reject(e);
            }
        }), t.promise;
    ...
    onSnapshotsInSync(t) {
        if (this.WT(), Qn(t)) return this.iE(t);
        {
    ...
    eE() {
        return new $e(this.$c, this.GT, this.YT.host, this.YT.ssl, this.YT.forceLongPolling);
    }
    tE(t, e) {
        const s = this.eE();
        return this.jT = new qn(Ae.nt(), s, this.zT, this.QT), this.jT.start(t, e);
    }
    static KT(t) {
 ...
 */        const i = t.options.projectId;
    ...
    get app() {
        if (!this.UT) throw new R(w.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.UT;
    }
    collection(t) {
        return fi("Firestore.collection", arguments, 1), Ii("Firestore.collection", "non-empty string", 1, t), 
        this.WT(), new sr(v.K(t), this);
    }
    doc(t) {
        return fi("Firestore.doc", arguments, 1), Ii("Firestore.doc", "non-empty string", 1, t), 
        this.WT(), Yn.nE(v.K(t), this);
    }
    collectionGroup(t) {
        if (fi("Firestore.collectionGroup", arguments, 1), Ii("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.WT(), new tr(new bt(v.G, t), this);
    }
    runTransaction(t) {
        return fi("Firestore.runTransaction", arguments, 1), Ii("Firestore.runTransaction", "function", 1, t), 
        this.WT().transaction(e => t(new zn(this, e)));
    }
    batch() {
        return this.WT(), new Hn(this);
    }
    static get logLevel() {
        switch (Pe()) {
          case s.DEBUG:
    ...
    static setLogLevel(t) {
        switch (fi("Firestore.setLogLevel", arguments, 1), Ii("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            Ve(s.DEBUG);
            break;
 ...
 */ class zn {
    ...
    get(t) {
        fi("Transaction.get", arguments, 1);
        const e = hr("Transaction.get", t, this.hE);
        return this.oE.A_([ e.kc ]).then(t => {
            if (!t || 1 !== t.length) return be();
            const s = t[0];
            if (s instanceof gt) return new Xn(this.hE, e.kc, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.aE);
            if (s instanceof Vt) return new Xn(this.hE, e.kc, s, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.aE);
            throw be();
        });
    ...
    set(t, e, s) {
        ...
        const i = hr("Transaction.set", t, this.hE);
        s = ir("Transaction.set", s);
        const [n, r] = ar(i.aE, e, "Transaction.set"), h = s.merge || s.mergeFields ? this.hE.JT.Dc(r, n, s.mergeFields) : this.hE.JT.vc(r, n);
        return this.oE.set(i.kc, h), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return "string" == typeof e || e instanceof ki ? (Ti("Transaction.update", arguments, 3), 
        n = hr("Transaction.update", t, this.hE), r = this.hE.JT.Fc("Transaction.update", e, s, i)) : (fi("Transaction.update", arguments, 2), 
        n = hr("Transaction.update", t, this.hE), r = this.hE.JT.Cc("Transaction.update", e)), 
        this.oE.update(n.kc, r), this;
    }
    delete(t) {
        fi("Transaction.delete", arguments, 1);
        const e = hr("Transaction.delete", t, this.hE);
...
class Hn {
    ...
    set(t, e, s) {
        Ei("WriteBatch.set", arguments, 2, 3), this._E();
        const i = hr("WriteBatch.set", t, this.hE);
        s = ir("WriteBatch.set", s);
        const [n, r] = ar(i.aE, e, "WriteBatch.set"), h = s.merge || s.mergeFields ? this.hE.JT.Dc(r, n, s.mergeFields) : this.hE.JT.vc(r, n);
        return this.uE = this.uE.concat(h.Ac(i.kc, lt.ft())), this;
    }
    update(t, e, s, ...i) {
        let n, r;
        return this._E(), "string" == typeof e || e instanceof ki ? (Ti("WriteBatch.update", arguments, 3), 
        n = hr("WriteBatch.update", t, this.hE), r = this.hE.JT.Fc("WriteBatch.update", e, s, i)) : (fi("WriteBatch.update", arguments, 2), 
        n = hr("WriteBatch.update", t, this.hE), r = this.hE.JT.Cc("WriteBatch.update", e)), 
        this.uE = this.uE.concat(r.Ac(n.kc, lt.exists(!0))), this;
    }
    delete(t) {
        fi("WriteBatch.delete", arguments, 1), this._E();
        const e = hr("WriteBatch.delete", t, this.hE);
        return this.uE = this.uE.concat(new It(e.kc, lt.ft())), this;
    }
    commit() {
 ...
 */ class Yn {
    constructor(t, e, s) {
        this.kc = t, this.firestore = e, this.aE = s, this.jT = this.firestore.WT();
    }
    static nE(t, e, s) {
        ...
        return new Yn(new C(t), e, s);
    }
    get id() {
        return this.kc.path.O();
    }
    get parent() {
        return new sr(this.kc.path.L(), this.firestore, this.aE);
    }
    get path() {
        return this.kc.path.j();
    }
    collection(t) {
        if (fi("DocumentReference.collection", arguments, 1), Ii("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new R(w.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        const e = v.K(t);
        return new sr(this.kc.path.child(e), this.firestore);
    }
    isEqual(t) {
        if (!(t instanceof Yn)) throw vi("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.kc.isEqual(t.kc) && this.aE === t.aE;
    }
    set(t, e) {
        Ei("DocumentReference.set", arguments, 1, 2), e = ir("DocumentReference.set", e);
        const [s, i] = ar(this.aE, t, "DocumentReference.set"), n = e.merge || e.mergeFields ? this.firestore.JT.Dc(i, s, e.mergeFields) : this.firestore.JT.vc(i, s);
        return this.jT.write(n.Ac(this.kc, lt.ft()));
    }
    update(t, e, ...s) {
        let i;
        return "string" == typeof t || t instanceof ki ? (Ti("DocumentReference.update", arguments, 2), 
        i = this.firestore.JT.Fc("DocumentReference.update", t, e, s)) : (fi("DocumentReference.update", arguments, 1), 
        i = this.firestore.JT.Cc("DocumentReference.update", t)), this.jT.write(i.Ac(this.kc, lt.exists(!0)));
    }
    delete() {
        return fi("DocumentReference.delete", arguments, 0), this.jT.write([ new It(this.kc, lt.ft()) ]);
    }
    onSnapshot(...t) {
        ...
        "object" != typeof t[i] || Qn(t[i]) || (s = t[i], bi("DocumentReference.onSnapshot", s, [ "includeMetadataChanges" ]), 
        Ai("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        i++);
        const n = {
            includeMetadataChanges: s.includeMetadataChanges
        };
        return Qn(t[i]) ? e = t[i] : (Ii("DocumentReference.onSnapshot", "function", i, t[i]), 
        wi("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]), wi("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]), 
        e = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        const i = new Un({
            next: t => {
                if (e.next) {
                    ...
                    e.next(new Xn(this.firestore, this.kc, s, t.fromCache, t.hasPendingWrites, this.aE));
                }
            },
            error: s
        }), n = this.jT.listen(bt.Wt(this.kc.path), i, t);
        return () => {
            i.NT(), this.jT.rl(n);
        };
    }
    get(t) {
        return Ei("DocumentReference.get", arguments, 0, 1), rr("DocumentReference.get", t), 
        new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.WT().DT(this.kc).then(t => {
                e(new Xn(this.firestore, this.kc, t, 
    ...
    withConverter(t) {
        return new Yn(this.kc, this.firestore, t);
    }
}
...
class Xn {
    constructor(t, e, s, i, n, r) {
        this.hE = t, this.kc = e, this.fE = s, this.TE = i, this.EE = n, this.aE = r;
    }
    data(t) {
        if (Ei("DocumentSnapshot.data", arguments, 0, 1), t = nr("DocumentSnapshot.data", t), 
        this.fE) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.aE) {
                const e = new Zn(this.hE, this.kc, this.fE, this.TE, this.EE);
                return this.aE.fromFirestore(e, t);
            }
            return new Wn(this.hE, this.hE.rE(), t.serverTimestamps, 
            /* converter= */ void 0).kT(this.fE.Lt());
        }
    }
    get(t, e) {
        if (Ei("DocumentSnapshot.get", arguments, 1, 2), e = nr("DocumentSnapshot.get", e), 
        this.fE) {
            const s = this.fE.data().field(tn("DocumentSnapshot.get", t));
            if (null !== s) {
                return new Wn(this.hE, this.hE.rE(), e.serverTimestamps, this.aE).kT(s);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new Yn(this.kc, this.hE, this.aE);
    }
    get exists() {
        return null !== this.fE;
    }
    get metadata() {
        return new Jn(this.EE, this.TE);
    }
    isEqual(t) {
        if (!(t instanceof Xn)) throw vi("isEqual", "DocumentSnapshot", 1, t);
        return this.hE === t.hE && this.TE === t.TE && this.kc.isEqual(t.kc) && (null === this.fE ? null === t.fE : this.fE.isEqual(t.fE)) && this.aE === t.aE;
    }
}
...
class tr {
    ...
    where(t, e, s) {
        fi("Query.where", arguments, 3), yi("Query.where", 3, s);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const i = function(t, e, s, i) {
            if (!e.some(t => t === i)) throw new R(w.INVALID_ARGUMENT, `Invalid value ${pi(i)} provided to function ` + `${t}() for its ${Di(s)} argument. Acceptable ` + `values: ${e.join(", ")}`);
            return i;
        ...
        n = this.firestore.JT.Nc("Query.where", s, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === i);
        const h = vt.create(r, i, n);
        return this.AE(h), new tr(this.IE.Gt(h), this.firestore, this.aE);
    }
    orderBy(t, e) {
        let s;
        if (Ei("Query.orderBy", arguments, 1, 2), wi("Query.orderBy", "non-empty string", 2, e), 
        ...
        const i = tn("Query.orderBy", t), n = new kt(i, s);
        return this.mE(n), new tr(this.IE.zt(n), this.firestore, this.aE);
    }
    limit(t) {
        return fi("Query.limit", arguments, 1), Ii("Query.limit", "number", 1, t), Si("Query.limit", 1, t), 
        new tr(this.IE.Ht(t), this.firestore, this.aE);
    }
    limitToLast(t) {
        return fi("Query.limitToLast", arguments, 1), Ii("Query.limitToLast", "number", 1, t), 
        Si("Query.limitToLast", 1, t), new tr(this.IE.Yt(t), this.firestore, this.aE);
    }
    startAt(t, ...e) {
        Ti("Query.startAt", arguments, 1);
        const s = this.PE("Query.startAt", t, e, 
        /*before=*/ !0);
        return new tr(this.IE.Jt(s), this.firestore, this.aE);
    }
    startAfter(t, ...e) {
    ...
    endBefore(t, ...e) {
        ...
        /*before=*/ !0);
        return new tr(this.IE.Xt(s), this.firestore, this.aE);
    }
    endAt(t, ...e) {
     ...
     */    VE(t, e) {
        ...
        // results.
                for (const e of this.IE.orderBy) if (e.field.Y()) s.push(X(this.firestore.$c, t.key)); else {
     ...
     */    gE(t, e, s) {
        ...
        for (let s = 0; s < e.length; s++) {
            ...
            if (i[s].field.Y()) {
                ...
                const s = new C(e);
                n.push(X(this.firestore.$c, s));
            } else {
                const e = this.firestore.JT.Nc(t, r);
                n.push(e);
            }
        }
        return new $t(n, s);
    ...
    onSnapshot(...t) {
        ...
        let e, s = {}, i = 0;
        return "object" != typeof t[i] || Qn(t[i]) || (s = t[i], bi("Query.onSnapshot", s, [ "includeMetadataChanges" ]), 
        Ai("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        i++), Qn(t[i]) ? e = t[i] : (Ii("Query.onSnapshot", "function", i, t[i]), wi("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        wi("Query.onSnapshot", "function", i + 2, t[i + 2]), e = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
    ...
    lE(t, e) {
        ...
        const i = new Un({
            next: t => {
                e.next && e.next(new er(this.firestore, this.IE, t, this.aE));
            },
            error: s
        }), n = this.firestore.WT(), r = n.listen(this.IE, i, t);
        return () => {
            i.NT(), n.rl(r);
        };
    }
    ...
    get(t) {
        return Ei("Query.get", arguments, 0, 1), rr("Query.get", t), this.pE(this.IE), new Promise((e, s) => {
            t && "cache" === t.source ? this.firestore.WT().CT(this.IE).then(t => {
                e(new er(this.firestore, this.IE, t, this.aE));
            }, s) : this.dE(e, s, t);
        });
    }
    dE(t, e, s) {
     ...
     */    RE(t) {
        if ("string" == typeof t) {
            ...
            return X(this.firestore.$c, new C(e));
        }
        if (t instanceof Yn) {
            const e = t;
            return X(this.firestore.$c, e.kc);
        }
        throw new R(w.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + `${pi(t)}.`);
    }
    /**
...
class er {
    constructor(t, e, s, i) {
        ...
        this.metadata = new Jn(s.hasPendingWrites, s.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        Ei("QuerySnapshot.forEach", arguments, 1, 2), Ii("QuerySnapshot.forEach", "function", 1, t), 
        this.vE.docs.forEach(s => {
            t.call(e, this.CE(s));
        });
    }
    get query() {
        return new tr(this.bE, this.hE, this.aE);
    }
    docChanges(t) {
        t && (bi("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Ai("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
 ...
 */
        function(t, e, s, i) {
            if (s.ss.B()) {
                ...
                return s.docChanges.map(r => {
                    const h = new Zn(t, r.doc.key, r.doc, s.fromCache, s.ns.has(r.doc.key), i);
                    return e = r.doc, {
                        type: "added",
                        doc: h,
                        oldIndex: -1,
            ...
            }
            {
                ...
                return s.docChanges.filter(t => e || 3 /* Metadata */ !== t.type).map(e => {
                    const r = new Zn(t, e.doc.key, e.doc, s.fromCache, s.ns.has(e.doc.key), i);
                    let h = -1, o = -1;
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof er)) throw vi("isEqual", "QuerySnapshot", 1, t);
        return this.hE === t.hE && this.bE.isEqual(t.bE) && this.vE.isEqual(t.vE) && this.aE === t.aE;
    }
    CE(t) {
        return new Zn(this.hE, t.key, t, this.metadata.fromCache, this.vE.ns.has(t.key), this.aE);
    }
}
...
class sr extends tr {
    ...
    get parent() {
        const t = this.IE.path.L();
        return t.B() ? null : new Yn(new C(t), this.firestore);
    }
    get path() {
        return this.IE.path.j();
    }
    doc(t) {
        if (Ei("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = De.cn()), Ii("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new R(w.INVALID_ARGUMENT, "Document path must be a non-empty string");
        const e = v.K(t);
        return Yn.nE(this.IE.path.child(e), this.firestore, this.aE);
    }
    add(t) {
        fi("CollectionReference.add", arguments, 1), Ii("CollectionReference.add", "object", 1, this.aE ? this.aE.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new sr(this.FE, this.firestore, t);
    }
}
...
function ir(t, e) {
    ...
    if (bi(t, e, [ "merge", "mergeFields" ]), Ai(t, "boolean", "merge", e.merge), mi(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof ki), 
...
function nr(t, e) {
    return void 0 === e ? {} : (bi(t, e, [ "serverTimestamps" ]), Pi(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function rr(t, e) {
    wi(t, "object", 1, e), e && (bi(t, e, [ "source" ]), Pi(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
const cr = ur(Gn, "Use firebase.firestore() instead."), _r = ur(zn, "Use firebase.firestore().runTransaction() instead."), lr = ur(Hn, "Use firebase.firestore().batch() instead."), dr = ur(Yn, "Use firebase.firestore().doc() instead."), fr = ur(Xn), Tr = ur(Zn), Er = ur(tr), Ir = ur(er), wr = ur(sr, "Use firebase.firestore().collection() instead."), Rr = ur(class {
    static delete() {
        return di("FieldValue.delete", arguments), new Oi;
    }
    static serverTimestamp() {
        return di("FieldValue.serverTimestamp", arguments), new xi;
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
        return Ti("FieldValue.arrayUnion", arguments, 1), new Bi(t);
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
        return Ti("FieldValue.arrayRemove", arguments, 1), new qi(t);
    }
    static increment(t) {
        return Ii("FieldValue.increment", "number", 1, t), fi("FieldValue.increment", arguments, 1), 
        new Ui(t);
    }
    isEqual(t) {
        return this === t;
    }
}, "Use FieldValue.<field>() instead."), Ar = ur($i, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), mr = {
    Firestore: cr,
    GeoPoint: Qi,
    Timestamp: p,
    Blob: Ar,
    ...
    FieldPath: ki,
    FieldValue: Rr,
    setLogLevel: Gn.setLogLevel,
    CACHE_SIZE_UNLIMITED: jn
};
...
class Vr {
    constructor() {
        this.NE = () => this.$E(), this.kE = () => this.LE(), this.ME = [], this.OE();
    }
    B_(t) {
        this.ME.push(t);
    }
    ...
    $E() {
        ...
        for (const t of this.ME) t(0 /* AVAILABLE */);
    }
    LE() {
        ge("ConnectivityMonitor", "Network connectivity changed: UNAVAILABLE");
        for (const t of this.ME) t(1 /* UNAVAILABLE */);
    }
 ...
 */
    ...
    }(t, (t, e) => new Gn(t, e, new Bn)), t.registerVersion("@firebase/firestore", "1.14.6");
}
