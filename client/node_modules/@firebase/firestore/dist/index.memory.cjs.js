...
/** Tests `left` and `right` for equality based on the backend semantics. */ function P(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return Ee(t.arrayValue.values || [], e.arrayValue.values || [], P);
...
function O(t, e) {
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return M(t.timestampValue, e.timestampValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = be(x(t.latitude), x(e.latitude));
            return 0 !== n ? n : be(x(t.longitude), x(e.longitude));
...
var Z = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Ee(this.elements, e.elements, P);
    }, t;
}(), H = /** @class */ function() {
    function t(t) {
        this.elements = t;
...
/** Transforms an array value via a remove operation. */ function X(t) {
...
e) {
    ...
    return e.__extends(n, t), n.prototype.at = function(t, e) {
        if (this.Et(t), ge(null != e.transformResults), !this.Rt.Tt(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
    ...
    return e.__extends(n, t), n.prototype.at = function(t, e) {
        ...
        return this.Et(t), this.Rt.Tt(t) ? new yt(this.key, g.min()) : t;
    }, n.prototype.Pt = function(t) {
        return null;
    }, n.prototype.isEqual = function(t) {
...
var ft, lt, pt = function(t, e) {
    ...
    function n(e, n, r, i) {
        var o = this;
        return (o = t.call(this, e, n) || this).kt = r, o.At = !!i.At, o.hasCommittedMutations = !!i.hasCommittedMutations, 
        o;
    }
    ...
    t.prototype.ee = function() {
        if (!this.Ut) if ("F" /* First */ === this.xt) this.Ut = new gt(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
     ...
     */    return e.__extends(n, t), n.create = function(t, e, r) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new _t(t, r) : "in" /* IN */ === e ? new Nt(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new It(t, r) : new n(t, e, r);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && L(this.value) === L(e) && this.fe(O(e, this.value));
    ...
    return e.__extends(n, t), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return B(e) && U(e.arrayValue, this.value);
    }, n;
    ...
    t.prototype._e = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? _.N(_.Z(o.referenceValue), e.key) : O(o, e.field(i.field)), 
     ...
     */ , s) {
        void 0 === i && (i = g.min()), void 0 === o && (o = g.min()), void 0 === s && (s = T.ht), 
...
var kt = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.N, this.root.Re(e, n, this.N).Ae(null, null, Pt.Pe, null, null));
    }, 
 ...
 */ var Yt = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Xe = Ft(), this.Je = new kt(this.N)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Xt.fs(e, n)), new t(g.min(), r, Wt(), qt(), zt());
    }, t;
}(), Xt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    t.prototype.zs = function(t) {
        ...
        if (r) {
            ...
            if (i.qt()) if (0 === n) {
                ...
                // queries.
                var o = new _(i.path);
                this.Qs(e, o, new yt(o, g.min()));
            } else ge(1 === n); else this.Xs(e) !== n && (
    ...
    t.prototype.Js = function(t) {
        ...
        var i = new Jt(t, n, this.xs, this.qs, r);
        return this.qs = qt(), this.Ms = re(), this.xs = new Ut(be), i;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.Ms.get(t);
        return e || (e = new Ut(be), this.Ms = this.Ms.Re(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Ks = function(t) {
        var e = this;
        this.Os.set(t, new ee), this.Ls.ei(t).forEach((function(n) {
 ...
 */ var oe = {
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (ge(void 0 === t || "string" == typeof t), T.fromBase64String(t || "")) : (ge(void 0 === t || t instanceof Uint8Array), 
        T.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.D(t.D());
    }, t.prototype.fromVersion = function(t) {
        return ge(!!t), g.v(this.v(t));
        ...
        return ge(t.length > 4 && "documents" === t.get(4)), t.k(5);
    }, 
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ii = function(t, e) {
        ...
        if ("targetChange" in t) {
            ...
            d.document;
            var y = this.Z(d.document), v = d.readTime ? this.fromVersion(d.readTime) : g.min(), m = new yt(y, v), w = d.removedTargetIds || [];
            e = new $t([], w, m.key, m);
            ...
            var N = t.filter;
            N.targetId;
            var I = N.count || 0, A = new Rt(I), T = N.targetId;
            e = new Kt(T, A);
        }
        return e;
        ...
        if (t.transform) {
            ...
            return ge(!0 === n.exists), new ot(u, a);
        }
        if (t.verify) {
        ...
        var c = null;
        return n.endAt && (c = this.Hi(n.endAt)), new mt(e, i, u, s, a, "F" /* First */ , h, c).ee();
    }, t.prototype.Ki = function(t) {
        var e = this.zi(t.we);
        return null == e ? null : {
            "goog-listen-tags": e
...
function(t, e, n, r, i) {
    ...
    t.prototype.Mn = function(t, e) {
        ...
        return this.Dn.xn(t, e).next((function(r) {
            var i = n.On(t, e, r), o = qt();
            return i.forEach((function(t, e) {
                // TODO(http://b/32275378): Don't conflate missing / deleted.
                e || (e = new yt(t, g.min())), o = o.Re(t, e);
            })), o;
        }));
    }, 
    /**
    ...
    t.prototype.Bn = function(t, e, n) {
        ...
        return this.Nn(t, new _(e)).next((function(t) {
            var e = Ft();
...
/** Represents the database ID a Firestore client is associated with. */ Se.er = -1;
...
var ke = function() {
    ...
    return t.prototype.mr = function(t, e) {
        return this.Er.add(e), De.resolve();
    }, t.prototype.jn = function(t, e) {
        return De.resolve(this.Er.getEntries(e));
    }, t;
}(), Ue = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.L(), r = this.index[e] || new Ut(w.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.q(), n = t.L(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Ut(w.N)).W();
    }, t;
}(), Oe = /** @class */ function() {
    function t(t) {
        this.Ir = t;
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Me(t) {
 ...
 */ var qe = /** @class */ function() {
    ...
    function t() {
        ...
        this.Or = new Le(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Wr = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.Br(), this.Fr ? [ 3 /*break*/ , 2 ] : (this.Fr = !0, (n = he.nt().window) && n.removeEventListener("visibilitychange", this.qr), 
                    [ 4 /*yield*/ , this.Qr(t) ]);
    ...
    t.prototype.jr = function(t) {
                ...
                return e.__awaiter(n, void 0, void 0, (function() {
                    ...
                    return e.__generator(this, (function(e) {
                        switch (e.label) {
                          ...
                          case 1:
                            return e.sent(), r.resolve(), this.Or.reset(), [ 3 /*break*/ , 3 ];

                          case 2:
                            if (!Me(n = e.sent())) throw r.resolve(), n;
                            // Failure will be handled by AsyncQueue
                                                        return pe("AsyncQueue", "Operation failed with retryable error: " + n), 
                            this.Or.lr(i), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.Cr.then((function() {
            return e.kr = !0, t().catch((function(t) {
                ...
                throw e.$r = t, e.kr = !1, de("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.kr = !1, t;
            }));
    ...
    t.prototype.dr = function(t, e, n) {
        ...
        var i = qe.gr(this, t, e, n, (function(t) {
            return r.Gr(t);
        }));
 ...
 */
function xe(t, e) {
    if (de("AsyncQueue", e + ": " + t), Me(t)) return new c(h.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Fe.nh = -1, Fe.rh = 1048576, Fe.hh = 41943040, Fe.sh = 10, Fe.ih = 1e3, Fe.oh = new Fe(Fe.hh, Fe.sh, Fe.ih), 
Fe.DISABLED = new Fe(Fe.nh, 0, 0);
...
var je = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = g.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.mh = new Re(this.dh, this.Dn, this.persistence.Ih()), 
        this.ah.Rh(this.mh)
    ...
    t.prototype.Ah = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return n = this.Dn, r = this.mh, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(e) {
                        ...
                        return o.Dn.Ph(e).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new Re(o.dh, n, o.persistence.Ih()), n.Ph(e);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = e.sent(), [ 2 /*return*/ , (this.Dn = n, this.mh = r, this.ah.Rh(this.mh), 
                    i) ];
                }
            }));
        }));
    ...
    t.prototype.$h = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            ...
            return e.Dn.kh(n, t).next((function(t) {
                return ge(null !== t), r = t.keys(), e.Dn.Lh(n, t);
            })).next((function() {
                return e.Dn.Nh(n);
            })).next((function() {
                return e.mh.qn(n, r);
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // cache.
                                        h instanceof yt && h.version.isEqual(g.min()) ? (
    ...
    t.jh = function(t, e, n) {
        ...
        return ge(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Te.C() - t.Te.C() >= this.Jh || n.ws.size + n.Ts.size + n.Es.size > 0);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return De.forEach(t, (function(t) {
                            return De.forEach(t.Kn, (function(n) {
                                return c.persistence.Yh.to(e, t.targetId, n);
                            })).next((function() {
                                return De.forEach(t.zn, (function(n) {
                  ...
                  case 2:
                    if (!Me(n = e.sent())) throw n;
                    // If `notifyLocalViewChanges` fails, we did not advance the sequence
                    // number for the documents that were included in this transaction.
                    // This might trigger them to be deleted earlier than they otherwise
                    // would have, but it should not invalidate the integrity of the data.
                                        return pe("LocalStore", "Failed to update sequence numbers: " + n), 
                    [ 3 /*break*/ , 3 ];
    ...
    t.prototype.ro = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            ...
            return e.Th.ho(n, t).next((function(i) {
                ...
                r = i, De.resolve(r)) : e.Th.oo(n).next((function(i) {
                    return r = new Dt(t, i, 0 /* Listen */ , n.Wh), e.Th.ao(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
    ...
    t.prototype.ho = function(t, e) {
        var n = this.lh.get(e);
        return void 0 !== n ? De.resolve(this.uh.get(n)) : this.Th.ho(t, e);
    }, 
    /**
    ...
    t.prototype.uo = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? De.resolve() : n.persistence.Yh.removeTarget(t, r);
        })).then((function() {
    ...
    t.prototype.co = function(t, e) {
        ...
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.ho(o, t.ee()).next((function(t) {
                ...
                return n.ah.Bn(o, t, e ? r : g.min(), e ? i : zt());
            })).next((function(t) {
                return {
                    documents: t,
                    _o: i
...
var Be = /** @class */ function() {
    function t() {
        ...
        this.wo = new Ut(ze.To), 
        // A set of outstanding references to a document sorted by target id.
        this.Eo = new Ut(ze.mo)
    ...
    t.prototype.Po = function(t) {
        var e = this, n = _.EMPTY, r = new ze(n, t), i = new ze(n, t + 1), o = [];
        ...
        var e = _.EMPTY, n = new ze(e, t), r = new ze(e, t + 1), i = zt();
        return this.Eo.Ge([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.yo = function(t) {
        var e = new ze(t, 0), n = this.wo.Ke(e);
    ...
    return t.To = function(t, e) {
        return _.N(t.key, e.key) || be(t.bo, e.bo);
    }, 
    /** Compare by ID then by key */ t.mo = function(t, e) {
        return be(t.bo, e.bo) || _.N(t.key, e.key);
    }, t;
}();
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function cn() {
    if ("undefined" == typeof Uint8Array) throw new c(h.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function fn() {
    if (!he.nt().vo) throw new c(h.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var ln = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        We("Blob.fromBase64String", arguments, 1), He("Blob.fromBase64String", "string", 1, e), 
        fn();
        try {
        ...
        if (We("Blob.fromUint8Array", arguments, 1), cn(), !(e instanceof Uint8Array)) throw sn("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(T.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return We("Blob.toBase64", arguments, 0), fn(), this.So.toBase64();
    }, t.prototype.toUint8Array = function() {
        return We("Blob.toUint8Array", arguments, 0), cn(), this.So.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    function t() {
        ...
        for (var n = 0; n < t.length; ++n) if (He("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new c(h.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.Co = new E(t);
    }
 ...
 */
var dn = new RegExp("[~\\*/\\[\\]]"), yn = function(t) {
    this.Fo = t;
}, vn = /** @class */ function(t) {
    function n() {
    ...
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        return new K(t.path, Y.instance);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this, "FieldValue.arrayUnion") || this).ko = e, n;
    }
    return e.__extends(n, t), n.prototype.Ci = function(t) {
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this, "FieldValue.arrayRemove") || this).ko = e, n;
    }
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        // Although array transforms are used with writes, the actual elements
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this, "FieldValue.increment") || this).Oo = e, n;
    }
    return e.__extends(n, t), n.prototype.Ci = function(t) {
        var e = new Tn({
            No: 3 /* Argument */ ,
            methodName: this.Fo
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = Rn(this.Oo, e), r = new J(t.serializer, n);
        return new K(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(yn), En = /** @class */ function() {
    function t(t, e) {
        if (We("GeoPoint", arguments, 2), He("GeoPoint", "number", 1, t), He("GeoPoint", "number", 2, e), 
...
/** A "context" object passed around while parsing user data. */ var Tn = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (An(this.No) && _n.test(t)) throw this.$o('Document fields cannot begin and end with "__"');
    }, t;
}(), Dn = /** @class */ function() {
    function t(t, e, n) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = n || he.nt().Ho(t)
        /** Parse document data from a non-merge set() call. */;
    }
    return t.prototype.Ko = function(t, e) {
        var n = this.zo(0 /* Set */ , t);
        kn("Data must be an object, but it was:", n, e);
        var r = Vn(e, n);
        return new Nn(new at(r), 
    ...
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Yo = function(t, e, n) {
        ...
        kn("Data must be an object, but it was:", r, e);
        var i, o, s = Vn(e, r);
        if (n) {
            for (var u = [], a = 0, f = n; a < f.length; a++) {
                var l = f[a], p = void 0;
                if (l instanceof pn) p = l.Co; else {
    ...
    /** Parse update data from a list of field/value arguments. */ t.prototype.Jo = function(t, e, n, r) {
        ...
        for (var a = [], f = new ht, l = o.length - 1; l >= 0; --l) if (!Un(a, o[l])) {
            var p = o[l], d = s[l], y = i.jo(p);
            if (d instanceof vn) 
            // Add it to the field mask, but don't add anything to updateData.
            a.push(p); else {
                var v = Rn(d, y);
        ...
        var g = new $(a);
        return new In(f.gt(), g, i.fieldTransforms);
    }, 
    ...
    t.prototype.Zo = function(t, e, n) {
        return void 0 === n && (n = !1), Rn(e, this.zo(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
 ...
 */
function Rn(t, e) {
    if (Sn(t)) return kn("Unsupported field value:", e, t), Vn(t, e);
    if (t instanceof yn) 
    ...
    return function(t, e) {
        ...
        if (!An(e.No)) throw e.$o(t.Fo + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.$o("Unsupported field value: " + nn(t));
    }(t, e);
}
...
function Sn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof v || t instanceof En || t instanceof ln || t instanceof gr || t instanceof yn);
}
 ...
 */ function Ln(t, e) {
    if (e instanceof pn) return e.Co;
    if ("string" == typeof e) return Pn(t, e);
 ...
 */ var On = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.ra = 0, this.ha = null, this.stream = null, this.Or = new Le(t, e)
        /**
    ...
    t.prototype.Ea = function(t) {
        ...
        return function(n) {
            e.sr.Sr((function() {
                return e.ra === t ? n() : (pe("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return e.__extends(n, t), n.prototype.Ra = function(t) {
    ...
    n.prototype.start = function() {
        this.ga = !1, t.prototype.start.call(this);
        ...
        ge(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.ga) {
        ...
        // The first response is always the handshake response
                return ge(!t.writeResults || 0 === t.writeResults.length), this.ga = !0, 
        this.listener.Ca();
    }, 
    /**
...
}(On), Cn = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        return (i = t.call(this) || this).ia = e, i.credentials = n, i.serializer = r, i;
    }
    ...
    function t(t) {
        ...
        this.La = Gt(), this.mutations = [], this.Oa = !1, 
        /**
    ...
    return t.prototype.xa = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Ba(), this.mutations.length > 0) throw new c(h.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , r.$a("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((n = i.sent()).forEach((function(t) {
                        t instanceof yt || t instanceof dt ? r.Ua(t) : ve();
                    })), n) ];
                }
            }));
        }));
        ...
        this.write([ new st(t, this.Rt(t)) ]), this.Ma.add(t);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return r.sent(), this.Oa = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    t.prototype.Rt = function(t) {
        var e = this.La.get(t);
        return !this.Ma.has(t) && e ? et.updateTime(e) : et.dt();
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.Ha ? (de(e), this.Ha = !1) : pe("OnlineStateTracker", e);
    ...
    n, r, i, o) {
        ...
        /**
             ...
             * again.
             */
        this.iu = !1, this.nu = o, this.nu.ru((function(t) {
            r.Sr((function() {
                return e.__awaiter(s, void 0, void 0, (function() {
                    return e.__generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.hu() ? (pe("RemoteStore", "Restarting streams for network reachability change."), 
        ...
        this.uu = function(t, e, n) {
            var r = me(t);
            return new Mn(e, r.ia, r.credentials, r.serializer, n);
        }(this.ka, r, {
            ...
            var r = me(t);
            return new qn(e, r.ia, r.credentials, r.serializer, n);
        }(this.ka, r, {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 2:
                    return t.sent(), this.tu.length > 0 && (pe("RemoteStore", "Stopping write stream with " + this.tu.length + " pending writes"), 
    ...
    t.prototype.gu = function(t) {
        ...
        this.su = new ne(this), this.uu.start(), this.au.Ka();
    }, 
    /**
    ...
    }, t.prototype._u = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var r, i, o;
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (this.au.set("Online" /* Online */), !(t instanceof te && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.vu(t) ];
                  ...
                  case 6:
                    if (t instanceof $t ? this.su.Bs(t) : t instanceof Kt ? this.su.zs(t) : this.su.Ws(t), 
                    n.isEqual(g.min())) return [ 3 /*break*/ , 13 ];
                    e.label = 7;

                  case 7:
                    return e.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.Za.xh() ];

                  case 8:
                    return i = e.sent(), n.S(i) >= 0 ? [ 4 /*yield*/ , this.Cu(n) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return pe("RemoteStore", "Failed to raise snapshot:", o = e.sent()), [ 4 /*yield*/ , this.Su(o) ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    // Disable network and raise offline snapshots
                    return r.sent(), this.au.set("Offline" /* Offline */), 
                            ...
                            return e.__generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    ...
                                    return pe("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , this.Za.xh() ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.eu.has(o) ? [ 4 /*yield*/ , this.bu.Du(o, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    e.sent(), this.eu.delete(o), this.su.removeTarget(o), e.label = 3;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return null !== (n = e.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.tu.length && this.fu.la(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.Nu(n), [ 4 /*yield*/ , this.Ru() ];
    ...
    t.prototype.Nu = function(t) {
        ...
        var n = this, r = this.tu.shift(), i = Te.from(r, t, e, this.fu.lastStreamToken);
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            return e.__generator(this, (function(e) {
                ...
                return Vt(t.code) ? [ 2 /*return*/ , (pe("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.fu.lastStreamToken), 
                this.fu.lastStreamToken = T.ht, this.Za.Mh(T.ht).catch(Ge)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                ...
                // logic kick in.
                return Vt(r = t.code) && r !== h.ABORTED ? (n = this.tu.shift(), [ 2 /*return*/ , (this.fu.ca(), 
                this.bu.xu(n.batchId, t).then((function() {
                    return i.Ru();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Bu = function() {
        return new xn(this.ka);
            ...
            return e.__generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    pe("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.ou() ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 2:
                    return (n = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.Au() ];

                  case 3:
                    e.sent(), n = this.au.set("Unknown" /* Unknown */), e.label = 4;
    ...
    function t() {
        this.Hu = new Gn, this.Ku = {}, this.bu = null, this.Wa = null, this.Xn = null;
    }
    return t.prototype.zu = function(t) {
        ...
        return this.Hu = new Gn, Promise.resolve();
    ...
    e) {
        ...
        this.ns = zt(), this.ac = new Yt(t.se.bind(t));
    }
    ...
    t.prototype.cc = function(t, e) {
        var n = this, r = e ? e.lc : new Zt, i = e ? e.ac : this.ac, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, h = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.dc = function(t, e, n) {
        ...
        return this.hc = u, 0 !== o.length || a ? {
            snapshot: new Ht(this.query, t.ac, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ec: s
        } : {
            Ec: s
    ...
    t.prototype.wc = function(t) {
        ...
        // updating many documents.
                var e = this.oc;
        this.oc = zt(), this.ac.forEach((function(e) {
            t.Ic(e.key) && (t.oc = t.oc.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.oc.has(e) || n.push(new Qn(e));
    ...
    t.prototype.Ac = function() {
        return Ht.os(this.query, this.ac, this.ns, 0 /* Local */ === this.hc);
    }, t;
}(), Yn = /** @class */ function() {
    function t(t, e, n, r) {
        this.Pr = t, this.Pc = e, this.updateFunction = n, this.yr = r, this.Vc = 5, this.Or = new Le(this.Pr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.pc = function() {
        ...
        this.Or.lr((function() {
            return e.__awaiter(t, void 0, void 0, (function() {
                var t, n, r = this;
                return e.__generator(this, (function(e) {
                    return t = this.Pc.Bu(), (n = this.gc(t)) && n.then((function(e) {
                        r.Pr.Sr((function() {
...
n) {
    ...
    n, r, i) {
        ...
        /**
             ...
             */
        this.Oc = new Map, this.qc = new Be, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Mc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.xc = new Map, this.Bc = Oe.Ar(), this.onlineState = "Unknown" /* Unknown */;
    }
    return Object.defineProperty(t.prototype, "Uc", {
        get: function() {
            return !0;
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    n = i.targetId, this.Cc.Xu(n), r = i.view.Ac(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.Za.ro(t.ee()) ];

                  case 2:
                    return o = e.sent(), s = this.Cc.Xu(o.targetId), n = o.targetId, [ 4 /*yield*/ , this.Wc(t, n, "current" === s) ];

                  case 3:
                    r = e.sent(), this.Uc && this.Pc.listen(o), e.label = 4;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return i = e.sent(), o = new Wn(t, i._o), s = o.cc(i.documents), u = Xt.fs(n, r && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.dc(s, 
                    /* updateLimboDocuments= */ this.Uc, u), this.jc(n, a.Ec), h = new Zn(t, n, o), 
                    [ 2 /*return*/ , (this.Nc.set(t, h), this.$c.has(n) ? this.$c.get(n).push(t) : this.$c.set(n, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.Qc("unlisten()"), n = this.Nc.get(t), (r = this.$c.get(n.targetId)).length > 1 ? [ 2 /*return*/ , (this.$c.set(n.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.Nc.delete(t)) ] : this.Uc ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Cc.Zu(n.targetId), this.Cc.ic(n.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.Za.uo(n.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Cc.ec(n.targetId), i.Pc.yu(n.targetId), i.Gc(n.targetId);
                    })).catch(Ge) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Gc(n.targetId), [ 4 /*yield*/ , this.Za.uo(n.targetId, 
    ...
    t.prototype.write = function(t, n) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Qc("write()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.Za.gh(t) ];

                  case 2:
                    return r = e.sent(), this.Cc.zu(r.batchId), this.Hc(r.batchId, n), [ 4 /*yield*/ , this.Kc(r.vh) ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.Pc.Ru() ];

                  case 4:
                    return e.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = e.sent(), o = xe(i, "Failed to persist write"), n.reject(o), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Qc("applyRemoteEvent()"), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Za.Bh(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        ge(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? n.Sc = !0 : t.Ts.size > 0 ? ge(n.Sc) : t.Es.size > 0 && (ge(n.Sc), 
                        n.Sc = !1));
                    })), [ 4 /*yield*/ , this.Kc(n, t) ];
    ...
    t.prototype.mc = function(t, e) {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.Cc.Ju(t, "rejected", n), r = this.Oc.get(t), (i = r && r.key) ? (o = (o = new kt(_.N)).Re(i, new yt(i, g.min())), 
                    s = zt().add(i), u = new Jt(g.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Ut(be), o, s), [ 4 /*yield*/ , this.Bh(u) ]) : [ 3 /*break*/ , 2 ];
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Qc("applySuccessfulWrite()"), n = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.Xc(n, /*error=*/ null), this.Jc(n), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Za.Sh(t) ];

                  case 2:
                    return r = e.sent(), this.Cc.Yu(n, "acknowledged"), [ 4 /*yield*/ , this.Kc(r) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // listen events.
                    this.Xc(t, n), this.Jc(t), e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Za.$h(t) ];

                  case 2:
                    return r = e.sent(), this.Cc.Yu(t, "rejected", n), [ 4 /*yield*/ , this.Kc(r) ];
    ...
    t.prototype.Zc = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    this.Pc.hu() || pe("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Za.Oh() ];

                  case 2:
                    return -1 === (n = e.sent()) ? [ 2 /*return*/ , void t.resolve() ] : ((r = this.xc.get(n) || []).push(t), 
                    this.xc.set(n, r), [ 3 /*break*/ , 4 ]);

                  case 3:
                    return i = e.sent(), o = xe(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.tl = function(t) {
        ...
        n || (n = new kt(be)), n = n.Re(t, e), this.Mc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Xc = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof zn ? (this.qc.to(i.key, t), this.il(i)) : i instanceof Qn ? (pe("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        var e = t.key;
        this.Lc.get(e) || (pe("SyncEngine", "New document in limbo: " + e), this.kc.push(e), 
        this.Yc());
    }, 
    /**
    ...
    t.prototype.Yc = function() {
        for (;this.kc.length > 0 && this.Lc.size < this.Dc; ) {
            ...
            this.Oc.set(e, new Hn(t)), this.Lc = this.Lc.Re(t, e), this.Pc.listen(new Dt(mt.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Se.er));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.rl = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return r = [], i = [], o = [], this.Nc.forEach((function(e, u) {
                        o.push(Promise.resolve().then((function() {
                            ...
                            var e = n && n.as.get(u.targetId), o = u.view.dc(t, 
                            /* updateLimboDocuments= */ s.Uc, e);
                            if (s.jc(u.targetId, o.Ec), o.snapshot) {
                                s.Uc && s.Cc.Ju(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), r.push(o.snapshot);
                  ...
                  case 1:
                    return e.sent(), this.Fc.Va(r), [ 4 /*yield*/ , this.Za.Zh(i) ];
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    ...
                    this.Cc.Ah(t, n.ph, n.yh), [ 4 /*yield*/ , this.Kc(n.Vh) ];
        ...
        var e = this.Oc.get(t);
        if (e && e.Sc) return zt().add(e.key);
        var n = zt(), r = this.$c.get(t);
        if (!r) return n;
    ...
    function t(t) {
        this.bu = t, this.al = new Ie((function(t) {
            return t.canonicalId();
    ...
    return t.prototype.listen = function(t) {
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    if (n = t.query, r = !1, (i = this.al.get(n)) || (r = !0, i = new Xn), !r) return [ 3 /*break*/ , 4 ];
                    e.label = 1;

                  case 1:
                    return e.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.bu.listen(n) ];

                  case 2:
                    return o.hl = e.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = e.sent(), u = xe(s, "Initialization of query '" + t.query + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.al.set(n, i), i.ol.push(t), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var n, r, i, o;
            return e.__generator(this, (function(e) {
                return n = t.query, r = !1, (i = this.al.get(n)) && (o = i.ol.indexOf(t)) >= 0 && (i.ol.splice(o, 1), 
                r = 0 === i.ol.length), r ? [ 2 /*return*/ , (this.al.delete(n), this.bu.yu(n)) ] : [ 2 /*return*/ ];
            }));
        }));
    ...
    return t.prototype.cl = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Ht(t.query, t.docs, t.ss, e, t.ns, t.fromCache, t.rs, 
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.mc = function(t) {
        ...
        t = Ht.os(t.query, t.docs, t.ns, t.fromCache), this.wl = !0, this.dl.next(t);
    }, t;
}(), tr = /** @class */ function() {
    function t() {}
    return t.prototype.Rh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(g.min()) ? this.Pl(t, e) : this.Al.qn(t, i).next((function(s) {
            var u = o.Vl(e, s);
            return (e.oe() || e.ae()) && o.fc(e.xt, u, i, n) ? o.Pl(t, e) : (fe() <= r.LogLevel.DEBUG && pe("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            o.Al.Bn(t, e, n).next((function(t) {
    ...
    t.prototype.fc = function(t, e, n, r) {
        ...
        return fe() <= r.LogLevel.DEBUG && pe("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.Al.Bn(t, e, g.min());
    }, t;
}(), er = /** @class */ function() {
    function t(t, e) {
        this.Fn = t, this.Yh = e, 
    ...
    return t.prototype.gl = function(t) {
        ...
        var o = new Ae(i, e, n, r);
        this.Dn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.yl = this.yl.add(new ze(a.key, i)), this.Fn.mr(t, a.key.path.L());
        }
        return De.resolve(o);
    }, t.prototype.kh = function(t, e) {
        return De.resolve(this.vl(e));
        ...
        return De.resolve(0 === this.Dn.length ? -1 : this.pl - 1);
    }, t.prototype.Ph = function(t) {
        return De.resolve(this.Dn.slice());
    }, t.prototype.$n = function(t, e) {
        var n = this, r = new ze(e, 0), i = new ze(e, Number.POSITIVE_INFINITY), o = [];
        return this.yl.Ge([ r, i ], (function(t) {
            var e = n.vl(t.bo);
            o.push(e);
        })), De.resolve(o);
    }, t.prototype.xn = function(t, e) {
        var n = this, r = new Ut(be);
        return e.forEach((function(t) {
            var e = new ze(t, 0), i = new ze(t, Number.POSITIVE_INFINITY);
            n.yl.Ge([ e, i ], (function(t) {
                r = r.add(t.bo);
            }));
        })), De.resolve(this.Cl(r));
        ...
        // because it precedes all other segments in an ordered traversal.
                _.et(i) || (i = i.child(""));
        var o = new ze(new _(i), 0), s = new Ut(be);
        ...
        var n = this;
        ge(0 === this.bl(e.batchId, "removed")), this.Dn.shift();
        var r = this.yl;
        return De.forEach(e.mutations, (function(i) {
            var o = new ze(i.key, e.batchId);
        ...
        var n = new ze(e, 0), r = this.yl.Ke(n);
 ...
 */
nr.Ll = /** @class */ function(t) {
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Ql = e, n;
    }
    ...
    t.prototype.Ln = function(t, e) {
        this.xl();
        var n = this.vh.get(e);
        return void 0 !== n ? De.resolve(n) : this.Bl(t, e);
    }, 
    /**
...
var rr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Gl = new Be, this.targetCount = 0, this.Hl = Oe.Rr();
    }
    return t.prototype.js = function(t, e) {
        ...
        return De.resolve(this.jl);
    }, t.prototype.oo = function(t) {
        return this.highestTargetId = this.Hl.next(), De.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Hl = new Oe(e), this.highestTargetId = e), t.sequenceNumber > this.jl && (this.jl = t.sequenceNumber);
    }, t.prototype.ao = function(t, e) {
        return this.zl(e), this.targetCount += 1, De.resolve();
    }, t.prototype.Gh = function(t, e) {
        return this.zl(e), De.resolve();
        ...
        return this.Gl.Io(e, n), De.resolve();
        ...
        return this.Gl.Po(e), De.resolve();
    }, t.prototype.lo = function(t, e) {
        var n = this.Gl.po(e);
        return De.resolve(n);
    }, t.prototype.yo = function(t, e) {
        return De.resolve(this.Gl.yo(e));
    }, t;
}(), ir = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.t_ = {}, this.e_ = new Se(0), this.s_ = !1, this.s_ = !0, this.Yh = t(this), 
        this.Th = new rr(this), this.Fn = new Pe, this.Cn = new nr(this.Fn, (function(t) {
            return e.Yh.i_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.t_[t.s()];
        return e || (e = new er(this.Fn, this.Yh), this.t_[t.s()] = e), e;
        ...
        return De.Sn(Object.values(this.t_).map((function(n) {
            return function() {
                return n.yo(t, e);
            };
        })));
    ...
    function n(e) {
        var n = this;
        return (n = t.call(this) || this).Wh = e, n;
    }
    /**
    ...
    return t.d_ = function(e) {
        ...
        return this.__.to(n, e), this.w_.delete(n), De.resolve();
    }, t.prototype.eo = function(t, e, n) {
        return this.__.eo(n, e), this.w_.add(n), De.resolve();
    }, t.prototype.Dl = function(t, e) {
        return this.w_.add(e), De.resolve();
        ...
        // Remove newly orphaned documents.
                return De.forEach(this.w_, (function(r) {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), this.I_ = this.R_(t), this.Za = this.A_(t), this.Pc = this.P_(t), 
                    this.bu = this.V_(t), this.p_ = this.y_(t), this.Cc.Wa = function(t) {
                        return n.bu.mc(t, 1 /* SharedClientState */);
                    }, this.Pc.bu = this.bu, [ 4 /*yield*/ , this.Za.start() ];

                  case 2:
                    return e.sent(), [ 4 /*yield*/ , this.Cc.start() ];

                  case 3:
                    return e.sent(), [ 4 /*yield*/ , this.Pc.start() ];

                  case 4:
                    return e.sent(), [ 4 /*yield*/ , this.Pc.Qu(this.bu.Uc) ];
     ...
     */
    r) {
        this.platform = t, this.v_ = e, this.credentials = n, this.Pr = r, this.clientId = we.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials._((function(s) {
            if (!o) return o = !0, pe("FirestoreClient", "Initializing. user=", s.uid), n.C_(t, e, s, i).then(r.resolve, r.reject);
            n.Pr.jr((function() {
                return n.Uu(s);
            }));
        })), 
     ...
     *     succeeded.
     */
    t.prototype.C_ = function(t, n, r, i) {
        return e.__awaiter(this, void 0, void 0, (function() {
            var o, s, u, a, h = this;
            return e.__generator(this, (function(c) {
                switch (c.label) {
                  case 0:
                    return c.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.D_(this.v_) ];

                  case 1:
                    return o = c.sent(), s = this.platform.Ho(this.v_.ii), u = function(t, e, n) {
                        return new Cn(t, e, n);
                  ...
                  case 2:
                    return c.sent(), this.persistence = t.persistence, this.Cc = t.Cc, this.Za = t.Za, 
    ...
    t.prototype.S_ = function() {
        ...
        return this.Pr.Hr(), pe("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.bu.Uu(t);
    }, 
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    return this.S_(), n = new ke, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            var r, i, o;
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Za.no(t) ];
                                  ...
                                  case 2:
                                    return i = e.sent(), o = xe(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.S_(), n = new ke, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return e.__awaiter(r, void 0, void 0, (function() {
                            ...
                            return e.__generator(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Za.co(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return r = e.sent(), i = new Wn(t, r._o), o = i.cc(r.documents), s = i.dc(o, 
                                    /* updateLimboDocuments= */ !1), n.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = e.sent(), a = xe(u, "Failed to execute query '" + t + " against cache"), 
...
var fr = /** @class */ function() {
    ...
    return t.prototype.Q_ = function(t) {
        ...
        return new En(x(t.latitude), x(t.longitude));
    }, t.prototype.K_ = function(t) {
        var e = this;
        ...
        var e = w.G(t);
        ge(ae(e));
        var n = new Ne(e.get(1), e.get(3)), r = new _(e.k(5));
        return n.isEqual(this.firestore.ta) || 
        // TODO(b/64130202): Somehow support foreign references.
        de("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.ta.projectId + "/" + this.firestore.ta.database + ") instead."), 
        new gr(r, this.firestore, this.converter);
    }, t;
}(), lr = Fe.nh, pr = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new c(h.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else Xe("settings", "non-empty string", "host", t.host), this.host = t.host, $e("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (on("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        $e("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        $e("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), $e("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        $e("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Fe.hh; else {
            if (t.cacheSizeBytes !== lr && t.cacheSizeBytes < Fe.rh) throw new c(h.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Fe.rh);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        $e("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(n, r, i) {
        var o = this;
        if (void 0 === i && (i = new ur), this.Y_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.X_ = new Ce, this.INTERNAL = {
            delete: function() {
            ...
            var s = n;
            this.Y_ = s, this.ta = t.tf(s), this.ef = s.name, this.sf = new p(r);
        } else {
            var u = n;
            if (!u.projectId) throw new c(h.INVALID_ARGUMENT, "Must provide projectId");
            this.ta = new Ne(u.projectId, u.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.ef = "[DEFAULT]", this.sf = new l;
        }
        this.if = i, this.nf = new pr({});
    }
    return Object.defineProperty(t.prototype, "rf", {
        get: function() {
            return this.hf || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.hf = new Dn(this.ta, this.nf.ignoreUndefinedProperties)), this.hf;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.settings = function(t) {
        We("Firestore.settings", arguments, 1), He("Firestore.settings", "object", 1, t);
        var e = new pr(t);
        if (this.Z_ && !this.nf.isEqual(e)) throw new c(h.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        var e, n;
        if (this.Z_) throw new c(h.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            var t, n = this;
            return e.__generator(this, (function(r) {
                if (void 0 !== this.Z_ && !this.Z_.O_) throw new c(h.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new ke, [ 2 /*return*/ , (this.X_.xr((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        var n, r;
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), n = this.cf(), [ 4 /*yield*/ , this.if.clearPersistence(n) ];
        ...
        if (this.J_(), cr(t)) return this._f(t);
        ...
        return new _e(this.ta, this.ef, this.nf.host, this.nf.ssl, this.nf.forceLongPolling);
    }, t.prototype.uf = function(t, e) {
        var n = this.cf();
        return this.Z_ = new ar(he.nt(), n, this.sf, this.X_), this.Z_.start(t, e);
    }, t.tf = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new c(h.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        get: function() {
            if (!this.Y_) throw new c(h.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Y_;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        return We("Firestore.collection", arguments, 1), He("Firestore.collection", "non-empty string", 1, t), 
        this.J_(), new Nr(w.G(t), this);
    }, t.prototype.doc = function(t) {
        return We("Firestore.doc", arguments, 1), He("Firestore.doc", "non-empty string", 1, t), 
        this.J_(), gr.ff(w.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (We("Firestore.collectionGroup", arguments, 1), He("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.J_(), new Er(new mt(w.H, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return We("Firestore.runTransaction", arguments, 1), He("Firestore.runTransaction", "function", 1, t), 
        this.J_().transaction((function(n) {
            return t(new yr(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.J_(), new vr(this);
        ...
        switch (We("Firestore.setLogLevel", arguments, 1), He("Firestore.setLogLevel", "non-empty string", 1, t), 
        t) {
          case "debug":
            le(r.LogLevel.DEBUG);
            break;
    ...
    return t.prototype.get = function(t) {
        var e = this;
        We("Transaction.get", arguments, 1);
        var n = Dr("Transaction.get", t, this.wf);
        return this.Tf.xa([ n.ea ]).then((function(t) {
            if (!t || 1 !== t.length) return ve();
            var r = t[0];
            if (r instanceof yt) return new wr(e.wf, n.ea, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Ef);
            if (r instanceof dt) return new wr(e.wf, n.ea, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Ef);
            throw ve();
        }));
        ...
        var r = Dr("Transaction.set", t, this.wf);
        n = Ir("Transaction.set", n);
        var i = Vr(r.Ef, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.wf.rf.Yo(s, o, n.mergeFields) : this.wf.rf.Ko(s, o);
        return this.Tf.set(r.ea, u), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof pn ? (Ye("Transaction.update", arguments, 3), 
        r = Dr("Transaction.update", t, this.wf), i = this.wf.rf.Jo("Transaction.update", e, n, o)) : (We("Transaction.update", arguments, 2), 
        r = Dr("Transaction.update", t, this.wf), i = this.wf.rf.Xo("Transaction.update", e)), 
        this.Tf.update(r.ea, i), this;
    }, t.prototype.delete = function(t) {
        We("Transaction.delete", arguments, 1);
        var e = Dr("Transaction.delete", t, this.wf);
    ...
    return t.prototype.set = function(t, e, n) {
        Ze("WriteBatch.set", arguments, 2, 3), this.Rf();
        var r = Dr("WriteBatch.set", t, this.wf);
        n = Ir("WriteBatch.set", n);
        var i = Vr(r.Ef, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.wf.rf.Yo(s, o, n.mergeFields) : this.wf.rf.Ko(s, o);
        return this.mf = this.mf.concat(u.xo(r.ea, et.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Rf(), "string" == typeof e || e instanceof pn ? (Ye("WriteBatch.update", arguments, 3), 
        r = Dr("WriteBatch.update", t, this.wf), i = this.wf.rf.Jo("WriteBatch.update", e, n, o)) : (We("WriteBatch.update", arguments, 2), 
        r = Dr("WriteBatch.update", t, this.wf), i = this.wf.rf.Xo("WriteBatch.update", e)), 
        this.mf = this.mf.concat(i.xo(r.ea, et.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        We("WriteBatch.delete", arguments, 1), this.Rf();
        var e = Dr("WriteBatch.delete", t, this.wf);
        return this.mf = this.mf.concat(new st(e.ea, et.dt())), this;
    }, t.prototype.commit = function() {
        return this.Rf(), this.If = !0, this.mf.length > 0 ? this.wf.J_().write(this.mf) : Promise.resolve();
    }, t.prototype.Rf = function() {
        if (this.If) throw new c(h.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), gr = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.ff = function(e, n, r) {
        ...
        get: function() {
            return new Nr(this.ea.path.L(), this.firestore, this.Ef);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (We("DocumentReference.collection", arguments, 1), He("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new c(h.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = w.G(t);
        return new Nr(this.ea.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        ...
        Ze("DocumentReference.set", arguments, 1, 2), e = Ir("DocumentReference.set", e);
        var n = Vr(this.Ef, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.rf.Yo(i, r, e.mergeFields) : this.firestore.rf.Ko(i, r);
        return this.Z_.write(o.xo(this.ea, et.dt()));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof pn ? (Ye("DocumentReference.update", arguments, 2), 
        n = this.firestore.rf.Jo("DocumentReference.update", t, e, r)) : (We("DocumentReference.update", arguments, 1), 
        n = this.firestore.rf.Xo("DocumentReference.update", t)), this.Z_.write(n.xo(this.ea, et.exists(!0)));
    }, t.prototype.delete = function() {
        return We("DocumentReference.delete", arguments, 0), this.Z_.write([ new st(this.ea, et.dt()) ]);
        ...
        "object" != typeof t[i] || cr(t[i]) || (on("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        $e("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return cr(t[i]) ? n = t[i] : (He("DocumentReference.onSnapshot", "function", i, t[i]), 
        Je("DocumentReference.onSnapshot", "function", i + 1, t[i + 1]), Je("DocumentReference.onSnapshot", "function", i + 2, t[i + 2]), 
        n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new hr({
            next: function(t) {
                if (e.next) {
                    ...
                    e.next(new wr(n.firestore, n.ea, r, t.fromCache, t.hasPendingWrites, n.Ef));
                }
            },
            error: r
        }), o = this.Z_.listen(mt.Wt(this.ea.path), i, t);
        return function() {
            i.B_(), n.Z_.yu(o);
        };
    }, t.prototype.get = function(t) {
        var e = this;
        return Ze("DocumentReference.get", arguments, 0, 1), Tr("DocumentReference.get", t), 
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.J_().q_(e.ea).then((function(t) {
                n(new wr(e.firestore, e.ea, t, 
                /*fromCache=*/ !0, t instanceof dt && t.At, e.Ef));
            }), r) : e.Pf(n, r, t);
        }));
    ...
    return t.prototype.data = function(t) {
        if (Ze("DocumentSnapshot.data", arguments, 0, 1), t = Ar("DocumentSnapshot.data", t), 
        this.Vf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Ef) {
                var e = new br(this.wf, this.ea, this.Vf, this.pf, this.yf);
                return this.Ef.fromFirestore(e, t);
            }
            return new fr(this.wf, this.wf.df(), t.serverTimestamps, 
            /* converter= */ void 0).Q_(this.Vf.Lt());
        }
    }, t.prototype.get = function(t, e) {
        if (Ze("DocumentSnapshot.get", arguments, 1, 2), e = Ar("DocumentSnapshot.get", e), 
        this.Vf) {
            var n = this.Vf.data().field(Ln("DocumentSnapshot.get", t));
            if (null !== n) return new fr(this.wf, this.wf.df(), e.serverTimestamps, this.Ef).Q_(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.ea.path.q();
        ...
        get: function() {
            return new gr(this.ea, this.wf, this.Ef);
        },
        enumerable: !0,
        configurable: !0
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = function(t, e, n, r) {
            ...
            return r;
        }(0, [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 0, n), s = Ln("Query.where", e);
        if (s.Y()) {
        ...
        return this.Sf(p), new t(this.gf.Ht(p), this.firestore, this.Ef);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (Ze("Query.orderBy", arguments, 1, 2), Je("Query.orderBy", "non-empty string", 2, n), 
        ...
        if (null !== this.gf.startAt) throw new c(h.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.gf.endAt) throw new c(h.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = Ln("Query.orderBy", e), o = new Tt(i, r);
        return this.Cf(o), new t(this.gf.Kt(o), this.firestore, this.Ef);
    }, t.prototype.limit = function(e) {
        return We("Query.limit", arguments, 1), He("Query.limit", "number", 1, e), un("Query.limit", 1, e), 
        new t(this.gf.zt(e), this.firestore, this.Ef);
    }, t.prototype.limitToLast = function(e) {
        return We("Query.limitToLast", arguments, 1), He("Query.limitToLast", "number", 1, e), 
        un("Query.limitToLast", 1, e), new t(this.gf.Yt(e), this.firestore, this.Ef);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Ye("Query.startAt", arguments, 1);
        var i = this.Df("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(this.gf.Xt(i), this.firestore, this.Ef);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Ye("Query.startAfter", arguments, 1);
        var i = this.Df("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(this.gf.Xt(i), this.firestore, this.Ef);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Ye("Query.endBefore", arguments, 1);
        var i = this.Df("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(this.gf.Jt(i), this.firestore, this.Ef);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        Ye("Query.endAt", arguments, 1);
    ...
    t.prototype.Ff = function(t, e) {
        ...
        for (var n = [], r = 0, i = this.gf.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(j(this.firestore.ta, t.key)); else {
    ...
    t.prototype.Nf = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.Y()) {
                ...
                if (!this.gf.le() && -1 !== s.indexOf("/")) throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.gf.path.child(w.G(s));
                ...
                var a = new _(u);
                i.push(j(this.firestore.ta, a));
            } else {
                var f = this.firestore.rf.Zo(t, s);
                i.push(f);
            }
        }
        return new At(i, n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || cr(t[i]) || (on("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        $e("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), cr(t[i]) ? n = t[i] : (He("Query.onSnapshot", "function", i, t[i]), Je("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        Je("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        ...
        var i = new hr({
            next: function(t) {
                e.next && e.next(new _r(n.firestore, n.gf, t, n.Ef));
            },
            error: r
        ...
        var e = this;
        return Ze("Query.get", arguments, 0, 1), Tr("Query.get", t), this.$f(this.gf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.J_().M_(e.gf).then((function(t) {
                n(new _r(e.firestore, e.gf, t, e.Ef));
            }), r) : e.Pf(n, r, t);
        }));
    }, t.prototype.Pf = function(t, e, n) {
        var r = this.Af({
    ...
    t.prototype.vf = function(t) {
        if ("string" == typeof t) {
            ...
            if (!this.gf.le() && -1 !== t.indexOf("/")) throw new c(h.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.gf.path.child(w.G(t));
            ...
            return j(this.firestore.ta, new _(e));
        }
        if (t instanceof gr) {
            var n = t;
            return j(this.firestore.ta, n.ea);
        }
    ...
    function t(t, e, n, r) {
        ...
        this.metadata = new mr(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        Ze("QuerySnapshot.forEach", arguments, 1, 2), He("QuerySnapshot.forEach", "function", 1, t), 
        this.Of.docs.forEach((function(r) {
            t.call(e, n.xf(r));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Er(this.Lf, this.wf, this.Ef);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (on("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), $e("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.Of.hs) throw new c(h.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e, n, r) {
            if (n.ss.M()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new br(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new br(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return new br(this.wf, t.key, t, this.metadata.fromCache, this.Of.ns.has(t.key), this.Ef);
    }, t;
}(), Nr = /** @class */ function(t) {
    function n(e, n, r) {
        var i = this;
        if ((i = t.call(this, mt.Wt(e), n, r) || this).Bf = e, e.length % 2 != 1) throw new c(h.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + e.j() + " has " + e.length);
        return i;
    }
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.M() ? null : new gr(new _(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = we.cn()), He("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new c(h.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = w.G(t);
        return gr.ff(this.gf.path.child(e), this.firestore, this.Ef);
    }, n.prototype.add = function(t) {
        We("CollectionReference.add", arguments, 1), He("CollectionReference.add", "object", 1, this.Ef ? this.Ef.toFirestore(t) : t);
        var e = this.doc();
...
function Ir(t, e) {
    ...
    if (on(t, e, [ "merge", "mergeFields" ]), $e(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function Ar(t, e) {
    return void 0 === e ? {} : (on(t, e, [ "serverTimestamps" ]), Ke(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Tr(t, e) {
    Je(t, "object", 1, e), e && (on(t, e, [ "source" ]), Ke(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var kr = Sr(dr, "Use firebase.firestore() instead."), Lr = Sr(yr, "Use firebase.firestore().runTransaction() instead."), Pr = Sr(vr, "Use firebase.firestore().batch() instead."), Ur = Sr(gr, "Use firebase.firestore().doc() instead."), Or = Sr(wr), Mr = Sr(br), qr = Sr(Er), Cr = Sr(_r), xr = Sr(Nr, "Use firebase.firestore().collection() instead."), Fr = Sr(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        return Qe("FieldValue.delete", arguments), new vn;
    }, t.serverTimestamp = function() {
        return Qe("FieldValue.serverTimestamp", arguments), new gn;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return Ye("FieldValue.arrayUnion", arguments, 1), new mn(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return Ye("FieldValue.arrayRemove", arguments, 1), new wn(t);
    }, t.increment = function(t) {
        return He("FieldValue.increment", "number", 1, t), We("FieldValue.increment", arguments, 1), 
        new bn(t);
    }, t.prototype.isEqual = function(t) {
        return this === t;
    }, t;
}(), "Use FieldValue.<field>() instead."), jr = Sr(ln, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), Gr = {
    Firestore: kr,
    GeoPoint: En,
    Timestamp: v,
    Blob: jr,
    ...
    FieldPath: pn,
    FieldValue: Fr,
    setLogLevel: dr.setLogLevel,
    CACHE_SIZE_UNLIMITED: lr
}, Br = /** @class */ function() {
    function t() {}
    ...
    Commit: "commit"
}, Yr = "gl-js/ fire/" + u, Zr = /** @class */ function() {
    function t(t) {
        this.ii = t.ii;
     ...
     */    return t.prototype.rd = function(t, e) {
        ...
        var n = [ this.nd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = s.createWebChannelTransport(), o = {
        ...
        this.rd(o.initMessageHeaders, e), 
        ...
        var a = r.createWebChannel(u, o), f = !1, l = !1, p = new Qr({
            zf: function(t) {
        ...
        return d(s.WebChannel.EventType.OPEN, (function() {
            ...
            l || (l = !0, pe("Connection", "WebChannel transport closed"), p.ed());
        })), d(s.WebChannel.EventType.ERROR, (function(t) {
            l || (l = !0, pe("Connection", "WebChannel transport errored:", t), p.ed(new c(h.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!l) {
                ...
                if (i) {
                    ...
                    l = !0, p.ed(new c(s, u)), a.close();
                } else pe("Connection", "WebChannel received:", n), p.sd(n);
            }
        })), setTimeout((function() {
 ...
 */
    !function(t, e) {
        t.INTERNAL.registerComponent(new o.Component("firestore", (function(t) {
            return function(t, e) {
                return new dr(t, e, new ur);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Gr)));
...
he.an(new (/** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "document", {
        ...
        return Promise.resolve(new Zr(t));
    }, t.prototype.b_ = function() {
        return zr.Kf() ? new zr : new Br;
