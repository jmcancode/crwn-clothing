...
var E$1 = {
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            if (t.R !== e) throw new N$1(E$1.ABORTED, "getToken aborted due to token change.");
            return n ? (Ve("string" == typeof n.accessToken), new I$1(n.accessToken, t.currentUser)) : null;
    ...
    function t(t, e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new N$1(E$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new N$1(E$1.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new N$1(E$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new N$1(E$1.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    ...
    function t(t, e, n) {
        void 0 === e ? e = 0 : e > t.length && Re(), void 0 === n ? n = t.length - e : n > t.length - e && Re(), 
    ...
    n.G = function(t) {
        ...
        // sequences (e.g. __id123__) and just passes them through raw (they exist
        // for legacy reasons and should not be used frequently).
        if (t.indexOf("//") >= 0) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid path (" + t + "). Paths must not contain // in them.");
...
var P$1 = /^[_a-zA-Z][_a-zA-Z0-9]*$/, L$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.$ = function(t, e, r) {
    ...
    n.J = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new N$1(E$1.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new N$1(E$1.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new N$1(E$1.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n;
}(S$1);

/** A dot-separated path for navigating sub-objects within a document. */ L$1.H = new L$1([]);
...
/** Returns whether the value represents -0. */ function F$1(t) {
...
/** Extracts the backend's type order for the provided value. */ function z(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? j(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : Re();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Q$1(t, e) {
    ...
    switch (n) {
      ...
      case 6 /* BlobValue */ :
        return function(t, e) {
            return X$1(t.bytesValue).isEqual(X$1(e.bytesValue));
        }(t, e);
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === r ? F$1(n) === F$1(r) : isNaN(n) && isNaN(r);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return Le(t.arrayValue.values || [], e.arrayValue.values || [], Q$1);
...
function Y$1(t, e) {
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return Z$1(t.timestampValue, e.timestampValue);

      case 4 /* ServerTimestampValue */ :
        return Z$1(G$1(t), G$1(e));
...
function Z$1(t, e) {
    ...
    var n = J$1(t), r = J$1(e), i = Pe(n.seconds, r.seconds);
...
function H$1(t) {
    return function t(e) {
        ...
        }(e.timestampValue) : "stringValue" in e ? e.stringValue : "bytesValue" in e ? X$1(e.bytesValue).toBase64() : "referenceValue" in e ? (r = e.referenceValue, 
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function X$1(t) {
    return "string" == typeof t ? C$1.fromBase64String(t) : C$1.fromUint8Array(t);
}

/** Returns a reference value for the provided database and key. */ function K$1(t, e) {
    return {
...
var st = /** @class */ function() {
    ...
    return t.prototype.ot = function(t, e) {
        ...
        return e instanceof t && Le(this.elements, e.elements, Q$1);
    }, t;
}(), ut = /** @class */ function() {
    function t(t) {
        this.elements = t;
...
e) {
    ...
    return __extends(n, e), n.prototype.at = function(t, e) {
        if (this.Et(t), Ve(null != e.transformResults), !this.Rt.Tt(t)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
...
var It, At, Tt = function(t, e) {
    ...
    return t.prototype.canonicalId = function() {
        if (null === this.Ot) {
            ...
            t += this.filters.map((function(t) {
                ...
                return t.canonicalId();
            })).join(","), x$1(this.limit) || (t += "|l:", t += this.limit), this.startAt && (t += "|lb:", 
        ...
        x$1(this.limit) || (t += ", limit: " + this.limit), this.orderBy.length > 0 && (t += ", orderBy: [" + this.orderBy.join(", ") + "]"), 
    ...
    return t.Wt = function(e) {
        ...
        get: function() {
            if (null === this.Bt) {
                ...
                t.Y() || this.Bt.push(new Ct(t)), this.Bt.push(new Ct(L$1.X(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.canonicalId = function() {
        ...
        return !x$1(this.limit) && "F" /* First */ === this.xt;
    }, t.prototype.ae = function() {
        return !x$1(this.limit) && "L" /* Last */ === this.xt;
    }, t.prototype.Gt = function() {
        return this.Mt.length > 0 ? this.Mt[0].field : null;
    }, t.prototype.jt = function() {
        for (var t = 0, e = this.filters; t < e.length; t++) {
            var n = e[t];
            if (n instanceof kt && n.ue()) return n.field;
        }
        return null;
    }, 
    ...
    t.prototype.ce = function(t) {
        for (var e = 0, n = this.filters; e < n.length; e++) {
            var r = n[e];
            if (r instanceof kt && t.indexOf(r.op) >= 0) return r.op;
        }
        return null;
    }, t.prototype.qt = function() {
        return this.ee().qt();
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        ...
        if (nt(r)) {
            if ("==" /* EQUAL */ !== e) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. Null supports only equality comparisons.");
            return new n(t, e, r);
        }
        if (rt(r)) {
            if ("==" /* EQUAL */ !== e) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. NaN supports only equality comparisons.");
            return new n(t, e, r);
        }
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Ut(t, r) : "in" /* IN */ === e ? new Ot(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Mt(t, r) : new n(t, e, r);
        ...
        return this.field.j() + this.op.toString() + H$1(this.value);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n && this.op === t.op && this.field.isEqual(t.field) && Q$1(this.value, t.value);
    }, n.prototype.toString = function() {
        return this.field.j() + " " + this.op + " " + H$1(this.value);
    }, n;
    ...
    t.prototype._e = function(t, e) {
        for (var n = 0, r = 0; r < this.position.length; r++) {
            ...
            if (n = i.field.Y() ? U$1.N(U$1.Z(o.referenceValue), e.key) : Y$1(o, e.field(i.field)), 
    ...
    return t.prototype.compare = function(t, e) {
        var n = this.de ? U$1.N(t.key, e.key) : function(t, e, n) {
            ...
            return null !== r && null !== i ? Y$1(r, i) : Re();
        }(this.field, t, e);
        switch (this.dir) {
          case "asc" /* ASCENDING */ :
            return n;
 ...
 *     Code.UNKNOWN.
 */ (At = It || (It = {}))[At.OK = 0] = "OK", At[At.CANCELLED = 1] = "CANCELLED", 
...
var Bt = /** @class */ function() {
    ...
    t.prototype.Re = function(t, e, n) {
        ...
        return (r = i < 0 ? r.Ae(null, null, null, r.left.Re(t, e, n), null) : 0 === i ? r.Ae(null, e, null, null, null) : r.Ae(null, null, null, null, r.right.Re(t, e, n))).Le();
    }, t.prototype.Oe = function() {
        if (this.left.M()) return t.EMPTY;
        var e = this;
        return e.left.qe() || e.left.left.qe() || (e = e.Me()), (e = e.Ae(null, null, null, e.left.Oe(), null)).Le();
    }, 
    ...
    t.prototype.je = function() {
        if (this.qe() && this.left.qe()) throw Re();
        if (this.right.qe()) throw Re();
        var t = this.left.je();
        if (t !== this.right.je()) throw Re();
 ...
 */ var oe = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Xe = Xt(), this.Je = new Bt(this.N)
        /**
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, he.fs(e, n)), new t(V$1.min(), r, ie(), Ht(), ne());
    }, t;
}(), he = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Bs = function(t) {
        for (var e = 0, n = t.ms; e < n.length; e++) {
            var r = n[e];
            t.Is instanceof _t ? this.Us(r, t.Is) : t.Is instanceof Dt && this.Qs(r, t.key, t.Is);
        }
    ...
    /** Processes and adds the WatchTargetChange to the current set of changes. */ t.prototype.Ws = function(t) {
        ...
        this.js(t, (function(n) {
            ...
            switch (t.state) {
              ...
              case 3 /* Current */ :
                e.Hs(n) && (r.ks(), r.vs(t.resumeToken));
                break;
    ...
    t.prototype.Js = function(t) {
        ...
        return this.qs = Ht(), this.Ms = ye(), this.xs = new Wt(Pe), i;
    }, 
    /**
    ...
    t.prototype.Xs = function(t) {
        var e = this.Gs(t).Ss();
        return this.Ls.ei(t).size + e.ws.size - e.Es.size;
    }, 
    /**
    ...
    t.prototype.Ns = function(t) {
        ...
        var e = this.Ms.get(t);
        return e || (e = new Wt(Pe), this.Ms = this.Ms.Re(t, e)), e;
    }, 
    /**
    ...
    t.prototype.Ys = function(t) {
        var e = this.Os.get(t);
        return e && e.gs ? null : this.Ls.si(t);
    }, 
    /**
    ...
    t.prototype.Ks = function(t) {
        var e = this;
        this.Os.set(t, new pe), this.Ls.ei(t).forEach((function(n) {
 ...
 */ var me = {
    ...
    t.prototype.ri = function(t) {
        return this.options.hi || x$1(t) ? t : {
            value: t
        };
    }, 
    /**
    ...
    t.prototype.oi = function(t) {
        var e;
        return x$1(e = "object" == typeof t ? t.value : t) ? null : e;
    }, 
    /**
    ...
    t.prototype.ai = function(t) {
        return function(t) {
            return "number" == typeof t && Number.isInteger(t) && !F$1(t) && t <= Number.MAX_SAFE_INTEGER && t >= Number.MIN_SAFE_INTEGER;
    ...
    t.prototype.ci = function(t) {
        return this.options.hi ? (Ve(void 0 === t || "string" == typeof t), C$1.fromBase64String(t || "")) : (Ve(void 0 === t || t instanceof Uint8Array), 
        C$1.fromUint8Array(t || new Uint8Array));
    }, t.prototype.toVersion = function(t) {
        return this.D(t.D());
    }, t.prototype.fromVersion = function(t) {
        return Ve(!!t), V$1.v(this.v(t));
        ...
        // in the local target cache.
                return 4 === e.length ? k$1.H : this.wi(e);
    }, Object.defineProperty(t.prototype, "mi", {
        get: function() {
            return new k$1([ "projects", this.ii.projectId, "databases", this.ii.database ]).j();
        },
        enumerable: !0,
        configurable: !0
    ...
    /** Creates an api.Document from key and fields (but no create/update time) */ t.prototype.Ii = function(t, e) {
        ...
        return "found" in t ? this.Pi(t) : "missing" in t ? this.Vi(t) : Re();
        ...
        if ("targetChange" in t) {
            ...
            if (!("filter" in t)) return Re();
            t.filter;
            var N = t.filter;
            N.targetId;
            var I = N.count || 0, A = new Ft(I), T = N.targetId;
            e = new fe(T, A);
        }
        return e;
    }, t.prototype.gi = function(t) {
        return "NO_CHANGE" === t ? 0 /* NoChange */ : "ADD" === t ? 1 /* Added */ : "REMOVE" === t ? 2 /* Removed */ : "CURRENT" === t ? 3 /* Current */ : "RESET" === t ? 4 /* Reset */ : Re();
        ...
        if (t.transform) {
            ...
            return Ve(!0 === n.exists), new mt(u, a);
        }
        if (t.verify) {
        ...
        var e = null;
        if ("setToServerValue" in t) Ve("REQUEST_TIME" === t.setToServerValue), e = ot.instance; else if ("appendMissingElements" in t) {
            var n = t.appendMissingElements.values || [];
            e = new st(n);
        } else if ("removeAllFromArray" in t) {
            var r = t.removeAllFromArray.values || [];
            e = new ut(r);
        } else "increment" in t ? e = new at(this, t.increment) : Re();
        var i = L$1.J(t.fieldPath);
        return new ft(i, e);
        ...
        null !== t.collectionGroup ? (e.parent = this.Ti(n), e.structuredQuery.from = [ {
            ...
            allDescendants: !0
        } ]) : (e.parent = this.Ti(n.L()), e.structuredQuery.from = [ {
            collectionId: n.q()
        } ]);
        ...
        if (0 !== t.length) {
            var n = t.map((function(t) {
                return t instanceof kt ? e.Yi(t) : Re();
            }));
    ...
    t.prototype.Zi = function(t) {
        ...
        return kt.create(this.on(t.fieldFilter.field), this.rn(t.fieldFilter.op), t.fieldFilter.value);
    }, 
    // visible for testing
    t.prototype.Yi = function(t) {
        if ("==" /* EQUAL */ === t.op) {
 ...
 */ var Ee = /** @class */ function() {
    ...
    return t.an = function(e) {
        t.platform && Re(), t.platform = e;
    }, t.nt = function() {
        return t.platform || Re(), t.platform;
    }, t;
...
function Te(t) {
    ...
    if (Ne.logLevel <= LogLevel.DEBUG) {
        var i = e.map(De);
        Ne.debug.apply(Ne, __spreadArrays([ "Firestore (" + w$1 + "): " + t ], i));
    }
}
...
function _e(t) {
    ...
    if (Ne.logLevel <= LogLevel.ERROR) {
        var i = e.map(De);
        Ne.error.apply(Ne, __spreadArrays([ "Firestore (" + w$1 + "): " + t ], i));
    }
}
...
function(t, e, n, r, i) {
    ...
    return t.prototype.catch = function(t) {
        ...
        var r = this;
        return this.Vn && Re(), this.Vn = !0, this.Pn ? this.error ? this.pn(n, this.error) : this.yn(e, this.result) : new t((function(t, i) {
            r.Rn = function(n) {
                r.yn(e, n).next(t, i);
            }, r.An = function(e) {
                r.pn(n, e).next(t, i);
    ...
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.kn = function(t, e, n) {
        return this.Cn.Ln(t, e).next((function(t) {
            for (var r = 0, i = n; r < i.length; r++) {
                t = i[r].ot(e, t);
            }
            return t;
...
var Be = function() {
    ...
    return t.prototype.mr = function(t, e) {
        return this.Er.add(e), xe.resolve();
    }, t.prototype.jn = function(t, e) {
        return xe.resolve(this.Er.getEntries(e));
    }, t;
}(), We = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.q(), n = t.L(), r = this.index[e] || new Wt(k$1.N), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.q(), n = t.L(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Wt(k$1.N)).W();
    }, t;
}(), Ye = /** @class */ function() {
    function t(t) {
        this.Ir = t;
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Ze(t) {
 ...
 */ var He = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Pr = t, this.ir = e, this.Vr = n, this.op = r, this.pr = i, this.yr = new Be, 
    ...
    t.prototype.cancel = function(t) {
        null !== this.br && (this.clearTimeout(), this.yr.reject(new N$1(E$1.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    ...
    function t() {
        ...
        this.Or = new ze(this, "async_queue_retry" /* AsyncQueueRetry */), 
    ...
    t.prototype.Wr = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Br(), this.Fr ? [ 3 /*break*/ , 2 ] : (this.Fr = !0, (e = Ee.nt().window) && e.removeEventListener("visibilitychange", this.qr), 
                    [ 4 /*yield*/ , this.Qr(t) ]);
    ...
    t.prototype.jr = function(t) {
                ...
                return __awaiter(r, void 0, void 0, (function() {
                    ...
                    return __generator(this, (function(n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return n.sent(), i.resolve(), this.Or.reset(), [ 3 /*break*/ , 3 ];

                          case 2:
                            if (!Ze(e = n.sent())) throw i.resolve(), e;
                            // Failure will be handled by AsyncQueue
                                                        return Te("AsyncQueue", "Operation failed with retryable error: " + e), 
                            this.Or.lr(o), [ 3 /*break*/ , 3 ];
        ...
        var e = this, n = this.Cr.then((function() {
            return e.kr = !0, t().catch((function(t) {
                ...
                throw e.$r = t, e.kr = !1, _e("INTERNAL UNHANDLED ERROR: ", t.stack || t.message || ""), 
                t;
            })).then((function(t) {
                return e.kr = !1, t;
            }));
 ...
 */
function $e(t, e) {
    if (_e("AsyncQueue", e + ": " + t), Ze(t)) return new N$1(E$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var Ke = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this._h = V$1.min(), this.Dn = t.fh(n), this.dh = t.wh(), this.Th = t.Eh(), this.mh = new Fe(this.dh, this.Dn, this.persistence.Ih()), 
        this.ah.Rh(this.mh)
    ...
    t.prototype.Ah = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this.Dn, r = this.mh, [ 4 /*yield*/ , this.persistence.runTransaction("Handle user change", "readonly", (function(n) {
                        ...
                        return o.Dn.Ph(n).next((function(s) {
                            ...
                            // MutationQueue.
                            r = new Fe(o.dh, e, o.persistence.Ih()), e.Ph(n);
                        })).next((function(t) {
                  ...
                  case 1:
                    return i = n.sent(), [ 2 /*return*/ , (this.Dn = e, this.mh = r, this.ah.Rh(this.mh), 
                    i) ];
                }
            }));
        }));
    ...
    /* Accept locally generated Mutations and commit them to storage. */ t.prototype.gh = function(t) {
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.mh.qn(o, i).next((function(i) {
                e = i;
                for (
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    ...
                    // exists=true
                    s.push(new vt(h.key, c, Nt(c.proto.mapValue), pt.exists(!0)));
                }
    ...
    t.prototype.Sh = function(t) {
        ...
        return this.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(n) {
            ...
            return e.Dn.Sh(n, t.batch, t.streamToken).next((function() {
                return e.Fh(n, t, i);
            })).next((function() {
                return i.apply(n);
            })).next((function() {
    ...
    t.prototype.$h = function(t) {
        ...
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", (function(n) {
            var r;
            return e.Dn.kh(n, t).next((function(t) {
                return Ve(null !== t), r = t.keys(), e.Dn.Lh(n, t);
            })).next((function() {
                return e.Dn.Nh(n);
            })).next((function() {
                return e.mh.qn(n, r);
    ...
    /** Returns the last recorded stream token for the current user. */ t.prototype.qh = function() {
        var t = this;
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(o) {
            ...
            e.as.forEach((function(e, s) {
                ...
                if (a) {
                    ...
                    u.push(n.Th.Uh(o, e.Es, s).next((function() {
                        return n.Th.Qh(o, e.ws, s);
                    })));
                    var h = e.resumeToken;
                    // Update the resume token if the change includes one.
                                        if (h.rt() > 0) {
                        var c = a.me(h, r).Ee(o.Wh);
                        i = i.Re(s, c), 
                        // Update the target data if there are target changes (or if
                        // sufficient time has passed since the last update).
                        t.jh(a, c, e) && u.push(n.Th.Gh(o, c));
                    }
                }
            }));
            var a = Ht(), h = ne();
            ...
            u.push(s.getEntries(o, h).next((function(t) {
                e.cs.forEach((function(i, h) {
                    ...
                    // access.
                    s.Hh(i, r), a = a.Re(i, h)) : null == c || h.version.S(c.version) > 0 || 0 === h.version.S(c.version) && c.hasPendingWrites ? (s.Kh(h, r), 
                    a = a.Re(i, h)) : Te("LocalStore", "Ignoring outdated watch update for ", i, ". Current version:", c.version, " Watch version:", h.version), 
                    e.ls.has(i) && u.push(n.persistence.Yh.zh(o, i));
                }));
            }))), !r.isEqual(V$1.min())) {
                var c = n.Th.xh(o).next((function(t) {
                    return n.Th.Xh(o, o.Wh, r);
                }));
                u.push(c);
            }
    ...
    t.jh = function(t, e, n) {
        ...
        return Ve(e.resumeToken.rt() > 0), 0 === t.resumeToken.rt() || (e.Te.C() - t.Te.C() >= this.Jh || n.ws.size + n.Ts.size + n.Es.size > 0);
                  ...
                  case 0:
                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(e) {
                        return xe.forEach(t, (function(t) {
                            return xe.forEach(t.Kn, (function(n) {
                                return c.persistence.Yh.to(e, t.targetId, n);
                            })).next((function() {
                                return xe.forEach(t.zn, (function(n) {
                                    return c.persistence.Yh.eo(e, t.targetId, n);
                                }));
                            }));
                        }));
                    })) ];
    ...
    t.prototype.so = function(t) {
        ...
        return this.persistence.runTransaction("Get next mutation batch", "readonly", (function(n) {
            return void 0 === t && (t = -1), e.Dn.io(n, t);
        }));
    }, 
    /**
    ...
    t.prototype.ro = function(t) {
        ...
        return this.persistence.runTransaction("Allocate target", "readwrite", (function(n) {
            var r;
            return e.Th.ho(n, t).next((function(i) {
                return i ? (
                // This target has been listened to previously, so reuse the
                // previous targetID.
                // TODO(mcg): freshen last accessed date?
                r = i, xe.resolve(r)) : e.Th.oo(n).next((function(i) {
                    return r = new xt(t, i, 0 /* Listen */ , n.Wh), e.Th.ao(n, r).next((function() {
                        return r;
                    }));
                }));
            }));
        })).then((function(n) {
            return null === e.uh.get(n.targetId) && (e.uh = e.uh.Re(n.targetId, n), e.lh.set(t, n.targetId)), 
            n;
        }));
    }, 
    /**
    ...
    t.prototype.ho = function(t, e) {
        var n = this.lh.get(e);
        return void 0 !== n ? xe.resolve(this.uh.get(n)) : this.Th.ho(t, e);
    }, 
    /**
    ...
    t.prototype.uo = function(t, e) {
        ...
        return this.persistence.runTransaction("Release target", i, (function(t) {
            return e ? xe.resolve() : n.persistence.Yh.removeTarget(t, r);
        })).then((function() {
    ...
    t.prototype.co = function(t, e) {
        var n = this, r = V$1.min(), i = ne();
        return this.persistence.runTransaction("Execute query", "readonly", (function(o) {
            return n.ho(o, t.ee()).next((function(t) {
                if (t) return r = t.lastLimboFreeSnapshotVersion, n.Th.lo(o, t.targetId).next((function(t) {
                    i = t;
                }));
            })).next((function() {
                return n.ah.Bn(o, t, e ? r : V$1.min(), e ? i : ne());
            })).next((function(t) {
                return {
                    documents: t,
                    _o: i
...
var en = /** @class */ function() {
    function t() {
        ...
        this.wo = new Wt(nn.To), 
        // A set of outstanding references to a document sorted by target id.
        this.Eo = new Wt(nn.mo)
    ...
    /** Adds a reference to the given document key for the given ID. */ t.prototype.to = function(t, e) {
        var n = new nn(t, e);
        this.wo = this.wo.add(n), this.Eo = this.Eo.add(n);
    }, 
    ...
    t.prototype.Po = function(t) {
        ...
        return this.Eo.Ge([ r, i ], (function(t) {
            e.Ro(t), o.push(t.key);
        })), o;
    }, t.prototype.Vo = function() {
        var t = this;
        this.wo.forEach((function(e) {
            return t.Ro(e);
        }));
    }, t.prototype.Ro = function(t) {
        this.wo = this.wo.delete(t), this.Eo = this.Eo.delete(t);
    }, t.prototype.po = function(t) {
        var e = U$1.EMPTY, n = new nn(e, t), r = new nn(e, t + 1), i = ne();
        return this.Eo.Ge([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.yo = function(t) {
        var e = new nn(t, 0), n = this.wo.Ke(e);
        return null !== n && t.isEqual(n.key);
    }, t;
}(), nn = /** @class */ function() {
    function t(t, e) {
        this.key = t, this.bo = e
        /** Compare by key then by ID */;
    }
    return t.To = function(t, e) {
        return U$1.N(t.key, e.key) || Pe(t.bo, e.bo);
    }, 
    /** Compare by ID then by key */ t.mo = function(t, e) {
        return Pe(t.bo, e.bo) || U$1.N(t.key, e.key);
    }, t;
}();
 ...
 */
function rn(t, e) {
    if (0 !== e.length) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + En(e.length, "argument") + ".");
}
 ...
 */ function on(t, e, n) {
    if (e.length !== n) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires " + En(n, "argument") + ", but was called with " + En(e.length, "argument") + ".");
}
 ...
 */ function sn(t, e, n) {
    if (e.length < n) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + En(n, "argument") + ", but was called with " + En(e.length, "argument") + ".");
}
 ...
 */ function un(t, e, n, r) {
    if (e.length < n || e.length > r) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + En(e.length, "argument") + ".");
}
...
function ln(t, e, n, r, i) {
    void 0 !== r && function(t, e, n, r, i) {
        ...
        var h = yn(r);
        throw new N$1(E$1.INVALID_ARGUMENT, "Invalid value " + h + " provided to function " + t + '() for option "' + n + '". Acceptable values: ' + o.join(", "));
    }(t, 0, n, r, i);
}
...
/** Helper to validate the type of a provided input. */ function pn(t, e, n, r) {
    if (!("object" === e ? dn(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = yn(r);
        throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + n + " to be of type " + e + ", but it was: " + i);
    }
}
...
/** Returns a string describing the type / value of the provided input. */ function yn(t) {
    ...
    return "function" == typeof t ? "a function" : Re();
}

function vn(t, e, n) {
    if (void 0 === n) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + bn(e) + " argument, but it was undefined.");
}
 ...
 */ function mn(t, e, n) {
    M$1(e, (function(e, r) {
        if (n.indexOf(e) < 0) throw new N$1(E$1.INVALID_ARGUMENT, "Unknown option '" + e + "' passed to function " + t + "(). Available options: " + n.join(", "));
    }));
}
 ...
 */ function gn(t, e, n, r) {
    var i = yn(r);
    return new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + bn(n) + " argument to be a " + e + ", but it was: " + i);
}

function wn(t, e, n) {
    if (n <= 0) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + bn(e) + " argument to be a positive number, but it was: " + n + ".");
}
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function Nn() {
    if ("undefined" == typeof Uint8Array) throw new N$1(E$1.UNIMPLEMENTED, "Uint8Arrays are not available in this environment.");
}

/** Helper function to assert Base64 functions are available at runtime. */ function In() {
    if (!Ee.nt().vo) throw new N$1(E$1.UNIMPLEMENTED, "Blobs are unavailable in Firestore in this environment.");
}
 ...
 */ var An = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        ...
        try {
            ...
            throw new N$1(E$1.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + e);
        }
    }, t.fromUint8Array = function(e) {
        ...
        return on("Blob.toBase64", arguments, 0), In(), this.So.toBase64();
    }, t.prototype.toUint8Array = function() {
        return on("Blob.toUint8Array", arguments, 0), Nn(), this.So.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        !function(t, e, n, r) {
            if (!(e instanceof Array) || e.length < 1) throw new N$1(E$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + En(1, "element") + ".");
        }(0, t);
        for (var n = 0; n < t.length; ++n) if (an("FieldPath", "string", n, t[n]), 0 === t[n].length) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.Co = new L$1(t);
    }
 ...
 * effect is the same.
 */
Tn.Do = new Tn(L$1.X().j());

/**
 * Matches any characters in a field path string that are reserved.
 */
var _n = new RegExp("[~\\*/\\[\\]]"), Dn = function(t) {
    this.Fo = t;
}, Rn = /** @class */ function(e) {
    function n() {
    ...
    return __extends(n, e), n.prototype.Ci = function(t) {
        if (2 /* MergeSet */ !== t.No) throw 1 /* Update */ === t.No ? t.$o("FieldValue.delete() can only appear at the top level of your update data") : t.$o("FieldValue.delete() cannot be used with set() unless you pass {merge:true}");
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayUnion") || this).ko = t, n;
    }
    return __extends(n, e), n.prototype.Ci = function(t) {
        ...
        var e = new Cn({
            ...
            methodName: this.Fo,
            Lo: !0
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = this.ko.map((function(t) {
            return Fn(t, e);
        })), r = new st(n);
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.arrayRemove") || this).ko = t, n;
    }
    return __extends(n, e), n.prototype.Ci = function(t) {
        // Although array transforms are used with writes, the actual elements
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this, "FieldValue.increment") || this).Oo = t, n;
    }
    return __extends(n, e), n.prototype.Ci = function(t) {
        var e = new Cn({
            No: 3 /* Argument */ ,
            methodName: this.Fo
        }, t.ii, t.serializer, t.ignoreUndefinedProperties), n = Fn(this.Oo, e), r = new at(t.serializer, n);
        return new ft(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Dn), Ln = /** @class */ function() {
    function t(t, e) {
        if (on("GeoPoint", arguments, 2), an("GeoPoint", "number", 1, t), an("GeoPoint", "number", 2, e), 
        !isFinite(t) || t < -90 || t > 90) throw new N$1(E$1.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new N$1(E$1.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
        this.qo = t, this.Mo = e;
    }
     ...
     */
    t.prototype.g = function(t) {
        return Pe(this.qo, t.qo) || Pe(this.Mo, t.Mo);
    }, t;
...
/** A "context" object passed around while parsing user data. */ var Cn = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Bo(), this.fieldTransforms = i || [], this.Vt = o || [];
    }
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Uo = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Uo({
            path: n,
            Lo: !1
        });
        return r.Wo(t), r;
        ...
        return new N$1(E$1.INVALID_ARGUMENT, "Function " + this.settings.methodName + "() called with invalid data. " + t + e);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.Wo(this.path.get(t));
    }, t.prototype.Wo = function(t) {
        if (0 === t.length) throw this.$o("Document fields must not be empty");
        if (qn(this.No) && Un.test(t)) throw this.$o('Document fields cannot begin and end with "__"');
    }, t;
}(), xn = /** @class */ function() {
    function t(t, e, n) {
        this.ii = t, this.ignoreUndefinedProperties = e, this.serializer = n || Ee.nt().Ho(t)
        /** Parse document data from a non-merge set() call. */;
    }
    return t.prototype.Ko = function(t, e) {
        var n = this.zo(0 /* Set */ , t);
        Bn("Data must be an object, but it was:", n, e);
        var r = jn(e, n);
        return new On(new bt(r), 
        /* fieldMask= */ null, n.fieldTransforms);
    }, 
    /** Parse document data from a set() call with '{merge:true}'. */ t.prototype.Yo = function(t, e, n) {
        var r = this.zo(2 /* MergeSet */ , t);
        Bn("Data must be an object, but it was:", r, e);
        var i, o, s = jn(e, r);
        if (n) {
            for (var u = [], a = 0, h = n; a < h.length; a++) {
                var c = h[a], f = void 0;
                if (c instanceof Tn) f = c.Co; else {
                    if ("string" != typeof c) throw Re();
                    f = Qn(t, c);
                }
                if (!r.contains(f)) throw new N$1(E$1.INVALID_ARGUMENT, "Field '" + f + "' is specified in your field mask but missing from your input data.");
                Wn(u, f) || u.push(f);
            }
    ...
    /** Parse update data from an update() call. */ t.prototype.Xo = function(t, e) {
        var n = this.zo(1 /* Update */ , t);
        Bn("Data must be an object, but it was:", n, e);
        var r = [], i = new Et;
        M$1(e, (function(e, o) {
            var s = Qn(t, e), u = n.jo(s);
            if (o instanceof Rn) 
        ...
        var o = new ct(r);
        return new Mn(i.gt(), o, n.fieldTransforms);
    }, 
    /** Parse update data from a list of field/value arguments. */ t.prototype.Jo = function(t, e, n, r) {
        var i = this.zo(1 /* Update */ , t), o = [ zn(t, e) ], s = [ n ];
        if (r.length % 2 != 0) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() needs to be called with an even number of arguments that alternate between field names and values.");
        ...
        var y = new ct(a);
        return new Mn(h.gt(), y, i.fieldTransforms);
    }, 
    /** Creates a new top-level parse context. */ t.prototype.zo = function(t, e) {
        return new Cn({
            No: t,
            methodName: e,
            path: L$1.H,
    ...
    t.prototype.Zo = function(t, e, n) {
        return void 0 === n && (n = !1), Fn(e, this.zo(n ? 4 /* ArrayArgument */ : 3 /* Argument */ , t));
    }, t;
}();
...
function Fn(t, e) {
    ...
    return function(t, e) {
        ...
        if (!qn(e.No)) throw e.$o(t.Fo + "() can only be used with update() and set()");
        if (null === e.path) throw e.$o(t.Fo + "() is not currently supported inside arrays");
        var n = t.Ci(e);
    ...
    e.path && e.Vt.push(e.path), t instanceof Array) {
        ...
        if (e.settings.Lo && 4 /* ArrayArgument */ !== e.No) throw e.$o("Nested arrays are not supported");
        return function(t, e) {
    ...
    return function(t, e) {
        ...
        if (t instanceof Vr) {
            ...
            return {
                referenceValue: e.serializer.li(t.ea.path, t.firestore.ta)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.$o("Unsupported field value: " + yn(t));
    }(t, e);
}
...
function Gn(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof R$1 || t instanceof Ln || t instanceof An || t instanceof Vr || t instanceof Dn);
}
 ...
 */ function zn(t, e) {
    if (e instanceof Tn) return e.Co;
    if ("string" == typeof e) return Qn(t, e);
    throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. Field path arguments must be of type string or FieldPath.");
}
 ...
 */ function Qn(t, e) {
    try {
        return function(t) {
            if (t.search(_n) >= 0) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Tn.bind.apply(Tn, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
                throw new N$1(E$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            }
        }(e).Co;
    } catch (e) {
        var n = (i = e) instanceof Error ? i.message : i.toString();
        throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() called with invalid data. " + n);
    }
    /**
 ...
 */ var Yn = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.ra = 0, this.ha = null, this.stream = null, this.Or = new ze(t, e)
        /**
    ...
    t.prototype.ca = function() {
        this.state = 0 /* Initial */ , this.Or.reset();
    }, 
    /**
    ...
    t.prototype.wa = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new N$1(E$1.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.Ia(e);
            }));
        }));
        ...
        var t = this;
        this.state = 4 /* Backoff */ , this.Or.lr((function() {
    ...
    t.prototype.Ea = function(t) {
        ...
        return function(n) {
            e.sr.Sr((function() {
                return e.ra === t ? n() : (Te("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    n.prototype.ya = function(t) {
        var e = {};
        e.database = this.serializer.mi, e.removeTarget = t, this.fa(e);
    }, n;
}(Yn), Hn = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    n.prototype.start = function() {
        this.ga = !1, e.prototype.start.call(this);
        ...
        Ve(!!t.streamToken), this.lastStreamToken = this.serializer.ci(t.streamToken), this.ga) {
        ...
        // The first response is always the handshake response
                return Ve(!t.writeResults || 0 === t.writeResults.length), this.ga = !0, 
        this.listener.Ca();
    }, 
    /**
    ...
    n.prototype.Da = function() {
        ...
        var t = {};
        t.database = this.serializer.mi, this.fa(t);
    }, 
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).ia = t, i.credentials = n, i.serializer = r, i;
    }
    /** Gets an auth token and invokes the provided RPC. */    return __extends(n, e), n.prototype.Na = function(t, e) {
        var n = this;
        return this.credentials.getToken().then((function(r) {
            return n.ia.Na(t, e, r);
        })).catch((function(t) {
            throw t.code === E$1.UNAUTHENTICATED && n.credentials.l(), t;
        }));
    }, 
    /** Gets an auth token and invokes the provided RPC with streamed results. */ n.prototype.$a = function(t, e) {
        var n = this;
        return this.credentials.getToken().then((function(r) {
            return n.ia.$a(t, e, r);
        })).catch((function(t) {
    ...
    function t(t) {
        ...
        this.La = te(), this.mutations = [], this.Oa = !1, 
        /**
    ...
    return t.prototype.xa = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.Ba(), this.mutations.length > 0) throw new N$1(E$1.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    ...
                                    }, [ 4 /*yield*/ , e.$a("BatchGetDocuments", i) ];
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof Dt || t instanceof _t ? i.Ua(t) : Re();
                    })), r) ];
                }
            }));
        }));
    }, t.prototype.set = function(t, e) {
        this.write(e.xo(t, this.Rt(t))), this.Ma.add(t);
    }, t.prototype.update = function(t, e) {
        try {
            this.write(e.xo(t, this.Qa(t)));
        } catch (t) {
            this.qa = t;
        }
        this.Ma.add(t);
    }, t.prototype.delete = function(t) {
        this.write([ new gt(t, this.Rt(t)) ]), this.Ma.add(t);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.Ba(), this.qa) throw this.qa;
                    return t = this.La, 
                  ...
                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.Oa = !0, [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        if (null !== n) {
            ...
            throw new N$1(E$1.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.Rt = function(t) {
        var e = this.La.get(t);
        return !this.Ma.has(t) && e ? pt.updateTime(e) : pt.dt();
    }, 
    /**
    ...
    t.prototype.Qa = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new N$1(E$1.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
        ...
        this.Ba(), this.mutations = this.mutations.concat(t);
    ...
    return t.prototype.Ka = function() {
        var t = this;
        0 === this.ja && (this.za("Unknown" /* Unknown */), this.Ga = this.Pr.dr("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.Ga = null, t.Ya("Backend didn't respond within 10 seconds."), t.za("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.Xa = function(t) {
        "Online" /* Online */ === this.state ? this.za("Unknown" /* Unknown */) : (this.ja++, 
        this.ja >= 1 && (this.Ja(), this.Ya("Connection failed 1 times. Most recent error: " + t.toString()), 
        this.za("Offline" /* Offline */)));
    }, 
    /**
    ...
    r, i, o, s) {
        ...
        /**
             ...
             * again.
             */
        this.iu = !1, this.nu = s, this.nu.ru((function(t) {
            i.Sr((function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            return this.hu() ? (Te("RemoteStore", "Restarting streams for network reachability change."), 
                            [ 4 /*yield*/ , this.ou() ]) : [ 3 /*break*/ , 2 ];
        ...
        this.uu = function(t, e, n) {
            var r = Se(t);
            return new Zn(e, r.ia, r.credentials, r.serializer, n);
        }(this.ka, i, {
            Aa: this.cu.bind(this),
            Ta: this.lu.bind(this),
            Va: this._u.bind(this)
        }), this.fu = function(t, e, n) {
            var r = Se(t);
            return new Hn(e, r.ia, r.credentials, r.serializer, n);
        }(this.ka, i, {
            Aa: this.du.bind(this),
            Ta: this.wu.bind(this),
            Ca: this.Tu.bind(this),
    ...
    /** Re-enables the network. Idempotent. */ t.prototype.enableNetwork = function() {
        return this.networkEnabled = !0, this.Eu();
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.hu() ? (t = this.fu, [ 4 /*yield*/ , this.Za.qh() ]) : [ 3 /*break*/ , 3 ];

                  case 1:
                    // This will start the write stream if necessary.
                    return t.lastStreamToken = e.sent(), this.mu() ? this.Iu() : this.au.set("Unknown" /* Unknown */), 
                    [ 4 /*yield*/ , this.Ru() ];
    ...
    t.prototype.disableNetwork = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.networkEnabled = !1, [ 4 /*yield*/ , this.Au() ];

                  case 1:
                    return t.sent(), 
                    // Set the OnlineState to Offline so get()s return from cache, etc.
                    this.au.set("Offline" /* Offline */), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.fu.stop() ];

                  case 1:
                    return t.sent(), [ 4 /*yield*/ , this.uu.stop() ];

                  case 2:
                    return t.sent(), this.tu.length > 0 && (Te("RemoteStore", "Stopping write stream with " + this.tu.length + " pending writes"), 
                    this.tu = []), this.Pu(), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), this.nu.Vu(), 
                    // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                    // triggering spurious listener events with cached data, etc.
                    this.au.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.listen = function(t) {
        this.eu.has(t.targetId) || (
        // Mark this as something the client is currently listening for.
        this.eu.set(t.targetId, t), this.mu() ? 
        // The listen will be sent in onWatchStreamOpen
        this.Iu() : this.uu.aa() && this.pu(t));
    }, 
    /**
    ...
    t.prototype.yu = function(t) {
        this.eu.delete(t), this.uu.aa() && this.gu(t), 0 === this.eu.size && (this.uu.aa() ? this.uu.la() : this.hu() && 
        // Revert to OnlineState.Unknown if the watch stream is not open and we
        // have no listeners, since without any listens to send we cannot
        // confirm if the stream is healthy and upgrade to OnlineState.Online.
        this.au.set("Unknown" /* Unknown */));
    }, 
    /** {@link TargetMetadataProvider.getTargetDataForTarget} */ t.prototype.si = function(t) {
        return this.eu.get(t) || null;
    }, 
    ...
    t.prototype.pu = function(t) {
        this.su.Ns(t.targetId), this.uu.pa(t);
    }, 
    /**
    ...
    t.prototype.gu = function(t) {
        this.su.Ns(t), this.uu.ya(t);
    }, t.prototype.Iu = function() {
        this.su = new de(this), this.uu.start(), this.au.Ka();
    }, 
    /**
    ...
    t.prototype.mu = function() {
        return this.hu() && !this.uu.oa() && this.eu.size > 0;
    }, t.prototype.hu = function() {
        return !this.iu && this.isPrimary && this.networkEnabled;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t = this;
            return __generator(this, (function(e) {
                return this.eu.forEach((function(e, n) {
                    t.pu(e);
                })), [ 2 /*return*/ ];
            }));
        }));
    ...
    }, t.prototype._u = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, i, o;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.au.set("Online" /* Online */), !(t instanceof le && 2 /* Removed */ === t.state && t.cause)) 
                    // Mark the client as online since we got a message from the server
                    return [ 3 /*break*/ , 6 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 5 ]), [ 4 /*yield*/ , this.vu(t) ];
                  ...
                  case 6:
                    if (t instanceof ce ? this.su.Bs(t) : t instanceof fe ? this.su.zs(t) : this.su.Ws(t), 
                    r.isEqual(V$1.min())) return [ 3 /*break*/ , 13 ];
                    n.label = 7;

                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , this.Za.xh() ];

                  case 8:
                    return i = n.sent(), r.S(i) >= 0 ? [ 4 /*yield*/ , this.Cu(r) ] : [ 3 /*break*/ , 10 ];
                  ...
                  case 11:
                    return Te("RemoteStore", "Failed to raise snapshot:", o = n.sent()), [ 4 /*yield*/ , this.Su(o) ];
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    return this.iu = !0, [ 4 /*yield*/ , this.Au() ];

                  case 1:
                    // Disable network and raise offline snapshots
                    return i.sent(), this.au.set("Offline" /* Offline */), 
                            ...
                            return __generator(this, (function(t) {
                                switch (t.label) {
                                  case 0:
                                    ...
                                    return Te("RemoteStore", "Retrying IndexedDB access"), [ 4 /*yield*/ , this.Za.xh() ];

                                  case 1:
                                    // Issue a simple read operation to determine if IndexedDB recovered.
                                    // Ideally, we would expose a health check directly on SimpleDb, but
                                    // RemoteStore only has access to persistence through LocalStore.
                                    return t.sent(), this.iu = !1, [ 4 /*yield*/ , this.Eu() ];
    ...
    t.prototype.Cu = function(t) {
        ...
        return n.as.forEach((function(n, r) {
            if (n.resumeToken.rt() > 0) {
                ...
                // A watched target might have been removed already.
                                i && e.eu.set(r, i.me(n.resumeToken, t));
            }
        })), 
        ...
        n.us.forEach((function(t) {
            ...
            if (n) {
                ...
                var r = new xt(n.target, t, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                e.pu(r);
            }
        })), this.bu.Bh(n);
    }, 
    /** Handles an error on a target */ t.prototype.vu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i, o;
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return r < i.length ? (o = i[r], this.eu.has(o) ? [ 4 /*yield*/ , this.bu.Du(o, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                  case 2:
                    n.sent(), this.eu.delete(o), this.su.removeTarget(o), n.label = 3;
    ...
    t.prototype.Ru = function() {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Fu() ? (t = this.tu.length > 0 ? this.tu[this.tu.length - 1].batchId : -1, 
                    [ 4 /*yield*/ , this.Za.so(t) ]) : [ 3 /*break*/ , 5 ];

                  case 1:
                    return null !== (e = n.sent()) ? [ 3 /*break*/ , 2 ] : (0 === this.tu.length && this.fu.la(), 
                    [ 3 /*break*/ , 4 ]);

                  case 2:
                    return this.Nu(e), [ 4 /*yield*/ , this.Ru() ];
                  ...
                  case 5:
                    return this.$u() && this.ku(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.Fu = function() {
        return this.hu() && this.tu.length < 10;
    }, 
    // For testing
    ...
    t.prototype.Nu = function(t) {
        this.tu.push(t), this.fu.aa() && this.fu.ba && this.fu.va(t.mutations);
    }, t.prototype.$u = function() {
        return this.hu() && !this.fu.oa() && this.tu.length > 0;
    }, t.prototype.ku = function() {
        this.fu.start();
    }, t.prototype.du = function() {
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                return this.fu.Da(), [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Tu = function() {
        var t = this;
        // Record the stream token.
                return this.Za.Mh(this.fu.lastStreamToken).then((function() {
            // Send the write pipeline now that the stream is established.
            for (var e = 0, n = t.tu; e < n.length; e++) {
                var r = n[e];
                t.fu.va(r.mutations);
            }
        })).catch(tn);
    }, t.prototype.Sa = function(t, e) {
        var n = this, r = this.tu.shift(), i = Ce.from(r, t, e, this.fu.lastStreamToken);
        return this.bu.Ou(i).then((function() {
            return n.Ru();
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return t && this.tu.length > 0 ? this.fu.ba ? [ 4 /*yield*/ , this.qu(t) ] : [ 3 /*break*/ , 2 ] : [ 3 /*break*/ , 5 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(e) {
                ...
                return jt(t.code) ? [ 2 /*return*/ , (Te("RemoteStore", "RemoteStore error before completed handshake; resetting stream token: ", this.fu.lastStreamToken), 
                this.fu.lastStreamToken = C$1.ht, this.Za.Mh(C$1.ht).catch(tn)) ] : [ 2 /*return*/ ];
            }));
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                ...
                // logic kick in.
                return jt(r = t.code) && r !== E$1.ABORTED ? (e = this.tu.shift(), [ 2 /*return*/ , (this.fu.ca(), 
                this.bu.xu(e.batchId, t).then((function() {
                    return i.Ru();
                }))) ]) : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Bu = function() {
        return new $n(this.ka);
        ...
        return __awaiter(this, void 0, void 0, (function() {
            return __generator(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    return t.sent(), this.au.set("Unknown" /* Unknown */), [ 4 /*yield*/ , this.enableNetwork() ];
            ...
            return __generator(this, (function(t) {
                switch (t.label) {
                  case 0:
                    ...
                    Te("RemoteStore", "RemoteStore restarting streams for new credential"), [ 4 /*yield*/ , this.ou() ]) : [ 3 /*break*/ , 2 ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return (e = t) ? [ 3 /*break*/ , 4 ] : [ 4 /*yield*/ , this.Au() ];

                  case 3:
                    n.sent(), e = this.au.set("Unknown" /* Unknown */), n.label = 4;
    ...
    function t() {
        this.Hu = new tr, this.Ku = {}, this.bu = null, this.Wa = null, this.Xn = null;
    }
    return t.prototype.zu = function(t) {
        ...
        return this.Hu.Wu(t), this.Ku[t] || "not-current";
    }, t.prototype.Ju = function(t, e, n) {
        this.Ku[t] = e;
    }, t.prototype.Zu = function(t) {
        this.Hu.ju(t);
    }, t.prototype.tc = function(t) {
        return this.Hu.activeTargetIds.has(t);
    }, t.prototype.ec = function(t) {
        delete this.Ku[t];
    }, t.prototype.sc = function() {
        return this.Hu.activeTargetIds;
    }, t.prototype.ic = function(t) {
        return this.Hu.activeTargetIds.has(t);
    }, t.prototype.start = function() {
        return this.Hu = new tr, Promise.resolve();
    }, t.prototype.Ah = function(t, e, n) {
        // No op.
    }, t.prototype.nc = function(t) {
        // No op.
    }, t.prototype.Vu = function() {}, t.prototype.tr = function(t) {}, t;
}(), nr = function(t) {
    this.key = t;
}, rr = function(t) {
    this.key = t;
    ...
    e) {
        this.query = t, this.rc = e, this.hc = null, 
        /**
        ...
        this.ns = ne(), this.ac = new oe(t.se.bind(t));
    }
    return Object.defineProperty(t.prototype, "uc", {
        /**
    ...
    t.prototype.cc = function(t, e) {
        var n = this, r = e ? e.lc : new se, i = e ? e.ac : this.ac, o = e ? e.ns : this.ns, s = i, u = !1, a = this.query.oe() && i.size === this.query.limit ? i.last() : null, h = this.query.ae() && i.size === this.query.limit ? i.first() : null;
    ...
    t.prototype.dc = function(t, e, n) {
        ...
        var s = e ? this.Tc() : [], u = 0 === this.oc.size && this.ds ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.hc;
        return this.hc = u, 0 !== o.length || a ? {
            snapshot: new ue(this.query, t.ac, i, o, t.ns, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ec: s
        } : {
            Ec: s
    ...
    t.prototype.Ic = function(t) {
        ...
        return !this.rc.has(t) && 
        // The local store doesn't think it's a result, so it shouldn't be in limbo.
        !!this.ac.has(t) && !this.ac.get(t).At;
    }, 
    /**
    ...
    t.prototype.wc = function(t) {
        ...
        t && (t.ws.forEach((function(t) {
            return e.rc = e.rc.add(t);
        })), t.Ts.forEach((function(t) {})), t.Es.forEach((function(t) {
            return e.rc = e.rc.delete(t);
        })), this.ds = t.ds);
        ...
        // updating many documents.
                var e = this.oc;
        this.oc = ne(), this.ac.forEach((function(e) {
            t.Ic(e.key) && (t.oc = t.oc.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.oc.has(e) || n.push(new rr(e));
    ...
    t.prototype.Rc = function(t) {
        this.rc = t._o, this.oc = ne();
        var e = this.cc(t.documents);
        return this.dc(e, /*updateLimboDocuments=*/ !0);
    }, 
    /**
    ...
    t.prototype.Ac = function() {
        return ue.os(this.query, this.ac, this.ns, 0 /* Local */ === this.hc);
    }, t;
}(), or = /** @class */ function() {
    function t(t, e, n, r) {
        this.Pr = t, this.Pc = e, this.updateFunction = n, this.yr = r, this.Vc = 5, this.Or = new ze(this.Pr, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.pc = function() {
        ...
        this.Or.lr((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = this.Pc.Bu(), (e = this.gc(t)) && e.then((function(e) {
                        r.Pr.Sr((function() {
        ...
        try {
            ...
            return !x$1(e) && e.catch && e.then ? e : (this.yr.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
...
n) {
    ...
    n, r, i) {
        this.Za = t, this.Pc = e, this.Cc = n, this.currentUser = r, this.Dc = i, this.Fc = null, 
        this.Nc = new Me((function(t) {
            return t.canonicalId();
        })), this.$c = new Map, 
        /**
        ...
        /**
             ...
             */
        this.Oc = new Map, this.qc = new en, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Mc = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.xc = new Map, this.Bc = Ye.Ar(), this.onlineState = "Unknown" /* Unknown */;
    }
    return Object.defineProperty(t.prototype, "Uc", {
        get: function() {
            return !0;
    ...
    t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Qc("listen()"), (i = this.Nc.get(t)) ? (
                    ...
                    e = i.targetId, this.Cc.Xu(e), r = i.view.Ac(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , this.Za.ro(t.ee()) ];

                  case 2:
                    return o = n.sent(), s = this.Cc.Xu(o.targetId), e = o.targetId, [ 4 /*yield*/ , this.Wc(t, e, "current" === s) ];

                  case 3:
                    r = n.sent(), this.Uc && this.Pc.listen(o), n.label = 4;
     ...
     * snapshot.
     */
    t.prototype.Wc = function(t, r, i) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, o, s, u, a, h;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.Za.co(t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), o = new ir(t, e._o), s = o.cc(e.documents), u = he.fs(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.dc(s, 
                    /* updateLimboDocuments= */ this.Uc, u), this.jc(r, a.Ec), h = new sr(t, r, o), 
                    [ 2 /*return*/ , (this.Nc.set(t, h), this.$c.has(r) ? this.$c.get(r).push(t) : this.$c.set(r, [ t ]), 
                    a.snapshot) ];
                }
            }));
        }));
    }, 
    /** Stops listening to the query. */ t.prototype.yu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i = this;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // to the target.
                    return this.Qc("unlisten()"), e = this.Nc.get(t), (r = this.$c.get(e.targetId)).length > 1 ? [ 2 /*return*/ , (this.$c.set(e.targetId, r.filter((function(e) {
                        return !e.isEqual(t);
                    }))), void this.Nc.delete(t)) ] : this.Uc ? (
                    // We need to remove the local query target first to allow us to verify
                    // whether any other client is still interested in this target.
                    this.Cc.Zu(e.targetId), this.Cc.ic(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , this.Za.uo(e.targetId, /*keepPersistedTargetData=*/ !1).then((function() {
                        i.Cc.ec(e.targetId), i.Pc.yu(e.targetId), i.Gc(e.targetId);
                    })).catch(tn) ]) : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    return this.Gc(e.targetId), [ 4 /*yield*/ , this.Za.uo(e.targetId, 
    ...
    t.prototype.write = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Qc("write()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , this.Za.gh(t) ];

                  case 2:
                    return e = n.sent(), this.Cc.zu(e.batchId), this.Hc(e.batchId, r), [ 4 /*yield*/ , this.Kc(e.vh) ];

                  case 3:
                    return n.sent(), [ 4 /*yield*/ , this.Pc.Ru() ];

                  case 4:
                    return n.sent(), [ 3 /*break*/ , 6 ];

                  case 5:
                    return i = n.sent(), o = $e(i, "Failed to persist write"), r.reject(o), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.runTransaction = function(t, e, n) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Qc("applyRemoteEvent()"), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Za.Bh(t) ];
                  ...
                  case 2:
                    ...
                    t.as.forEach((function(t, e) {
                        ...
                        Ve(t.ws.size + t.Ts.size + t.Es.size <= 1), t.ws.size > 0 ? n.Sc = !0 : t.Ts.size > 0 ? Ve(n.Sc) : t.Es.size > 0 && (Ve(n.Sc), 
                        n.Sc = !1));
                    })), [ 4 /*yield*/ , this.Kc(e, t) ];
    ...
    t.prototype.mc = function(t, e) {
        this.Qc("applyOnlineStateChange()");
        var n = [];
        this.Nc.forEach((function(e, r) {
            var i = r.view.mc(t);
            i.snapshot && n.push(i.snapshot);
        })), this.Fc.zc(t), this.Fc.Va(n), this.onlineState = t;
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Qc("rejectListens()"), 
                    // PORTING NOTE: Multi-tab only.
                    this.Cc.Ju(t, "rejected", r), e = this.Oc.get(t), (i = e && e.key) ? (o = (o = new Bt(U$1.N)).Re(i, new Dt(i, V$1.min())), 
                    s = ne().add(i), u = new ae(V$1.min(), 
                    /* targetChanges= */ new Map, 
                    /* targetMismatches= */ new Wt(Pe), o, s), [ 4 /*yield*/ , this.Bh(u) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 1:
                    ...
                    this.Lc = this.Lc.remove(i), this.Oc.delete(t), this.Yc(), [ 3 /*break*/ , 4 ];

                  case 2:
                    return [ 4 /*yield*/ , this.Za.uo(t, /* keepPersistedTargetData */ !1).then((function() {
                        return a.Gc(t, r);
                    })).catch(tn) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Qc("applySuccessfulWrite()"), e = t.batch.batchId, 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught
                    // up), so we raise user callbacks first so that they consistently happen
                    // before listen events.
                    this.Xc(e, /*error=*/ null), this.Jc(e), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Za.Sh(t) ];

                  case 2:
                    return r = n.sent(), this.Cc.Yu(e, "acknowledged"), [ 4 /*yield*/ , this.Kc(r) ];
    ...
    }, t.prototype.xu = function(t, r) {
        return __awaiter(this, void 0, void 0, (function() {
            var e;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Qc("rejectFailedWrite()"), 
                    // The local store may or may not be able to apply the write result and
                    // raise events immediately (depending on whether the watcher is caught up),
                    // so we raise user callbacks first so that they consistently happen before
                    // listen events.
                    this.Xc(t, r), this.Jc(t), n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , this.Za.$h(t) ];

                  case 2:
                    return e = n.sent(), this.Cc.Yu(t, "rejected", r), [ 4 /*yield*/ , this.Kc(e) ];
    ...
    t.prototype.Zc = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    this.Pc.hu() || Te("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Za.Oh() ];
                  ...
                  case 3:
                    return i = n.sent(), o = $e(i, "Initialization of waitForPendingWrites() operation failed"), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.tl = function(t) {
        this.xc.forEach((function(e) {
            e.forEach((function(e) {
                e.reject(new N$1(E$1.CANCELLED, t));
            }));
        })), this.xc.clear();
    }, t.prototype.Hc = function(t, e) {
        var n = this.Mc[this.currentUser.s()];
        n || (n = new Bt(Pe)), n = n.Re(t, e), this.Mc[this.currentUser.s()] = n;
    }, 
    /**
    ...
    t.prototype.Xc = function(t, e) {
        ...
        // okay for there to be no callback for this ID.
                if (n) {
            var r = n.get(t);
            r && (e ? r.reject(e) : r.resolve(), n = n.remove(t)), this.Mc[this.currentUser.s()] = n;
        }
    }, t.prototype.Gc = function(t, e) {
        var n = this;
        void 0 === e && (e = null), this.Cc.Zu(t);
        for (var r = 0, i = this.$c.get(t); r < i.length; r++) {
            var o = i[r];
            this.Nc.delete(o), e && this.Fc.el(o, e);
        }
        this.$c.delete(t), this.Uc && this.qc.Po(t).forEach((function(t) {
            n.qc.yo(t) || 
        ...
        var e = this.Lc.get(t);
        null !== e && (this.Pc.yu(e), this.Lc = this.Lc.remove(t), this.Oc.delete(e), this.Yc());
    }, t.prototype.jc = function(t, e) {
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof nr ? (this.qc.to(i.key, t), this.il(i)) : i instanceof rr ? (Te("SyncEngine", "Document no longer in limbo: " + i.key), 
            this.qc.eo(i.key, t), this.qc.yo(i.key) || 
            // We removed the last reference for this key
            this.sl(i.key)) : Re();
        }
    }, t.prototype.il = function(t) {
        var e = t.key;
        this.Lc.get(e) || (Te("SyncEngine", "New document in limbo: " + e), this.kc.push(e), 
        this.Yc());
    }, 
    /**
     ...
     */
    t.prototype.Yc = function() {
        for (;this.kc.length > 0 && this.Lc.size < this.Dc; ) {
            var t = this.kc.shift(), e = this.Bc.next();
            this.Oc.set(e, new ur(t)), this.Lc = this.Lc.Re(t, e), this.Pc.listen(new xt(St.Wt(t.path).ee(), e, 2 /* LimboResolution */ , Ge.er));
        }
    }, 
    // Visible for testing
    ...
    t.prototype.rl = function() {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = [], i = [], o = [], this.Nc.forEach((function(n, u) {
                        o.push(Promise.resolve().then((function() {
                            var e = u.view.cc(t);
                            return e.fc ? s.Za.co(u.query, /* usePreviousResults= */ !1).then((function(t) {
                                var n = t.documents;
                                return u.view.cc(n, e);
                            })) : e;
                            // The query has a limit and some docs were removed, so we need
                            // to re-run the query against the local store to make sure we
                            // didn't lose any good docs that had been past the limit.
                                                })).then((function(t) {
                            var n = r && r.as.get(u.targetId), o = u.view.dc(t, 
                            /* updateLimboDocuments= */ s.Uc, n);
                            if (s.jc(u.targetId, o.Ec), o.snapshot) {
                                s.Uc && s.Cc.Ju(u.targetId, o.snapshot.fromCache ? "not-current" : "current"), e.push(o.snapshot);
                  ...
                  case 1:
                    return n.sent(), this.Fc.Va(e), [ 4 /*yield*/ , this.Za.Zh(i) ];
    ...
    }, t.prototype.Qc = function(t) {}, t.prototype.Uu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e;
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.currentUser.isEqual(t) ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , this.Za.Ah(t) ];

                  case 1:
                    return e = n.sent(), this.currentUser = t, 
                    // Fails tasks waiting for pending writes requested by previous user.
                    this.tl("'waitForPendingWrites' promise is rejected due to a user change."), 
                    // TODO(b/114226417): Consider calling this only in the primary tab.
                    this.Cc.Ah(t, e.ph, e.yh), [ 4 /*yield*/ , this.Kc(e.Vh) ];

                  case 2:
                    n.sent(), n.label = 3;

                  case 3:
                    return [ 4 /*yield*/ , this.Pc.Uu() ];
        ...
        var e = this.Oc.get(t);
        if (e && e.Sc) return ne().add(e.key);
        var n = ne(), r = this.$c.get(t);
        if (!r) return n;
        for (var i = 0, o = r; i < o.length; i++) {
            var s = o[i], u = this.Nc.get(s);
            n = n.ze(u.view.uc);
        }
        return n;
    }, t;
}(), hr = function() {
    this.hl = void 0, this.ol = [];
}, cr = /** @class */ function() {
    function t(t) {
        this.bu = t, this.al = new Me((function(t) {
            return t.canonicalId();
        })), this.onlineState = "Unknown" /* Unknown */ , this.ul = new Set, this.bu.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.al.get(e)) || (r = !0, i = new hr), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), o = i, [ 4 /*yield*/ , this.bu.listen(e) ];

                  case 2:
                    return o.hl = n.sent(), [ 3 /*break*/ , 4 ];

                  case 3:
                    return s = n.sent(), u = $e(s, "Initialization of query '" + t.query + "' failed"), 
                    [ 2 /*return*/ , void t.onError(u) ];

                  case 4:
                    return this.al.set(e, i), i.ol.push(t), 
                    // Run global snapshot listeners if a consistent snapshot has been emitted.
                    t.mc(this.onlineState), i.hl && t.cl(i.hl) && this.ll(), [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.yu = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            var e, r, i, o;
            return __generator(this, (function(n) {
                return e = t.query, r = !1, (i = this.al.get(e)) && (o = i.ol.indexOf(t)) >= 0 && (i.ol.splice(o, 1), 
                r = 0 === i.ol.length), r ? [ 2 /*return*/ , (this.al.delete(e), this.bu.yu(e)) ] : [ 2 /*return*/ ];
            }));
        }));
    }, t.prototype.Va = function(t) {
        for (var e = !1, n = 0, r = t; n < r.length; n++) {
            var i = r[n], o = i.query, s = this.al.get(o);
            if (s) {
                for (var u = 0, a = s.ol; u < a.length; u++) {
                    a[u].cl(i) && (e = !0);
                }
                s.hl = i;
            }
        ...
        var n = this.al.get(t);
        if (n) for (var r = 0, i = n.ol; r < i.length; r++) {
            i[r].onError(e);
        }
        ...
        this.onlineState = t;
        var e = !1;
        this.al.forEach((function(n, r) {
            for (var i = 0, o = r.ol; i < o.length; i++) {
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                o[i].mc(t) && (e = !0);
            }
        })), e && this.ll();
    ...
    function t(t, e, n) {
        this.query = t, this.dl = e, 
        /**
             * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
             * observer. This flag is set to true once we've actually raised an event.
             */
        this.wl = !1, this.Tl = null, this.onlineState = "Unknown" /* Unknown */ , this.options = n || {}
        /**
    ...
    return t.prototype.cl = function(t) {
        ...
        var o = !1;
        return this.wl ? this.El(t) && (this.dl.next(t), o = !0) : this.ml(t, this.onlineState) && (this.Il(t), 
        o = !0), this.Tl = t, o;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.mc = function(t) {
        this.onlineState = t;
        var e = !1;
        return this.Tl && !this.wl && this.ml(this.Tl, t) && (this.Il(this.Tl), e = !0), 
        e;
        ...
        // above) and are waiting for a sync.
                return !(this.options.Rl && n || t.docs.M() && "Offline" /* Offline */ !== e);
        ...
        t = ue.os(t.query, t.docs, t.ns, t.fromCache), this.wl = !0, this.dl.next(t);
    }, t;
}(), lr = /** @class */ function() {
    function t() {}
    return t.prototype.Rh = function(t) {
        ...
        // collection, rather than to perform individual lookups.
                return e.te() || n.isEqual(V$1.min()) ? this.Pl(t, e) : this.Al.qn(t, r).next((function(o) {
            var u = i.Vl(e, o);
            return (e.oe() || e.ae()) && i.fc(e.xt, u, r, n) ? i.Pl(t, e) : (Ie() <= LogLevel.DEBUG && Te("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), e.toString()), 
            i.Al.Bn(t, e, n).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Vl = function(t, e) {
    ...
    t.prototype.fc = function(t, e, n, r) {
        ...
        return Ie() <= LogLevel.DEBUG && Te("IndexFreeQueryEngine", "Using full collection scan to execute query:", e.toString()), 
        this.Al.Bn(t, e, V$1.min());
    }, t;
}(), pr = /** @class */ function() {
    function t(t, e) {
        this.Fn = t, this.Yh = e, 
        ...
        this.yl = new Wt(nn.To);
    }
    return t.prototype.gl = function(t) {
        return xe.resolve(0 === this.Dn.length);
    }, t.prototype.Sh = function(t, e, n) {
        var r = e.batchId, i = this.bl(r, "acknowledged");
        return Ve(0 === i), 
        // Verify that the batch in the queue is the one to be acknowledged.
        this.Dn[i], this.lastStreamToken = n, xe.resolve();
        ...
        var i = this.pl;
        this.pl++, this.Dn.length > 0 && this.Dn[this.Dn.length - 1];
        var o = new qe(i, e, n, r);
        this.Dn.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.yl = this.yl.add(new nn(a.key, i)), this.Fn.mr(t, a.key.path.L());
        }
        return xe.resolve(o);
    }, t.prototype.kh = function(t, e) {
        return xe.resolve(this.vl(e));
    }, t.prototype.io = function(t, e) {
        var n = e + 1, r = this.Sl(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return xe.resolve(this.Dn.length > i ? this.Dn[i] : null);
    }, t.prototype.Oh = function() {
        return xe.resolve(0 === this.Dn.length ? -1 : this.pl - 1);
    }, t.prototype.Ph = function(t) {
        return xe.resolve(this.Dn.slice());
    }, t.prototype.$n = function(t, e) {
        var n = this, r = new nn(e, 0), i = new nn(e, Number.POSITIVE_INFINITY), o = [];
        return this.yl.Ge([ r, i ], (function(t) {
            var e = n.vl(t.bo);
            o.push(e);
        })), xe.resolve(o);
    }, t.prototype.xn = function(t, e) {
        var n = this, r = new Wt(Pe);
        return e.forEach((function(t) {
            var e = new nn(t, 0), i = new nn(t, Number.POSITIVE_INFINITY);
            n.yl.Ge([ e, i ], (function(t) {
                r = r.add(t.bo);
            }));
        })), xe.resolve(this.Cl(r));
        ...
        // because it precedes all other segments in an ordered traversal.
                U$1.et(i) || (i = i.child(""));
        var o = new nn(new U$1(i), 0), s = new Wt(Pe);
        // Find unique batchIDs referenced by all documents potentially matching the
        // query.
                return this.yl.He((function(t) {
            var e = t.key.path;
            return !!n.B(e) && (
            ...
            // ancestor queries.
            e.length === r && (s = s.add(t.bo)), !0);
        }), o), xe.resolve(this.Cl(s));
        ...
        var n = this;
        Ve(0 === this.bl(e.batchId, "removed")), this.Dn.shift();
        var r = this.yl;
        return xe.forEach(e.mutations, (function(i) {
            var o = new nn(i.key, e.batchId);
            return r = r.delete(o), n.Yh.Dl(t, i.key);
        })).next((function() {
            n.yl = r;
        }));
    }, t.prototype.Fl = function(t) {
        ...
        var n = new nn(e, 0), r = this.yl.Ke(n);
        return xe.resolve(e.isEqual(r && r.key));
    }, t.prototype.Nh = function(t) {
        return this.Dn.length, xe.resolve();
    }, 
    /**
    ...
    t.prototype.Hh = function(t) {
        ...
        for (var r = Xt(), i = new U$1(e.path.child("")), o = this.docs.ve(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.$e(); ) {
            var s = o.Ne(), u = s.key, a = s.value, h = a.$l, c = a.readTime;
...
dr.Ll = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Ql = t, n;
    }
    return __extends(n, e), n.prototype.dc = function(t) {
        var e = this, n = [];
        return this.vh.forEach((function(r, i) {
            i ? n.push(e.Ql.Kh(t, i, e.readTime)) : e.Ql.Hh(r);
        })), xe.vn(n);
    }, n.prototype.Bl = function(t, e) {
        return this.Ql.Ln(t, e);
    }, n.prototype.Ul = function(t, e) {
        return this.Ql.getEntries(t, e);
    }, n;
}(/** @class */ function() {
    function t() {
        // A mapping of document key to the new cache entry that should be written (or null if any
        // existing cache entry should be removed).
        this.vh = new Me((function(t) {
            return t.toString();
        })), this.ql = !1;
    }
     ...
     */
    t.prototype.Kh = function(t, e) {
        this.xl(), this.readTime = e, this.vh.set(t.key, t);
    }, 
    /**
    ...
    t.prototype.Hh = function(t, e) {
        this.xl(), e && (this.readTime = e), this.vh.set(t, null);
    }, 
    /**
    ...
    t.prototype.Ln = function(t, e) {
        this.xl();
        var n = this.vh.get(e);
        return void 0 !== n ? xe.resolve(n) : this.Bl(t, e);
    }, 
    /**
     ...
     */
    t.prototype.apply = function(t) {
        return this.xl(), this.ql = !0, this.dc(t);
    }, 
    /** Helper to assert this.changes is not null  */ t.prototype.xl = function() {}, 
    t;
}());
...
var yr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.Gl = new en, this.targetCount = 0, this.Hl = Ye.Rr();
    }
    return t.prototype.js = function(t, e) {
        return this.Wl.forEach((function(t, n) {
            return e(n);
        })), xe.resolve();
    }, t.prototype.xh = function(t) {
        return xe.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.Kl = function(t) {
        return xe.resolve(this.jl);
    }, t.prototype.oo = function(t) {
        return this.highestTargetId = this.Hl.next(), xe.resolve(this.highestTargetId);
    }, t.prototype.Xh = function(t, e, n) {
        return n && (this.lastRemoteSnapshotVersion = n), e > this.jl && (this.jl = e), 
        xe.resolve();
    }, t.prototype.zl = function(t) {
        this.Wl.set(t.target, t);
        var e = t.targetId;
        e > this.highestTargetId && (this.Hl = new Ye(e), this.highestTargetId = e), t.sequenceNumber > this.jl && (this.jl = t.sequenceNumber);
    }, t.prototype.ao = function(t, e) {
        return this.zl(e), this.targetCount += 1, xe.resolve();
    }, t.prototype.Gh = function(t, e) {
        return this.zl(e), xe.resolve();
    }, t.prototype.Yl = function(t, e) {
        return this.Wl.delete(e.target), this.Gl.Po(e.targetId), this.targetCount -= 1, 
        xe.resolve();
    }, t.prototype.Xl = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Wl.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.Wl.delete(s), o.push(r.Jl(t, u.targetId)), 
            i++);
        ...
        var n = this.Wl.get(e) || null;
        return xe.resolve(n);
    }, t.prototype.Qh = function(t, e, n) {
        return this.Gl.Io(e, n), xe.resolve();
    }, t.prototype.Uh = function(t, e, n) {
        this.Gl.Ao(e, n);
        var r = this.persistence.Yh, i = [];
        return r && e.forEach((function(e) {
            i.push(r.Dl(t, e));
        })), xe.vn(i);
    }, t.prototype.Jl = function(t, e) {
        return this.Gl.Po(e), xe.resolve();
    }, t.prototype.lo = function(t, e) {
        var n = this.Gl.po(e);
        return xe.resolve(n);
    }, t.prototype.yo = function(t, e) {
        return xe.resolve(this.Gl.yo(e));
    }, t;
}(), vr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.t_ = {}, this.e_ = new Ge(0), this.s_ = !1, this.s_ = !0, this.Yh = t(this), 
        this.Th = new yr(this), this.Fn = new Qe, this.Cn = new dr(this.Fn, (function(t) {
            return e.Yh.i_(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        return this.s_ = !1, Promise.resolve();
        ...
        var e = this.t_[t.s()];
        return e || (e = new pr(this.Fn, this.Yh), this.t_[t.s()] = e), e;
        ...
        var i = new mr(this.e_.next());
        return this.Yh.h_(), n(i).next((function(t) {
            return r.Yh.o_(i).next((function() {
                return t;
            }));
        })).gn().then((function(t) {
            return i.a_(), t;
        ...
        return xe.Sn(Object.values(this.t_).map((function(n) {
            return function() {
                return n.yo(t, e);
            };
        })));
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Wh = t, n;
    }
    /**
    ...
    return t.d_ = function(e) {
        ...
        return this.__.to(n, e), this.w_.delete(n), xe.resolve();
    }, t.prototype.eo = function(t, e, n) {
        return this.__.eo(n, e), this.w_.add(n), xe.resolve();
    }, t.prototype.Dl = function(t, e) {
        return this.w_.add(e), xe.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.__.Po(e.targetId).forEach((function(t) {
            return n.w_.add(t);
        }));
        var r = this.persistence.Eh();
        return r.lo(t, e.targetId).next((function(t) {
            t.forEach((function(t) {
                return n.w_.add(t);
            }));
        })).next((function() {
        ...
        // Remove newly orphaned documents.
                return xe.forEach(this.w_, (function(r) {
        ...
        return xe.Sn([ function() {
            return xe.resolve(n.__.yo(e));
        }, function() {
            return n.persistence.Eh().yo(t, e);
        }, function() {
            return n.persistence.u_(t, e);
        } ]);
    }, t;
}(), wr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Cc = this.E_(t), this.persistence = this.m_(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return n.sent(), this.I_ = this.R_(t), this.Za = this.A_(t), this.Pc = this.P_(t), 
                    this.bu = this.V_(t), this.p_ = this.y_(t), this.Cc.Wa = function(t) {
                        return e.bu.mc(t, 1 /* SharedClientState */);
                    }, this.Pc.bu = this.bu, [ 4 /*yield*/ , this.Za.start() ];
                  ...
                  case 4:
                    return n.sent(), [ 4 /*yield*/ , this.Pc.Qu(this.bu.Uc) ];
        ...
        return new cr(this.bu);
    }, t.prototype.R_ = function(t) {
        return null;
    }, t.prototype.A_ = function(t) {
        return new Ke(this.persistence, new lr, t.g_);
    }, t.prototype.m_ = function(t) {
        return new vr(gr.d_);
    }, t.prototype.P_ = function(t) {
        var e = this;
        return new Kn(this.Za, t.ka, t.Pr, (function(t) {
            return e.bu.mc(t, 0 /* RemoteStore */);
        }), t.platform.b_());
    }, t.prototype.E_ = function(t) {
        return new er;
    }, t.prototype.V_ = function(t) {
        return new ar(this.Za, this.Pc, this.Cc, t.g_, t.Dc);
    }, t.prototype.clearPersistence = function(t) {
        throw new N$1(E$1.FAILED_PRECONDITION, "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.");
    }, t;
}(), br = /** @class */ function() {
    function t(t, e, n, 
    /**
     ...
     */
    r) {
        this.platform = t, this.v_ = e, this.credentials = n, this.Pr = r, this.clientId = ke.cn()
        /**
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.credentials._((function(s) {
            if (!o) return o = !0, Te("FirestoreClient", "Initializing. user=", s.uid), n.C_(t, e, s, i).then(r.resolve, r.reject);
            n.Pr.jr((function() {
                return n.Uu(s);
            }));
        })), 
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        var t = this;
        return this.S_(), this.Pr.enqueue((function() {
            return t.bu.enableNetwork();
        }));
    }, 
    /**
     ...
     *     succeeded.
     */
    t.prototype.C_ = function(t, r, i, o) {
        return __awaiter(this, void 0, void 0, (function() {
            var s, u, a, h, c = this;
            return __generator(this, (function(f) {
                switch (f.label) {
                  case 0:
                    return f.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , this.platform.D_(this.v_) ];

                  case 1:
                    return s = f.sent(), u = this.platform.Ho(this.v_.ii), a = function(t, e, n) {
                        return new Jn(t, e, n);
                  ...
                  case 2:
                    return f.sent(), this.persistence = t.persistence, this.Cc = t.Cc, this.Za = t.Za, 
                    this.Pc = t.Pc, this.bu = t.bu, this.I_ = t.I_, this.N_ = t.p_, 
                    // When a user calls clearPersistence() in one client, all other clients
                    // need to be terminated to allow the delete to succeed.
                    this.persistence.r_((function() {
    ...
    t.prototype.S_ = function() {
        if (this.Pr.Mr) throw new N$1(E$1.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.Uu = function(t) {
        return this.Pr.Hr(), Te("FirestoreClient", "Credential Changed. Current user: " + t.uid), 
        this.bu.Uu(t);
    }, 
    /** Disables the network connection. Pending operations will not complete. */ t.prototype.disableNetwork = function() {
        var t = this;
        return this.S_(), this.Pr.enqueue((function() {
            return t.bu.disableNetwork();
        }));
                ...
                return __generator(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        ...
                        return this.I_ && this.I_.stop(), [ 4 /*yield*/ , this.Pc.Vu() ];

                      case 1:
                        return t.sent(), [ 4 /*yield*/ , this.Cc.Vu() ];

                      case 2:
                        return t.sent(), [ 4 /*yield*/ , this.persistence.Vu() ];
    ...
    t.prototype.waitForPendingWrites = function() {
        ...
        var i = new fr(t, e, n);
        return this.Pr.Sr((function() {
            return r.N_.listen(i);
        })), i;
    }, t.prototype.yu = function(t) {
        var e = this;
        // Checks for termination but does not raise error, allowing unlisten after
        // termination to be a no-op.
                this.O_ || this.Pr.Sr((function() {
            return e.N_.yu(t);
        }));
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.S_(), r = new Be, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return __awaiter(i, void 0, void 0, (function() {
                            var e, i, o;
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Za.no(t) ];

                                  case 1:
                                    return (e = n.sent()) instanceof _t ? r.resolve(e) : e instanceof Dt ? r.resolve(null) : r.reject(new N$1(E$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                    [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return i = n.sent(), o = $e(i, "Failed to get document '" + t + " from cache"), 
                    ...
                    return this.S_(), r = new Be, [ 4 /*yield*/ , this.Pr.enqueue((function() {
                        return __awaiter(i, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Za.co(t, 
                                    /* usePreviousResults= */ !0) ];

                                  case 1:
                                    return e = n.sent(), i = new ir(t, e._o), o = i.cc(e.documents), s = i.dc(o, 
                                    /* updateLimboDocuments= */ !1), r.resolve(s.snapshot), [ 3 /*break*/ , 3 ];

                                  case 2:
                                    return u = n.sent(), a = $e(u, "Failed to execute query '" + t + " against cache"), 
        ...
        var n = new Be;
        return this.Pr.Sr((function() {
            return e.bu.write(t, n);
        })), n.promise;
    }, t.prototype.ii = function() {
        return this.v_.ii;
    }, t.prototype._l = function(t) {
        var e = this;
        this.S_(), this.Pr.Sr((function() {
            return e.N_._l(t), Promise.resolve();
        }));
    }, t.prototype.fl = function(t) {
        var e = this;
        ...
        // shutdown to be a no-op.
                this.O_ || this.Pr.Sr((function() {
            return e.N_.fl(t), Promise.resolve();
        }));
        ...
        var n = new Be;
        return this.Pr.Sr((function() {
            return e.bu.runTransaction(e.Pr, t, n), Promise.resolve();
        })), n.promise;
    }, t;
}(), Er = /** @class */ function() {
    function t(t) {
    ...
    return t.prototype.next = function(t) {
        this.x_(this.observer.next, t);
    }, t.prototype.error = function(t) {
        this.x_(this.observer.error, t);
...
var Ir = /** @class */ function() {
    function t(t, e, n, r) {
        this.firestore = t, this.timestampsInSnapshots = e, this.U_ = n, this.converter = r;
    }
    return t.prototype.Q_ = function(t) {
        switch (z(t)) {
          ...
          case 3 /* TimestampValue */ :
            return this.W_(t.timestampValue);
          ...
          case 6 /* BlobValue */ :
            return new An(X$1(t.bytesValue));

          case 7 /* RefValue */ :
            return this.G_(t.referenceValue);

          case 8 /* GeoPointValue */ :
            return this.H_(t.geoPointValue);

          case 9 /* ArrayValue */ :
            return this.K_(t.arrayValue);
        ...
        switch (this.U_) {
          case "previous":
            ...
            return null == e ? null : this.Q_(e);

          case "estimate":
            return this.W_(G$1(t));

          default:
            return null;
        }
    }, t.prototype.W_ = function(t) {
        var e = J$1(t), n = new R$1(e.seconds, e.nanos);
        return this.timestampsInSnapshots ? n : n.toDate();
    }, t.prototype.G_ = function(t) {
        var e = k$1.G(t);
        Ve(be(e));
        var n = new Oe(e.get(1), e.get(3)), r = new U$1(e.k(5));
        return n.isEqual(this.firestore.ta) || 
        // TODO(b/64130202): Somehow support foreign references.
        _e("Document " + r + " contains a document reference within a different database (" + n.projectId + "/" + n.database + ") which is not supported. It will be treated as a reference in the current database (" + this.firestore.ta.projectId + "/" + this.firestore.ta.database + ") instead."), 
        new Vr(r, this.firestore, this.converter);
    }, t;
}(), Ar = Xe.nh, Tr = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new N$1(E$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else cn("settings", "non-empty string", "host", t.host), this.host = t.host, fn("settings", "boolean", "ssl", t.ssl), 
        this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (mn("settings", t, [ "host", "ssl", "credentials", "timestampsInSnapshots", "cacheSizeBytes", "experimentalForceLongPolling", "ignoreUndefinedProperties" ]), 
        fn("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        fn("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), fn("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        fn("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Xe.hh; else {
            if (t.cacheSizeBytes !== Ar && t.cacheSizeBytes < Xe.rh) throw new N$1(E$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Xe.rh);
    ...
    function t(r, i, o) {
        var s = this;
        if (void 0 === o && (o = new wr), this.Y_ = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.X_ = new Je, this.INTERNAL = {
            delete: function() {
                    ...
                    return __generator(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            ...
                            // throws an exception.
                            return this.J_(), [ 4 /*yield*/ , this.Z_.terminate() ];
            ...
            var u = r;
            this.Y_ = u, this.ta = t.tf(u), this.ef = u.name, this.sf = new T$1(i);
        } else {
            var a = r;
            if (!a.projectId) throw new N$1(E$1.INVALID_ARGUMENT, "Must provide projectId");
            this.ta = new Oe(a.projectId, a.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.ef = "[DEFAULT]", this.sf = new A$1;
        }
        this.if = o, this.nf = new Tr({});
    }
    return Object.defineProperty(t.prototype, "rf", {
        get: function() {
            return this.hf || (
            // Lazy initialize UserDataReader once the settings are frozen
            this.hf = new xn(this.ta, this.nf.ignoreUndefinedProperties)), this.hf;
        },
        enumerable: !0,
        configurable: !0
        ...
        var e = new Tr(t);
        if (this.Z_ && !this.nf.isEqual(e)) throw new N$1(E$1.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        this.nf = e, void 0 !== e.credentials && (this.sf = function(t) {
            if (!t) return new A$1;
            switch (t.type) {
              case "gapi":
                var e = t.af;
              ...
              default:
                throw new N$1(E$1.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(e.credentials));
    }, t.prototype.enableNetwork = function() {
        return this.J_(), this.Z_.enableNetwork();
    }, t.prototype.disableNetwork = function() {
        return this.J_(), this.Z_.disableNetwork();
    }, t.prototype.enablePersistence = function(t) {
        var e, n;
        if (this.Z_) throw new N$1(E$1.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1;
        ...
        this.uf(this.if, {
            L_: !0,
            cacheSizeBytes: this.nf.cacheSizeBytes,
            synchronizeTabs: r
        });
        ...
        return __awaiter(this, void 0, void 0, (function() {
            var t, r = this;
            return __generator(this, (function(i) {
                if (void 0 !== this.Z_ && !this.Z_.O_) throw new N$1(E$1.FAILED_PRECONDITION, "Persistence cannot be cleared after this Firestore instance is initialized.");
                return t = new Be, [ 2 /*return*/ , (this.X_.xr((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e, r;
                        return __generator(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), e = this.cf(), [ 4 /*yield*/ , this.if.clearPersistence(e) ];
        ...
        get: function() {
            return this.J_(), this.Z_.O_;
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.waitForPendingWrites = function() {
        return this.J_(), this.Z_.waitForPendingWrites();
    }, t.prototype.onSnapshotsInSync = function(t) {
        if (this.J_(), Nr(t)) return this._f(t);
        ...
        return new Ue(this.ta, this.ef, this.nf.host, this.nf.ssl, this.nf.forceLongPolling);
    }, t.prototype.uf = function(t, e) {
        var n = this.cf();
        return this.Z_ = new br(Ee.nt(), n, this.sf, this.X_), this.Z_.start(t, e);
    }, t.tf = function(t) {
        if (e = t.options, !Object.prototype.hasOwnProperty.call(e, "projectId")) throw new N$1(E$1.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
 ...
 */        if (!n || "string" != typeof n) throw new N$1(E$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        return new Oe(n);
    }, Object.defineProperty(t.prototype, "app", {
        get: function() {
            if (!this.Y_) throw new N$1(E$1.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.Y_;
        },
        enumerable: !0,
        configurable: !0
        ...
        this.J_(), new Or(k$1.G(t), this);
    }, t.prototype.doc = function(t) {
        return on("Firestore.doc", arguments, 1), an("Firestore.doc", "non-empty string", 1, t), 
        this.J_(), Vr.ff(k$1.G(t), this);
    }, t.prototype.collectionGroup = function(t) {
        if (on("Firestore.collectionGroup", arguments, 1), an("Firestore.collectionGroup", "non-empty string", 1, t), 
        t.indexOf("/") >= 0) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid collection ID '" + t + "' passed to function Firestore.collectionGroup(). Collection IDs must not contain '/'.");
        return this.J_(), new Lr(new St(k$1.H, t), this);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return on("Firestore.runTransaction", arguments, 1), an("Firestore.runTransaction", "function", 1, t), 
        this.J_().transaction((function(n) {
            return t(new Dr(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.J_(), new Rr(this);
        ...
        t) {
          ...
          default:
            throw new N$1(E$1.INVALID_ARGUMENT, "Invalid log level: " + t);
        }
    }, 
    // Note: this is not a property because the minifier can't work correctly with
    // the way TypeScript compiler outputs properties.
    t.prototype.df = function() {
        return this.nf.timestampsInSnapshots;
    }, t;
}(), Dr = /** @class */ function() {
    function t(t, e) {
        this.wf = t, this.Tf = e;
    ...
    return t.prototype.get = function(t) {
        ...
        var n = xr("Transaction.get", t, this.wf);
        return this.Tf.xa([ n.ea ]).then((function(t) {
            if (!t || 1 !== t.length) return Re();
            var r = t[0];
            if (r instanceof Dt) return new kr(e.wf, n.ea, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Ef);
            if (r instanceof _t) return new kr(e.wf, n.ea, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.Ef);
            throw Re();
        }));
        ...
        var r = xr("Transaction.set", t, this.wf);
        n = Mr("Transaction.set", n);
        var i = jr(r.Ef, e, "Transaction.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.wf.rf.Yo(s, o, n.mergeFields) : this.wf.rf.Ko(s, o);
        return this.Tf.set(r.ea, u), this;
        ...
        r = xr("Transaction.update", t, this.wf), i = this.wf.rf.Jo("Transaction.update", e, n, o)) : (on("Transaction.update", arguments, 2), 
        r = xr("Transaction.update", t, this.wf), i = this.wf.rf.Xo("Transaction.update", e)), 
        this.Tf.update(r.ea, i), this;
    }, t.prototype.delete = function(t) {
        on("Transaction.delete", arguments, 1);
        var e = xr("Transaction.delete", t, this.wf);
        return this.Tf.delete(e.ea), this;
    }, t;
}(), Rr = /** @class */ function() {
    function t(t) {
        this.wf = t, this.mf = [], this.If = !1;
    }
    return t.prototype.set = function(t, e, n) {
        un("WriteBatch.set", arguments, 2, 3), this.Rf();
        var r = xr("WriteBatch.set", t, this.wf);
        n = Mr("WriteBatch.set", n);
        var i = jr(r.Ef, e, "WriteBatch.set"), o = i[0], s = i[1], u = n.merge || n.mergeFields ? this.wf.rf.Yo(s, o, n.mergeFields) : this.wf.rf.Ko(s, o);
        return this.mf = this.mf.concat(u.xo(r.ea, pt.dt())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Rf(), "string" == typeof e || e instanceof Tn ? (sn("WriteBatch.update", arguments, 3), 
        r = xr("WriteBatch.update", t, this.wf), i = this.wf.rf.Jo("WriteBatch.update", e, n, o)) : (on("WriteBatch.update", arguments, 2), 
        r = xr("WriteBatch.update", t, this.wf), i = this.wf.rf.Xo("WriteBatch.update", e)), 
        this.mf = this.mf.concat(i.xo(r.ea, pt.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        on("WriteBatch.delete", arguments, 1), this.Rf();
        var e = xr("WriteBatch.delete", t, this.wf);
        return this.mf = this.mf.concat(new gt(e.ea, pt.dt())), this;
    }, t.prototype.commit = function() {
        return this.Rf(), this.If = !0, this.mf.length > 0 ? this.wf.J_().write(this.mf) : Promise.resolve();
    }, t.prototype.Rf = function() {
        if (this.If) throw new N$1(E$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), Vr = /** @class */ function() {
    function t(t, e, n) {
        this.ea = t, this.firestore = e, this.Ef = n, this.Z_ = this.firestore.J_();
    }
    return t.ff = function(e, n, r) {
        if (e.length % 2 != 0) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + e.j() + " has " + e.length);
        return new t(new U$1(e), n, r);
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.ea.path.q();
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(t.prototype, "parent", {
        get: function() {
            return new Or(this.ea.path.L(), this.firestore, this.Ef);
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(t.prototype, "path", {
        get: function() {
            return this.ea.path.j();
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.collection = function(t) {
        if (on("DocumentReference.collection", arguments, 1), an("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new N$1(E$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = k$1.G(t);
        return new Or(this.ea.path.child(e), this.firestore);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw gn("isEqual", "DocumentReference", 1, e);
        return this.firestore === e.firestore && this.ea.isEqual(e.ea) && this.Ef === e.Ef;
    }, t.prototype.set = function(t, e) {
        un("DocumentReference.set", arguments, 1, 2), e = Mr("DocumentReference.set", e);
        var n = jr(this.Ef, t, "DocumentReference.set"), r = n[0], i = n[1], o = e.merge || e.mergeFields ? this.firestore.rf.Yo(i, r, e.mergeFields) : this.firestore.rf.Ko(i, r);
        return this.Z_.write(o.xo(this.ea, pt.dt()));
    }, t.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Tn ? (sn("DocumentReference.update", arguments, 2), 
        n = this.firestore.rf.Jo("DocumentReference.update", t, e, r)) : (on("DocumentReference.update", arguments, 1), 
        n = this.firestore.rf.Xo("DocumentReference.update", t)), this.Z_.write(n.xo(this.ea, pt.exists(!0)));
    }, t.prototype.delete = function() {
        return on("DocumentReference.delete", arguments, 0), this.Z_.write([ new gt(this.ea, pt.dt()) ]);
        ...
        "object" != typeof t[i] || Nr(t[i]) || (mn("DocumentReference.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        fn("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++);
        var o = {
            includeMetadataChanges: r.includeMetadataChanges
        };
        return Nr(t[i]) ? n = t[i] : (an("DocumentReference.onSnapshot", "function", i, t[i]), 
        ...
        var i = new Er({
            next: function(t) {
                if (e.next) {
                    var r = t.docs.get(n.ea);
                    e.next(new kr(n.firestore, n.ea, r, t.fromCache, t.hasPendingWrites, n.Ef));
                }
            },
            error: r
        }), o = this.Z_.listen(St.Wt(this.ea.path), i, t);
        return function() {
            i.B_(), n.Z_.yu(o);
        };
    }, t.prototype.get = function(t) {
        ...
        new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.J_().q_(e.ea).then((function(t) {
                n(new kr(e.firestore, e.ea, t, 
                /*fromCache=*/ !0, t instanceof _t && t.At, e.Ef));
            }), r) : e.Pf(n, r, t);
        }));
        ...
        var r = this.Af({
            ...
            next: function(i) {
                ...
                e(new N$1(E$1.UNAVAILABLE, "Failed to get document because the client is offline.")) : i.exists && i.metadata.fromCache && n && "server" === n.source ? e(new N$1(E$1.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : t(i);
            },
            error: e
        });
    }, t.prototype.withConverter = function(e) {
        return new t(this.ea, this.firestore, e);
    }, t;
}(), Sr = /** @class */ function() {
    function t(t, e) {
    ...
    function t(t, e, n, r, i, o) {
        this.wf = t, this.ea = e, this.Vf = n, this.pf = r, this.yf = i, this.Ef = o;
    }
    return t.prototype.data = function(t) {
        if (un("DocumentSnapshot.data", arguments, 0, 1), t = qr("DocumentSnapshot.data", t), 
        this.Vf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.Ef) {
                var e = new Pr(this.wf, this.ea, this.Vf, this.pf, this.yf);
                return this.Ef.fromFirestore(e, t);
            }
            return new Ir(this.wf, this.wf.df(), t.serverTimestamps, 
            /* converter= */ void 0).Q_(this.Vf.Lt());
        }
    }, t.prototype.get = function(t, e) {
        if (un("DocumentSnapshot.get", arguments, 1, 2), e = qr("DocumentSnapshot.get", e), 
        this.Vf) {
            var n = this.Vf.data().field(zn("DocumentSnapshot.get", t));
            if (null !== n) return new Ir(this.wf, this.wf.df(), e.serverTimestamps, this.Ef).Q_(n);
        }
    }, Object.defineProperty(t.prototype, "id", {
        get: function() {
            return this.ea.path.q();
        ...
        get: function() {
            return new Vr(this.ea, this.wf, this.Ef);
        },
        enumerable: !0,
        configurable: !0
        ...
        get: function() {
            return new Sr(this.yf, this.pf);
        },
        enumerable: !0,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw gn("isEqual", "DocumentSnapshot", 1, e);
        return this.wf === e.wf && this.pf === e.pf && this.ea.isEqual(e.ea) && (null === this.Vf ? null === e.Vf : this.Vf.isEqual(e.Vf)) && this.Ef === e.Ef;
    }, t;
}(), Pr = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
...
}(kr), Lr = /** @class */ function() {
    function t(t, e, n) {
        this.gf = t, this.firestore = e, this.Ef = n;
    }
    return t.prototype.where = function(e, n, r) {
        ...
        var i, o = function(t, e, n, r) {
            if (!e.some((function(t) {
                return t === r;
            }))) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid value " + yn(r) + " provided to function Query.where() for its " + bn(2) + " argument. Acceptable values: " + e.join(", "));
            return r;
        ...
        if (s.Y()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            if ("in" /* IN */ === o) {
                this.bf(r, o);
        ...
        } else "in" /* IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || this.bf(r, o), 
        i = this.firestore.rf.Zo("Query.where", r, 
        // We only allow nested arrays for IN queries.
        /** allowArrays = */ "in" /* IN */ === o);
        var f = kt.create(s, o, i);
        return this.Sf(f), new t(this.gf.Ht(f), this.firestore, this.Ef);
        ...
        void 0 === n || "asc" === n) r = "asc" /* ASCENDING */; else {
            if ("desc" !== n) throw new N$1(E$1.INVALID_ARGUMENT, "Function Query.orderBy() has unknown direction '" + n + "', expected 'asc' or 'desc'.");
            r = "desc" /* DESCENDING */;
        }
        if (null !== this.gf.startAt) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.gf.endAt) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        var i = zn("Query.orderBy", e), o = new Ct(i, r);
        return this.Cf(o), new t(this.gf.Kt(o), this.firestore, this.Ef);
    }, t.prototype.limit = function(e) {
        return on("Query.limit", arguments, 1), an("Query.limit", "number", 1, e), wn("Query.limit", 1, e), 
        new t(this.gf.zt(e), this.firestore, this.Ef);
    }, t.prototype.limitToLast = function(e) {
        return on("Query.limitToLast", arguments, 1), an("Query.limitToLast", "number", 1, e), 
        wn("Query.limitToLast", 1, e), new t(this.gf.Yt(e), this.firestore, this.Ef);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        sn("Query.startAt", arguments, 1);
        var i = this.Df("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(this.gf.Xt(i), this.firestore, this.Ef);
        ...
        /*before=*/ !0);
        return new t(this.gf.Jt(i), this.firestore, this.Ef);
        ...
        return this.firestore === e.firestore && this.gf.isEqual(e.gf);
    }, t.prototype.withConverter = function(e) {
        return new t(this.gf, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.Df = function(t, e, n, r) {
        if (vn(t, 1, e), e instanceof kr) {
            if (n.length > 0) throw new N$1(E$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "().");
            var i = e;
            if (!i.exists) throw new N$1(E$1.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + t + "().");
            return this.Ff(i.Vf, r);
        }
        var o = [ e ].concat(n);
    ...
    t.prototype.Ff = function(t, e) {
        ...
        // results.
        for (var n = [], r = 0, i = this.gf.orderBy; r < i.length; r++) {
            var o = i[r];
            if (o.field.Y()) n.push(K$1(this.firestore.ta, t.key)); else {
                var s = t.field(o.field);
                if (j(s)) throw new N$1(E$1.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + o.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === s) {
                    var u = o.field.j();
                    throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + u + "' (used as the orderBy) does not exist.");
                }
                n.push(s);
            }
        }
    ...
    t.prototype.Nf = function(t, e, n) {
        ...
        var r = this.gf.Mt;
        if (e.length > r.length) throw new N$1(E$1.INVALID_ARGUMENT, "Too many arguments provided to " + t + "(). The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        for (var i = [], o = 0; o < e.length; o++) {
            var s = e[o];
            if (r[o].field.Y()) {
                if ("string" != typeof s) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + t + "(), but got a " + typeof s);
                if (!this.gf.le() && -1 !== s.indexOf("/")) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + t + "() must be a plain document ID, but '" + s + "' contains a slash.");
                var u = this.gf.path.child(k$1.G(s));
                if (!U$1.et(u)) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new U$1(u);
                i.push(K$1(this.firestore.ta, a));
            } else {
                var h = this.firestore.rf.Zo(t, s);
                i.push(h);
            }
        }
        return new qt(i, n);
        ...
        var n, r = {}, i = 0;
        return "object" != typeof t[i] || Nr(t[i]) || (mn("Query.onSnapshot", r = t[i], [ "includeMetadataChanges" ]), 
        fn("Query.onSnapshot", "boolean", "includeMetadataChanges", r.includeMetadataChanges), 
        i++), Nr(t[i]) ? n = t[i] : (an("Query.onSnapshot", "function", i, t[i]), hn("Query.onSnapshot", "function", i + 1, t[i + 1]), 
        hn("Query.onSnapshot", "function", i + 2, t[i + 2]), n = {
            next: t[i],
            error: t[i + 1],
            complete: t[i + 2]
        }), this.$f(this.gf), this.Af(r, n);
    }, t.prototype.Af = function(t, e) {
        var n = this, r = function(t) {
            console.error("Uncaught Error in onSnapshot:", t);
        };
        ...
        var i = new Er({
            next: function(t) {
                e.next && e.next(new Ur(n.firestore, n.gf, t, n.Ef));
            },
            error: r
        }), o = this.firestore.J_(), s = o.listen(this.gf, i, t);
        return function() {
            i.B_(), o.yu(s);
        };
    }, t.prototype.$f = function(t) {
        if (t.ae() && 0 === t.Mt.length) throw new N$1(E$1.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
    }, t.prototype.get = function(t) {
        var e = this;
        return un("Query.get", arguments, 0, 1), Cr("Query.get", t), this.$f(this.gf), new Promise((function(n, r) {
            t && "cache" === t.source ? e.firestore.J_().M_(e.gf).then((function(t) {
                n(new Ur(e.firestore, e.gf, t, e.Ef));
            }), r) : e.Pf(n, r, t);
        }));
    }, t.prototype.Pf = function(t, e, n) {
        var r = this.Af({
            ...
            next: function(i) {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                r(), i.metadata.fromCache && n && "server" === n.source ? e(new N$1(E$1.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : t(i);
            },
            error: e
        });
    }, 
    ...
    t.prototype.vf = function(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.gf.le() && -1 !== t.indexOf("/")) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + t + "' contains a '/' character.");
            var e = this.gf.path.child(k$1.G(t));
            if (!U$1.et(e)) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return K$1(this.firestore.ta, new U$1(e));
        }
        if (t instanceof Vr) {
            var n = t;
            return K$1(this.firestore.ta, n.ea);
        }
        throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + yn(t) + ".");
    }, 
    /**
    ...
    t.prototype.bf = function(t, e) {
        if (!Array.isArray(t) || 0 === t.length) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
        if (t.length > 10) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
        if (t.indexOf(null) >= 0) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'null' in the value array.");
        if (t.filter((function(t) {
            return Number.isNaN(t);
        })).length > 0) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters cannot contain 'NaN' in the value array.");
        ...
        if (t instanceof kt) {
            ...
            if (t.ue()) {
                var o = this.gf.jt();
                if (null !== o && !o.isEqual(t.field)) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have inequality filters on '" + o.toString() + "' and '" + t.field.toString() + "'");
                var s = this.gf.Gt();
                ...
                var u = null;
                if (i && (u = this.gf.ce(n)), null === u && r && (u = this.gf.ce(e)), null != u) 
                // We special case when it's a duplicate op to give a slightly clearer error message.
                throw u === t.op ? new N$1(E$1.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + t.op.toString() + "' filter.") : new N$1(E$1.INVALID_ARGUMENT, "Invalid query. You cannot use '" + t.op.toString() + "' filters with '" + u.toString() + "' filters.");
            }
        }
        ...
        if (!e.isEqual(t)) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, >, or >=) on field '" + t.toString() + "' and so you must also use '" + t.toString() + "' as your first Query.orderBy(), but your first Query.orderBy() is on field '" + e.toString() + "' instead.");
    }, t;
}(), Ur = /** @class */ function() {
    function t(t, e, n, r) {
        this.wf = t, this.Lf = e, this.Of = n, this.Ef = r, this.qf = null, this.Mf = null, 
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        get: function() {
            return new Lr(this.Lf, this.wf, this.Ef);
        },
        enumerable: !0,
        configurable: !0
        ...
        if (e && this.Of.hs) throw new N$1(E$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        return this.qf && this.Mf === e || (this.qf = 
        /**
     ...
     */
        function(t, e, n, r) {
            if (n.ss.M()) {
                ...
                return n.docChanges.map((function(e) {
                    var o = new Pr(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r);
                    return e.doc, {
                        type: "added",
                        doc: o,
                        oldIndex: -1,
            ...
            return n.docChanges.filter((function(t) {
                ...
                var i = new Pr(t, e.doc.key, e.doc, n.fromCache, n.ns.has(e.doc.key), r), s = -1, u = -1;
        ...
        }(this.wf, e, this.Of, this.Ef), this.Mf = e), this.qf;
    }, 
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.wf === e.wf && this.Lf.isEqual(e.Lf) && this.Of.isEqual(e.Of) && this.Ef === e.Ef;
    }, t.prototype.xf = function(t) {
        return new Pr(this.wf, t.key, t, this.metadata.fromCache, this.Of.ns.has(t.key), this.Ef);
    }, t;
}(), Or = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, St.Wt(t), n, r) || this).Bf = t, t.length % 2 != 1) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.j() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        get: function() {
            return this.gf.path.q();
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(n.prototype, "parent", {
        get: function() {
            var t = this.gf.path.L();
            return t.M() ? null : new Vr(new U$1(t), this.firestore);
        },
        enumerable: !0,
        configurable: !0
    }), Object.defineProperty(n.prototype, "path", {
        get: function() {
            return this.gf.path.j();
        },
        enumerable: !0,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ke.cn()), an("CollectionReference.doc", "non-empty string", 1, t), 
        "" === t) throw new N$1(E$1.INVALID_ARGUMENT, "Document path must be a non-empty string");
        var e = k$1.G(t);
        return Vr.ff(this.gf.path.child(e), this.firestore, this.Ef);
    }, n.prototype.add = function(t) {
        on("CollectionReference.add", arguments, 1), an("CollectionReference.add", "object", 1, this.Ef ? this.Ef.toFirestore(t) : t);
        var e = this.doc();
...
function Mr(t, e) {
    ...
    if (mn(t, e, [ "merge", "mergeFields" ]), fn(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + yn(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new N$1(E$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + yn(r[o]));
        }(t, e, n, r, i);
    }(t, "mergeFields", "a string or a FieldPath", e.mergeFields, (function(t) {
        return "string" == typeof t || t instanceof Tn;
    })), void 0 !== e.mergeFields && void 0 !== e.merge) throw new N$1(E$1.INVALID_ARGUMENT, "Invalid options passed to function " + t + '(): You cannot specify both "merge" and "mergeFields".');
    return e;
}
...
function xr(t, e, n) {
    if (e instanceof Vr) {
        if (e.firestore !== n) throw new N$1(E$1.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
        return e;
    }
...
function Gr(t, e) {
    function n() {
        ...
        throw e && (t += " ", t += e), new N$1(E$1.INVALID_ARGUMENT, t);
    }
...
var Br = Gr(_r, "Use firebase.firestore() instead."), zr = Gr(Dr, "Use firebase.firestore().runTransaction() instead."), Qr = Gr(Rr, "Use firebase.firestore().batch() instead."), Wr = Gr(Vr, "Use firebase.firestore().doc() instead."), Yr = Gr(kr), Zr = Gr(Pr), Hr = Gr(Lr), Jr = Gr(Ur), $r = Gr(Or, "Use firebase.firestore().collection() instead."), Xr = Gr(/** @class */ function() {
    function t() {}
    return t.delete = function() {
        return rn("FieldValue.delete", arguments), new Rn;
    }, t.serverTimestamp = function() {
        return rn("FieldValue.serverTimestamp", arguments), new Vn;
    }, t.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return sn("FieldValue.arrayUnion", arguments, 1), new Sn(t);
    }, t.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we need access to the Firestore instance.
                return sn("FieldValue.arrayRemove", arguments, 1), new kn(t);
...
}(), "Use FieldValue.<field>() instead."), Kr = Gr(An, "Use Blob.fromUint8Array() or Blob.fromBase64String() instead."), ti = {
    Firestore: Br,
    GeoPoint: Ln,
    Timestamp: R$1,
    Blob: Kr,
    ...
    return t.prototype.ru = function(t) {
        ...
        window.removeEventListener("online", this.Uf), window.removeEventListener("offline", this.Wf);
    }, t.prototype.Hf = function() {
        window.addEventListener("online", this.Uf), window.addEventListener("offline", this.Wf);
    }, t.prototype.Qf = function() {
        Te("ConnectivityMonitor", "Network connectivity changed: AVAILABLE");
        for (var t = 0, e = this.Gf; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
     ...
     */    return t.prototype.rd = function(t, e) {
        ...
        return new Promise((function(o, s) {
            ...
            u.listenOnce(esm_3.COMPLETE, (function() {
                try {
                    switch (u.getLastErrorCode()) {
                      ...
                      case esm_2.TIMEOUT:
                        Te("Connection", 'RPC "' + t + '" timed out'), s(new N$1(E$1.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case esm_2.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                s(new N$1(i, r.message));
                            } else s(new N$1(E$1.UNKNOWN, "Server responded with status " + u.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        Te("Connection", 'RPC "' + t + '" failed'), s(new N$1(E$1.UNAVAILABLE, "Connection failed."));
                        break;
            ...
            r.rd(c, n), u.send(i, "POST", h, c, 15);
        }));
    }, t.prototype.$a = function(t, e, n) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.Na(t, e, n);
    }, t.prototype.Pa = function(t, e) {
        var n = [ this.nd, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = esm_1(), i = {
        ...
        this.rd(i.initMessageHeaders, e), 
        ...
        return v(esm_4.EventType.OPEN, (function() {
            ...
            d || (d = !0, Te("Connection", "WebChannel transport closed"), y.ed());
        })), v(esm_4.EventType.ERROR, (function(t) {
            d || (d = !0, Te("Connection", "WebChannel transport errored:", t), y.ed(new N$1(E$1.UNAVAILABLE, "The operation could not be completed")));
            ...
            if (!d) {
                ...
                if (i) {
                    ...
                    d = !0, y.ed(new N$1(u, a)), s.close();
                } else Te("Connection", "WebChannel received:", n), y.sd(n);
            }
        })), setTimeout((function() {
    ...
    t.prototype.hd = function(t) {
        var e = ii[t];
        return this.nd + "/v1/projects/" + this.ii.projectId + "/databases/" + this.ii.database + "/documents:" + e;
    }, t;
}();
